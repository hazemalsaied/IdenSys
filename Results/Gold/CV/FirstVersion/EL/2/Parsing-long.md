...
### Existing MWEs: 
1- **υπέβαλε πρόταση** (LVC, 1)Tokens : 
υπέβαλε
πρόταση
...
### Existing MWEs: 
1- **βάζει στο τραπέζι** (ID)Tokens : 
βάζει
στο
τραπέζι

### Identified MWEs: 
1- **βάζει στο τραπέζι** Tokens : 
βάζει
στο
τραπέζι
...
### Existing MWEs: 
1- **ανοίγει η κερκόπορτα** (ID)Tokens : 
ανοίγει
η
κερκόπορτα
...
### Existing MWEs: 
1- **θέτει στο τραπέζι** (ID, 1)Tokens : 
θέτει
στο
τραπέζι

### Identified MWEs: 
1- **θέτει στο τραπέζι** Tokens : 
θέτει
στο
τραπέζι
...
### Existing MWEs: 
1- **βγήκαν στη σύνταξη** (LVC, 2)Tokens : 
βγήκαν
στη
σύνταξη
...
### Existing MWEs: 
1- **έχει τη δυνατότητα** (ID, 3)Tokens : 
έχει
τη
δυνατότητα
...
### Existing MWEs: 
1- **ανοίξει τα χαρτιά του** (ID, 1)Tokens : 
ανοίξει
τα
χαρτιά
του
...
### Existing MWEs: 
1- **Επί τάπητος τεθούν** (ID)Tokens : 
Επί
τάπητος
τεθούν
...
### Existing MWEs: 
1- **λάβει μέτρα λιτότητος** (LVC)Tokens : 
λάβει
μέτρα
λιτότητος
...
### Existing MWEs: 
1- **ληφθούν αποφάσεις** (LVC, 7)Tokens : 
ληφθούν
αποφάσεις
...
### Existing MWEs: 
1- **πράσινο φως έδωσαν** (LVC)Tokens : 
πράσινο
φως
έδωσαν
...
### Existing MWEs: 
1- **τράπηκαν σε φυγή** (LVC)Tokens : 
τράπηκαν
σε
φυγή

### Identified MWEs: 
1- **Έσπασαν πέτρες** Tokens : 
Έσπασαν
πέτρες
...
### Existing MWEs: 
1- **πραγματοποιεί έρευνες** (LVC, 1)Tokens : 
πραγματοποιεί
έρευνες
...
### Existing MWEs: 
1- **δόθηκαν στη δημοσιότητα** (LVC, 11)Tokens : 
δόθηκαν
στη
δημοσιότητα

### Identified MWEs: 
1- **δόθηκαν στη δημοσιότητα** Tokens : 
δόθηκαν
στη
δημοσιότητα
...
### Existing MWEs: 
1- **βάζει νερό στο κρασί του** (ID, 2)Tokens : 
βάζει
νερό
στο
κρασί
...
### Identified MWEs: 
1- **βάζει νερό στο κρασί του** Tokens : 
βάζει
νερό
στο
κρασί
...
### Existing MWEs: 
1- **δημοσιότητα πάρει** (LVC)Tokens : 
δημοσιότητα
πάρει
...
### Existing MWEs: 
1- **έδωσαν ώθηση** (LVC, 2)Tokens : 
έδωσαν
ώθηση

### Identified MWEs: 
1- **έδωσαν ώθηση** Tokens : 
έδωσαν
ώθηση
...
### Existing MWEs: 
1- **κάνει επενδύσεις** (LVC)Tokens : 
κάνει
επενδύσεις

### Identified MWEs: 
1- **κάνει επενδύσεις** Tokens : 
κάνει
επενδύσεις
...
### Existing MWEs: 
1- **εναρκτήριο λάκτισμα έδωσε** (LVC)Tokens : 
εναρκτήριο
λάκτισμα
έδωσε

### Identified MWEs: 
1- **έδωσε στάση** Tokens : 
έδωσε
στάση
...
### Existing MWEs: 
1- **κάθεται σε αναμμένα κάρβουνα** (ID)Tokens : 
κάθεται
σε
αναμμένα
κάρβουνα
...
### Existing MWEs: 
1- **κάνει κινήσεις** (LVC, 1)Tokens : 
κάνει
κινήσεις

### Identified MWEs: 
1- **κάνει κινήσεις** Tokens : 
κάνει
κινήσεις
...
### Existing MWEs: 
1- **συναφθεί συμφωνία** (LVC)Tokens : 
συναφθεί
συμφωνία
...
### Existing MWEs: 
1- **θέσουμε σε εφαρμογή** (LVC, 5)Tokens : 
θέσουμε
σε
εφαρμογή

### Identified MWEs: 
1- **θέσουμε σε εφαρμογή** Tokens : 
θέσουμε
σε
εφαρμογή
...
### Existing MWEs: 
1- **ανοίγοντας τον δρόμο** (ID, 5)Tokens : 
ανοίγοντας
τον
δρόμο

### Identified MWEs: 
1- **ανοίγοντας τον δρόμο** Tokens : 
ανοίγοντας
τον
δρόμο
...
### Existing MWEs: 
1- **κάνει πρόταση** (LVC, 3)Tokens : 
κάνει
πρόταση

### Identified MWEs: 
1- **κάνει πρόταση** Tokens : 
κάνει
πρόταση
...
### Existing MWEs: 
1- **μελέτη βιωσιμότητας κάνει** (LVC)Tokens : 
μελέτη
βιωσιμότητας
κάνει
...
### Existing MWEs: 
1- **τεθεί ζήτημα** (LVC)Tokens : 
τεθεί
ζήτημα

### Identified MWEs: 
1- **τεθεί εκ ζήτημα** Tokens : 
τεθεί
εκ
ζήτημα
...
### Existing MWEs: 
1- **έκανε την εμφάνισή του** (LVC, 1)Tokens : 
έκανε
την
εμφάνισή
του
...
### Existing MWEs: 
1- **πάρει σάρκα και οστά** (ID)Tokens : 
πάρει
σάρκα
και
οστά
...
### Existing MWEs: 
1- **είναι προ των πυλών** (ID)Tokens : 
είναι
προ
των
πυλών
...
### Existing MWEs: 
1- **Σε εξέλιξη βρίσκεται** (LVC)Tokens : 
Σε
εξέλιξη
βρίσκεται
...
### Existing MWEs: 
1- **πραγματοποιηθεί έρευνες** (LVC, 1)Tokens : 
πραγματοποιηθεί
έρευνες
...
### Existing MWEs: 
1- **επισκέψεων πραγματοποιήσει** (LVC)Tokens : 
επισκέψεων
πραγματοποιήσει
...
### Existing MWEs: 
1- **πραγματοποιήσει επίσκεψη** (LVC)Tokens : 
πραγματοποιήσει
επίσκεψη

### Identified MWEs: 
1- **πραγματοποιήσει επίσκεψη** Tokens : 
πραγματοποιήσει
επίσκεψη
...
### Existing MWEs: 
1- **κρέμεται από μια κλωστή** (ID)Tokens : 
κρέμεται
από
μια
κλωστή
...
### Existing MWEs: 
1- **διεξάγονται εκλογές** (LVC)Tokens : 
διεξάγονται
εκλογές
...
### Existing MWEs: 
1- **βρέθηκε σε κίνδυνο** (LVC, 1)Tokens : 
βρέθηκε
σε
κίνδυνο
...
### Existing MWEs: 
1- **κάνω έκκληση** (LVC, 4)Tokens : 
κάνω
έκκληση

### Identified MWEs: 
1- **κάνω έκκληση** Tokens : 
κάνω
έκκληση
...
### Existing MWEs: 
1- **ελάμβανε γνώση** (LVC, 1)Tokens : 
ελάμβανε
γνώση

### Identified MWEs: 
1- **ελάμβανε γνώση** Tokens : 
ελάμβανε
γνώση
...
### Existing MWEs: 
1- **δώσει εντολή** (LVC, 10)Tokens : 
δώσει
εντολή

### Identified MWEs: 
1- **δώσει εντολή** Tokens : 
δώσει
εντολή
...
### Existing MWEs: 
1- **έχει ευθύνες** (LVC, 3)Tokens : 
έχει
ευθύνες

### Identified MWEs: 
1- **έχει ευθύνες** Tokens : 
έχει
ευθύνες
...
### Existing MWEs: 
1- **Έπαιξε στα ζάρια** (ID)Tokens : 
Έπαιξε
στα
ζάρια

### Identified MWEs: 
1- **Έπαιξε στα ζάρια** Tokens : 
Έπαιξε
στα
ζάρια
...
### Existing MWEs: 
1- **έχουμε χρέος** (LVC)Tokens : 
έχουμε
χρέος

### Identified MWEs: 
1- **έχουμε χρέος** Tokens : 
έχουμε
χρέος
...
### Existing MWEs: 
1- **φέρουμε σε πέρας** (LVC, 2)Tokens : 
φέρουμε
σε
πέρας
...
### Existing MWEs: 
1- **έλαβε τέλος** (LVC)Tokens : 
έλαβε
τέλος

### Identified MWEs: 
1- **έλαβε τέλος** Tokens : 
έλαβε
τέλος
...
### Existing MWEs: 
1- **αναφορά κάνει** (LVC)Tokens : 
αναφορά
κάνει

### Identified MWEs: 
1- **κάνει στους συνανθρώπους** Tokens : 
κάνει
στους
συνανθρώπους
...
### Existing MWEs: 
1- **διάλειμμα έκανε** (LVC)Tokens : 
διάλειμμα
έκανε

### Identified MWEs: 
1- **έκανε γραφείο** Tokens : 
έκανε
γραφείο
...
### Existing MWEs: 
1- **τίθεται ερώτημα** (LVC, 1)Tokens : 
τίθεται
ερώτημα
...
### Existing MWEs: 
1- **ανοίξω το δρόμο** (ID, 5)Tokens : 
ανοίξω
το
δρόμο

### Identified MWEs: 
1- **ανοίξω το δρόμο** Tokens : 
ανοίξω
το
δρόμο
...
### Existing MWEs: 
1- **το βάζω κάτω** (ID, 1)Tokens : 
το
βάζω
κάτω

### Identified MWEs: 
1- **το βάζω κάτω** Tokens : 
το
βάζω
κάτω
...
### Existing MWEs: 
1- **κάνει πράξη** (LVC)Tokens : 
κάνει
πράξη

### Identified MWEs: 
1- **κάνει πράξη** Tokens : 
κάνει
πράξη
...
### Existing MWEs: 
1- **κάνει ανταρσία** (LVC)Tokens : 
κάνει
ανταρσία

### Identified MWEs: 
1- **κάνει ανταρσία** Tokens : 
κάνει
ανταρσία
...
### Existing MWEs: 
1- **δώσει βάρος** (LVC)Tokens : 
δώσει
βάρος

### Identified MWEs: 
1- **δώσει βάρος** Tokens : 
δώσει
βάρος
