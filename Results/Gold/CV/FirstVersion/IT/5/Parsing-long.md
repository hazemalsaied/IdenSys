...
### Existing MWEs: 
1- **posta in contrapposizione** (LVC)Tokens : 
posta
in
contrapposizione
...
### Existing MWEs: 
1- **andare oltre** (VPC, 2)Tokens : 
andare
oltre

### Identified MWEs: 
1- **andare oltre** Tokens : 
andare
oltre
...
### Existing MWEs: 
1- **ritagliando- si** (IReflV)Tokens : 
ritagliando-
si
...
### Existing MWEs: 
1- **incontra il favore** (ID)Tokens : 
incontra
il
favore
...
### Existing MWEs: 
1- **prende parte** (LVC, 1)Tokens : 
prende
parte

### Identified MWEs: 
1- **prende parte** Tokens : 
prende
parte
...
### Existing MWEs: 
1- **conservare ricordo** (LVC)Tokens : 
conservare
ricordo
...
### Existing MWEs: 
1- **si comporta** (IReflV, 2)Tokens : 
si
comporta

### Identified MWEs: 
1- **si comporta** Tokens : 
si
comporta
...
### Existing MWEs: 
1- **darebbero per buona** (ID)Tokens : 
darebbero
per
buona

### Identified MWEs: 
1- **darebbero per buona** Tokens : 
darebbero
per
buona
...
### Existing MWEs: 
1- **differenziar- si** (IReflV)Tokens : 
differenziar-
si
...
### Existing MWEs: 
1- **trova applicazioni** (LVC)Tokens : 
trova
applicazioni
...
### Existing MWEs: 
1- **trovato uso** (LVC)Tokens : 
trovato
uso

### Identified MWEs: 
1- **trovato uso** Tokens : 
trovato
uso
...
### Existing MWEs: 
1- **sottometter- si** (IReflV)Tokens : 
sottometter-
si
...
### Existing MWEs: 
1- **si distinsero** (IReflV, 2)Tokens : 
si
distinsero

### Identified MWEs: 
1- **si distinsero** Tokens : 
si
distinsero
...
### Existing MWEs: 
1- **erano parte** (LVC, 4)Tokens : 
erano
parte

### Identified MWEs: 
1- **erano parte** Tokens : 
erano
parte
...
### Existing MWEs: 
1- **mettono in relazione** (ID, 1)Tokens : 
mettono
in
relazione

### Identified MWEs: 
1- **mettono in relazione** Tokens : 
mettono
in
relazione
...
### Existing MWEs: 
1- **fatte rivendicazioni** (LVC)Tokens : 
fatte
rivendicazioni
