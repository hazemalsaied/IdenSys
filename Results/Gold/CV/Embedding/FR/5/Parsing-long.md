...
2- **prendre précaution** (IReflV)Tokens : 
prendre
précaution
...
### Identified MWEs: 
1- **font de même** (ID)Tokens : 
font
de
même

2- **en font de même** (ID)Tokens : 
en
font
de
même
...
### Identified MWEs: 
1- **prennent precautions** (LVC)Tokens : 
prennent
precautions
...
### Identified MWEs: 
1- **traité signé** (LVC)Tokens : 
traité
signé

## Sentence No. 15119 - fr-ud-train_13688
depuis 4 mois , avec une science avisée , le capitaine de le génie gunther dirigeait par la sape et par la mine les travaux de siège régulier qui devaient ouvrir la voie à notre infanterie . 
### Existing MWEs: 
1- **ouvrir la voie** (ID, 1)Tokens : 
ouvrir
la
voie
...
### Existing MWEs: 
1- **se démarque** (IReflV, 2)Tokens : 
se
démarque

### Identified MWEs: 
1- **se démarque** (IReflV)Tokens : 
se
démarque
...
### Existing MWEs: 
1- **ça fait** (ID, 1)Tokens : 
ça
fait

## Sentence No. 15129 - fr-ud-train_13698
les gens ne se rendent pas bien compte de le coût énorme de l' opération ! 
### Existing MWEs: 
1- **se rendent compte** (ID, 6)Tokens : 
se
rendent
compte
...
### Existing MWEs: 
1- **menaient vie** (LVC, 2)Tokens : 
menaient
vie

### Identified MWEs: 
1- **menaient vie** (LVC)Tokens : 
menaient
vie
...
### Existing MWEs: 
1- **disputera match** (LVC, 9)Tokens : 
disputera
match

### Identified MWEs: 
1- **disputera match** (LVC)Tokens : 
disputera
match
...
a une question sur l' avenir de les relations algéro-libyennes , le premier ministre a réaffirmé que la libye était un pays « frère et voisin » à lequel , a -t -il dit , « nous ne tournerons pas le dos » . 
### Existing MWEs: 
1- **tournerons le dos** (ID, 2)Tokens : 
tournerons
le
dos

## Sentence No. 15162 - fr-ud-train_13731
un autre évènement fut marquant dans l' histoire de le palais : le 21 juin 1979 , un pyromane mit le feu à le bâtiment , entraînant la destruction d' un de les minarets et de deux tours , ainsi que de nombreux dommages dus à l' eau utilisée pour éteindre l' incendie . 
### Existing MWEs: 
1- **mit le feu** (ID, 3)Tokens : 
mit
le
feu

### Identified MWEs: 
1- **mit le feu** (ID)Tokens : 
mit
le
feu
...
### Existing MWEs: 
1- **se trouvent** (IReflV, 73)Tokens : 
se
trouvent
...
et si vous réservez , ne vous fiez pas à les tarifs indiqués sur le site de l' hôtel : à l' arrivée , vous découvrirez que tous les tarifs sont mystérieusement revus à la hausse d' environ 20 € . 
### Existing MWEs: 
...
### Identified MWEs: 
1- **vous fiez** (IReflV)Tokens : 
vous
fiez

## Sentence No. 15171 - fr-ud-train_13740
1 , le début de le prologue de jean est centré sur ce mot , « verbe » ( verbum ) en langue grecque ( langue dans laquelle l' Évangile fut écrit ) logos , il y a la synthèse de toute la profondeur et la force de la relation entre mot -- son -- divinité . 
### Existing MWEs: 
1- **il y a** (ID, 132)Tokens : 
il
y
...
les manifestations ont eu lieu dans un premier temps dans l' État de floride , puis dans de nombreuses villes de les États-unis notamment new york et chicago . 
### Existing MWEs: 
1- **eu lieu** (ID, 74)Tokens : 
eu
lieu
...
de nombreux gisements ont été découverts , la plupart se trouvant dans le canton de le valais , les autres dans les cantons de les grisons et de saint-gall . 
### Existing MWEs: 
1- **se trouvant** (IReflV, 73)Tokens : 
se
trouvant
...
### Existing MWEs: 
1- **prenant part** (ID, 14)Tokens : 
prenant
part

### Identified MWEs: 
1- **prenant part** (ID)Tokens : 
prenant
part
...
### Identified MWEs: 
1- **subit pertes** (LVC)Tokens : 
subit
pertes

## Sentence No. 15212 - fr-ud-train_13781
le matin nous partons retrouver les avocats de la défense que nous rencontrons dans un café à coté de le palais de justice de aïn sebaa où doit se dérouler le procès . 
### Existing MWEs: 
1- **se dérouler** (IReflV, 39)Tokens : 
se
dérouler
...
la coupe de france 2008 a eu lieu de le 8 septembre 2007 à le 27 avril 2008 . 
### Existing MWEs: 
1- **eu lieu** (ID, 74)Tokens : 
eu
lieu
...
### Existing MWEs: 
1- **s' articule** (IReflV, 2)Tokens : 
s'
articule

### Identified MWEs: 
1- **s' articule** (IReflV)Tokens : 
s'
articule

## Sentence No. 15236 - fr-ud-train_13805
pour les communes de moins de 10_000 habitants , les recensements ont lieu tous les cinq ans , les populations légales intermédiaires sont quant à elles estimées par calcul . 
### Existing MWEs: 
1- **ont lieu** (ID, 74)Tokens : 
ont
lieu
...
nous pouvons également faire quelques estimations de durée en partant de le temps qu' il faudrait pour rembourser les dettes . 
### Existing MWEs: 
1- **il faudrait** (ID, 91)Tokens : 
il
faudrait

### Identified MWEs: 
1- **il faudrait** (ID)Tokens : 
il
faudrait

## Sentence No. 15246 - fr-ud-train_13815
elle a la charge de la formation de les élèves officiers . 
### Existing MWEs: 
1- **a charge** (ID)Tokens : 
a
charge

### Identified MWEs: 
1- **a charge** (LVC)Tokens : 
a
charge
...
### Existing MWEs: 
1- **se situer** (IReflV, 33)Tokens : 
se
situer

### Identified MWEs: 
1- **se situer** (IReflV)Tokens : 
se
situer
...
victorin de pettau ( mort en 303 ou 304 ) était un auteur ecclésiastique , dont l' activité se situe à les alentours de 270 , et qui subit le martyre lors de la persécution de l' empereur dioclétien . 
### Existing MWEs: 
1- **se situe** (IReflV, 33)Tokens : 
se
situe
...
la mairie et l' église se situant à le bourg , les commerces eux sont présents à la gare avec un salon de coiffure , un magasin tupperware , une boulangerie , un bistrot , une épicerie et enfin sa boucherie réputée pour ses saucisses à l' oignon ( médaille d' or à les salon de l' agriculture de paris ) . 
### Existing MWEs: 
1- **se situant** (IReflV, 33)Tokens : 
se
situant
...
désapprouvant cette décision , l' armée yougoslave se révolte deux jours plus tard et proclame la majorité de le jeune pierre ii . 
### Existing MWEs: 
1- **se révolte** (IReflV, 2)Tokens : 
se
révolte
...
### Existing MWEs: 
1- **a valeur** (ID)Tokens : 
a
valeur

### Identified MWEs: 
1- **a valeur** (LVC)Tokens : 
a
valeur

## Sentence No. 15287 - fr-ud-train_13856
le solde naturel annuel , qui est la différence entre le nombre de naissances et le nombre de décès enregistrés à le cours d' une même année , connaît une forte baisse , puisque la variation annuelle due à le solde naturel passe de 0,8 à -0,1 . 
### Existing MWEs: 
1- **connaît baisse** (LVC)Tokens : 
connaît
baisse
...
### Existing MWEs: 
1- **mettra en scène** (ID, 10)Tokens : 
mettra
en
scène

### Identified MWEs: 
1- **mettra en scène** (ID)Tokens : 
mettra
en
scène

## Sentence No. 15298 - fr-ud-train_13867
une vieille tradition populaire dit qu' elle se tenait à l' origine à saint-denis-de-méré , à quelques kilomètres à le nord-est ; 
### Existing MWEs: 
1- **se tenait** (IReflV, 4)Tokens : 
se
tenait

## Sentence No. 15307 - fr-ud-train_13876
barbie se fait virer de le tournage de " la princesse à le petit pois " parce qu' elle n' a pas la même vision de les choses que le réalisateur . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **prendre soin** (ID, 3)Tokens : 
prendre
soin

### Identified MWEs: 
1- **prendre soin** (ID)Tokens : 
prendre
soin

## Sentence No. 15317 - fr-ud-train_13886
l' exploitation de le patrimoine génétique , qui n' a pas moins d' impact psychologique que celle de le nouveau monde ou de l' espace , met en position dangereuse l' intégrité traditionnelle de l' identité humaine , et est encadrée par un cortège de lois éthiques . 
### Existing MWEs: 
1- **a impact** (LVC, 3)Tokens : 
a
impact

## Sentence No. 15318 - fr-ud-train_13887
il y a alors trans-phosphorylation à le niveau de certains résidus tyrosines de le récepteur ( activité tyrosine kinase intrinsèque de le récepteur ) . 
### Existing MWEs: 
1- **il y a** (ID, 132)Tokens : 
il
y
...
un jugement impérial consacra la réunification de la bavière-landshut et la bavière munichoise et en peu d' années , landshut , naguère capitale et plaque tournante de le commerce de le sel ( l' « or blanc » qui avait fait la fortune de les ducs ) , perdit de son importance . 
### Existing MWEs: 
1- **fait fortune** (ID, 1)Tokens : 
fait
fortune
...
### Existing MWEs: 
1- **jouer jeu** (LVC)Tokens : 
jouer
jeu

### Identified MWEs: 
1- **jouer le jeu** (ID)Tokens : 
jouer
le
jeu
...
### Existing MWEs: 
1- **fait tournées** (LVC, 2)Tokens : 
fait
tournées

### Identified MWEs: 
1- **fait tournées** (LVC)Tokens : 
fait
tournées
...
il n' y eut pas d' équipes exemptées qui passèrent d' office à le tour suivant . 
### Existing MWEs: 
1- **il y eut** (ID, 132)Tokens : 
il
y
eut
...
l' hôtel mahari se trouve à la lisière de le quartier no 2 à syrte . 
### Existing MWEs: 
1- **se trouve** (IReflV, 73)Tokens : 
se
trouve
...
celui-ci permet de doper la production de les aciéries à un moment où il faut alimenter les usines construites grâce à le plan marshall . 
### Existing MWEs: 
1- **il faut** (ID, 91)Tokens : 
il
faut
...
### Existing MWEs: 
1- **se battrait** (IReflV, 9)Tokens : 
se
battrait

### Identified MWEs: 
1- **se battrait** (IReflV)Tokens : 
se
battrait
...
### Existing MWEs: 
1- **s' en suivi** (ID, 1)Tokens : 
s'
en
suivi

### Identified MWEs: 
1- **s' suivi** (IReflV)Tokens : 
s'
suivi
...
### Existing MWEs: 
1- **avait tendance** (LVC, 10)Tokens : 
avait
tendance

### Identified MWEs: 
1- **avait tendance** (LVC)Tokens : 
avait
tendance

## Sentence No. 15392 - fr-ud-train_13961
il doit par ailleurs tenir compte de les orientations définies par l' agence régionale de santé . 
### Existing MWEs: 
...
le 14 mars 2011 , un camion d' essence carbu-réacteur ( jet a1 ) exploité par pétro air services , propriété d' aéropro , s' est renversé à l' aéroport de saint-hubert laissant s' échapper 19_000 l de carburant dans le réseau d' égout autour de l' aéroport . 
### Existing MWEs: 
...
en tête de le classement , orléans et le mans s' imposent face à strasbourg ( 99-71 ) et à rouen ( 85-64 ) . 
### Existing MWEs: 
1- **s' imposent** (IReflV, 12)Tokens : 
s'
imposent
...
### Existing MWEs: 
1- **se déroulerait** (IReflV, 39)Tokens : 
se
déroulerait

### Identified MWEs: 
1- **se déroulerait** (IReflV)Tokens : 
se
déroulerait
...
### Existing MWEs: 
1- **déployer efforts** (LVC)Tokens : 
déployer
efforts

## Sentence No. 15437 - fr-ud-train_14006
la famille villebois-mareuil prétendait avoir été anoblie par le roi philippe-auguste sur le champ de bataille de bouvines en 1214 , être originaire de le périgord et s' être implantée en mayenne . 
### Existing MWEs: 
1- **s' implantée** (IReflV, 1)Tokens : 
s'
implantée

### Identified MWEs: 
1- **s' implantée** (IReflV)Tokens : 
s'
implantée

## Sentence No. 15439 - fr-ud-train_14008
ce grand écart place la france dans une position qui pourrait s' avérer délicate vis-à-vis de l' union européenne : elle rend l' accomplissement de les obligations de résultat fixées par la directive cadre sur l' eau ( dce ) à l' horizon 2015 plus coûteux , plus difficile et plus aléatoire . 
### Existing MWEs: 
1- **s' avérer** (IReflV, 10)Tokens : 
s'
avérer
...
ce sera aussi l' une de les plus grosses introductions en bourse de tous les temps , qui se situera vers le 6e rang à les etats-unis ( derrière notamment celles de visa et general motors ) et le 15e rang mondial , selon la société de recherche renaissance capital , spécialisée dans les entrées en bourse . 
### Existing MWEs: 
1- **se situera** (IReflV, 33)Tokens : 
se
situera

### Identified MWEs: 
1- **se situera** (IReflV)Tokens : 
se
situera
...
### Existing MWEs: 
1- **tomber amoureuse** (ID, 2)Tokens : 
tomber
amoureuse
...
holden mcneil a co-créé avec son ami banky edwards le comic book bluntman & chronic , qui met en scène deux super-héros inspirés de les dealers jay & silent bob . 
### Existing MWEs: 
...
puis , il lance l' assaut sur korhal , mais mengsk lui file entre les doigts à le dernier moment , sauvé par raynor . 
### Existing MWEs: 
1- **lance assaut** (LVC, 2)Tokens : 
lance
assaut

## Sentence No. 15499 - fr-ud-train_14068
les différents travaux se composent de le broyage de les sarments , réalisé lorsque les sarments sont tirés et mis à le milieu de le rang . 
### Existing MWEs: 
1- **se composent** (IReflV, 9)Tokens : 
se
composent
...
ce qui provoqua le fait que 95 % de les terres étaient à le mains de seigneurs protestants ( qui s' étaient déjà emparé de les terres à le xviie siècle ) ou de petits propriétaires protestants à la fin de le xviiie siècle , la plupart de les irlandais n' étant plus que fermiers ou ouvriers agricoles . 
### Existing MWEs: 
1- **s' emparé** (IReflV, 16)Tokens : 
s'
emparé
...
face à la situation de les enfants et de les adolescents qui se trouvent en difficulté scolaire , à les problèmes d' absentéisme , de démotivation , de comportements perturbateurs et violents , ces nouveaux organes semblent présenter le meilleur cadre pour encadrer les élèves mal dans leur peau . 
### Existing MWEs: 
1- **se trouvent** (IReflV, 73)Tokens : 
se
trouvent
...
y a -t -il eu des réactions à le niveau de le maroc ? 
### Existing MWEs: 
1- **y -il eu** (ID)Tokens : 
y
-il
...
le terme est aussi quelquefois utilisé pour faire référence à le logarithme de le côté droit de cette expression , qui est approximativement égal à 1,186_569_110 . 
### Existing MWEs: 
...
« il faudra à le moins deux mois entre la mise en place de le conseil d' administration et l' accueil de les premiers jeunes » , explique jeanne schneider , la directrice de la future école de la deuxième chance . 
### Existing MWEs: 
1- **il faudra** (ID, 91)Tokens : 
il
faudra
...
### Existing MWEs: 
1- **se prononce** (IReflV, 4)Tokens : 
se
prononce

### Identified MWEs: 
1- **se prononce** (IReflV)Tokens : 
se
prononce
...
### Existing MWEs: 
1- **me demandais** (IReflV, 3)Tokens : 
me
demandais

### Identified MWEs: 
1- **me demandais** (IReflV)Tokens : 
me
demandais

2- **se sortir** (IReflV)Tokens : 
se
sortir

## Sentence No. 15559 - fr-ud-train_14128
pour trouver un appartement ou une villa à les issambres ou dans le coin , je vous conseille fortement de vous adresser à cette agence . 
### Existing MWEs: 
1- **vous adresser** (IReflV)Tokens : 
vous
adresser

## Sentence No. 15574 - fr-ud-train_14143
il se réfère à les principes édictés par l' alliance coopérative internationale ( déclaration sur l' identité coopérative ) . 
### Existing MWEs: 
1- **se réfère** (IReflV, 6)Tokens : 
se
réfère
...
### Existing MWEs: 
1- **feront apparition** (LVC, 11)Tokens : 
feront
apparition

### Identified MWEs: 
1- **feront apparition** (LVC)Tokens : 
feront
apparition

## Sentence No. 15606 - fr-ud-train_14175
il participe à l' attaque de juin 2004 de la ville congolaise de bukavu et bat en retraite à le rwanda voisin après la défaite . 
### Existing MWEs: 
1- **bat en retraite** (ID, 1)Tokens : 
bat
en
retraite

### Identified MWEs: 
1- **bat en retraite** (ID)Tokens : 
bat
en
retraite
...
ces mesures d' austérité s' articulent autour d' une hausse de les prélèvements obligatoires , une réduction de les dépenses publiques et une vague de privatisations . 
### Existing MWEs: 
1- **s' articulent** (IReflV, 2)Tokens : 
s'
articulent
...
### Existing MWEs: 
1- **se demandera** (IReflV, 3)Tokens : 
se
demandera

### Identified MWEs: 
1- **se demandera** (IReflV)Tokens : 
se
demandera
...
### Existing MWEs: 
1- **faire en sorte** (ID, 2)Tokens : 
faire
en
sorte

### Identified MWEs: 
1- **faire en sorte** (ID)Tokens : 
faire
en
sorte
...
### Existing MWEs: 
1- **se moquer** (IReflV, 2)Tokens : 
se
moquer

### Identified MWEs: 
1- **se moquer** (IReflV)Tokens : 
se
moquer

## Sentence No. 15662 - fr-ud-train_14231
avant de me rendre dans les camps , j' ai rencontré un représentant de le front polisario à londres qui m' a dit : « les camps sont l' un de les endroits les plus sûrs de cette planète » . 
### Existing MWEs: 
1- **me rendre** (IReflV, 32)Tokens : 
me
rendre

### Identified MWEs: 
1- **me rendre** (IReflV)Tokens : 
me
rendre

## Sentence No. 15673 - fr-ud-train_14242
le gouvernement , réuni en conseil de les ministres , conseille également son chef lorsque celui-ci souhaite poser la question de confiance à le congrès de les députés ou demander la dissolution de les cortes . 
### Existing MWEs: 
1- **poser question** (LVC, 5)Tokens : 
poser
question

### Identified MWEs: 
1- **question demander** (LVC)Tokens : 
question
demander

2- **poser question demander** (ID)Tokens : 
poser
question
demander

## Sentence No. 15686 - fr-ud-train_14255
la cérémonie de les 9èmes latin grammy awards a eu lieu le 13 novembre 2008 à le toyota center de houston à le texas et a été diffusée sur univision . 
### Existing MWEs: 
1- **eu lieu** (ID, 74)Tokens : 
eu
lieu
...
l' association vient d' acquérir pour un montant de 1_200 € un bateau de servitude pour les travaux à effectuer sur le plan d' eau . 
### Existing MWEs: 
1- **travaux effectuer** (LVC, 2)Tokens : 
travaux
effectuer

### Identified MWEs: 
1- **travaux effectuer** (LVC)Tokens : 
travaux
effectuer
...
### Existing MWEs: 
1- **auront lieu** (ID, 74)Tokens : 
auront
lieu

### Identified MWEs: 
1- **auront lieu** (ID)Tokens : 
auront
lieu
...
### Existing MWEs: 
1- **livré bataille** (LVC, 2)Tokens : 
livré
bataille

### Identified MWEs: 
1- **livré bataille** (LVC)Tokens : 
livré
bataille
...
il faudrait être bien difficile pour ne pas passer là une soirée de les plus agréables . 
### Existing MWEs: 
1- **il faudrait** (ID, 91)Tokens : 
il
faudrait
...
il est fréquent que les verts se voient reprocher leur fondamentalisme , leur réalisme ou à le contraire leur « gauchisme » ( suite à l' adhésion de militants venus de l' extrême gauche ou de le psu , à les alentours de 1992 ) . 
### Existing MWEs: 
1- **se voient** (IReflV, 13)Tokens : 
se
voient
...
a l' intérieur de le donjon se dressent de gros piliers de bois . 
### Existing MWEs: 
1- **se dressent** (IReflV, 4)Tokens : 
se
dressent
...
elle faisait partie avant cela de le département de l' ourthe . 
### Existing MWEs: 
...
la gestion de le savoir ( gs ) a pour objectif la valorisation de le savoir à le sein d' une entreprise ou d' une organisation pour de meilleures performances . 
### Existing MWEs: 
...
l' usage officiel a lieu le 25 avril , en place de grève , sanson tranche parfaitement la tête de le bandit nicolas pelletier . 
### Existing MWEs: 
1- **a lieu** (ID, 74)Tokens : 
a
lieu
...
### Existing MWEs: 
1- **a signification** (LVC, 3)Tokens : 
a
signification
...
### Existing MWEs: 
1- **photographies prises** (LVC)Tokens : 
photographies
prises
...
lors de le match retour 2 / 2 disputé à le stade d' highbury , un doublé de cantona , répond à l' ouverture de le score par paul gascoigne , permettant à les espoirs français d' obtenir un match nul et la qualification . 
### Existing MWEs: 
...
la santé de les personnages n' est pas indiquée : ils peuvent se rétablir mais plusieurs coup enchainés rapidement à la suite entraînent la mort . 
### Existing MWEs: 
1- **se rétablir** (IReflV)Tokens : 
se
rétablir
...
le succès de le marché hebdomadaire qui se déroulait sur le cours carnot tous les dimanche , incita les agriculteurs de la commune à perfectionner leur outil de travail en créant , dès 1958 , un ceta . 
### Existing MWEs: 
1- **se déroulait** (IReflV, 39)Tokens : 
se
déroulait

### Identified MWEs: 
1- **se déroulait** (IReflV)Tokens : 
se
déroulait
...
buh - buh ray et d-von ( 2 des nombreux « fils » de willy loman " big daddy " dudley ) ont acquis leur reconnaissance pour leur degré d' interviews à connotation profane , explicite , et vitriolique , qui antagonisait la foule à le point de l' amener à faire une émeute . 
### Existing MWEs: 
1- **faire émeute** (ID)Tokens : 
faire
émeute
...
### Existing MWEs: 
1- **effectue demande** (LVC)Tokens : 
effectue
demande

## Sentence No. 15913 - fr-ud-train_14482
ceux qui en doutent doivent méditer cet élan de patriotisme qui s' est emparé spontanément de notre jeunesse , à la suite de les incidents qui ont émaillé la qualification de l' équipe nationale de football à la coupe de le monde 2010 . 
### Existing MWEs: 
1- **s' emparé** (IReflV, 16)Tokens : 
s'
emparé
...
il faut dire que l' halalisation de les restaurants en question est présentée par quick comme un simple « test » . 
### Existing MWEs: 
1- **il faut** (ID, 91)Tokens : 
il
faut
...
selon la tradition , le nom de le village proviendrait de les prisonniers de les tartares fait prisonniers à le moyen Âge par les princes ruthènes , les arłaman ( vagabonds ) . 
### Existing MWEs: 
1- **fait prisonniers** (ID, 6)Tokens : 
fait
prisonniers
...
formé lors de le déclin de le vérisme , sensible à la musique de wagner , il obtient son premier succès avec giovanni gallurese , créé à turin en 1905 . 
### Existing MWEs: 
...
la contrepartie de les divorces unilatéraux et de les répudiations infondés consiste dans une prestation compensatoire sans remise en cause de l' acte de volonté unilatéral : la femme a droit à des dommages-intérêts pour le préjudice qu' elle a subi , elle a en principe la garde de les enfants et doit retourner auprès de son tuteur matrimonial ; 
### Existing MWEs: 
1- **a droit** (LVC, 14)Tokens : 
a
droit
...
la population est alors indigène et fait partie de les nearchi , peuple établi sur une partie de la crau et de les alpilles . 
### Existing MWEs: 
1- **fait partie** (ID, 71)Tokens : 
fait
partie
...
### Existing MWEs: 
1- **s' appuyait** (IReflV, 7)Tokens : 
s'
appuyait

### Identified MWEs: 
1- **s' appuyait** (IReflV)Tokens : 
s'
appuyait
...
### Existing MWEs: 
1- **conventions signées** (LVC, 1)Tokens : 
conventions
signées
...
elle est traditionnellement divisée en deux parties : la zone de sorgenfrei-tornquist à le nord-ouest , et la zone de teisseyre-tornquist à le sud-est , la jonction s' effectuant à le niveau de bornholm . 
### Existing MWEs: 
1- **jonction effectuant** (LVC)Tokens : 
jonction
effectuant

## Sentence No. 16026 - fr-ud-dev_00041
le solde naturel annuel , qui est la différence entre le nombre de naissances et le nombre de décès enregistrés à le cours d' une même année , connaît une forte augmentation , puisque la variation annuelle due à le solde naturel passe de -1 à -0,8 . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **porter nom** (ID, 12)Tokens : 
porter
nom

### Identified MWEs: 
1- **porter nom** (ID)Tokens : 
porter
nom
...
le 24 ric , créé par décret de le 16 décembre 1902 a été mis sur pied à perpignan . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **ont positions** (LVC, 1)Tokens : 
ont
positions

## Sentence No. 16066 - fr-ud-dev_00081
l extension de la ligne 7 de le métro de new york est étroitement liée à le ré-aménagement de l' hudson yards , elle a pour but d' étendre l' irt flushing line , vers l' ouest à partir de son terminus actuel à times square . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **s' abattit** (IReflV, 3)Tokens : 
s'
abattit

### Identified MWEs: 
1- **s' abattit** (IReflV)Tokens : 
s'
abattit
...
il lui restait à battre pat buchanan , relativement isolé à le sein de le parti , steve forbes , phillip gramm ( soutenu notamment par le sénateur john mccain de l' arizona et la sénatrice kay bailey hutchison de le texas ) alors que pete wilson , le gouverneur de californie et ancien sénateur , soutenu par la branche modérée et progressiste de le parti , se retirait rapidement de la course . 
### Existing MWEs: 
1- **se retirait** (IReflV, 15)Tokens : 
se
retirait

### Identified MWEs: 
1- **se retirait** (IReflV)Tokens : 
se
retirait
...
l' habit de les cristaux est majoritairement hypidiomorphe et la texture prend l' allure d' une mosaïque . 
### Existing MWEs: 
1- **prend allure** (LVC)Tokens : 
prend
allure

## Sentence No. 16091 - fr-ud-dev_00106
lorsque chilpéric ii et rainfroy accordent un « royaume et des dons » à eudes , ils ne livrent pas le royaume de neustrie à eudes mais paient une alliance par la reconnaissance de le vice-royaume d' aquitaine et la scelle par un échange de dons selon un cérémonial rigoureusement identique à celui qui régla la rencontre entre judicaël et dagobert i. 
### Existing MWEs: 
1- **alliance scelle** (LVC)Tokens : 
alliance
scelle
...
selon les initiateurs de ce comité ( pensé à la manière de le comité de vigilance de les intellectuels antifascistes de l' entre deux guerres ) , les historiens ont aussi leur rôle de citoyens à assumer . 
### Existing MWEs: 
1- **rôle assumer** (LVC)Tokens : 
rôle
assumer

### Identified MWEs: 
1- **ont rôle** (LVC)Tokens : 
ont
rôle
...
### Identified MWEs: 
1- **tenu parole** (LVC)Tokens : 
tenu
parole

## Sentence No. 16129 - fr-ud-dev_00144
son travail est récompensé : à le début de la saison 2008 , nick holt , coordinateur de la défense , et pete carroll décide de placer matthews dans une position hybride où matthews se tient en position de defensive end , mais utilise la vitesse et la tactique d' un linebacker . 
### Existing MWEs: 
1- **se tient** (IReflV, 4)Tokens : 
se
tient
...
l' information n' a d' ailleurs fait l' objet d' aucun démenti de la part de le ministère de la justice algérienne . 
### Existing MWEs: 
1- **fait l' objet** (ID, 23)Tokens : 
fait
l'
...
à le fil de les histoires , plusieurs seconds couteaux ( et quelques grands héros ) se sont greffés à les vengeurs . 
### Existing MWEs: 
1- **se greffés** (IReflV)Tokens : 
se
greffés

## Sentence No. 16154 - fr-ud-dev_00169
située à proximité de la route menant à le parc national de zion , il s' agit d' une de les villes fantômes les plus connues de le pays . 
### Existing MWEs: 
1- **il s' agit** (ID, 85)Tokens : 
il
s'
...
### Existing MWEs: 
1- **eut effet** (LVC, 5)Tokens : 
eut
effet

### Identified MWEs: 
1- **eut effet** (LVC)Tokens : 
eut
effet
...
il se compose de deux ensembles de lamelles articulés et fixées les unes à les autres par des rivets . 
### Existing MWEs: 
1- **se compose** (IReflV, 9)Tokens : 
se
compose
...
### Existing MWEs: 
1- **remporté succès** (LVC, 2)Tokens : 
remporté
succès

## Sentence No. 16181 - fr-ud-dev_00196
celui-ci fait 5_000 morts mais s' arrête juste devant une petite chapelle dédiée à marie . 
### Existing MWEs: 
1- **s' arrête** (IReflV, 5)Tokens : 
s'
arrête
...
simultanément , xara a libéré partiellement les sources de le logiciel -- mises sous licence gpl -- et a fait appel à l' aide communautaire pour le portage sous linux et mac os x . 
### Existing MWEs: 
1- **fait appel** (LVC, 26)Tokens : 
fait
appel
...
les premières sorties de l' eau connues dateraient de le dévonien supérieur , vers -365 ma , avec ichthyostega , « le plus ancien de les vertébrés connus présentant des adaptations pour une locomotion autre que la nage » . 
### Existing MWEs: 
1- **présentant adaptations** (LVC, 1)Tokens : 
présentant
adaptations

### Identified MWEs: 
1- **présentant adaptations** (LVC)Tokens : 
présentant
adaptations
...
une lettre qu' il adressa le 3 avril 1568 à le ministre william cecil donne un récit détaillé de la fuite de la reine d' Écosse le 25 mars précédent . 
### Existing MWEs: 
1- **donne récit** (LVC)Tokens : 
donne
récit

## Sentence No. 16244 - fr-ud-dev_00259
en mai 1955 , il souhaita , afin de pouvoir approcher de le premier ministre français , pierre mendès france , réaliser une interview de le romancier et lauréat de le prix nobel françois mauriac , qui était un ami proche de le premier ministre . 
### Existing MWEs: 
1- **réaliser interview** (LVC)Tokens : 
réaliser
interview
...
face à l' explosion de la demande de numéros liée à la démocratisation de le fax et de la téléphonie mobile , france télécom développa un nouveau plan , mis en œuvre le 18 octobre 1996 à 23 heures . 
### Existing MWEs: 
1- **mis en œuvre** (ID, 11)Tokens : 
mis
en
œuvre
...
il joua à la sampdoria , à la juventus ( pour qui il joua son premier match le 6 novembre 1960 lors d' une défaite contre le milan 4-3 en serie a ) et à le milan ac , remportant des titres à le niveaux national et européen . 
### Existing MWEs: 
1- **joua match** (LVC, 5)Tokens : 
joua
match
...
### Existing MWEs: 
1- **se produisit** (IReflV, 24)Tokens : 
se
produisit

### Identified MWEs: 
1- **se produisit** (IReflV)Tokens : 
se
produisit

## Sentence No. 16272 - fr-ud-dev_00287
livré à les britanniques et adaptés par eux , le m10 prit le nom dachilles . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **s' fait remarquer** (ID, 3)Tokens : 
s'
fait
remarquer
...
les deux scientifiques sont conscients de l' importance de les guérisons obtenues , mais ont un préjugé défavorable , facilement compréhensible , vis-à-vis de l' appareillage que priore leur décrit confusément dans son mauvais français . 
### Existing MWEs: 
1- **ont préjugé** (LVC, 2)Tokens : 
ont
préjugé

### Identified MWEs: 
1- **ont préjugé** (LVC)Tokens : 
ont
préjugé

## Sentence No. 16298 - fr-ud-dev_00313
les nounous ont proposé à les enfants un spectacle de marionnettes mettant en scène les animaux de la jungle . 
### Existing MWEs: 
1- **mettant en scène** (ID, 10)Tokens : 
mettant
en
...
toutefois , cette proximité de les trois grands types de climat a pour effet de les niveler avec une nette prédominance de le climat méditerranéen . 
### Existing MWEs: 
1- **a effet** (LVC, 5)Tokens : 
a
effet
...
l' irak dépendant grandement de le pétrole , saddam tenta de diversifier l' économie en menant un plan d' industrialisation . 
### Existing MWEs: 
1- **menant plan** (LVC)Tokens : 
menant
plan

## Sentence No. 16323 - fr-ud-dev_00338
meilleur restaurant à djibouti , le restaurant mer rouge à djibouti fait parti de les restaurants à découvrir absolument , de par sa qualité , son prix et son accueil . 
### Existing MWEs: 
1- **fait parti** (ID, 1)Tokens : 
fait
parti

### Identified MWEs: 
1- **fait parti** (ID)Tokens : 
fait
parti

## Sentence No. 16327 - fr-ud-dev_00342
quant à le cheval , en particulier le cheval ailé , il s' agit d' un symbole funéraire et d' un guide pour les âmes de les morts ( psychopompe ) . 
### Existing MWEs: 
1- **il s' agit** (ID, 85)Tokens : 
il
s'
...
d' autre part , le rôle joué par l' algérie dans la décolonisation de le continent africain a été mis en évidence par les participants qui ont focalisé sur l' aide dont ont bénéficié les différents mouvements de libération en afrique de la part de l' algérie . 
### Existing MWEs: 
1- **rôle joué** (LVC, 5)Tokens : 
rôle
joué
...
en raison de blessures à l' épaule , il ne dispute que 41 parties à le cours de la saison 2010 , et sa moyenne à le bâton n' est que de 0,185 . 
### Existing MWEs: 
1- **dispute parties** (LVC, 1)Tokens : 
dispute
parties
...
il demande à les religions de se conformer à la vertu naturelle de religion , sans tomber dans les excès qu' engendre trop souvent l' instinct religieux dans l' homme . 
### Existing MWEs: 
1- **se conformer** (IReflV, 2)Tokens : 
se
conformer

### Identified MWEs: 
1- **se conformer** (IReflV)Tokens : 
se
conformer
...
stan avouera avoir été influencé par cette façon « qui permet de tout dire sans se soucier de les intransigeances académiques ou institutionnelles » . 
### Existing MWEs: 
...
il y avait près de 1000 personnes à le lancement de l' événement à l' arsenal , le 8 septembre . 
### Existing MWEs: 
1- **il y avait** (ID, 132)Tokens : 
il
y
...
### Existing MWEs: 
1- **atterrissage effectué** (LVC)Tokens : 
atterrissage
effectué

## Sentence No. 16424 - fr-ud-dev_00439
la liste de les pilotes présents durant la saison 2011 se trouve sur le site officiel de la formula nippon 
### Existing MWEs: 
1- **se trouve** (IReflV, 73)Tokens : 
se
trouve
...
on rajoute à cela que la loi sur le tabac n' y est pas de le tout respectée , pour , semble t' il , le plus grand plaisir de le patron . 
### Existing MWEs: 
...
2- **signer paix** (LVC)Tokens : 
signer
paix

## Sentence No. 16441 - fr-ud-dev_00456
dans le même temps , nous cherchons une formule qui soit à la fois souple pour s' adapter à les différents lieux et à les temps liturgiques , et suffisamment fixe et immuable pour imprimer une sorte de marque de fabrique à notre chorale . 
### Existing MWEs: 
1- **s' adapter** (IReflV, 3)Tokens : 
s'
adapter
...
dans un silence médiatique où seuls les articles de presse défavorables font écho , les salariés de les ports français sont en proie à des pressions , alors qu' ils sont les victimes d' une situation injuste . 
### Existing MWEs: 
1- **font écho** (ID, 1)Tokens : 
font
écho

## Sentence No. 16483 - fr-ud-dev_00498
le marché commun de le golfe , devant déboucher vers la mise en place d' une monnaie commune , connaît aujourd'hui des retards en raison , entre autres de les divergences nées entre ryadh et abou dhabi , principalement à le sujet de le siège de la future banque centrale . 
### Existing MWEs: 
1- **connaît retards** (LVC)Tokens : 
connaît
retards
...
### Existing MWEs: 
1- **signé conventions** (LVC, 1)Tokens : 
signé
conventions
...
### Existing MWEs: 
1- **gardé souvenir** (LVC, 1)Tokens : 
gardé
souvenir

## Sentence No. 16514 - fr-ud-dev_00529
le suédois marcus allbäck inscrit le but de l' histoire de la coupe de le monde à la minute de la rencontre contre les anglais . 
### Existing MWEs: 
1- **inscrit but** (LVC, 2)Tokens : 
inscrit
but
...
commentaire de le président : il n' accepte pas « des relations diplomatiques conduites d' une manière aussi irresponsable » . 
### Existing MWEs: 
1- **relations conduites** (LVC)Tokens : 
relations
conduites
...
### Existing MWEs: 
1- **s' aliène** (IReflV)Tokens : 
s'
aliène

## Sentence No. 16531 - fr-ud-dev_00546
et déjà l' on fait cas de la réouverture imminente de les frontières longtemps réclamée par nos voisins de l' ouest . 
### Existing MWEs: 
1- **fait cas** (ID)Tokens : 
fait
cas
...
il peut s' agir de koláčky ( petites tartes ) ou encore de ovocné knedliky ( quenelles à les fruits ) . 
### Existing MWEs: 
1- **il s' agir** (ID, 85)Tokens : 
il
s'
...
### Existing MWEs: 
1- **perd la vie** (ID, 2)Tokens : 
perd
la
vie

### Identified MWEs: 
1- **perd la vie** (ID)Tokens : 
perd
la
vie

## Sentence No. 16543 - fr-ud-dev_00558
outre leur signification historique , les couleurs andalouses se distinguent par leur charge symbolique recueillie dans l' hymne de la communauté : le vert et le blanc représentent le désir de paix et l' espérance de le peuple d' andalousie . 
### Existing MWEs: 
1- **se distinguent** (IReflV, 10)Tokens : 
se
distinguent
...
### Existing MWEs: 
1- **s' illustra** (IReflV, 2)Tokens : 
s'
illustra

### Identified MWEs: 
1- **s' illustra** (IReflV)Tokens : 
s'
illustra
...
### Existing MWEs: 
1- **exercice pratique** (LVC)Tokens : 
exercice
pratique

## Sentence No. 16571 - fr-ud-dev_00586
son siège social se trouve à londres , à le royaume-uni . 
### Existing MWEs: 
1- **se trouve** (IReflV, 73)Tokens : 
se
trouve
...
### Existing MWEs: 
1- **portait nom** (ID, 12)Tokens : 
portait
nom

### Identified MWEs: 
1- **portait nom** (ID)Tokens : 
portait
nom
...
l' activité taurine a subi des hauts et de bas liés à les soubresauts historiques et économiques de le pays . 
### Existing MWEs: 
1- **subi hauts et bas** (LVC)Tokens : 
subi
hauts
et
bas
...
pour le garder sous sa coupe , robert lui donne une promotion , à le déplaisir de mcarson . 
### Existing MWEs: 
1- **donne promotion** (LVC)Tokens : 
donne
promotion
...
il accepte alors , sur la désignation de le général de maud'huy , de prendre sa succession à la direction générale et l' organisation de les scouts catholiques de france . 
### Existing MWEs: 
1- **prendre succession** (LVC, 3)Tokens : 
prendre
succession

### Identified MWEs: 
1- **prendre succession** (LVC)Tokens : 
prendre
succession

## Sentence No. 16626 - fr-ud-dev_00641
contrairement à la ville de park city qui occupait une place de premier rang à l' époque de la voie de chemin de fer , cave city a su tirer parti de le réseau autoroutier . 
### Existing MWEs: 
1- **tirer parti** (ID)Tokens : 
tirer
parti
...
ce village se situe dans le sud-ouest de le pays d' ouche dans lequel il jouxte les communes de planches , sainte-gauburge-sainte-colombe à le sud et mahéru à l' est . 
### Existing MWEs: 
1- **se situe** (IReflV, 33)Tokens : 
se
situe
...
### Existing MWEs: 
1- **s' illustre** (IReflV, 2)Tokens : 
s'
illustre

### Identified MWEs: 
1- **s' illustre** (IReflV)Tokens : 
s'
illustre

## Sentence No. 16644 - fr-ud-dev_00659
une collection de ses gravures se trouve à le musée d' art et d' histoire de saint-denis . 
### Existing MWEs: 
1- **se trouve** (IReflV, 73)Tokens : 
se
trouve
...
gorse réalise également de nombreuses expositions personnelles ( galerie de france ( 1969 ) , maison de la radio de bordeaux ( 1971 ) , centre culturel de meudon ( 1973 ) , office de le tourisme d' avoriaz ( 2005 ) ) mais aussi collectives ( salon de l' École française à le musée d' art moderne de la ville de paris ( 1969 ) , salon de mai ( 1975 ) , semaine franco-tunisienne , sousse ( 1986 ) ) . 
### Existing MWEs: 
1- **réalise expositions** (LVC, 1)Tokens : 
réalise
expositions
...
### Existing MWEs: 
1- **prennent leur distance** (ID)Tokens : 
prennent
leur
distance

### Identified MWEs: 
1- **prennent distance** (LVC)Tokens : 
prennent
distance

## Sentence No. 16671 - fr-ud-dev_00686
la longueur de le module m n' est autre que sa longueur comme groupe à opérateurs . 
### Existing MWEs: 
...
le baron zu guttenberg , 39 ans , le plus populaire de les ministres de la chancelière angela merkel , obtient un indice de satisfaction de 73 % , selon un sondage réalisé mardi pour la chaîne de télévision publique ard . 
### Existing MWEs: 
1- **sondage réalisé** (LVC)Tokens : 
sondage
réalisé
...
c' est alors qu' il prend ses distances avec la droite pour se rallier définitivement à le camp républicain . 
### Existing MWEs: 
1- **prend ses distances** (ID)Tokens : 
prend
ses
distances

### Identified MWEs: 
1- **prend distances** (LVC)Tokens : 
prend
distances

## Sentence No. 16692 - fr-ud-dev_00707
les médecins purent bientôt le déclarer hors de danger , et même les plus hostiles à le staretz durent convenir qu' il s' était produit là un événement quasi miraculeux de guérison à distance . 
### Existing MWEs: 
1- **s' produit** (IReflV, 24)Tokens : 
s'
produit
...
ce dernier est connu pour avoir pris des mesures de clémence à l' égard de les juifs de paris . 
### Existing MWEs: 
1- **pris mesures** (LVC, 5)Tokens : 
pris
mesures

### Identified MWEs: 
1- **pris mesures** (LVC)Tokens : 
pris
mesures

## Sentence No. 16698 - fr-ud-dev_00713
elle lui rit à le nez , et niida furieux lui tire dessus , écorchant le visage de chigusa . 
### Existing MWEs: 
1- **rit à le nez** (ID, 1)Tokens : 
rit
à
le
nez
...
### Existing MWEs: 
1- **faire marché** (ID)Tokens : 
faire
marché

### Identified MWEs: 
1- **faire marché** (LVC)Tokens : 
faire
marché

## Sentence No. 16709 - fr-ud-dev_00724
après des débuts comme apprenti , il ouvrit plus tard son propre magasin sur la place de le quartier puis s' y fit construire une maison . 
### Existing MWEs: 
1- **s' fit** (IReflV, 16)Tokens : 
s'
fit
...
attardons -nous désormais sur la une de le quotidien « l' economiste » de 31 mai 2011 . 
### Existing MWEs: 
1- **attardons -nous** (IReflV)Tokens : 
attardons
-nous
...
### Existing MWEs: 
1- **mènera campagnes** (LVC, 1)Tokens : 
mènera
campagnes
...
obama voulait gagner l' opinion publique de les pays qui ont fait leur révolution , comme en tunisie et en Égypte . 
### Existing MWEs: 
1- **fait révolution** (LVC)Tokens : 
fait
révolution
...
### Identified MWEs: 
1- **s' engagée** (IReflV)Tokens : 
s'
engagée

## Sentence No. 16757 - fr-ud-dev_00772
professeur d' arts plastiques , cette bordelaise de 26 ans a tout abandonné pour se consacrer à la libération de le colonel major kaddour terhzaz . 
### Existing MWEs: 
...
il s' agit de le premier bound for glory , évènement est le plus important de la tna . 
### Existing MWEs: 
1- **il s' agit** (ID, 85)Tokens : 
il
s'
...
en 2003 la firme t.a. ( tecnologie d' avanguardia ) , sous l' impulsion de les frères giovanni sebastiano et gian luca giannotti , a créé une marque de montres techniques de précision , sai ambrosini , se référant à l' origine d' équipementier de la firme . 
### Existing MWEs: 
1- **se référant** (IReflV, 6)Tokens : 
se
référant

### Identified MWEs: 
1- **se référant** (IReflV)Tokens : 
se
référant

## Sentence No. 16778 - fr-ud-dev_00793
pour les assurances épargne-pension , le fisc ne prend en compte que le rendement garanti et l' éventuelle participation à les bénéfices est exemptée de l' impôt final . 
### Existing MWEs: 
1- **prend en compte** (ID, 7)Tokens : 
prend
en
compte
...
### Existing MWEs: 
1- **mettent en cause** (ID, 4)Tokens : 
mettent
en
cause

### Identified MWEs: 
1- **mettent en cause** (ID)Tokens : 
mettent
en
cause
...
à le lieu de ceci , ruge décida que sa seule chance était de jouer la montre , d' immobiliser les allemands jusqu' à ce que des renforts puissent arriver de france et de le royaume-uni . 
### Existing MWEs: 
1- **jouer la montre** (ID)Tokens : 
jouer
la
montre

## Sentence No. 16803 - fr-ud-dev_00818
la bourse de paris a terminé en fanfare jeudi ( + 3,05 % ) , retrouvant le niveau de les 3.600 points , sur un marché dopé par la bonne tenue de wall street , le secteur de l' immobilier américain et des indicateurs européens redonnant confiance à les intervenants . 
### Existing MWEs: 
1- **redonnant confiance** (ID)Tokens : 
redonnant
confiance

### Identified MWEs: 
1- **redonnant confiance** (LVC)Tokens : 
redonnant
confiance
...
### Existing MWEs: 
1- **réalisera augmentation** (LVC)Tokens : 
réalisera
augmentation
...
### Existing MWEs: 
1- **se déroulaient** (IReflV, 39)Tokens : 
se
déroulaient
...
la 60e cérémonie de les primetime emmy awards , organisée par l' académie de les arts et de les sciences de la télévision et récompensant les séries télévisées diffusées à le cours de la saison 2007-2008 , s' est déroulée le 21 septembre 2008 à le nokia theater de los angeles . 
### Existing MWEs: 
1- **s' déroulée** (IReflV, 39)Tokens : 
s'
déroulée
...
à les élections générales de le 9 mars 2008 , elle se présente pour l' un de les quatre sièges à le sénat dans la province de pontevedra , et remporte plus de voix , soit le quatrième meilleur résultat . 
### Existing MWEs: 
1- **se présente** (IReflV, 18)Tokens : 
se
présente
...
### Existing MWEs: 
1- **il conviendra** (ID, 8)Tokens : 
il
conviendra

### Identified MWEs: 
1- **il conviendra** (ID)Tokens : 
il
conviendra

## Sentence No. 16871 - fr-ud-dev_00886
en réalité , le chef de le gouvernement espagnol oublie qu' une démocratie se doit d' être exemplaire et à la hauteur de les valeurs qu' elle proclame . 
### Existing MWEs: 
...
les vignobles autorisés se situent à le nord -- est de la province d' udine dans les communes de tarcento , nimis , faedis , povoletto , attimis , torreano , san pietro al natisone , prepotto , premariacco , buttrio , manzano , san giovanni al natisone et corno di rosazzo . 
### Existing MWEs: 
1- **se situent** (IReflV, 33)Tokens : 
se
situent
...
une partie de le forum s' écroule à le ixe siècle à la suite d' un glissement de terrain . 
### Existing MWEs: 
1- **s' écroule** (IReflV, 5)Tokens : 
s'
écroule

### Identified MWEs: 
1- **s' écroule** (IReflV)Tokens : 
s'
écroule

## Sentence No. 16882 - fr-ud-dev_00897
la commanderie de carentoir se situe dans un hameau de la commune de carentoir , dans le département de le morbihan , à environ soixante kilomètres à le nord de saint-nazaire , soixante kilomètres de vannes et de rennes . 
### Existing MWEs: 
1- **se situe** (IReflV, 33)Tokens : 
se
situe
...
des liens financiers avec les nazis existaient depuis 1936 , quand le ministre de les finances allemand hjalmar schacht avait rendu visite à le prince pour mettre en place un montage financier à partir de banques allemandes . 
### Existing MWEs: 
1- **rendu visite** (LVC, 6)Tokens : 
rendu
visite

### Identified MWEs: 
1- **rendu visite** (LVC)Tokens : 
rendu
visite

## Sentence No. 16887 - fr-ud-dev_00902
issue des résultats de les élections législatives françaises de 1986 , qui pour la première fois sous la cinquième république , se sont déroulées ( partiellement ) à le scrutin proportionnel ( listes départementales ) à un seul tour . 
### Existing MWEs: 
1- **se déroulées** (IReflV, 39)Tokens : 
se
déroulées
...
### Existing MWEs: 
1- **présente excuses** (LVC, 1)Tokens : 
présente
excuses
...
le club de le nac breda , défait lors de le barrage de qualification pour la ligue de les champions et troisième de la saison régulière , devra ainsi se contenter de la coupe intertoto 2008 . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **ayant rendement** (LVC, 1)Tokens : 
ayant
rendement
...
### Existing MWEs: 
1- **fait apparition** (LVC, 11)Tokens : 
fait
apparition
...
selon les époques et les civilisations , les artistes ont exécuté ces figurines de manière réaliste , ou bien , à le contraire , ils ont pris la plus grande liberté pour interpréter leur sujet . 
### Existing MWEs: 
1- **pris liberté** (ID)Tokens : 
pris
liberté

## Sentence No. 16939 - fr-ud-dev_00954
la température minimale moyenne de l' année se situe autour de les 9 ° c et la maximale 19 ° c . 
### Existing MWEs: 
1- **se situe** (IReflV, 33)Tokens : 
se
situe
...
### Identified MWEs: 
1- **prit en conséquence** (ID)Tokens : 
prit
en
conséquence

## Sentence No. 16954 - fr-ud-dev_00969
il se prélasse à le soleil , souvent avec son corps aligné parallèlement à les rayons de le soleil . 
### Existing MWEs: 
1- **se prélasse** (IReflV)Tokens : 
se
prélasse
...
2- **accomplit pays** (LVC)Tokens : 
accomplit
pays

## Sentence No. 16968 - fr-ud-dev_00983
il fait partie de les clubs fondateurs de le deuxième niveau national , baptisé promotion , en 1909 . 
### Existing MWEs: 
1- **fait partie** (ID, 71)Tokens : 
fait
partie
...
le village culmine à 600 m sur un site escarpé s' allongeant sur une longue arête rocheuse grise et domine la vallée de le cernon tout en étant abrité par le plateau de le larzac . 
### Existing MWEs: 
1- **s' allongeant** (IReflV)Tokens : 
s'
allongeant
...
cet hôpital s' est finalement transformé en ce que nous considérons maintenant comme un hôpital , avec des moines et des auxiliaires laïcs prodiguant des soins médicaux à les malades et à les pèlerins victimes de les nombreuses épidémies et maladies chroniques qui ont frappé l' europe occidentale à le moyen Âge . 
### Existing MWEs: 
1- **prodiguant soins** (LVC)Tokens : 
prodiguant
soins
...
### Existing MWEs: 
1- **mal tourné** (ID)Tokens : 
mal
tourné

## Sentence No. 17002 - fr-ud-dev_01017
le réseau artisans de le monde propose des interventions dans les écoles , des formations et des outils pédagogiques ( accessible par la centrale d' achats solidar'monde ) « pour permettre à les citoyens , selon les termes de l' association , d' avoir un regard critique sur les dysfonctionnements de le commerce international et de devenir acteurs d' une société plus juste » . 
### Existing MWEs: 
1- **avoir regard** (LVC)Tokens : 
avoir
regard
...
### Existing MWEs: 
1- **avoir significations** (LVC, 3)Tokens : 
avoir
significations

### Identified MWEs: 
1- **avoir significations** (LVC)Tokens : 
avoir
significations
...
### Identified MWEs: 
1- **donnait raison** (ID)Tokens : 
donnait
raison

## Sentence No. 17036 - fr-ud-dev_01051
la compagnie se substitue également à le pouvoir de le kaiser en nommant des fonctionnaires subalternes . 
### Existing MWEs: 
1- **se substitue** (IReflV, 1)Tokens : 
se
substitue

### Identified MWEs: 
1- **se substitue** (IReflV)Tokens : 
se
substitue
...
### Existing MWEs: 
1- **donner conseils** (LVC, 2)Tokens : 
donner
conseils
...
" nous apprécions les efforts de l' algérie dans le domaine de la lutte contre le terrorisme , tant à le maghreb que dans la région de le sahel ou ailleurs et nous en sommes très reconnaissants " , a affirmé m. benjamin dans une conférence de presse tenue à l' ambassade de les etats-unis à alger . 
### Existing MWEs: 
1- **conférence de presse tenue** (LVC)Tokens : 
conférence
de
presse
tenue
...
à le cœur de le bourg se trouve une plaza mayor à arcades , ombragée et fleurie . 
### Existing MWEs: 
1- **se trouve** (IReflV, 73)Tokens : 
se
trouve
...
### Existing MWEs: 
1- **voir le jour** (ID, 7)Tokens : 
voir
le
jour

### Identified MWEs: 
1- **voir le jour** (ID)Tokens : 
voir
le
jour

## Sentence No. 17081 - fr-ud-dev_01096
l' adjudant-général jean-daniel Œhlert fit alors marche sur les positions de les chouans afin de les enlever de vive force . 
### Existing MWEs: 
1- **fit marche** (LVC)Tokens : 
fit
marche

## Sentence No. 17091 - fr-ud-dev_01106
selon m. ménard , la nomination de m. parent sera « bien vue de les communautés culturelles » , puisqu' il a une sensibilité certaine sur ces questions . 
### Existing MWEs: 
1- **a sensibilité** (LVC)Tokens : 
a
sensibilité
...
le conseil constitutionnel s' est prononcé par décision ( dc n° 2010-626 ) de le 29 mars 2011 , sur la loi organique relative à le défenseur de les droits dont il avait été saisi par le premier ministre en application de les articles 46 et 61 de la constitution . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **connaîtra rebondissement** (LVC)Tokens : 
connaîtra
rebondissement

## Sentence No. 17123 - fr-ud-dev_01138
plus de 100 personnes se trouvaient à l' intérieur de l' usine à le moment de l' explosion . 
### Existing MWEs: 
1- **se trouvaient** (IReflV, 73)Tokens : 
se
trouvaient
...
en 1997 , l' américain décroche la médaille de bronze lors de les mondiaux indoor de paris , ainsi qu' à les championnats de le monde d' athènes , se classant derrière le danois wilson kipketer et le cubain norberto téllez . 
### Existing MWEs: 
...
à le yémen , des dizaines de milliers de manifestants ont envahi sanaa pour demander le départ de le président ali abdallah saleh , qui s' en est pris à le président américain barack obama et a accusé israël et les etats-unis de manipuler les arabes . 
### Existing MWEs: 
1- **s' en pris** (ID, 1)Tokens : 
s'
en
pris

### Identified MWEs: 
1- **s' pris** (IReflV)Tokens : 
s'
pris
...
pour accompagner le lancement de les ses différents macintosh , apple a fait appel de manière récurrente à la publicité . 
### Existing MWEs: 
1- **fait appel** (LVC, 26)Tokens : 
fait
appel
...
### Existing MWEs: 
1- **se produira** (IReflV, 24)Tokens : 
se
produira

### Identified MWEs: 
1- **se produira** (IReflV)Tokens : 
se
produira
...
### Existing MWEs: 
1- **faire partie** (ID, 71)Tokens : 
faire
partie

### Identified MWEs: 
1- **exercer fonctions** (LVC)Tokens : 
exercer
fonctions

2- **faire partie** (ID)Tokens : 
faire
partie

## Sentence No. 17223 - fr-ud-dev_01238
de même , certains plats , comme la carpe farcie , ont été élaborés afin de ne pas transgresser l' interdit de séparer le grain de l' ivraie , c'est-à-dire la chair de le poisson de ses arêtes . 
### Existing MWEs: 
1- **séparer le grain de l' ivraie** (ID)Tokens : 
séparer
le
grain
de
...
le score est encore alourdi par les colmariens peu avant la fin de le match , à la 87e , où marjewski inscrit le cinquième et dernier but de la rencontre . 
### Existing MWEs: 
1- **inscrit but** (LVC, 2)Tokens : 
inscrit
but
...
### Existing MWEs: 
1- **lut dans pensées** (ID)Tokens : 
lut
dans
pensées

## Sentence No. 17242 - fr-ud-dev_01257
nasser est pris à le piège et il entre en conflit avec l' arabie saoudite . 
### Existing MWEs: 
...
marty se l' approprie et décide de l' adapter , sans le consentement de jason , à le grand écran . 
### Existing MWEs: 
1- **se approprie** (IReflV)Tokens : 
se
approprie
...
### Identified MWEs: 
1- **fit morts** (LVC)Tokens : 
fit
morts

2- **eu résultat** (LVC)Tokens : 
eu
résultat

## Sentence No. 17251 - fr-ud-dev_01266
compte tenu également de le niveau de les investissements , c' est aussi le démarrage de le règne de les grandes entreprises qui sont capables d' intégration verticale et / ou de spécialisation . 
### Existing MWEs: 
...
grâce à certaines inscriptions nous savons presque certainement que la cité s' élève aujourd'hui dans la zone de le quartier colli aniene . 
### Existing MWEs: 
1- **s' élève** (IReflV, 21)Tokens : 
s'
élève
...
### Existing MWEs: 
1- **se mit** (IReflV, 6)Tokens : 
se
mit

## Sentence No. 17288 - fr-ud-dev_01303
les premières notices sur castrum sancti clementis sont de 962 quand ottone i en fit don à les comtes de carpegna . 
### Existing MWEs: 
1- **fit don** (LVC, 3)Tokens : 
fit
don

### Identified MWEs: 
1- **fit don** (LVC)Tokens : 
fit
don

2- **en fit don** (ID)Tokens : 
en
fit
don
...
### Existing MWEs: 
1- **exerça influence** (LVC, 2)Tokens : 
exerça
influence
...
### Existing MWEs: 
1- **fit apparition** (LVC, 11)Tokens : 
fit
apparition
...
athènes est entrée tardivement en récession , à le moment où les autres économies européennes se relèvent . 
### Existing MWEs: 
1- **se relèvent** (IReflV, 1)Tokens : 
se
relèvent

### Identified MWEs: 
1- **se relèvent** (IReflV)Tokens : 
se
relèvent

## Sentence No. 17312 - fr-ud-dev_01327
» déjà , à le mois d' avril , lors de le vote de le budget primitif , ils avaient tiré la sonnette d' alarme . 
### Existing MWEs: 
1- **tiré la sonnette d' alarme** (ID)Tokens : 
tiré
la
sonnette
d'
...
affublé d' un costume à les couleurs de la bannière étoilée et muni d' un bouclier issu de les technologies les plus avancées , captain america est envoyé à le front afin de mettre la pâté à les allemands et redonner du courage à les troupes américaines . 
### Existing MWEs: 
1- **mettre la pâté** (ID)Tokens : 
mettre
la
pâté

## Sentence No. 17361 - fr-ud-dev_01376
une démarche similaire a eu lieu en 1964 dans l' État de le mississippi où le mississippi freedom democratic party avait avec succès contesté la « légitimité de le parti démocrate local » . 
### Existing MWEs: 
1- **eu lieu** (ID, 74)Tokens : 
eu
lieu
...
si vous travaillez dans le quartier et que vous en avez marre de manger à la cantine de l' entreprise , allez vous restaurer à les jardins d' epicure . 
### Existing MWEs: 
1- **en avez marre** (ID)Tokens : 
en
avez
marre
...
### Existing MWEs: 
1- **se retirent** (IReflV, 15)Tokens : 
se
retirent
...
on y dispense le même enseignement qu' à paris , mais les concours et les diplômes , entrepris sous la direction de le maître d' atelier local , sont envoyés par le train et jugés dans la capitale . 
### Existing MWEs: 
1- **dispense enseignement** (LVC)Tokens : 
dispense
enseignement

## Sentence No. 17387 - fr-ud-dev_01402
m. sleimane doit clôturer mardi ces consultations avant de désigner un nouveau premier ministre pour remplacer saad hariri , dont le gouvernement d' union s' est effondré le 12 janvier avec la démission de les ministres de le camp de le hezbollah . 
### Existing MWEs: 
1- **s' effondré** (IReflV, 4)Tokens : 
s'
effondré

### Identified MWEs: 
1- **s' effondré** (IReflV)Tokens : 
s'
effondré
...
### Existing MWEs: 
1- **troc fit** (LVC)Tokens : 
troc
fit

### Identified MWEs: 
1- **fit mer** (LVC)Tokens : 
fit
mer

## Sentence No. 17399 - fr-ud-dev_01414
puis elle se tourne vers le théâtre en 1932 et est engagée à le birmingham repertory théâtre . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **exercent pouvoir** (LVC, 2)Tokens : 
exercent
pouvoir
...
kenshin n' ayant que l' intention de faire une démonstration de force n' était pas resté sur les terres de le clan hojo . 
### Existing MWEs: 
1- **ayant intention** (LVC, 3)Tokens : 
ayant
intention
...
### Existing MWEs: 
1- **disputèrent matchs** (LVC, 9)Tokens : 
disputèrent
matchs
...
### Existing MWEs: 
1- **s' étendent** (IReflV, 17)Tokens : 
s'
étendent

### Identified MWEs: 
1- **s' étendent** (IReflV)Tokens : 
s'
étendent

## Sentence No. 17451 - fr-ud-dev_01466
À l' ouverture de la tombe , un parfum merveilleux s' échappe de le cercueil , si bien que toutes les personnes présentes se croient à le paradis . 
### Existing MWEs: 
1- **s' échappe** (IReflV, 8)Tokens : 
s'
échappe
...
à le sud , les deux micro-pays de le val d' angoumois et de le pays d' aigre offrent des paysages de plaines et de forêt et font transition avec l' angoumois . 
### Existing MWEs: 
1- **font transition** (LVC)Tokens : 
font
transition
...
il s' agit donc d' un thyréophore basal , proche de l' ancêtre commun à les stégosauriens et ankylosauriens . 
### Existing MWEs: 
1- **il s' agit** (ID, 85)Tokens : 
il
s'
...
si , ce qui est probable , le premier ministre grec va à le bout de sa décision et que ses compatriotes rejettent le plan de sauvetage financier européen , la sortie de leur pays de la zone euro en sera inéluctable et , par effet induit , l' éclatement de celle-ci . 
### Existing MWEs: 
1- **va à le bout** (ID)Tokens : 
va
à
le
bout
...
en demi-finale , le japonais hidetoshi nakata marque le seul but de le match contre l' australie sur un coup franc de les 18 mètres tiré à raz de terre . 
### Existing MWEs: 
1- **marque but** (LVC, 5)Tokens : 
marque
but
...
conséquence : la moitié de les entreprises ayant obtenu un prêt ont dû apporter une garantie , et , dans les trois quarts de les cas , ce sont les dirigeants qui se sont portés garants . 
### Existing MWEs: 
1- **se portés** (IReflV, 1)Tokens : 
se
portés

## Sentence No. 17523 - fr-ud-dev_01538
ce stage se déroule de le lundi 4 à le vendredi 8 juillet . 
### Existing MWEs: 
1- **se déroule** (IReflV, 39)Tokens : 
se
déroule
...
### Existing MWEs: 
1- **faire arbitrage** (LVC, 1)Tokens : 
faire
arbitrage

### Identified MWEs: 
1- **faire arbitrage** (LVC)Tokens : 
faire
arbitrage
...
### Existing MWEs: 
1- **transactions font** (LVC)Tokens : 
transactions
font
...
### Existing MWEs: 
1- **s' en prennent** (ID, 1)Tokens : 
s'
en
prennent

### Identified MWEs: 
1- **s' prennent** (IReflV)Tokens : 
s'
prennent
...
### Identified MWEs: 
1- **trouvé preneur** (IReflV)Tokens : 
trouvé
preneur

## Sentence No. 17592 - fr-ud-test_00011
est -ce le fait de le hasard ou d' une malédiction que toute la zone comprise entre le soudan et la mauritanie soit instable ? 
### Existing MWEs: 
...
### Existing MWEs: 
1- **prenons conscience** (ID, 5)Tokens : 
prenons
conscience
...
### Existing MWEs: 
1- **pointe le bout de son nez** (ID)Tokens : 
pointe
le
bout
de
...
de nombreux marocains le pensent en n' hésitant pas à l' accuser , en tant que premier opérateur de le pays , d' abandonner des pans entiers de l' économie marocaine entre les mains de les réseaux affairistes et de les milieux de la corruption et à grossir les rangs de les mécontents . 
### Existing MWEs: 
1- **grossir les rangs** (ID)Tokens : 
grossir
les
rangs

## Sentence No. 17664 - fr-ud-test_00083
c'est-à-dire -- poursuit -il son argument -- , " avant , le maroc pensait que les indépendantistes étaient tout à le mieux un 5 % , les militants , mais quand on nous a vus tous unis , main dans la main , on n' en revenait pas ; 
### Existing MWEs: 
1- **n' en revenait pas** (ID, 1)Tokens : 
n'
en
revenait
pas
...
### Identified MWEs: 
1- **revenait ;** (LVC)Tokens : 
revenait
;

## Sentence No. 17671 - fr-ud-test_00090
tenue trois mois après la précédente réunion informelle de la valette ( malte ) , cette nouvelle rencontre se déroule sous les auspices de l' envoyé personnel de le secrétaire général de les nations unies pour le sahara occidental , m. christopher ross , en présence de les délégations de les deux parties et des représentants de les deux pays observateurs , l' algérie et la mauritanie . 
### Existing MWEs: 
1- **se déroule** (IReflV, 39)Tokens : 
se
déroule
...
a aucun moment , de le jour ou de la nuit s' il le faut . 
### Existing MWEs: 
1- **il faut** (ID, 91)Tokens : 
il
faut
...
m. ross réussira -t -il à faire valoir le droit international dans ces négociations , rabat bénéficiant de le soutien , entre autres , d' un membre permanent de le conseil de sécurité de l' onu , la france en l' occurrence . 
### Existing MWEs: 
...
la préfecture de police de paris déconseille à les automobilistes de se déplacer . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **en ont dans le slip** (ID)Tokens : 
en
ont
dans
le
...
à le sein de cette équipe professionnelle , chacun est important et a son rôle à jouer pour contribuer à le rayonnement de la ville de bayonne et de la culture basque . 
### Existing MWEs: 
1- **rôle jouer** (LVC, 5)Tokens : 
rôle
jouer
...
prenant la parole , charles mwando nsimba a sollicité un délai supplémentaire avant de répondre à les préoccupations soulevées , estimant que des éléments nouveaux y avaient été introduits . 
### Existing MWEs: 
1- **prenant la parole** (ID, 1)Tokens : 
prenant
la
parole

### Identified MWEs: 
1- **prenant la parole** (ID)Tokens : 
prenant
la
parole
...
troisième temps , andrea dovizioso ( honda ) s' en est approché ( 2:00.531 ) , comme ben spies et jorge lorenzo , tous deux sur yamaha m1 et distancés de moins de 8/10e de seconde de le leader . 
### Existing MWEs: 
1- **s' approché** (IReflV, 8)Tokens : 
s'
approché

### Identified MWEs: 
1- **s' approché** (IReflV)Tokens : 
s'
approché
...
il y a un personnage très absent tout à le long de le roman , le " peuple " . 
### Existing MWEs: 
1- **il y a** (ID, 132)Tokens : 
il
y
...
### Existing MWEs: 
1- **voyaient d' œil** (ID)Tokens : 
voyaient
d'
œil

## Sentence No. 17723 - fr-ud-test_00142
il s' agit de les importateurs utilisés par le comité fal pour établir le baromètre de le passage à le port . 
### Existing MWEs: 
1- **il s' agit** (ID, 85)Tokens : 
il
s'
...
ce sera l' ultime étape de coupe de france pour les catégories espoirs , la revanche de les championnats de france chez les vétérans , de plus en plus motivés par la compétition et quelques jours plus tard l' incontournable épreuve internationale qui cette année se déroulera en open . 
### Existing MWEs: 
1- **se déroulera** (IReflV, 39)Tokens : 
se
déroulera

### Identified MWEs: 
1- **se déroulera** (IReflV)Tokens : 
se
déroulera
...
### Existing MWEs: 
1- **n' est pas à son coup d' essai** (ID)Tokens : 
n'
est
pas
à
...
hormis ce professeur d' anglais , à le lycée , qui , quand elle le voyait sourire , pensait qu' il se moquait d' elle . 
### Existing MWEs: 
1- **se moquait** (IReflV, 2)Tokens : 
se
moquait

### Identified MWEs: 
1- **se moquait** (IReflV)Tokens : 
se
moquait
...
### Existing MWEs: 
1- **il était temps** (ID, 3)Tokens : 
il
était
temps

### Identified MWEs: 
1- **il était temps** (ID)Tokens : 
il
était
temps
...
### Existing MWEs: 
1- **réalisé travail** (LVC, 1)Tokens : 
réalisé
travail
...
### Existing MWEs: 
1- **on change pas une équipe qui gagne** (ID)Tokens : 
on
change
pas
une
...
### Existing MWEs: 
1- **le hasard fait bien les choses** (ID)Tokens : 
le
hasard
fait
bien
...
### Existing MWEs: 
1- **économies faites** (LVC)Tokens : 
économies
faites

## Sentence No. 17837 - fr-ud-test_00256
le patron semble avoir à cœur de ne pas négliger les plats à le profit de les vins . 
### Existing MWEs: 
1- **avoir à cœur** (ID)Tokens : 
avoir
à
cœur
...
nous avons pris possesion de 2 chambres cabines ayant les toilettes en commun : poussière et saleté étaient à le rendez-vous ! 
### Existing MWEs: 
1- **pris possesion** (ID, 4)Tokens : 
pris
possesion

### Identified MWEs: 
1- **pris possesion** (ID)Tokens : 
pris
possesion

2- **étaient à le rendez-vous** (ID)Tokens : 
étaient
à
le
rendez-vous
...
### Existing MWEs: 
1- **couronner le tout** (ID, 1)Tokens : 
couronner
le
tout
...
### Existing MWEs: 
1- **avais besoin** (LVC, 20)Tokens : 
avais
besoin

### Identified MWEs: 
1- **avais besoin** (LVC)Tokens : 
avais
besoin
...
pour mettre à les normes l' installation électrique de mon appart , j' ai fait appel à eux car les avis semblaient bons . 
### Existing MWEs: 
1- **fait appel** (LVC, 26)Tokens : 
fait
appel
