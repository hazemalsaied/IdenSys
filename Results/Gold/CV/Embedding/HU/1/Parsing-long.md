...
3- **nyújtottak biztosítékot** (LVC)Tokens : 
nyújtottak
biztosítékot
...
### Identified MWEs: 
1- **nyújtott hozzájárulás** (LVC)Tokens : 
nyújtott
hozzájárulás
...
### Existing MWEs: 
1- **eljárhat** (VPC)Tokens : 
eljárhat

## Sentence No. 124 - 
Így például ha egy kft. és egy részvénytársaság egyesül , a részvénykibocsátás joga a gt. ( új ) 72. § (4) bekezdése alapján nyilvánvalóan kizárólag csak a részvénytársaságot illeti meg . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 137 - 
a (2)-(4) bekezdésben megjelölt részesedés értékét , illetve a törzsbetétek értékét , valamint részvények értékét a létrejövő gazdasági társaság vagyonmérleg-tervezetében már nem lehet szerepeltetni . 
### Existing MWEs: 
1- **bekezdésben** (VPC, 543)Tokens : 
bekezdésben
...
## Sentence No. 138 - 
a beolvadásnál irányadó különleges szabályok 
### Existing MWEs: 
1- **beolvadásnál** (VPC, 2)Tokens : 
beolvadásnál
...
## Sentence No. 139 - 
a gt. ( új ) 73. §-a a beolvadással megvalósuló egyesülés esetére állapít meg különleges szabályokat . 
### Existing MWEs: 
1- **beolvadással** (VPC, 2)Tokens : 
beolvadással
...
## Sentence No. 141 - 
a gt. ( új ) 73. § (4) bekezdése ugyancsak hitelezővédelmi okokból állapít meg tőkevédelmi szabályokat . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 143 - 
ezzel az előírással is a tőkevédelmet és ezen keresztül a hitelezők érdekeit védi a törvény . 
### Existing MWEs: 
1- **előírással** (VPC, 122)Tokens : 
előírással
...
## Sentence No. 146 - 
a gt. ( új ) 176. § (1) bekezdése szerint az összes részvény névértékének az összege alkotja a társaság alaptőkéjét , illetve jegyzett tőkéjét . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 148 - 
ennek a sorsáról ezért értelmezésünk szerint a számviteli törvény előírásaira figyelemmel szabadon dönthetnek a társaságok . 
### Existing MWEs: 
1- **előírásaira** (VPC, 122)Tokens : 
előírásaira
...
2- **száll át** (VPC)Tokens : 
száll
át

## Sentence No. 158 - 
Összeolvadás során csak az azonos társasági formájú gazdasági társaságok választhatnak a jogutód gazdasági társaságnak más társasági formát . 
### Existing MWEs: 
1- **Összeolvadás** (VPC, 1)Tokens : 
Összeolvadás
...
## Sentence No. 162 - 
az összeolvadásnál irányadó különleges szabályok 
### Existing MWEs: 
1- **összeolvadásnál** (VPC, 1)Tokens : 
összeolvadásnál
...
## Sentence No. 163 - 
a gt. ( új ) 74. §-a az összeolvadással történő egyesülés speciális szabályait állapítja meg . 
### Existing MWEs: 
1- **összeolvadással** (VPC, 1)Tokens : 
összeolvadással
...
## Sentence No. 166 - 
a gt. ( új ) , amint arra a 72. § indokolásánál már utaltunk , a korábbi szabályozással ellentétben nem tiltja az eltérő felelősségi formájú társaságok egyesülését és a cégformaváltással történő átalakulás lehetőségéhez hasonlóan mindegyik társasági forma számára módot ad a mindegyik társasági formával való egyesülésre . 
### Existing MWEs: 
1- **módot ad** (LVC)Tokens : 
módot
ad
...
## Sentence No. 167 - 
a jogutód társaság cégformája tekintetében azonban megkötéseket állít fel . 
### Existing MWEs: 
1- **állít fel** (VPC)Tokens : 
állít
fel

## Sentence No. 171 - 
a gt. ( új ) 74. § (2) bekezdése a 73. §-ához hasonlóan tőkevédelmi és ezen keresztül hitelező érdekvédelmi szabályokat állapít meg . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 174 - 
a gt. ( új ) 75. §-a az egyesüléssel összefüggő vezető tisztségviselői feladatokat és az egyesülési szerződés tartalmát állapítja meg . 
### Existing MWEs: 
1- **összefüggő** (VPC, 9)Tokens : 
összefüggő
...
## Sentence No. 176 - 
ezért az egyesüléssel érintett gazdasági társaságnak külön-külön megtartott legfőbb szervi ülésein arról kell határozniuk a vezető tisztségviselők és a felügyelő bizottság előterjesztése alapján , hogy a tagok , illetve a részvényesek egyetértenek -e az egyesülés szándékával . 
### Existing MWEs: 
1- **megtartott ülésein** (LVC)Tokens : 
megtartott
ülésein

## Sentence No. 182 - 
az egyesülésről szóló átalakulási közleményben a 65. § (2) bekezdésében felsoroltakon kívül meg kell jelölni az egyesülés módját is . 
### Existing MWEs: 
1- **bekezdésében** (VPC, 543)Tokens : 
bekezdésében
...
## Sentence No. 192 - 
a gt. ( új ) 60. § (3) bekezdése alapján a részvénytársaságokat átalakulással kizárólag csak zártkörűen lehet alapítani . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 193 - 
ez alól a főszabály alól a törvény egyedül a részvénytársaságok egyesülése esetére állapít meg kivételi szabályt . 
### Existing MWEs: 
1- **kivételi** (VPC, 9)Tokens : 
kivételi
...
## Sentence No. 197 - 
az egyesülésre is irányadó gt. ( új ) 69. § (1) bekezdéséből következően ugyanis a megszűnő jogelőd részvénytársaságok részvényei a cégbejegyzéssel érvénytelenné válnak , és ezek helyett a jogutód részvénytársaságnak kell a megállapodás szerinti részvényeket biztosítani a részvényesek számára . 
### Existing MWEs: 
1- **bekezdéséből** (VPC, 543)Tokens : 
bekezdéséből
...
## Sentence No. 198 - 
a gt. ( új ) 202. §-a új lehetőségként a zártkörűen működő részvénytársaságok számára a névre szóló részvények átruházásának a korlátozását is megengedi és azt a részvénytársaság beleegyezéséhez köthetővé teszi . 
### Existing MWEs: 
1- **átruházásának** (VPC, 82)Tokens : 
átruházásának
...
## Sentence No. 201 - 
a gt. ( új ) 76. § (1) g) pontjából azonban mind a névre szóló , mind a bemutatóra szóló részvénynél , valamint a dematerializált részvénynél egyaránt részletezni kell az átruházás szabályait . 
### Existing MWEs: 
1- **átruházás** (VPC, 82)Tokens : 
átruházás
...
## Sentence No. 202 - 
- meg kell jelölni az egyesülési szerződésben azt az időpontot is , amelytől fogva a részvények részesedésre jogosítanak az adózott eredményből . 
### Existing MWEs: 
1- **részesedésre jogosítanak** (LVC)Tokens : 
részesedésre
jogosítanak
...
## Sentence No. 211 - 
- a 76. § (3) bekezdés utolsó fordulata alapján pedig a vezető tisztségviselőknek a részvénytársaság költségére teljes , vagy kivonatos másolatot kell adniuk a részvényesek által megismerhető iratokról az azt kérő részvényesek számára . 
### Existing MWEs: 
1- **bekezdés** (VPC, 543)Tokens : 
bekezdés
...
## Sentence No. 213 - 
az értékelés esetleges nehézsége esetén erre a körülményre is ki kell térni . 
### Existing MWEs: 
1- **ki térni** (VPC)Tokens : 
ki
térni
...
## Sentence No. 216 - 
- a gt. ( új ) 76. § (6) bekezdése az 1988. évi vi. tv. szabályozásának a hiányosságát pótolva az egyesüléssel érintett részvénytársaságok által kibocsátott kötvényesek helyzetét rendezi . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 217 - 
ennek az előírásnak az értelmében az átváltoztatható kötvény tulajdonosainak a jogosultsága nem lehet hátrányosabb , mint amivel a jogelőd társaságban rendelkeztek . 
### Existing MWEs: 
1- **előírásnak** (VPC, 122)Tokens : 
előírásnak
...
## Sentence No. 218 - 
ez alól csak az az eset jelenthet kivételt , ha valamennyi átváltoztatható kötvénytulajdonos hozzájárul a jogosultságának a megváltoztatásához . 
### Existing MWEs: 
1- **kivételt** (VPC, 40)Tokens : 
kivételt
...
## Sentence No. 223 - 
ha több részvényfajta , illetve részvényosztály létezik , az egyesülést kimondó határozat meghozatala során a 238. §-t megfelelően alkalmazni kell . 
### Existing MWEs: 
1- **megfelelően** (VPC, 81)Tokens : 
megfelelően
...
## Sentence No. 229 - 
a gt. ( új ) 77. § (3) bekezdése speciális részvényesi érdekvédelmi szabályt állapít meg . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 232 - 
erre azonban természetesen csakis akkor van lehetőségük a hitelezőknek , ha a részvénytársaság korábban már nem nyújtott a számukra biztosítékot . 
### Existing MWEs: 
1- **nyújtott biztosítékot** (LVC)Tokens : 
nyújtott
biztosítékot
...
## Sentence No. 244 - 
a gt. ( új ) 78. § (1) bekezdése szerint a szétválásra az átalakulásra irányadó közös szabályokat , tehát a vii. fejezet 1. címe alatt lévő előírásokat és az átalakulással létrejövő társasági formára vonatkozó rendelkezéseket , tehát a 2. cím alattiakat kell alkalmazni . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 246 - 
emellett a jogutódlással létrejövő társasági forma alapítására vonatkozó szabályokat is természetesen megfelelően alkalmazni kell . 
### Existing MWEs: 
1- **megfelelően** (VPC, 81)Tokens : 
megfelelően
...
## Sentence No. 247 - 
a 78. § (1) bekezdése a szétválásnak - az egyesülés tükörképeként - két formáját állapítja meg . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 249 - 
a gt. ( új ) 78. § (2) bekezdéséből következően a gazdasági társaságok legfőbb szerve bármikor elhatározhatja - a közös szabályokban lévő tilalmak hiányában - , hogy a társaságuk több gazdasági társaságra váljon szét . 
### Existing MWEs: 
1- **bekezdéséből** (VPC, 543)Tokens : 
bekezdéséből
...
## Sentence No. 257 - 
az egyes cégformáknál azonban ilyenkor figyelemmel kell lenni az adott társasági forma átalakulására vonatkozó különleges szabályokra is . 
### Existing MWEs: 
1- **figyelemmel lenni** (LVC)Tokens : 
figyelemmel
lenni

## Sentence No. 258 - 
a kiválásnál a gt. ( új ) 78. § (4) bekezdése alapján az a gazdasági társaság , amelyből a jogutód társaság kiválása történik , változatlan cégformában folytatja a működését . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 259 - 
a létesítő okirat módosításaival a kivált tagok , illetve részvényesek részvételével a társasági vagyon megállapodás szerinti részével új gazdasági társaság jön létre . 
### Existing MWEs: 
1- **jön létre** (VPC, 16)Tokens : 
jön
létre
...
## Sentence No. 261 - 
ezért ezek a cégek is a 78. §-ban szabályozott két szétválási mód közül választhatva hajthatják végre az ilyen irányú szervezeti változásokat . 
### Existing MWEs: 
1- **hajthatják végre** (VPC)Tokens : 
hajthatják
végre

## Sentence No. 262 - 
a gazdasági társaság legfőbb szerve a 62. § (2) bekezdésében meghatározottak mellett azt is felméri , hogy a gazdasági társaság tagjai ( részvényesei ) melyik jogutód gazdasági társaság tagjává kívánnak válni . 
### Existing MWEs: 
1- **bekezdésében** (VPC, 543)Tokens : 
bekezdésében
...
## Sentence No. 267 - 
eszerint ugyanis a szétválás elhatározásáról döntő legfőbb szervi ülésen a 72. § (2) bekezdésében előírtak mellett azt is fel kell mérni , hogy a gazdasági társaság tagjai , illetve részvényesei melyik jogutód gazdasági társaságnak a tagjai kívánnak lenni . 
### Existing MWEs: 
1- **bekezdésében** (VPC, 543)Tokens : 
bekezdésében
...
## Sentence No. 277 - 
hangsúlyozni kell , hogy a szétválás mindkét módjára irányadó szabályokat állapít meg viszont a gt. ( új ) 79. § (2)-(3) bekezdése . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 279 - 
a gt. ( új ) 79. § (4) bekezdése értelmében olyan esetekben , ha a szétválási szerződésben valamelyik vagyontárgyról nem rendelkeztek , akkor az a vagyontárgy , vagy annak az ellenértéke a szétválási szerződésben meghatározott vagyonmegosztás alapján valamennyi jogutód társaságot megilleti . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 283 - 
ez az új előírás kizárja az 1988. évi vi. tv. alapján olyan nem ritka olyan megoldásokat , hogy a szétválással létrejött több cég közül az egyikre terheltek minimális vagyon mellett a kötelezettségeket , míg a másik , vagy többi társaságba a tiszta vagyont mentették át a szétválási szerződés alapján . 
### Existing MWEs: 
1- **előírás** (VPC, 122)Tokens : 
előírás
...
## Sentence No. 284 - 
a hitelezők pedig ilyen módon " jogszerűen " kilettek játszva és a fedezetük a szervezeti átalakulással lényegében el lett vonva . 
### Existing MWEs: 
1- **kilettek játszva** (VPC)Tokens : 
kilettek
játszva
...
## Sentence No. 288 - 
továbbá a szétváló gazdasági társaságot megillető jogok és kötelezettségek megosztására irányuló megállapodás főbb előírásait is . 
### Existing MWEs: 
1- **előírásait** (VPC, 122)Tokens : 
előírásait
...
## Sentence No. 291 - 
ennél a döntésnél szerintünk a szétválási szerződés többlet tartalmi szabályait meghatározó 79. § (2) bekezdésének a rendelkezéseit lehetne támpontul használni . 
### Existing MWEs: 
1- **bekezdésének** (VPC, 543)Tokens : 
bekezdésének
...
## Sentence No. 292 - 
fel kell tüntetni a hirdetményben a hitelezőknek szóló felhívást is . 
### Existing MWEs: 
1- **fel tüntetni** (VPC, 18)Tokens : 
fel
tüntetni
...
## Sentence No. 297 - 
a részvénytársaságok szétválásánál a törvény a gt. ( új ) 79. § (6) bekezdésében visszautal a 4. cím alatt a részvénytársaságok egyesülésére vonatkozó különleges szabályokra . 
### Existing MWEs: 
1- **bekezdésében** (VPC, 543)Tokens : 
bekezdésében
...
## Sentence No. 298 - 
ezért olyankor , ha részvénytársaságok részvénytársasággá válnak szét , a 76-77. § rendelkezéseit megfelelően alkalmazni kell . 
### Existing MWEs: 
1- **megfelelően** (VPC, 81)Tokens : 
megfelelően
...
## Sentence No. 301 - 
a gt. ( új ) 78. § (2) bekezdése ugyanis az egyesüléssel ellentétben semmilyen esetben sem teszi lehetővé azt , hogy szétválással nyilvánosan működő részvénytársaságot hozzanak létre . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 306 - 
az átalakulás cégbejegyzésével összefüggő rendelkezéseket részben megváltoztatta az új törvény . 
### Existing MWEs: 
1- **összefüggő** (VPC, 9)Tokens : 
összefüggő
...
## Sentence No. 316 - 
egyidejűleg ilyenkor is kérni kell a jogelőd beolvadó cégek törlését . 
### Existing MWEs: 
1- **beolvadó** (VPC)Tokens : 
beolvadó

## Sentence No. 321 - 
a vagyonmérleg tervezetet és a vagyonmérlegben meghatározott saját tőke közötti pozitív különbözetnél ezt ( vagyis a különbözetet ) jegyzett tőkén felüli vagyonként kell figyelembe venni . 
### Existing MWEs: 
1- **figyelembe venni** (LVC, 25)Tokens : 
figyelembe
venni
...
## Sentence No. 323 - 
a gt. ( új ) 80. § (2) bekezdés utolsó fordulata szerint a végleges vagyonmérlegre és vagyonleltárra vonatkozó rendelkezéseket a számviteli törvény állapítja meg . 
### Existing MWEs: 
1- **bekezdés** (VPC, 543)Tokens : 
bekezdés
...
## Sentence No. 326 - 
ezért erre a helyzetre a korábbi szabályokkal ellentétben már nem határoz meg a gt. ( új ) további előírásokat . 
### Existing MWEs: 
1- **előírásokat** (VPC, 122)Tokens : 
előírásokat
...
## Sentence No. 332 - 
ugyanilyen tilalmat tartalmaz az államháztartásról szóló 1992. évi xxxviii. törvény 94. § (2) bekezdése a költségvetési szervek vonatkozásában . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 333 - 
az egyetemlegesség pedig a hitelező számára azt teszi lehetővé , hogy választása szerint léphessen fel akár valamennyi taggal szemben , akár pl. csak az általa leginkább teljesítőképesnek tartott egyetlen taggal szemben a teljes követelésért . 
### Existing MWEs: 
1- **léphessen fel** (VPC)Tokens : 
léphessen
fel

## Sentence No. 334 - 
ez utóbbi a nem természetes személy alapítók , illetve tagok esetében nem is lenne megvalósítható , de valamilyen jellegű közreműködést , tevékenységet , a társaság érdekében kifejtett megnyilvánulást , közrehatást a gt. ( új ) - közelebbi meghatározás nélkül - megkíván . 
### Existing MWEs: 
1- **közreműködést** (VPC)Tokens : 
közreműködést

## Sentence No. 342 - 
az 1991. évi xlv. törvény 49. § (6) bekezdése ezt a két formációt annyiban hatályon kívül helyezte , hogy 1992._i._1-jétől ilyen társasági formában közkereseti társaság már nem volt alapítható . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 344 - 
a társasági szerződésben - a 11. §-ban felsoroltakon felül szükség szerint - meg kell határozni a tagok által vállalt személyes közreműködés módját , tartalmát és a taggyűlés működésének szabályait . 
### Existing MWEs: 
1- **közreműködés** (VPC)Tokens : 
közreműködés

## Sentence No. 346 - 
a gt. ( új ) 11. § h) pontja alapján - ami az egyes társasági formáknál előírt további kötelező tartalmi elemekre utal - állapít meg a gt. ( új ) 82. § speciális érvényességi kellékeket a kkt. társasági szerződésére . 
### Existing MWEs: 
1- **előírt** (VPC, 23)Tokens : 
előírt
...
3- **hozzájárulással** Tokens : 
hozzájárulással

## Sentence No. 351 - 
a szerződés módosításhoz a gt. ( új ) 89. § (5) bek. alapján egyhangúság kell , a szerződés alakiságánál pedig tekintettel kell lenni a gt. ( új ) 20. § (1) bekezdésétől eltérő - speciális rendelkezést tartalmazó - gt. ( új ) 89. § (6) bek.-re is . 
### Existing MWEs: 
1- **bekezdésétől** (VPC, 543)Tokens : 
bekezdésétől

### Identified MWEs: 
1- **bekezdésétől** Tokens : 
bekezdésétől

## Sentence No. 352 - 
a társasági szerződés eltérő rendelkezése hiányában a társaságtól megválás esetén [ gt. ( új ) 92. § ] vagy a társaság jogutód nélküli megszűnésekor csak az elszámolás eredményeként mutatkozó pénzbeli juttatásra tarthat igényt a tag . 
### Existing MWEs: 
...
## Sentence No. 353 - 
a társaság tagjai személyesen közreműködhetnek a társaság tevékenységében . 
### Existing MWEs: 
1- **közreműködhetnek** (VPC)Tokens : 
közreműködhetnek

## Sentence No. 354 - 
a tagot személyes közreműködéséért díjazás illetheti meg . 
### Existing MWEs: 
1- **közreműködéséért** (VPC)Tokens : 
közreműködéséért

## Sentence No. 357 - 
a társaság az év végén a számviteli törvény szerinti beszámolót készít . 
### Existing MWEs: 
1- **beszámolót** (VPC, 13)Tokens : 
beszámolót
...
## Sentence No. 361 - 
a beszámoló kötelező tartalmát és mellékleteit részletesen az számv. tv. írja elő , a gt. ( új ) csak utal a társaság ezzel kapcsolatos kötelezettségére . 
### Existing MWEs: 
1- **beszámoló** (VPC, 13)Tokens : 
beszámoló
...
## Sentence No. 362 - 
a társaság jogi személy tagja az üzletvezetést a saját szervezeti képviseletére jogosult természetes személy útján látja el . 
### Existing MWEs: 
...
## Sentence No. 366 - 
az üzletvezetéssel a tagok maguk közül megbízhatnak bárkit , egy vagy több tagot is egyszerre aki nem esik a vezető tisztségviselőkre vonatkozó tiltó vagy korlátozó rendelkezések alá [ gt. ( új ) 22-25. § ] . 
### Existing MWEs: 
1- **esik alá** (VPC)Tokens : 
esik
alá

## Sentence No. 371 - 
más kérdés , hogy a természetes személy üzletvezetőkkel szemben érvényesülő kizáró okok és tilalmak a jogi személy képviselőjével szemben sem állhatnak fenn . 
### Existing MWEs: 
1- **állhatnak fenn** (VPC)Tokens : 
állhatnak
fenn
...
### Existing MWEs: 
1- **járhat el** (VPC, 1)Tokens : 
járhat
el

### Identified MWEs: 
1- **járhat el** (VPC)Tokens : 
járhat
el

## Sentence No. 374 - 
a társasági szerződés úgy is rendelkezhet , hogy több üzletvezetésre jogosult tag csak együttesen járhat el . 
### Existing MWEs: 
1- **járhat el** (VPC, 1)Tokens : 
járhat
el
...
## Sentence No. 377 - 
lehetőség van azonban arra is , hogy a társasági szerződésben az együttes eljárást írják elő , de erről kifejezetten kell ilyenkor rendelkezni . 
### Existing MWEs: 
1- **írják elő** (VPC, 24)Tokens : 
írják
elő
...
2- **írják elő** (VPC)Tokens : 
írják
elő

## Sentence No. 381 - 
a társaságot az üzletvezetésre jogosult tagok képviselik , és a társasági szerződésben foglaltaknak megfelelően gyakorolják cégjegyzési jogukat . 
### Existing MWEs: 
1- **gyakorolják jogukat** (LVC, 5)Tokens : 
gyakorolják
jogukat
...
2- **gyakorolják jogukat** (LVC)Tokens : 
gyakorolják
jogukat
...
## Sentence No. 389 - 
a tagok gyűlése ( taggyűlés ) a leadható összes szavazatszámhoz viszonyítva számított egyszerű szótöbbséggel határoz , kivéve azokat a kérdéseket , amelyek esetében e törvény vagy a társasági szerződés háromnegyedes szótöbbséget vagy egyhangúságot ír elő . 
### Existing MWEs: 
1- **ír elő** (VPC, 24)Tokens : 
ír
elő
...
## Sentence No. 403 - 
a tagoknak a gt. ( új ) 81. § (1) bek. szerinti korlátlan és egyetemleges felelőssége csak mögöttes , illetve másodlagos felelősségként jöhet szóba ha a társaság vagyona a tartozásait nem fedezi . 
### Existing MWEs: 
1- **jöhet szóba** (LVC)Tokens : 
jöhet
szóba
...
### Existing MWEs: 
1- **hozott döntésről** (LVC, 1)Tokens : 
hozott
döntésről
...
## Sentence No. 411 - 
a hitelező követelésének fedezetéül csak az a vagyonhányad szolgál , amely a tagot a társaság vagy a tagsági jogviszony megszűnése esetére megilleti . 
### Existing MWEs: 
1- **fedezetéül szolgál** (LVC)Tokens : 
fedezetéül
szolgál

## Sentence No. 418 - 
a tagsági viszony megszűnésének eseteit a gt. ( új ) 92. § taxatívan - kimerítően - sorolja fel . 
### Existing MWEs: 
1- **sorolja fel** (LVC)Tokens : 
sorolja
fel

## Sentence No. 423 - 
lényegében ezt mondja ki a gt. ( új ) esetében is alkalmazható bh1994. 685. sz. döntés is azzal , hogy kkt. esetében a tagoknak a társaságba bevitt vagyoni hozzájárulása adásvétel tárgyát nem képezheti . 
### Existing MWEs: 
1- **hozzájárulása** (VPC, 98)Tokens : 
hozzájárulása
...
## Sentence No. 426 - 
a tagsági viszonynak rendes felmondás útján történő megszüntetésére csak a határozatlan időre szóló társaság esetén van helye . 
### Existing MWEs: 
1- **felmondás** (VPC, 2)Tokens : 
felmondás
...
## Sentence No. 428 - 
a rendes felmondásnak semmilyen előzetes feltétele nincs , bármikor és indokolás nélkül megilleti ez a jog mindegyik tagot . 
### Existing MWEs: 
1- **felmondásnak** (VPC, 2)Tokens : 
felmondásnak

### Identified MWEs: 
1- **felmondásnak** Tokens : 
felmondásnak
...
## Sentence No. 436 - 
a tagsági viszony megszűnésének esetén , ha az nem a tag halála vagy a jogutód nélküli megszűnése miatt történik [ gt. ( új ) 92. § f) ] a tovább működő társaságnak a volt tagjával el kell számolnia . 
### Existing MWEs: 
1- **el számolnia** (VPC, 1)Tokens : 
el
számolnia

### Identified MWEs: 
1- **el számolnia** (VPC)Tokens : 
el
számolnia

## Sentence No. 437 - 
a tag halála vagy jogutód nélküli megszűnésénél az előzőek szerinti elszámolás fogalmilag nem jöhet szóba . 
### Existing MWEs: 
...
## Sentence No. 438 - 
az elszámolásnak a tagsági viszony megszűnésének időpontjára vetített vagyoni állapot szerint kell történnie akkor is ha pl. a felmondás érvényességével kapcsolatos per csak jóval később zárul le . 
### Existing MWEs: 
1- **felmondás** (VPC, 2)Tokens : 
felmondás

### Identified MWEs: 
1- **elszámolásnak** Tokens : 
elszámolásnak
...
## Sentence No. 441 - 
az elszámolás módjára és formájára vonatkozóan a gt. ( új ) semmilyen megkötést a fentieken túl nem tartalmaz , ezért a feleknek ebben a kérdésben széleskörű megegyezési lehetősége van a kölcsönösen legmegfelelőbb teljesítésre . 
### Existing MWEs: 
1- **legmegfelelőbb** (VPC, 81)Tokens : 
legmegfelelőbb
...
2- **legmegfelelőbb** Tokens : 
legmegfelelőbb

## Sentence No. 442 - 
csak ennek hiányában érvényesül a gt. ( új ) 95. § (2) bekezdésében három hónapban megállapított teljesítési határidő . 
### Existing MWEs: 
1- **bekezdésében** (VPC, 543)Tokens : 
bekezdésében
...
## Sentence No. 444 - 
megállapodás hiányában az örökössel történő elszámolásra a 95. § rendelkezéseit kell megfelelően alkalmazni . 
### Existing MWEs: 
1- **megfelelően** (VPC, 81)Tokens : 
megfelelően
...
## Sentence No. 449 - 
a meghalt tag örökösének is lehetősége van azonban arra , hogy a társaság tagjává váljon ha arra igényt tart és a társaság tagjai a belépését elfogadják . 
### Existing MWEs: 
1- **igényt tart** (LVC)Tokens : 
igényt
tart

## Sentence No. 453 - 
a tagságot nem kívánó jogutód viszont nem tarthatja hosszabb ideig bizonytalanságban a többi tagot ebben a kérdésben , ezért a nemleges nyilatkozatának megtételénél a ptk.-nak a jogok jóhiszemű gyakorlásának követelménye mellett a gt. ( új ) 7. § (1) bekezdésére kell tekintettel lenni . 
### Existing MWEs: 
1- **bekezdésére** (VPC, 543)Tokens : 
bekezdésére
...
## Sentence No. 456 - 
ezt a rendelkezést a megszűnt tag jogutódjára megfelelően alkalmazni kell . 
### Existing MWEs: 
1- **megfelelően** (VPC, 81)Tokens : 
megfelelően
...
## Sentence No. 457 - 
a tagsági viszony megszűnésének a gt. ( új ) 92. § a)_-_e) és g) pontjaiban írt eseteinél önmagában a társaságtól való megválás és a gt. ( új ) 95. § szerinti elszámolás nem jelenti a tag részéről az összes vagyoni kötelezettség egyszer és mindenkorra való megszűnését is . 
### Existing MWEs: 
1- **elszámolás** (VPC, 8)Tokens : 
elszámolás
...
## Sentence No. 463 - 
ha a társaság az (1) bekezdésben meghatározott okból megszűnik , a végelszámolót a cégbíróság rendeli ki . 
### Existing MWEs: 
1- **bekezdésben** (VPC, 543)Tokens : 
bekezdésben
...
2- **végelszámolót** Tokens : 
végelszámolót

## Sentence No. 464 - 
a társaság megszűnésének a gt. ( új ) 98. §-ában írt esete a gt. ( új ) 53. § (2) d) pontban írt kivételes szabályt tartalmazza annyiban , hogy a társaság nem azonnali hatállyal szűnik meg ha a tagok száma egy főre csökken , hanem lehetőség van arra , hogy három hónapig a társaság még működjön . 
### Existing MWEs: 
1- **kivételes** (VPC, 4)Tokens : 
kivételes
...
## Sentence No. 473 - 
ha eltérő rendelkezés nincs , akkor a vagyoni hozzájárulás arányában történő felosztás elve érvényesül . 
### Existing MWEs: 
1- **hozzájárulás** (VPC, 98)Tokens : 
hozzájárulás
...
## Sentence No. 477 - 
a követelést egyedül kielégítő tag a többi taggal szemben a rájuk eső rész erejéig léphet fel megtérítési igénnyel . 
### Existing MWEs: 
1- **léphet fel** (VPC)Tokens : 
léphet
fel

## Sentence No. 479 - 
a kültagnak az előzőek szerinti korlátozott vagyoni felelőssége alól csak a gt. ( új ) 103. § (1) bek. jelent kivételt . 
### Existing MWEs: 
1- **kivételt** (VPC, 40)Tokens : 
kivételt
...
### Existing MWEs: 
1- **részt vesz** (LVC, 1)Tokens : 
részt
vesz

## Sentence No. 484 - 
ebben az esetben a tagok közös elhatározásának függvényében van lehetősége a kültagnak minden lehetséges esetre előre nem meghatározható terjedelmű , de mindenképpen csak kisebb részfeladatokra korlátozódó irányítási teendők ellátására . 
### Existing MWEs: 
1- **ellátására** (VPC, 7)Tokens : 
ellátására
...
## Sentence No. 488 - 
a kültagnak a gt. ( új ) 101. § (1) bek. szerinti korlátozott felelőssége kizárja , hogy a társaság tartozásáért a hitelező közvetlenül a kültaggal szemben léphessen fel . 
### Existing MWEs: 
1- **léphessen fel** (VPC)Tokens : 
léphessen
fel
...
## Sentence No. 491 - 
ha úgy döntenek , hogy a kültag neve szerepeljen a cégnévben ezzel azt a látszatot kelthetik mintha a kültag is beltag lenne , vagy nem betéti hanem közkereseti társaságról lenne szó , azaz a felelősségi viszonyokról a cégnév félrevezetésre lehet alkalmas . 
### Existing MWEs: 
1- **félrevezetésre** (VPC)Tokens : 
félrevezetésre

## Sentence No. 494 - 
ha a társaságból valamennyi beltag kiválik , a társaság megszűnik , kivéve , haa ) az utolsó beltag kiválásától számított három hónapon belül új beltag belépését a cégbírósághoz bejelentik , illetveb ) a kültagok elhatározzák a társaságnak közkereseti társaságként való továbbfolytatását , és 
### Existing MWEs: 
1- **kivéve** (VPC, 12)Tokens : 
kivéve
...
## Sentence No. 499 - 
a közkereseti társaságkénti tovább működés esetén alkalmazni kell a gt. ( új ) 71. § (2) bekezdését ami az ilyen társasági formaváltást nem tekinti átalakulásnak . 
### Existing MWEs: 
1- **bekezdését** (VPC, 543)Tokens : 
bekezdését
...
## Sentence No. 504 - 
a 104. § szerinti esetekben a működés közkereseti társaságként való továbbfolytatásában részt venni nem kívánó bel- , illetve kültagokkal a 95. § rendelkezései szerint kell elszámolni . 
### Existing MWEs: 
1- **elszámolni** (VPC, 2)Tokens : 
elszámolni
...
## Sentence No. 506 - 
a társaság és a kiváló tag ( tagok ) elszámolására a gt. ( új ) 95. §-át kell alkalmazni . 
### Existing MWEs: 
1- **elszámolására** (VPC, 8)Tokens : 
elszámolására

### Identified MWEs: 
1- **elszámolására** Tokens : 
elszámolására

## Sentence No. 507 - 
ha a vállalat vagyona a tartozásokat nem fedezi , a tagok a vállalat tartozásaiért együttesen - vagyoni hozzájárulásuk arányában - , kezesként felelnek . 
### Existing MWEs: 
1- **hozzájárulásuk** (VPC, 98)Tokens : 
hozzájárulásuk
...
### Existing MWEs: 
1- **hozzájárulásához** (VPC, 98)Tokens : 
hozzájárulásához

### Identified MWEs: 
1- **hozzájárulásához** Tokens : 
hozzájárulásához
...
## Sentence No. 542 - 
a tagok között a nyereség és a veszteség - ha a társasági szerződés eltérően nem rendelkezik - vagyoni hozzájárulásuk arányában oszlik meg . 
### Existing MWEs: 
1- **hozzájárulásuk** (VPC, 98)Tokens : 
hozzájárulásuk
...
## Sentence No. 547 - 
a 107. § (1) b) pontjához fűzött magyarázatnál már említésre került , hogy a nyereség és veszteség viselés szabályait ( arányát ) a társasági szerződésben meg kell határozni . 
### Existing MWEs: 
1- **említésre került** (LVC)Tokens : 
említésre
került
...
### Existing MWEs: 
1- **hozhat határozatot** (LVC, 4)Tokens : 
hozhat
határozatot
...
## Sentence No. 557 - 
az utóbbi hatáskör megállapításnál a gt. ( új ) 22. § (4) bekezdésében foglaltakra is figyelemmel kell lenni , mely szerint a társaság legfőbb szerve csak akkor és olyan körben vonhatja el a vezető tisztségviselő ( igazgató ) hatáskörét , ha azt a társasági szerződés lehetővé teszi . 
### Existing MWEs: 
1- **bekezdésében** (VPC, 543)Tokens : 
bekezdésében
...
## Sentence No. 558 - 
az 1988. évi vi. tv. rendelkezett az igazgató és az igazgatótanács közé " beékelődött " igazgatóságról , mint operatív testületről , melyre az igazgatótanács egyes feladatai átruházhatók voltak . 
### Existing MWEs: 
1- **átruházhatók** (VPC, 1)Tokens : 
átruházhatók

### Identified MWEs: 
1- **átruházhatók** Tokens : 
átruházhatók

## Sentence No. 559 - 
a hatályos szabályozás azonban ilyen szervezet felállításáról nem rendelkezik . 
### Existing MWEs: 
1- **felállításáról** (VPC)Tokens : 
felállításáról

## Sentence No. 561 - 
ugyanakkor ezen álláspontnak ellentmond , hogy a tagsági viszony kilépéssel történő megszűnését szabályozó gt. ( új ) 117. § (2) bekezdése szerint a kilépési szándékot az igazgatótanácsnak , illetve az igazgatóságnak kell bejelenteni . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 563 - 
az igazgatótanács szükség szerint , de évente legalább egyszer tart ülést . 
### Existing MWEs: 
1- **tart ülést** (LVC, 1)Tokens : 
tart
ülést

### Identified MWEs: 
1- **tart ülést** (LVC)Tokens : 
tart
ülést

## Sentence No. 567 - 
Évente minimum egyszer össze kell hívni az igazgatótanács ülését , mert a mérleg ( éves beszámoló ) elfogadása és az eredmény felhasználásáról a döntés e szerv kizárólagos hatáskörébe tartozik . 
### Existing MWEs: 
1- **beszámoló** (VPC, 13)Tokens : 
beszámoló
...
## Sentence No. 569 - 
a törvény ugyanakkor azt sem írja elő , hogy az összehívás részletes szabályait a társasági szerződésbe kellene foglalni . 
### Existing MWEs: 
1- **írja elő** (VPC, 24)Tokens : 
írja
elő
...
## Sentence No. 571 - 
a szavazati jog - a társasági szerződés eltérő rendelkezése hiányában - a tagokat vagyoni hozzájárulásuk arányában illeti meg . 
### Existing MWEs: 
1- **hozzájárulásuk** (VPC, 98)Tokens : 
hozzájárulásuk
...
## Sentence No. 572 - 
az igazgató tanács határozatképessége megállapításánál nem a tagok vagyoni hozzájárulásából , hanem a szavazatok mértékéből kell kiindulni . 
### Existing MWEs: 
1- **hozzájárulásából** (VPC, 98)Tokens : 
hozzájárulásából

### Identified MWEs: 
1- **hozzájárulásából** Tokens : 
hozzájárulásából
...
### Existing MWEs: 
1- **határozatait hozza** (LVC, 6)Tokens : 
határozatait
hozza

## Sentence No. 577 - 
az igazgatótanács főszabályként egyszerű szótöbbséggel hozza határozatait . 
### Existing MWEs: 
1- **hozza határozatait** (LVC, 3)Tokens : 
hozza
határozatait

### Identified MWEs: 
1- **hozza határozatait** (LVC)Tokens : 
hozza
határozatait

## Sentence No. 578 - 
e kérdések tekintetében tehát a társasági szerződés csakis szigorúbb szavazatarányt írhat elő , amennyiben el kíván térni a törvény rendelkezésétől . 
### Existing MWEs: 
1- **írhat elő** (VPC, 5)Tokens : 
írhat
elő

### Identified MWEs: 
1- **írhat elő** (VPC)Tokens : 
írhat
elő
...
## Sentence No. 584 - 
főként kisebb taglétszámmal működő társaságok esetében és ilyenkor is a kevésbé jelentős kérdések tekintetében lehet jelentősége az ülésen kívüli határozathozatalnak . 
### Existing MWEs: 
1- **határozathozatalnak** (LVC)Tokens : 
határozathozatalnak
...
## Sentence No. 586 - 
az igazgatótanács a vállalat vezető állású dolgozóival kapcsolatos egyes munkáltatói jogok gyakorlását saját egyetértéséhez kötheti . 
### Existing MWEs: 
1- **munkáltatói jogok** (LVC)Tokens : 
munkáltatói
jogok

## Sentence No. 588 - 
a (2) bekezdése szerint közös vállalat esetében a vezető tisztségviselőnek az igazgató minősül . 
### Existing MWEs: 
1- **bekezdése** (VPC, 543)Tokens : 
bekezdése
...
## Sentence No. 589 - 
az igazgatóra alkalmazni kell a vezető tisztségviselőkre vonatkozó , a gt. ( új ) általános részében előírtakat is . 
### Existing MWEs: 
1- **előírtakat** (VPC, 23)Tokens : 
előírtakat
...
## Sentence No. 591 - 
a vállalat alapításakor az igazgatót a társasági szerződésben kell kijelölni , ezt követően az igazgatót az igazgatótanács választja meg , hívja vissza , és gyakorolja az igazgató felett a munkáltatói jogokat . 
### Existing MWEs: 
...
## Sentence No. 601 - 
az igazgatótanács a gt. ( új ) 114. § (2) bekezdésében írtakon túl az igazgató jogkörét csakis akkor és annyiban vonhatja el amennyiben azt a társasági szerződés megengedi . 
### Existing MWEs: 
1- **bekezdésében** (VPC, 543)Tokens : 
bekezdésében
...
## Sentence No. 602 - 
megszűnik a tisztség az időtartam lejártával , visszahívással , törvényben meghatározott kizáró ok bekövetkeztével , lemondással , elhalálozással . 
### Existing MWEs: 
1- **lemondással** (VPC, 15)Tokens : 
lemondással
...
## Sentence No. 604 - 
utóbbi esetben a lemondott igazgató megbízatása akkor is megszűnik , ha a 60 nap még nem telt le . 
### Existing MWEs: 
1- **lemondott** (VPC)Tokens : 
lemondott
...
## Sentence No. 608 - 
a határozatban meg kell jelölni a csatlakozás időpontját , a csatlakozással járó vagyoni hozzájárulás esedékességét , és a csatlakozó tag szavazati jogának mértékét . 
### Existing MWEs: 
1- **hozzájárulás** (VPC, 98)Tokens : 
hozzájárulás
...
## Sentence No. 612 - 
a csatlakozó tag a csatlakozás előtt keletkezett tartozásokért fennálló felelősségét kizárhatja , éspedig az igazgató tanácshoz intézett nyilatkozatával . 
### Existing MWEs: 
...
## Sentence No. 626 - 
méltánytalan volna a többi taggal szemben , ha a kilépő tag felelőssége a kilépés előtt keletkezett tartozásokért a kilépéssel megszűnne , ezért a törvény erre nézve a kilépéstől számított 5 évig a tag kezesi felelősségét előírja . 
### Existing MWEs: 
1- **előírja** (VPC, 12)Tokens : 
előírja
...
## Sentence No. 629 - 
a kiadás időpontját a vállalat számviteli törvény szerinti beszámolója alapján úgy kell meghatározni , hogy az ne veszélyeztesse a vállalat további működését , de időtartama ne legyen hosszabb három évnél . 
### Existing MWEs: 
1- **beszámolója** (VPC, 13)Tokens : 
beszámolója
...
## Sentence No. 637 - 
ha a tag megszűnik vagy meghal , a tag jogutódjával ( örökösével ) a 118. § megfelelő alkalmazásával el kell számolni . 
### Existing MWEs: 
1- **el számolni** (VPC, 1)Tokens : 
el
számolni
...
2- **el számolni** (VPC)Tokens : 
el
számolni

## Sentence No. 638 - 
ha azonban a jogutód ( örökös ) folytatni kívánja a tag tevékenységét , igazgatótanács hozzájárulásával a vállalat tagjává válhat . 
### Existing MWEs: 
1- **hozzájárulásával** (VPC, 98)Tokens : 
hozzájárulásával
...
## Sentence No. 639 - 
ebben az esetben az új tag felelősségére az (1) bekezdés rendelkezéseit megfelelően alkalmazni kell . 
### Existing MWEs: 
1- **bekezdés** (VPC, 543)Tokens : 
bekezdés
...
## Sentence No. 646 - 
ezért a jogutóddal a vállalatnak el kell számolnia . 
### Existing MWEs: 
1- **el számolnia** (VPC, 1)Tokens : 
el
számolnia
...
## Sentence No. 647 - 
az elszámolásra a tagkilépés esetére irányadó szabályokat kell alkalmazni [ gt. ( új ) 118. § ] . 
### Existing MWEs: 
1- **elszámolásra** (VPC, 8)Tokens : 
elszámolásra
...
## Sentence No. 648 - 
arra is mód van azonban , hogy az örökös illetve jogutód az igazgatótanács hozzájárulásával a vállalat tagjává váljon . 
### Existing MWEs: 
1- **hozzájárulásával** (VPC, 98)Tokens : 
hozzájárulásával
...
## Sentence No. 649 - 
ebben az esetben elszámolási viszony a vállalat és a jogutód között nem keletkezik , az örökös , illetve jogutód a tag " helyébe lép " , amiből az is következik , hogy a " taggá válása " előtt keletkezett kötelezettségekért , tartozásokért is felel . 
### Existing MWEs: 
1- **elszámolási** (VPC, 1)Tokens : 
elszámolási
...
## Sentence No. 653 - 
e vagyonmaradványt főszabályként a tagok között vagyoni hozzájárulásuk arányában kell felosztani . 
### Existing MWEs: 
1- **hozzájárulásuk** (VPC, 98)Tokens : 
hozzájárulásuk
...
## Sentence No. 654 - 
a társaság kötelezettségeiért - e törvényben meghatározott kivétellel - a tag nem felel . 
### Existing MWEs: 
1- **kivétellel** (VPC, 40)Tokens : 
kivétellel
...
## Sentence No. 661 - 
a gazdasági társaságok társasági szerződéseire általánosan kötelező előírásokat a gt. ( új ) 11. § (1) a)-g) pontjai tartalmazzák . 
### Existing MWEs: 
1- **előírásokat** (VPC, 122)Tokens : 
előírásokat
...
## Sentence No. 664 - 
Így pl. a 123. § (1) f)-g) pontjára ( a felügyelőbizottságra és a könyvvizsgálóra ) a gt. ( új ) általános részében a 31-38. § és a 41-45. § ad szabályozást vagy pl. a (2) h) pontjára ( dolgozói üzletrészek ) a 145-146. § tartalmaz rendelkezést . 
### Existing MWEs: 
1- **ad szabályozást** (LVC)Tokens : 
ad
szabályozást
...
## Sentence No. 678 - 
a törzsbetétek az egyes tagok vagyoni hozzájárulását jelentik . 
### Existing MWEs: 
1- **hozzájárulását** (VPC, 98)Tokens : 
hozzájárulását
...
### Existing MWEs: 
1- **jogaikat gyakorolhatják** (LVC, 23)Tokens : 
jogaikat
gyakorolhatják
...
## Sentence No. 686 - 
a társaság bejegyzésére csak azután kerülhet sor , ha a bejegyzési kérelem benyújtásáiga ) a nem pénzbeli betéteket teljes egészében a társaság rendelkezésére bocsátották , ésb ) minden egyes pénzbeli betétnek legalább a felét és összesen legalább egymillió forintot a társaság számlájára befizették . 
### Existing MWEs: 
1- **benyújtásáiga** (VPC, 1)Tokens : 
benyújtásáiga
...
## Sentence No. 689 - 
ezzel kapcsolatban az egyébként más tárgykörben hozott , de a gt. ( új)-ra is alkalmazható bh1994. 91. sz. döntés az indokolásában tartalmaz a fentiekkel egyező iránymutató állásfoglalást . 
### Existing MWEs: 
1- **hozott döntés** (LVC, 1)Tokens : 
hozott
döntés
...
## Sentence No. 694 - 
a pénzbetétek befizetésének kötelezettségét nem lehet úgy sem megkerülni , hogy pl. a bejegyzés után úgy módosítják a társasági szerződést , hogy a még be nem fizetett pénzbetét helyett nem pénzbeli vagyoni hozzájárulást teljesítenek . 
### Existing MWEs: 
1- **hozzájárulást teljesítenek** (LVC, 2)Tokens : 
hozzájárulást
teljesítenek
...
## Sentence No. 698 - 
ezért az ezzel okozott kárért az abban részt vevők egyetemleges és korlátlan vagyoni felelősségével szankcionálja a gt. ( új ) ezt a magatartást . 
### Existing MWEs: 
1- **okozott kárért** (LVC)Tokens : 
okozott
kárért
...
## Sentence No. 702 - 
a tilalom megsértésével a gyakorlatban legtöbbször az olyan esetekben találkozni , amikor ún. tagi kölcsönt próbálnak meg a társasággal szemben a törzsbetét befizetési kötelezettség fejében elszámolni . 
### Existing MWEs: 
1- **elszámolni** (VPC, 2)Tokens : 
elszámolni
...
## Sentence No. 704 - 
ilyen megállapodás hiányában a tagsági jog megszűnésétől számított hatvan napon belül nyilvános árverést kell tartani . 
### Existing MWEs: 
1- **árverést tartani** (LVC)Tokens : 
árverést
tartani
...
## Sentence No. 711 - 
a mellékszolgáltatás teljesítésének feltételeit a társasági szerződésben kell szabályozni . 
### Existing MWEs: 
1- **feltételeit** (VPC, 81)Tokens : 
feltételeit
