...
2- **si facevano onore** (ID), Interleaving Tokens : 
si
facevano
onore
...
### Existing MWEs: 
1- **fare un passo indietro** (ID, 4)Tokens : 
fare
un
passo
indietro
...
### Existing MWEs: 
1- **si stringe nel dolore** (ID)Tokens : 
si
stringe
nel
dolore
...
### Existing MWEs: 
1- **aventi diritto al voto** (ID)Tokens : 
aventi
diritto
al
voto
...
### Existing MWEs: 
1- **costituire parte civile** (ID)Tokens : 
costituire
parte
civile
...
### Existing MWEs: 
1- **si tratterebbe** (IReflV, 12)Tokens : 
si
tratterebbe
...
### Existing MWEs: 
1- **dare il via** (ID, 1)Tokens : 
dare
il
via

### Identified MWEs: 
1- **dare il via** (ID)Tokens : 
dare
il
via
...
### Existing MWEs: 
1- **entrato in azione** (ID)Tokens : 
entrato
in
azione

### Identified MWEs: 
1- **facendo- si** (IReflV)Tokens : 
facendo-
si
...
### Existing MWEs: 
1- **si riferisce** (IReflV, 4)Tokens : 
si
riferisce
...
### Existing MWEs: 
1- **effettuate modifiche** (LVC)Tokens : 
effettuate
modifiche
...
### Existing MWEs: 
1- **presentato ricorso** (LVC)Tokens : 
presentato
ricorso
...
### Existing MWEs: 
1- **prenderanno il via** (ID, 1)Tokens : 
prenderanno
il
via
...
### Existing MWEs: 
1- **prestare attenzione** (LVC, 1)Tokens : 
prestare
attenzione

### Identified MWEs: 
1- **prestare attenzione** (LVC)Tokens : 
prestare
attenzione
...
### Existing MWEs: 
1- **si sviluppato** (IReflV, 2)Tokens : 
si
sviluppato
...
### Existing MWEs: 
1- **preso fuoco** (LVC)Tokens : 
preso
fuoco

### Identified MWEs: 
1- **preso fuoco** (ID)Tokens : 
preso
fuoco
...
### Existing MWEs: 
1- **posto sotto sequestro** (LVC)Tokens : 
posto
sotto
sequestro
...
### Existing MWEs: 
1- **rivelar- si** (IReflV)Tokens : 
rivelar-
si

### Identified MWEs: 
1- **recar- si** (IReflV)Tokens : 
recar-
si
...
### Existing MWEs: 
1- **si verificate** (IReflV, 1)Tokens : 
si
verificate
...
### Existing MWEs: 
1- **si verificati** (IReflV, 1)Tokens : 
si
verificati
...
### Existing MWEs: 
1- **prendere atto** (ID, 2)Tokens : 
prendere
atto

### Identified MWEs: 
1- **prendere atto** (ID)Tokens : 
prendere
atto
...
### Existing MWEs: 
1- **si svolte** (IReflV, 9)Tokens : 
si
svolte

### Identified MWEs: 
1- **si svolte** (IReflV)Tokens : 
si
svolte
...
### Existing MWEs: 
1- **recuperare posizioni** (ID)Tokens : 
recuperare
posizioni
...
### Existing MWEs: 
1- **fare rifornimento** (LVC)Tokens : 
fare
rifornimento
...
### Existing MWEs: 
1- **si avvantaggiano** (IReflV)Tokens : 
si
avvantaggiano
...
### Existing MWEs: 
1- **ritorna alla ribalta** (ID)Tokens : 
ritorna
alla
ribalta
...
### Existing MWEs: 
1- **restare al comando** (ID)Tokens : 
restare
al
comando
...
### Existing MWEs: 
1- **fecero ingresso** (LVC, 2)Tokens : 
fecero
ingresso
...
### Existing MWEs: 
1- **rinviato a giudizio** (ID)Tokens : 
rinviato
a
giudizio
...
### Existing MWEs: 
1- **prendere parte** (LVC, 3)Tokens : 
prendere
parte

### Identified MWEs: 
1- **prendere parte** (LVC)Tokens : 
prendere
parte
...
### Existing MWEs: 
1- **preso il via** (ID, 1)Tokens : 
preso
il
via

### Identified MWEs: 
1- **preso il via** (ID)Tokens : 
preso
il
via
...
### Existing MWEs: 
1- **prendere il via** (ID, 1)Tokens : 
prendere
il
via

### Identified MWEs: 
1- **prendere il via** (ID)Tokens : 
prendere
il
via

2- **schierate in griglia** (ID)Tokens : 
schierate
in
griglia
...
### Existing MWEs: 
1- **riportato a normalità** (ID)Tokens : 
riportato
a
normalità
...
### Existing MWEs: 
1- **qualificando- si** (IReflV)Tokens : 
qualificando-
si
...
### Existing MWEs: 
1- **decisioni prese** (LVC)Tokens : 
decisioni
prese

### Identified MWEs: 
1- **prese su torino** (ID)Tokens : 
prese
su
torino
...
### Existing MWEs: 
1- **dati alle fiamme** (ID, 2)Tokens : 
dati
alle
fiamme
...
### Existing MWEs: 
1- **tenere manifestazione** (LVC)Tokens : 
tenere
manifestazione
...
### Existing MWEs: 
1- **mantenere la testa** (ID)Tokens : 
mantenere
la
testa
...
### Existing MWEs: 
1- **effettuate intercettazioni** (LVC)Tokens : 
effettuate
intercettazioni
...
### Existing MWEs: 
1- **dato nome in codice** (ID)Tokens : 
dato
nome
in
codice
...
### Existing MWEs: 
1- **passano il turno** (ID, 1)Tokens : 
passano
il
turno

### Identified MWEs: 
1- **passano il turno** (ID)Tokens : 
passano
il
turno
...
### Existing MWEs: 
1- **perdere conoscenza** (ID)Tokens : 
perdere
conoscenza
...
### Existing MWEs: 
1- **superano il turno** (ID, 1)Tokens : 
superano
il
turno
...
### Existing MWEs: 
1- **allunga le distanze** (ID)Tokens : 
allunga
le
distanze
...
### Existing MWEs: 
1- **infilando in porta** (ID)Tokens : 
infilando
in
porta
...
### Existing MWEs: 
1- **avuti gli scontri** (LVC)Tokens : 
avuti
gli
scontri
...
### Existing MWEs: 
1- **si sentono traditi** (IReflV)Tokens : 
si
sentono
traditi
...
### Existing MWEs: 
1- **si comportando** (IReflV, 2)Tokens : 
si
comportando
...
### Existing MWEs: 
1- **la partita è decisa** (ID)Tokens : 
la
partita
è
decisa
...
### Existing MWEs: 
1- **interviene di pugno** (ID)Tokens : 
interviene
di
pugno
...
### Existing MWEs: 
1- **mettendo fuori causa** (ID)Tokens : 
mettendo
fuori
causa
...
### Existing MWEs: 
1- **effettuato trapianto** (LVC)Tokens : 
effettuato
trapianto
...
### Existing MWEs: 
1- **arrivare a coprire** (ID)Tokens : 
arrivare
a
coprire
...
### Existing MWEs: 
1- **mettendo a punto** (ID, 3)Tokens : 
mettendo
a
punto

### Identified MWEs: 
1- **mettendo a punto** (ID)Tokens : 
mettendo
a
punto
...
### Existing MWEs: 
1- **ottiene il massimo con il minimo** (OTH)Tokens : 
ottiene
il
massimo
con
...
### Existing MWEs: 
1- **prenderanno iniziative** (LVC, 1)Tokens : 
prenderanno
iniziative
