...
### Identified MWEs: 
1- **κρούει τον κώδωνα του κινδύνου** (ID)Tokens : 
κρούει
τον
κώδωνα
του
...
### Identified MWEs: 
1- **βάζουν στο στόχαστρό** (VPC)Tokens : 
βάζουν
στο
στόχαστρό
...
### Identified MWEs: 
1- **δόθηκε στη δημοσιότητα** (LVC)Tokens : 
δόθηκε
στη
δημοσιότητα
