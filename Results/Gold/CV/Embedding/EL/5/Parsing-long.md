...
2- **κλείνονται στον εαυτό τους** (ID, 2)Tokens : 
κλείνονται
στον
εαυτό
τους
...
2- **έχουν αντίκτυπο** (LVC, 1)Tokens : 
έχουν
αντίκτυπο
...
### Existing MWEs: 
1- **πάρει διαστάσεις** (LVC, 3)Tokens : 
πάρει
διαστάσεις

### Identified MWEs: 
1- **πάρει διαστάσεις** (LVC)Tokens : 
πάρει
διαστάσεις
...
### Existing MWEs: 
1- **υπόκεινται σε αναθεωρήσεις** (LVC)Tokens : 
υπόκεινται
σε
αναθεωρήσεις
...
### Existing MWEs: 
1- **κάνει πίσω** (VPC, 6)Tokens : 
κάνει
πίσω

### Identified MWEs: 
1- **κάνει πίσω** (VPC)Tokens : 
κάνει
πίσω
...
### Existing MWEs: 
1- **προκαλέσει τριβές** (LVC)Tokens : 
προκαλέσει
τριβές
...
### Identified MWEs: 
1- **βάλει υποψηφιότητα** (LVC)Tokens : 
βάλει
υποψηφιότητα
...
### Existing MWEs: 
1- **θέσει ερώτημα** (LVC, 3)Tokens : 
θέσει
ερώτημα

### Identified MWEs: 
1- **θέσει εαυτό** (LVC)Tokens : 
θέσει
εαυτό
...
### Existing MWEs: 
1- **προκαλέσει πονοκέφαλο** (LVC)Tokens : 
προκαλέσει
πονοκέφαλο
...
### Identified MWEs: 
1- **δώσει στους καναλάρχες** (LVC)Tokens : 
δώσει
στους
καναλάρχες

2- **τα δώσει στους καναλάρχες** (ID)Tokens : 
τα
δώσει
στους
καναλάρχες

3- **έκανε λόγο** (LVC)Tokens : 
έκανε
λόγο
...
### Existing MWEs: 
1- **βάλει στο μάτι** (ID, 2)Tokens : 
βάλει
στο
μάτι

### Identified MWEs: 
1- **βάλει στο μάτι** (ID)Tokens : 
βάλει
στο
μάτι
...
### Existing MWEs: 
1- **δοθεί εντολή** (LVC, 9)Tokens : 
δοθεί
εντολή

### Identified MWEs: 
1- **έχει δυνατότητα** (LVC)Tokens : 
έχει
δυνατότητα

2- **δοθεί εντολή** (LVC)Tokens : 
δοθεί
εντολή
...
### Existing MWEs: 
1- **Έχω ευθύνη** (LVC, 2)Tokens : 
Έχω
ευθύνη

### Identified MWEs: 
1- **Έχω ευθύνη** (LVC)Tokens : 
Έχω
ευθύνη
...
Τι μέλλει γενέσθαι ; 
### Existing MWEs: 
1- **Τι μέλλει γενέσθαι** (OTH)Tokens : 
Τι
μέλλει
γενέσθαι
...
### Existing MWEs: 
1- **λαμβάνεται υπόψη** (ID, 13)Tokens : 
λαμβάνεται
υπόψη

### Identified MWEs: 
1- **λαμβάνεται ποσό** (LVC)Tokens : 
λαμβάνεται
ποσό

2- **λαμβάνεται υπόψη** (ID)Tokens : 
λαμβάνεται
υπόψη
...
### Existing MWEs: 
1- **ανοίγει το δρόμο** (ID, 9)Tokens : 
ανοίγει
το
δρόμο
...
### Existing MWEs: 
1- **δίνει τη δυνατότητα** (LVC)Tokens : 
δίνει
τη
δυνατότητα
...
### Existing MWEs: 
1- **καταπίνει την κάμηλο** (ID)Tokens : 
καταπίνει
την
κάμηλο
...
### Existing MWEs: 
1- **φωτογραφίες τράβηξαν** (LVC)Tokens : 
φωτογραφίες
τράβηξαν
...
### Existing MWEs: 
1- **θέτει στο επίκεντρο** (LVC)Tokens : 
θέτει
στο
επίκεντρο
...
### Existing MWEs: 
1- **υλοποίηση πραγματοποιηθεί** (LVC)Tokens : 
υλοποίηση
πραγματοποιηθεί
...
### Existing MWEs: 
1- **κουνάνε το δάχτυλο** (ID, 2)Tokens : 
κουνάνε
το
δάχτυλο

### Identified MWEs: 
1- **κουνάνε το δάχτυλο** (ID)Tokens : 
κουνάνε
το
δάχτυλο
...
### Existing MWEs: 
1- **σηκώνουμε το γάντι** (ID)Tokens : 
σηκώνουμε
το
γάντι
...
### Existing MWEs: 
1- **φωνάζει ο κλέφτης για να φοβηθεί ο νοικοκύρης** (ID)Tokens : 
φωνάζει
ο
κλέφτης
για
...
### Existing MWEs: 
1- **πάρει πίσω** (VPC)Tokens : 
πάρει
πίσω

### Identified MWEs: 
1- **πάρει πίσω** (ID)Tokens : 
πάρει
πίσω
...
### Existing MWEs: 
1- **Στάση εργασίας πραγματοποιήσουν** (LVC)Tokens : 
Στάση
εργασίας
πραγματοποιήσουν
...
### Existing MWEs: 
1- **Σε επίσχεση εργασίας προχωρούν** (LVC)Tokens : 
Σε
επίσχεση
εργασίας
προχωρούν
...
### Existing MWEs: 
1- **κάνουν λόγο για** (LVC, 4)Tokens : 
κάνουν
λόγο
για
...
### Existing MWEs: 
1- **κάνοντας λόγο για** (LVC, 4)Tokens : 
κάνοντας
λόγο
για
...
### Existing MWEs: 
1- **καταλήγουμε στα συμπεράσματα** (LVC, 2)Tokens : 
καταλήγουμε
στα
συμπεράσματα
...
### Existing MWEs: 
1- **έχουν πρόσβαση** (LVC, 1)Tokens : 
έχουν
πρόσβαση

### Identified MWEs: 
1- **έχουν πρόσβαση** (LVC)Tokens : 
έχουν
πρόσβαση
