...
2- **έθεσε στον εαυτό της** (ID)Tokens : 
έθεσε
στον
εαυτό
της
...
### Identified MWEs: 
1- **θέτει στο τραπέζι** (LVC)Tokens : 
θέτει
στο
τραπέζι
...
### Identified MWEs: 
1- **κάνει στους συνανθρώπους** (LVC)Tokens : 
κάνει
στους
συνανθρώπους
