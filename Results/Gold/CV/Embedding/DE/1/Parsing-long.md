...
2- **außer kraft gesetzt** (ID)Tokens : 
außer
kraft
gesetzt
...
### Identified MWEs: 
1- **aufrecht erhalten** (VPC)Tokens : 
aufrecht
erhalten
...
### Identified MWEs: 
1- **sich bewusst** (IReflV)Tokens : 
sich
bewusst

2- **machen sich bewusst** (ID)Tokens : 
machen
sich
bewusst
...
### Identified MWEs: 
1- **es schief** (ID)Tokens : 
es
schief

2- **ging es schief** (ID)Tokens : 
ging
es
schief
