...
### Identified MWEs: 
1- **stellen zurückgeht** (ID)Tokens : 
stellen
zurückgeht
...
## Sentence No. 4678 - 
dokumenten information copyright © lippische landes-zeitung 2013 dokument erstellt am 08.07.2013 um 18:47:46 uhr letzte Änderung am 08.07.2013 um 18:48:59 uhr auch wird es wieder entspannungskurse geben , darunter meditationskurse , einen kursus für fußreflexzonenmassage und einen abend zum wohlfühlen mit anke weiß , an dem die teilnehmer die wohltuenden klänge tibetanischer klangschalen genießen können . 
### Existing MWEs: 
1- **es geben** (ID, 28)Tokens : 
es
geben
...
## Sentence No. 4684 - 
franz zehendmaier aus kreuth steht mit 10 964 stimmen als fünfter nachrücker bei den freien wählern fest . 
### Existing MWEs: 
1- **steht fest** (VPC, 4)Tokens : 
steht
fest
...
### Existing MWEs: 
1- **kommt vor** (VPC, 1)Tokens : 
kommt
vor

## Sentence No. 4687 - 
10.46 uhr : wie die leiterin der wiener landeswahlbehörde , stadträtin sandra frauenberger , bekannt gibt , lag die wahlbeteiligung in wien um 10 uhr bei 11,46 prozent . 
### Existing MWEs: 
1- **bekannt gibt** (ID)Tokens : 
bekannt
gibt

## Sentence No. 4692 - 
brüderpaar aus doline beim " freeriden " gerettet offenbar macht eben das material den unterschied . 
### Existing MWEs: 
1- **macht unterschied** (ID)Tokens : 
macht
unterschied
...
## Sentence No. 4699 - 
sami allagui kam nicht mehr aus der kabine wer einen solchen zaun möchte , muss sich daher in eine warteliste eintragen . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **auf stand sein** (ID)Tokens : 
auf
stand
sein

## Sentence No. 4701 - 
auch für die laufbahn seines landtagsnachfolgers gerd weimer spielte er eine wichtige rolle . 
### Existing MWEs: 
1- **spielte rolle** (ID, 5)Tokens : 
spielte
rolle
...
## Sentence No. 4704 - 
natürlich wolle man die berufsschule behalten , doch bei der standortfrage könne man nicht überstürzt dem erstbesten wunsch nach dem rennbahn-gelände nachgeben , sondern müsse alternativen prüfen . 
### Existing MWEs: 
1- **nachgeben** (VPC)Tokens : 
nachgeben

## Sentence No. 4705 - 
dann habe ihn bei einer anderen schlange niemand vorgelassen und er habe sich wieder hinten anstellen müssen . 
### Existing MWEs: 
1- **anstellen** (VPC, 1)Tokens : 
anstellen
...
## Sentence No. 4714 - 
der münchhausenweg gestern gegen 11.40 uhr : während auf dem nachbargrundstück sanierungsarbeiten laufen , sortiert shariar e. ( 44 ) im keller seines einfamilienhauses akten . 
### Existing MWEs: 
1- **sanierungsarbeiten laufen** (ID)Tokens : 
sanierungsarbeiten
laufen
...
### Identified MWEs: 
1- **vorgestellt** Tokens : 
vorgestellt

## Sentence No. 4733 - 
der garten lange : in beiden bereichen befindet sich jeweils ein teich . 
### Existing MWEs: 
1- **befindet sich** (IReflV, 1)Tokens : 
befindet
sich

## Sentence No. 4739 - 
sollte es nach der wahl keine klaren mehrheiten geben , würde der druck in der spd groß , sich mit der union zu einigen . 
### Existing MWEs: 
1- **es geben** (ID, 28)Tokens : 
es
geben
...
### Existing MWEs: 
1- **aussieht** (VPC, 1)Tokens : 
aussieht

## Sentence No. 4744 - 
ein großes lob zollte er den mitarbeitern des life houses , die sehr viel mühe in dieses projekt gesteckt hätten . 
### Existing MWEs: 
1- **lob zollte** (ID)Tokens : 
lob
zollte

### Identified MWEs: 
1- **zollte hätten** (ID)Tokens : 
zollte
hätten

## Sentence No. 4751 - 
zur verfügung gestellt von donau niederösterreich tourismus gmbh ( einlösbar bis ende okt. . 
### Existing MWEs: 
1- **zur verfügung gestellt** (ID, 2)Tokens : 
zur
verfügung
gestellt
...
## Sentence No. 4756 - 
während nach und nach die läufer der kurzen strecke entrudelten , gab löbel auf der strecke weiter gas . 
### Existing MWEs: 
1- **gab gas** (ID)Tokens : 
gab
gas
...
## Sentence No. 4762 - 
die deutsche ophthalmologische gesellschaft ( dog ) rät daher allen , die älter als 50 jahre alt sind , regelmäßig eine augenärztliche untersuchung vorzunehmen . 
### Existing MWEs: 
1- **vorzunehmen** (VPC)Tokens : 
vorzunehmen

## Sentence No. 4766 - 
diese haben aber noch gar keine zustimmung gegeben . 
### Existing MWEs: 
1- **zustimmung gegeben** (LVC)Tokens : 
zustimmung
gegeben

## Sentence No. 4772 - 
Üblicherweise verhindert ein in die straßenbahnen eingebauter kompressor , dass dieser effekt auftritt . 
### Existing MWEs: 
1- **auftritt** (VPC, 6)Tokens : 
auftritt
...
## Sentence No. 4774 - 
der stimmung auf den rängen tat das zumindest keinen abbruch . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **spendet kraft** (LVC)Tokens : 
spendet
kraft

## Sentence No. 4786 - 
durch diese maßnahme wird der boden offen gehalten , das bodenleben angeregt , der humusgehalt erhöht und die feuchtigkeit gespeichert . 
### Existing MWEs: 
1- **angeregt** (VPC)Tokens : 
angeregt

## Sentence No. 4793 - 
hier müssten mehr mittel eingestellt werden . 
### Existing MWEs: 
1- **eingestellt** (VPC, 8)Tokens : 
eingestellt
...
## Sentence No. 4794 - 
" das ist der trend , da kannst du nicht gegen den strom schwimmen " , wird hackl etwas später , mit blick auf das abschneiden der spÖ in steyr , sagen . 
### Existing MWEs: 
1- **abschneiden** (VPC)Tokens : 
abschneiden

## Sentence No. 4797 - 
die gruppe will ehrenmal und alte friedhofskapelle wieder auf vordermann bringen . 
### Existing MWEs: 
1- **auf vordermann bringen** (ID)Tokens : 
auf
vordermann
bringen

## Sentence No. 4798 - 
salat-saucen nach angaben eines behördensprechers gab es bei dem zwischenfall sieben bis zehn verletzte . 
### Existing MWEs: 
1- **gab es** (ID, 57)Tokens : 
gab
es
...
## Sentence No. 4799 - 
das aber könne die rostocker uni-klinik zusammen mit artcline , einer kleiner firma mit bislang vier forschern , nicht allein leisten . 
### Existing MWEs: 
1- **könne leisten** (ID)Tokens : 
könne
leisten

## Sentence No. 4801 - 
12.33 uhr : falls sie es verpasst haben - diese duelle gibt es in der qualifikation zur champions league ! 
### Existing MWEs: 
1- **gibt es** (ID)Tokens : 
gibt
es
...
## Sentence No. 4803 - 
er läuft ende des jahres 2013 aus . 
### Existing MWEs: 
1- **läuft aus** (VPC, 2)Tokens : 
läuft
aus
...
### Existing MWEs: 
1- **aufmerksamkeit gewidmet** (LVC)Tokens : 
aufmerksamkeit
gewidmet

## Sentence No. 4818 - 
andererseits votierten hinterländer vereine dafür , neben dem eintrittspreis von zwei euro auch einen ermäßigungstarif von 1,50 euro für schüler , auszubildende , studierende und rentner einzuführen - eine im fußballkreis marburg längst übliche regelung . 
### Existing MWEs: 
1- **einzuführen** (VPC, 2)Tokens : 
einzuführen

### Identified MWEs: 
1- **einzuführen** Tokens : 
einzuführen
...
### Existing MWEs: 
1- **nimmt hürde** (ID)Tokens : 
nimmt
hürde

## Sentence No. 4823 - 
am spielort bamberg ging es aber nicht nur um das duell zweier play-off-anwärter , sondern auch um den langjährigen ttf-präsidenten rainer ihle . 
### Existing MWEs: 
1- **ging es um** (ID, 2)Tokens : 
ging
es
um
...
## Sentence No. 4827 - 
der kardinalkämmerer des heiligen stuhls steht der apostolischen kammer vor , die während einer sedisvakanz zwischen dem ende eines pontifikats und der ausrufung eines neuen papstes die güter des vatikans verwaltet . 
### Existing MWEs: 
1- **steht vor** (VPC)Tokens : 
steht
vor
...
### Existing MWEs: 
1- **klingt aus** (VPC)Tokens : 
klingt
aus

## Sentence No. 4831 - 
die regionalligamannschaft des fc bayern setzt sich im kleinen derby gegen 1860 durch . 
### Existing MWEs: 
1- **setzt durch** (VPC, 3)Tokens : 
setzt
durch

## Sentence No. 4832 - 
die absperrung sei gut beleuchtet gewesen , stellte der oberstaatsanwalt fest . 
### Existing MWEs: 
1- **stellte fest** (VPC, 3)Tokens : 
stellte
fest
...
### Existing MWEs: 
1- **auf prüfstand stellt** (ID)Tokens : 
auf
prüfstand
stellt

## Sentence No. 4842 - 
die firmengründer sollen kurz vor der insolvenz millionen eingestrichen haben . 
### Existing MWEs: 
1- **eingestrichen** (VPC)Tokens : 
eingestrichen

## Sentence No. 4844 - 
bäume werden leider kaum als sensible lebewesen angesehen . 
### Existing MWEs: 
...
## Sentence No. 4849 - 
für die jüngsten wird es bald ein bibertreffen geben . 
### Existing MWEs: 
1- **es geben** (ID, 28)Tokens : 
es
geben
...
### Existing MWEs: 
1- **drehten auf** (VPC)Tokens : 
drehten
auf

## Sentence No. 4863 - 
zusammen stark für die heimatgeschichte so soll das nicht weitergehen : im arbeitskreis " heimat und geschichte " gibt es nun räume und möglichkeiten , um mit gleichgesinnten forschungen zu betreiben und auszuarbeiten . 
### Existing MWEs: 
1- **gibt es** (ID, 57)Tokens : 
gibt
es
...
## Sentence No. 4864 - 
der eintrag in dem blog stammt von mitte april , wurde in den schwedischen medien aber erst am donnerstag publik gemacht . 
### Existing MWEs: 
1- **publik gemacht** (ID)Tokens : 
publik
gemacht
...
## Sentence No. 4872 - 
bayern-verteidiger in der orf-diskussion war der finanzskandal der themenschwerpunkt , burgstaller und haslauer schoben sich den schwarzen peter zu . 
### Existing MWEs: 
1- **schoben sich den schwarzen peter zu** (ID)Tokens : 
schoben
sich
den
schwarzen
...
## Sentence No. 4878 - 
ich antwortete , laxenburg schätze ich noch aus zeiten , als wir schüler alle dorthin geschliffen wurden und sagte ihm , wir brauchen themen , geschichten , daraus machen wir ein konzept , das lege ich dem orf vor , und sagte ihm unter der bedingung zu , wenn ich dafür ich einen guten sendeplatz bekomme , und dass es da für mich immer noch nur den orf gibt , abgesehen von servus tv . 
### Existing MWEs: 
1- **sagte zu** (VPC, 1)Tokens : 
sagte
zu

### Identified MWEs: 
1- **lege vor** (VPC)Tokens : 
lege
vor
...
## Sentence No. 4882 - 
mit seinem märchenhaften geschichten verstand es preußler , auch erwachsene für seine erzählungen zu begeistern . 
### Existing MWEs: 
1- **verstand es** (ID)Tokens : 
verstand
es

## Sentence No. 4884 - 
das hamas-mitglied maisara abu hamdijeh musste als drahtzieher eines versuchten selbstmordanschlages eine lebenslange gefängnisstrafe verbüßen . 
### Existing MWEs: 
1- **gefängnisstrafe verbüßen** (ID)Tokens : 
gefängnisstrafe
verbüßen
...
### Existing MWEs: 
1- **gedanken machen** (LVC, 1)Tokens : 
gedanken
machen

## Sentence No. 4887 - 
zudem muss besiktas , der club des Öfb-nationalspielers veli kaflak die kommenden vier spiele der süper lig vor leeren rängen bestreiten . 
### Existing MWEs: 
1- **spiele bestreiten** (ID)Tokens : 
spiele
bestreiten
...
### Identified MWEs: 
1- **macht es** (ID)Tokens : 
macht
es

## Sentence No. 4897 - 
endlos-diskussion bei reddit sammelt gruselige sprüche von kindern " venus and adonis " von john blow und " dido and aeneas " von henry purcell wuchsen in den letzten wochen aus dem ungemein erfolgreichen projekt der festwochen alter musik , das teilnehmern des jährlichen cesti-gesangswettbewerbs jeweils im folgejahr eine auftrittschance gibt . 
### Existing MWEs: 
1- **auftrittschance gibt** (ID)Tokens : 
auftrittschance
gibt

## Sentence No. 4898 - 
das highlight des studientags wird ab 13 uhr das schon traditionelle mausefallenrennen sein , bei dem schülerinnen und schüler mit selbst konstruierten und gebauten fahrzeugen aus mausefallen einen wettkampf austragen . 
### Existing MWEs: 
1- **austragen** (VPC, 3)Tokens : 
austragen
...
## Sentence No. 4902 - 
doch der thw musste vor dieser saison eine zäsur vornehmen : mit torhüter thierry omeyer , welthandballer daniel narcisse , kapitän marcus ahlm und shooter momir ilic verließen gleich vier spieler mit dem prädikat weltklasse den verein . 
### Existing MWEs: 
1- **vornehmen** (VPC)Tokens : 
vornehmen
...
## Sentence No. 4913 - 
sie lud sich und pareys ortschronistin christiane wagner selbst beim museum ein . 
### Existing MWEs: 
1- **lud ein** (VPC, 4)Tokens : 
lud
ein
...
## Sentence No. 4918 - 
in der bezirksklasse steht im titelrennen ein dreikampf zwischen dem tv calmbach ii ( 16:2 ) , dem sv glatten ( 15:3 ) und dem ttc ottenbronn ii ( 14:4 ) an . 
### Existing MWEs: 
1- **steht an** (VPC)Tokens : 
steht
an
...
## Sentence No. 4924 - 
die uhr läuft , auch wenn der kunde zum beispiel im stau steht . 
### Existing MWEs: 
1- **im stau steht** (ID)Tokens : 
im
stau
steht

## Sentence No. 4927 - 
da nutzt ihm vorläufig auch der lädierte kampfanzug nichts , wenn er im verschneiten tennessee bruchlandet . 
### Existing MWEs: 
1- **bruchlandet** (ID)Tokens : 
bruchlandet

## Sentence No. 4934 - 
die gemeinschaftsschule ist im schuljahr 2012/2013 eingeführt worden . 
### Existing MWEs: 
1- **eingeführt** (VPC, 2)Tokens : 
eingeführt
...
## Sentence No. 4938 - 
die philippinen wollen ihre 342 soldaten von den golan-höhen abziehen . 
### Existing MWEs: 
1- **abziehen** (VPC, 1)Tokens : 
abziehen

## Sentence No. 4942 - 
ich habe mich geschämt und gedemütigt gefühlt . 
### Existing MWEs: 
1- **mich geschämt** (IReflV)Tokens : 
mich
geschämt
...
### Existing MWEs: 
1- **schlafengehen** (ID)Tokens : 
schlafengehen

## Sentence No. 4953 - 
porsche panamera - technische daten : fünftürige , viersitzige limousine der oberklasse ; länge : 5,02 ( 5,17 meter ) meter , breite : 1,93 meter , höhe : 1,42 meter , radstand : 2,92 meter ( daten in klammern : langversion ) eine fahrt mit geisterbär inklusive vor dem winter wird sie nicht abgeschlossen sein . 
### Existing MWEs: 
1- **abgeschlossen** (VPC, 8)Tokens : 
abgeschlossen

## Sentence No. 4954 - 
wo wir ansetzen , das sind notwendige upgrades , um wirkungsgrade und produktivität der linien zu erhöhen . 
### Existing MWEs: 
1- **ansetzen** (VPC)Tokens : 
ansetzen
...
## Sentence No. 4956 - 
veilchen-blaue augen und ein teint wie porzellan : es fällt nicht schwer zu glauben , dass rachel nichols ihre ersten schritte im show-business als model machte . 
### Existing MWEs: 
...
## Sentence No. 4966 - 
wertmäßig kam heute ein umsatz im prime market ( doppelzählung ) von 180,516 ( 169,887 ) mio. euro zu stande , wovon 45,53 mio. euro allein auf erste group entfielen . 
### Existing MWEs: 
1- **kam zu stande** (ID)Tokens : 
kam
zu
stande
...
## Sentence No. 4978 - 
nach informationen von sport bild plus kommt ein wechsel zu neapel , in der kommenden saison immerhin teilnehmer an der champions league , für gomez aber nicht infrage . 
### Existing MWEs: 
1- **kommt infrage** (VPC)Tokens : 
kommt
infrage
...
## Sentence No. 4979 - 
ein teil der abgaben kommt zwar auch uns wieder zugute , aber dennoch hakt es in diesem system gewaltig . 
### Existing MWEs: 
1- **kommt zugute** (VPC)Tokens : 
kommt
zugute
...
## Sentence No. 4986 - 
vom ersten tag an , wo das kommen 2012 der stadt angekündigt worden sei , sei das miteinander einwandfrei verlaufen . 
### Existing MWEs: 
1- **angekündigt** (VPC, 9)Tokens : 
angekündigt
...
## Sentence No. 4987 - 
badstuber fällt aus letzteres ist nicht ungefährlich , denn die abhänge des schinderwaldes driften extrem steil nach unten . 
### Existing MWEs: 
1- **fällt aus** (VPC, 1)Tokens : 
fällt
aus
...
### Identified MWEs: 
1- **fällt ungefährlich** (ID)Tokens : 
fällt
ungefährlich

## Sentence No. 4989 - 
" das klischee vom polnischen kriminellen gibt es in italien nicht " , erklärt guido dazu . 
### Existing MWEs: 
1- **gibt es** (ID, 57)Tokens : 
gibt
es
...
## Sentence No. 4992 - 
für das abenteuerepos " australia " stand kidman 2008 mit hugh jackman in ihrer heimat vor der kamera . 
### Existing MWEs: 
1- **stand vor der kamera** (ID)Tokens : 
stand
vor
der
kamera
...
## Sentence No. 4999 - 
er saß bereits wegen ns-wiederbetätigung im gefängnis . 
### Existing MWEs: 
1- **saß im gefängnis** (ID)Tokens : 
saß
im
gefängnis

## Sentence No. 5007 - 
mit sehr viel engagement haben die acht schüler dieser neuen ag ein stück nach einem roman der schriftstellerin joyce carol oates mit dem titel " amok " im theaterkeller der schule aufgeführt . 
### Existing MWEs: 
1- **aufgeführt** (VPC, 3)Tokens : 
aufgeführt
