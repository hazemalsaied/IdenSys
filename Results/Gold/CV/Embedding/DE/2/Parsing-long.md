...
2- **sich aufmerksam machen** (ID)Tokens : 
sich
aufmerksam
machen
...
### Existing MWEs: 
1- **ging nicht viel** (ID)Tokens : 
ging
nicht
viel

### Identified MWEs: 
1- **ging viel** (VPC)Tokens : 
ging
viel
...
### Existing MWEs: 
1- **herrscht hochbetrieb** (LVC)Tokens : 
herrscht
hochbetrieb
...
### Existing MWEs: 
1- **verwahren uns** (IReflV)Tokens : 
verwahren
uns

### Identified MWEs: 
1- **gehen an land** (ID)Tokens : 
gehen
an
land
...
### Existing MWEs: 
1- **stand im wege** (ID)Tokens : 
stand
im
wege

### Identified MWEs: 
1- **stand nichts** (ID)Tokens : 
stand
nichts
...
### Existing MWEs: 
1- **auf trainerbank sitzen** (ID)Tokens : 
auf
trainerbank
sitzen
...
### Existing MWEs: 
1- **ergebnis erzielen** (LVC)Tokens : 
ergebnis
erzielen
...
### Existing MWEs: 
1- **durchbruch schaffen** (LVC)Tokens : 
durchbruch
schaffen
...
### Identified MWEs: 
1- **setzte qualifizieren** (ID)Tokens : 
setzte
qualifizieren
...
### Existing MWEs: 
1- **ofenfrisch serviert** (ID)Tokens : 
ofenfrisch
serviert
...
### Existing MWEs: 
1- **zu gesicht bekommen** (ID)Tokens : 
zu
gesicht
bekommen
...
### Existing MWEs: 
1- **zu viele köche die im brei herumrühren** (ID)Tokens : 
zu
viele
köche
die
...
### Existing MWEs: 
1- **macht eindruck** (LVC, 1)Tokens : 
macht
eindruck

### Identified MWEs: 
1- **macht eindruck** (VPC)Tokens : 
macht
eindruck
...
### Existing MWEs: 
1- **zugriffsrechte erteilen** (LVC)Tokens : 
zugriffsrechte
erteilen
...
### Existing MWEs: 
1- **war auf leinwand zu sehen** (ID)Tokens : 
war
auf
leinwand
zu
...
### Existing MWEs: 
1- **der weg ist das ziel** (ID)Tokens : 
der
weg
ist
das
...
### Existing MWEs: 
1- **steht auf dem spiel** (ID)Tokens : 
steht
auf
dem
spiel
...
### Existing MWEs: 
1- **auf die straße gehen** (ID)Tokens : 
auf
die
straße
gehen
...
### Existing MWEs: 
1- **fahren krallen aus** (ID)Tokens : 
fahren
krallen
aus
...
### Existing MWEs: 
1- **greift zur bewertungskeule** (ID)Tokens : 
greift
zur
bewertungskeule

### Identified MWEs: 
1- **greift notiert** (ID)Tokens : 
greift
notiert
...
### Existing MWEs: 
1- **erstattete anzeige** (LVC)Tokens : 
erstattete
anzeige
...
### Existing MWEs: 
1- **dargestellt** (VPC, 1)Tokens : 
dargestellt

### Identified MWEs: 
1- **dargestellt** Tokens : 
dargestellt

## Sentence No. 2359 - 
psalm : " wenn mein geist in Ängsten ist , so nimmst du dich meiner an " . 
### Existing MWEs: 
1- **nimmst an** (VPC)Tokens : 
nimmst
an
...
### Existing MWEs: 
1- **darstellten** (VPC, 1)Tokens : 
darstellten

### Identified MWEs: 
1- **darstellten** Tokens : 
darstellten
...
### Existing MWEs: 
1- **auf programm stand** (ID)Tokens : 
auf
programm
stand

### Identified MWEs: 
1- **stand polanski** (ID)Tokens : 
stand
polanski
...
### Existing MWEs: 
1- **in empfang genommen** (LVC)Tokens : 
in
empfang
genommen
...
### Existing MWEs: 
1- **steht zur verfügung** (ID, 2)Tokens : 
steht
zur
verfügung

### Identified MWEs: 
1- **steht zur verfügung** (ID)Tokens : 
steht
zur
verfügung
...
### Existing MWEs: 
1- **hatten alle hände voll zu tun** (ID)Tokens : 
hatten
alle
hände
voll
...
### Existing MWEs: 
1- **stand unter alkoholeinfluss** (ID, 1)Tokens : 
stand
unter
alkoholeinfluss

### Identified MWEs: 
1- **stand unter alkoholeinfluss** (ID)Tokens : 
stand
unter
alkoholeinfluss
