...
2- **се надява получи** (IReflV)Tokens : 
се
надява
получи
...
### Identified MWEs: 
1- **извършени ще бъде взето решение** (LVC)Tokens : 
извършени
ще
бъде
взето
