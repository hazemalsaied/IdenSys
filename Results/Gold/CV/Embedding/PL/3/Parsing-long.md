...
2- **pożyczkach zaciągnięte** (LVC)Tokens : 
pożyczkach
zaciągnięte
...
### Identified MWEs: 
1- **przeprowadziła kontrolę** (LVC)Tokens : 
przeprowadziła
kontrolę

2- **znalazło się** (IReflV)Tokens : 
znalazło
się
...
### Identified MWEs: 
1- **podejmując ryzyka** (LVC)Tokens : 
podejmując
ryzyka
...
### Identified MWEs: 
1- **udzielania komunii** (LVC)Tokens : 
udzielania
komunii
...
### Identified MWEs: 
1- **pełnić jarmołowicz** (LVC)Tokens : 
pełnić
jarmołowicz
...
### Identified MWEs: 
1- **opiekowania się** (IReflV)Tokens : 
opiekowania
się
...
## Sentence No. 5553 - 
opzz od lutego ub . roku prowadziło negocjacje z konfederacją pracodawców . 
### Existing MWEs: 
1- **prowadziło negocjacje** (LVC)Tokens : 
prowadziło
negocjacje
...
### Existing MWEs: 
1- **przyjścia na świat** (ID, 1)Tokens : 
przyjścia
na
świat

### Identified MWEs: 
1- **przyjścia na świat** (ID)Tokens : 
przyjścia
na
świat

## Sentence No. 5564 - 
w wielką sobotę celebrował trzygodzinną mszę paschalną , a wcześniej udzielił sakramentu chrztu i bierzmowania dziewięciu osobom z różnych krajów świata . 
### Existing MWEs: 
1- **udzielił sakramentu** (LVC)Tokens : 
udzielił
sakramentu

## Sentence No. 5565 - 
w niedzielę celebrował świąteczną mszę świętą na placu świętego piotra , a potem wygłosił orędzie wielkanocne i złożył uczestnikom uroczystości świąteczne życzenia . 
### Existing MWEs: 
1- **złożył życzenia** (LVC)Tokens : 
złożył
życzenia
...
## Sentence No. 5571 - 
granitowa płyta , podstawa pomnika , o wymiarach 130 na 80 centymetrów znajdowała się pół metra pod ziemią niedaleko baszty brackiej w lubaniu . 
### Existing MWEs: 
1- **znajdowała się** (IReflV, 40)Tokens : 
znajdowała
się
...
## Sentence No. 5573 - 
kierowca zmierzającej z naprzeciwka hondy zbigniew r . nie zachował należytej ostrożności podczas wyprzedzania i jadąc lewym pasem , uderzył w forda transita , którym podróżowali członkowie szczecineckiej grupy . 
### Existing MWEs: 
1- **zachował ostrożności** (LVC)Tokens : 
zachował
ostrożności

## Sentence No. 5574 - 
kierujący furgonetką lider " terne roma " bogdan trojanek nie miał szansy uniknąć czołowego zderzenia . 
### Existing MWEs: 
1- **miał szansy** (LVC, 14)Tokens : 
miał
szansy

### Identified MWEs: 
1- **miał szansy** (LVC)Tokens : 
miał
szansy

## Sentence No. 5584 - 
niemiecki profesor gunther von hagens przeprowadził w środę w londyńskiej galerii atlantis pierwszą od 170 lat publiczną sekcję zwłok 72-letniego mężczyzny . 
### Existing MWEs: 
1- **przeprowadził sekcję zwłok** (LVC)Tokens : 
przeprowadził
sekcję
zwłok

## Sentence No. 5591 - 
kiedy opiekunowie zorientowali się , że dziecka nie ma , wezwali policję . 
### Existing MWEs: 
1- **zorientowali się** (IReflV, 4)Tokens : 
zorientowali
się

### Identified MWEs: 
1- **zorientowali się** (IReflV)Tokens : 
zorientowali
się

## Sentence No. 5598 - 
kilka tygodni wcześniej media pisały , że szef komisji finansów publicznych , jako doradca prawny firmy " agros " , starał się umożliwić jej niezapłacenie zaległego podatku vat . 
### Existing MWEs: 
...
## Sentence No. 5606 - 
mimo że temperatury nie należały do rekordowych , to jednak dały się we znaki . 
### Existing MWEs: 
1- **dały się we znaki** (ID)Tokens : 
dały
się
we
znaki
...
## Sentence No. 5610 - 
lekarz orzecznik może zbadać ubezpieczonego przebywającego na zwolnieniu , skierować go na badanie specjalistyczne , a także zażądać od lekarza leczącego udostępnienia dokumentacji medycznej . 
### Existing MWEs: 
1- **przebywającego na zwolnieniu** (LVC)Tokens : 
przebywającego
na
zwolnieniu

## Sentence No. 5617 - 
ich kształt będzie nawiązaniem do historycznych fortów , znajdujących się w tym rejonie miasta . 
### Existing MWEs: 
1- **znajdujących się** (IReflV, 40)Tokens : 
znajdujących
się
...
## Sentence No. 5618 - 
zagospodarowane zostaną tereny w pobliżu pomnika armii poznań , które z różnych względów cieszą się dziś " złą sławą " . 
### Existing MWEs: 
...
## Sentence No. 5622 - 
po kilku godzinach większość wycofała się , jednak co najmniej trzy czołgi pozostają na wzgórzu wznoszącym się nad betlejem . 
### Existing MWEs: 
1- **wznoszącym się** (IReflV)Tokens : 
wznoszącym
się
...
## Sentence No. 5635 - 
nowy lokator niestety nie mógł się zgodzić pod wspólnym dachem z dwoma innymi psami . 
### Existing MWEs: 
1- **się zgodzić** (IReflV, 5)Tokens : 
się
zgodzić
...
## Sentence No. 5636 - 
a może to one nie tolerowały gościa , bo , jak zapewniają pracownicy schroniska , u nich zachowuje się nienagannie . 
### Existing MWEs: 
1- **zachowuje się** (IReflV, 5)Tokens : 
zachowuje
się

### Identified MWEs: 
1- **zachowuje się** (IReflV)Tokens : 
zachowuje
się

## Sentence No. 5641 - 
były prezydent jako jedyny reprezentant europy wytypowany przez komitet organizacyjny , weźmie czynny udział w ceremonii otwarcia igrzysk olimpijskich . 
### Existing MWEs: 
1- **weźmie udział** (LVC, 27)Tokens : 
weźmie
udział
...
## Sentence No. 5652 - 
jednak sam fakt nie oznacza jeszcze dokonania przestępstwa . 
### Existing MWEs: 
1- **dokonania przestępstwa** (LVC)Tokens : 
dokonania
przestępstwa
...
## Sentence No. 5653 - 
dziewczyny spotkały się w programie . 
### Existing MWEs: 
1- **spotkały się** (IReflV, 22)Tokens : 
spotkały
się
...
## Sentence No. 5654 - 
obie narzeczone zerwały z nim kontakt i zapowiedziały , że nie chcą go znać . 
### Existing MWEs: 
1- **nie chcą znać** (ID)Tokens : 
nie
chcą
znać

## Sentence No. 5659 - 
wstydzę się i naprawię szkody - płaczliwie zapewniała sąd . 
### Existing MWEs: 
1- **wstydzę się** (IReflV, 1)Tokens : 
wstydzę
się

### Identified MWEs: 
1- **wstydzę się** (IReflV)Tokens : 
wstydzę
się

## Sentence No. 5660 - 
przed sądem okręgowym w koszalinie stanęli wczoraj oskarżeni : klaudia g . ( 19 lat ) , grzegorz sz . ( 24 lata ) , bogdan k . ( 20-latek ) . 
### Existing MWEs: 
1- **przed sądem stanęli** (ID)Tokens : 
przed
sądem
stanęli

## Sentence No. 5662 - 
zwolnienie z opłat przysługuje zarówno nadawcom indywidualnym , jak i instytucjom niosącym pomoc powodzianom . 
### Existing MWEs: 
1- **niosącym pomoc** (LVC, 1)Tokens : 
niosącym
pomoc

### Identified MWEs: 
1- **niosącym pomoc** (LVC)Tokens : 
niosącym
pomoc

## Sentence No. 5665 - 
sędzia miał wezwać wnioskodawcę do siebie i oświadczyć , że będzie mógł mu przyznać jedynie 20 tysięcy złotych odszkodowania . 
### Existing MWEs: 
1- **przyznać odszkodowania** (LVC)Tokens : 
przyznać
odszkodowania

## Sentence No. 5666 - 
do teresy czekaj , prezesa sądu okręgowego w lublinie , dotarło już oświadczenie mężczyzny , który próbował dostać odszkodowanie . 
### Existing MWEs: 
1- **dostać odszkodowanie** (LVC)Tokens : 
dostać
odszkodowanie
...
### Existing MWEs: 
1- **złożą przyrzeczenie** (LVC)Tokens : 
złożą
przyrzeczenie

### Identified MWEs: 
1- **pary złożą** (LVC)Tokens : 
pary
złożą

## Sentence No. 5703 - 
postępowanie prowadzi kp w długołęce . 
### Existing MWEs: 
1- **postępowanie prowadzi** (LVC)Tokens : 
postępowanie
prowadzi
...
## Sentence No. 5707 - 
wczoraj w warszawie dokonano podsumowania centralnego etapu corocznego konkursu " agroliga " na najlepszego rolnika i firmę branży rolniczej , organizowanego m.in . przez " agrobazar " , redakcję rolną telewizji polskiej , ministerstwo rolnictwa . 
### Existing MWEs: 
1- **dokonano podsumowania** (LVC)Tokens : 
dokonano
podsumowania

## Sentence No. 5718 - 
agencja prasowa ddp zamierza odwołać się od wyroku . 
### Existing MWEs: 
1- **odwołać się** (IReflV, 3)Tokens : 
odwołać
się
...
## Sentence No. 5724 - 
z listy sld o miejsce w senacie ubiegają się dwaj obecni senatorowie - bogusław litwiniec i marian noga oraz była senator maria berny . 
### Existing MWEs: 
1- **ubiegają się** (IReflV, 3)Tokens : 
ubiegają
się

### Identified MWEs: 
1- **ubiegają się** (IReflV)Tokens : 
ubiegają
się

## Sentence No. 5726 - 
gorzej sprawa ma się ze wspólną listą " senat 2001 " centroprawicy . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **padają ofiarą** (ID)Tokens : 
padają
ofiarą

### Identified MWEs: 
1- **uprawianie magii** (LVC)Tokens : 
uprawianie
magii
...
### Existing MWEs: 
1- **dokonano zmian** (LVC, 2)Tokens : 
dokonano
zmian

### Identified MWEs: 
1- **dokonano zmian** (LVC)Tokens : 
dokonano
zmian

## Sentence No. 5741 - 
oprócz ekip pogotowia udział w mistrzostwach wzięli pracownicy szpitalnych oddziałów ratunkowych , straży pożarnej i granicznej oraz ratownicy górscy . 
### Existing MWEs: 
1- **udział wzięli** (LVC, 1)Tokens : 
udział
wzięli

## Sentence No. 5742 - 
wszyscy startujący musieli przejść testy teoretyczne oraz wykazać się swoimi umiejętnościami w akcji . 
### Existing MWEs: 
1- **wykazać się** (IReflV, 2)Tokens : 
wykazać
się
...
## Sentence No. 5748 - 
już w sobotę natomiast " cantus " wystąpi w policach na " cecyliadzie " , imprezie ku czci św . cecylii , obok pięciu innych chórów ( m.in . " post scriptum " z polic , który dał kilka miesięcy temu koncert w połczynie ) , solistów z opery poznańskiej oraz gwiazdy wieczoru - anny marii jopek . 
### Existing MWEs: 
1- **dał koncert** (LVC)Tokens : 
dał
koncert

## Sentence No. 5749 - 
najważniejsza różnica dotyczy zakazu powoływania się w reklamach telewizyjnych na osoby , które mogą być kojarzone ze środowiskiem lekarskim . 
### Existing MWEs: 
1- **powoływania się** (IReflV, 7)Tokens : 
powoływania
się

### Identified MWEs: 
1- **powoływania się** (IReflV)Tokens : 
powoływania
się
...
### Existing MWEs: 
1- **miała premierę** (LVC)Tokens : 
miała
premierę

## Sentence No. 5765 - 
od trzech lat w szwedzkim saabie zespół kobiet , pracownic tej firmy , zajmuje się konsultacją projektów i testowaniem nowych modeli samochodów . 
### Existing MWEs: 
1- **zajmuje się** (IReflV, 33)Tokens : 
zajmuje
się
...
### Existing MWEs: 
1- **popisywało się** (IReflV)Tokens : 
popisywało
się
...
### Existing MWEs: 
1- **życzenia odebrał** (LVC)Tokens : 
życzenia
odebrał

## Sentence No. 5778 - 
trzej przewodnicy grupy zdążyli uciec , pozostali nie stawiali oporu podczas aresztowania . 
### Existing MWEs: 
1- **stawiali oporu** (LVC, 1)Tokens : 
stawiali
oporu

### Identified MWEs: 
1- **stawiali oporu** (LVC)Tokens : 
stawiali
oporu

## Sentence No. 5779 - 
teraz ich los leży w rękach wojewody . 
### Existing MWEs: 
1- **leży w rękach** (ID)Tokens : 
leży
w
rękach
...
## Sentence No. 5784 - 
reprezentuje on kasy przed władzami publicznymi , opracowuje jednolite dla wszystkich kas rozwiązania , prowadzi działalność szkoleniową . 
### Existing MWEs: 
1- **prowadzi działalność** (LVC, 3)Tokens : 
prowadzi
działalność

### Identified MWEs: 
1- **prowadzi działalność** (LVC)Tokens : 
prowadzi
działalność

## Sentence No. 5793 - 
zdaniem sędziego , najpiękniejsza okazała się właśnie polka . 
### Existing MWEs: 
1- **okazała się** (IReflV, 44)Tokens : 
okazała
się
...
## Sentence No. 5794 - 
dogi z hodowli jadwigi szłapki prezentują się dobrze nie tylko na wystawowych ringach , ale też . . . w obiektywie kamer . 
### Existing MWEs: 
1- **prezentują się** (IReflV, 1)Tokens : 
prezentują
się

### Identified MWEs: 
1- **prezentują się** (IReflV)Tokens : 
prezentują
się
...
## Sentence No. 5812 - 
o dostęp do tzw . teczek może starać się każdy , kto był poszkodowany przez prl . 
### Existing MWEs: 
1- **starać się** (IReflV, 20)Tokens : 
starać
się
...
## Sentence No. 5813 - 
jeśli formularz wypełni osoba , która np . była konfidentem , a poda się za pokrzywdzoną , grozi jej kara za wprowadzenie w błąd pracownika ipn . 
### Existing MWEs: 
1- **wprowadzenie w błąd** (ID)Tokens : 
wprowadzenie
w
błąd

### Identified MWEs: 
1- **poda się** (IReflV)Tokens : 
poda
się
...
## Sentence No. 5826 - 
na dwa i pół roku więzienia skazał wczoraj sąd okręgowy w szczecinie henryka z . , który molestował swoją nieletnią córkę i znęcał się nad konkubiną . 
### Existing MWEs: 
1- **znęcał się** (IReflV, 4)Tokens : 
znęcał
się

### Identified MWEs: 
1- **znęcał się** (IReflV)Tokens : 
znęcał
się

## Sentence No. 5828 - 
fizycznie i psychicznie znęcał się też nad konkubiną . 
### Existing MWEs: 
1- **znęcał się** (IReflV, 4)Tokens : 
znęcał
się
...
## Sentence No. 5837 - 
zdaniem ratowników praktycznie nie ma już szans , aby żołnierz mógł przeżyć . 
### Existing MWEs: 
1- **ma szans** (LVC, 14)Tokens : 
ma
szans
...
## Sentence No. 5841 - 
stąd janusz b . dodzwonił się do polski i poinformował , że jest cały i zdrowy . 
### Existing MWEs: 
1- **dodzwonił się** (IReflV)Tokens : 
dodzwonił
się
...
## Sentence No. 5843 - 
w wyprawie brało udział dziewięć osób , jednak wchodziły na szczyt w małych , 2- 3-osobowych grupach . 
### Existing MWEs: 
1- **brało udział** (LVC, 12)Tokens : 
brało
udział
...
## Sentence No. 5844 - 
niemal tysiąc podpisów złożono pod zamieszczoną w internecie petycją w obronie barów mlecznych . 
### Existing MWEs: 
1- **podpisów złożono** (LVC, 2)Tokens : 
podpisów
złożono

### Identified MWEs: 
1- **podpisów złożono** (LVC)Tokens : 
podpisów
złożono

## Sentence No. 5849 - 
moskwa , która nie przyznała , że jej dyplomaci zajmowali się działalnością szpiegowską , jeszcze 11 listopada zagroziła " adekwatną reakcją " . 
### Existing MWEs: 
1- **zajmowali się** (IReflV, 33)Tokens : 
zajmowali
się

### Identified MWEs: 
1- **zajmowali się** (IReflV)Tokens : 
zajmowali
się

## Sentence No. 5857 - 
pracodawca , który przez co najmniej cztery i pół roku zatrudni osoby niepełnosprawne , zarejestrowane jako bezrobotne w powiatowym urzędzie pracy lub poszukujące pracy , może otrzymać zwrot kosztów do wysokości 30-krotnego przeciętnego miesięcznego wynagrodzenia z tytułu organizacji nowych stanowisk pracy . 
### Existing MWEs: 
1- **otrzymać zwrot** (LVC)Tokens : 
otrzymać
zwrot
...
## Sentence No. 5858 - 
przedstawiciele essa nie chcą na razie mówić w jaki sposób doszło do kradzieży prądu , ani też jakie spółka poniosła straty . 
### Existing MWEs: 
1- **poniosła straty** (LVC)Tokens : 
poniosła
straty

## Sentence No. 5861 - 
w lutym z uwagi na zagrożenie chorobą bse i pryszczycą główny lekarz weterynarii wydał decyzję zamknięcia granic dla zwierząt i ich podrobów pochodzących z krajów unii europejskiej . 
### Existing MWEs: 
1- **wydał decyzję** (LVC)Tokens : 
wydał
decyzję
...
## Sentence No. 5862 - 
zakaz ten objął także jelita , a właśnie uszlachetnianiem jelit zajmowały się te dwa zakłady . 
### Existing MWEs: 
1- **zajmowały się** (IReflV, 33)Tokens : 
zajmowały
się

### Identified MWEs: 
1- **zajmowały się** (IReflV)Tokens : 
zajmowały
się

## Sentence No. 5864 - 
prokurator postawił im zarzut nieumyślnego narażenia na bezpośrednie niebezpieczeństwo utraty życia lub ciężkiego uszczerbku na zdrowiu . 
### Existing MWEs: 
1- **postawił zarzut** (LVC, 5)Tokens : 
postawił
zarzut

### Identified MWEs: 
1- **postawił zarzut** (LVC)Tokens : 
postawił
zarzut

## Sentence No. 5866 - 
poszkodowana domaga się 200 tysięcy złotych odszkodowania . 
### Existing MWEs: 
1- **domaga się** (IReflV, 12)Tokens : 
domaga
się
...
## Sentence No. 5869 - 
chciała usiąść i odpocząć , ale nagle straciła przytomność . 
### Existing MWEs: 
1- **straciła przytomność** (ID)Tokens : 
straciła
przytomność

## Sentence No. 5874 - 
ma nadzieję odwiedzić modne na wschodzie kluby karaoke , gdzie każdy może wejść na scenę i zaśpiewać tekst wyświetlany na telebimie . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **ofiarą padły** (ID)Tokens : 
ofiarą
padły

## Sentence No. 5891 - 
koło " grzybka " przy bramie portowej pojawili się geolodzy , którzy badają grunt . 
### Existing MWEs: 
1- **pojawili się** (IReflV, 52)Tokens : 
pojawili
się
...
## Sentence No. 5898 - 
zaczaja się na zebry , hieny i szakale . 
### Existing MWEs: 
1- **zaczaja się** (IReflV)Tokens : 
zaczaja
się

## Sentence No. 5914 - 
w głosowaniu wzięło udział 410 posłów , przeciw wnioskowi głosowało 235 , za 125 , wstrzymało się od głosów 50 posłów . 
### Existing MWEs: 
1- **wzięło udział** (LVC, 27)Tokens : 
wzięło
udział
...
## Sentence No. 5924 - 
rada ministrów odtajniła raport z kontroli przeprowadzonej w grom jesienią 1999 r . 
### Existing MWEs: 
1- **kontroli przeprowadzonej** (LVC, 1)Tokens : 
kontroli
przeprowadzonej

### Identified MWEs: 
1- **kontroli przeprowadzonej** (LVC)Tokens : 
kontroli
przeprowadzonej

## Sentence No. 5927 - 
stocznia czeka też aż minister skarbu państwa , wiesław kaczmarek podejmie decyzję o dokapitalizowaniu agencji rozwoju przemysłu , która ma być gwarantem kredytu w wysokości 40 mln usd . 
### Existing MWEs: 
1- **podejmie decyzję** (LVC, 15)Tokens : 
podejmie
decyzję
...
### Existing MWEs: 
1- **wejdą w skład** (ID)Tokens : 
wejdą
w
skład

## Sentence No. 5938 - 
za nieprzypadkowe przy tym uznał ujawnienie przez prokuraturę informacji , że rozpoczęto właśnie śledztwo w sprawie domniemanego przyjęcia korzyści materialnej przez prezydenta miasta . 
### Existing MWEs: 
1- **przyjęcia korzyści** (LVC)Tokens : 
przyjęcia
korzyści

## Sentence No. 5951 - 
według danych stowarzyszenia praw pacjentów primum non nocere na 2000 skarg , które wpłynęły w roku 1999 do rzeczników odpowiedzialności zawodowej izb lekarskich , wydano i uprawomocniło się mniej niż 100 orzeczeń uznających winę lekarza . 
### Existing MWEs: 
1- **wydano orzeczeń** (LVC)Tokens : 
wydano
orzeczeń

## Sentence No. 5952 - 
prawomocne kary to nagany , upomnienia i jedno czasowe zawieszenie prawa wykonywania zawodu . 
### Existing MWEs: 
1- **wykonywania zawodu** (LVC)Tokens : 
wykonywania
zawodu

## Sentence No. 5956 - 
białoruś zagroziła czechom zerwaniem stosunków dyplomatycznych , jeśli praga nie wyda prezydentowi aleksandrowi Łukaszence wizy , aby mógł wziąć udział w praskim szczycie nato - podały wczoraj agencje . 
### Existing MWEs: 
1- **wziąć udział** (LVC, 27)Tokens : 
wziąć
udział
...
## Sentence No. 5959 - 
mająca inklinacje do mocniejszych trunków panienka niedawno została ukarana przez sąd za picie piwa w nocnym klubie . 
### Existing MWEs: 
1- **mająca inklinacje** (LVC)Tokens : 
mająca
inklinacje
...
## Sentence No. 5961 - 
już we wtorek prezydent kwaśniewski wybiera się z roboczą wizytą do paryża , by przekonywać do naszych racji prezydenta jacquesa chiraka . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **przyjmuje na siebie** (ID)Tokens : 
przyjmuje
na
siebie

## Sentence No. 5966 - 
ujawniono i zabezpieczono wiele tysięcy litrów spirytusu i papierosów , rozpracowano grupy dokonujące oszustw poprzez tworzenie fikcyjnych kolizji drogowych i wyłudzające podatek vat . 
### Existing MWEs: 
1- **dokonujące oszustw** (LVC)Tokens : 
dokonujące
oszustw

## Sentence No. 5967 - 
systematycznie prowadzili kontrole , zmierzające do ujawnienia różnego rodzaju piractwa . 
### Existing MWEs: 
1- **prowadzili kontrole** (LVC)Tokens : 
prowadzili
kontrole
...
## Sentence No. 5971 - 
postanowienie o wstrzymaniu ataków zawarte zostało w grudniu , po rozmowach z władzami autonomii palestyńskiej . 
### Existing MWEs: 
1- **postanowienie zawarte** (LVC)Tokens : 
postanowienie
zawarte

## Sentence No. 5981 - 
podczas weryfikacji nominowanych komisja konkursowa brała pod uwagę m.in . wielkość sprzedaży firm na rynku lokalnym i zewnętrznym , dynamikę wzrostu zatrudnienia , innowacyjność , wartość inwestycji lokalnych i nowoczesność technologii oraz eksport . 
### Existing MWEs: 
1- **brała pod uwagę** (ID, 3)Tokens : 
brała
pod
uwagę

### Identified MWEs: 
1- **brała pod uwagę** (ID)Tokens : 
brała
pod
uwagę

## Sentence No. 5985 - 
nie ma szans na kompromis w sprawie cmentarza orląt we lwowie . 
### Existing MWEs: 
1- **ma szans** (LVC, 14)Tokens : 
ma
szans
...
## Sentence No. 5987 - 
jedynie mer lwowa lubmomyr buniak opowiedział się za przyjęciem tekstu napisu na grobie nieznanego Żołnierza zgodnie z polskimi oczekiwaniami . 
### Existing MWEs: 
1- **opowiedział się** (IReflV, 6)Tokens : 
opowiedział
się
...
## Sentence No. 5989 - 
przy ul . powstańców warszawy w sopocie policja ujęła dwóch młodych mężczyzn , którzy posługiwali się fałszywą kartą telefoniczną , niezmiennie wykazującą 100 impulsów . 
### Existing MWEs: 
1- **posługiwali się** (IReflV, 4)Tokens : 
posługiwali
się

### Identified MWEs: 
1- **posługiwali się** (IReflV)Tokens : 
posługiwali
się

## Sentence No. 5992 - 
michał s . i maciej j . posługiwali się sfałszowaną kartą telefoniczną od pewnego czasu . 
### Existing MWEs: 
1- **posługiwali się** (IReflV, 4)Tokens : 
posługiwali
się
...
### Existing MWEs: 
1- **głos zabrał** (ID)Tokens : 
głos
zabrał

## Sentence No. 5997 - 
był bez karty jazdy , a instruktor nie posiada uprawnień do szkolenia kierowców na tę kategorię prawa jazdy . 
### Existing MWEs: 
1- **posiada uprawnień** (LVC)Tokens : 
posiada
uprawnień
...
## Sentence No. 6006 - 
w happeningu brało udział 20 osób , sympatyków amnesty international . 
### Existing MWEs: 
1- **brało udział** (LVC, 12)Tokens : 
brało
udział
...
## Sentence No. 6010 - 
gdy ściągnęli maski , okazało się , że sami też są pomalowani na biało . 
### Existing MWEs: 
1- **okazało się** (IReflV, 44)Tokens : 
okazało
się
...
## Sentence No. 6012 - 
75 osób bierze udział w trwającej od wczoraj iv międzynarodowej wieczerzy wigilijnej zorganizowanej przez polskie stowarzyszenie na rzecz osób z upośledzeniem umysłowym . 
### Existing MWEs: 
1- **bierze udział** (LVC, 12)Tokens : 
bierze
udział
...
### Existing MWEs: 
1- **niestosowanie się** (IReflV, 2)Tokens : 
niestosowanie
się

### Identified MWEs: 
1- **niestosowanie się** (IReflV)Tokens : 
niestosowanie
się

## Sentence No. 6024 - 
Śmierć na miejscu poniosło pięcioro pasażerów pks . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **wybrali się** (IReflV, 4)Tokens : 
wybrali
się

### Identified MWEs: 
1- **wybrali się** (IReflV)Tokens : 
wybrali
się

## Sentence No. 6036 - 
mogą się o nie starać uczniowie trzecich klas gimnazjów i ci , którzy już uczą się w szkole średniej . 
### Existing MWEs: 
1- **się starać** (IReflV, 3)Tokens : 
się
starać

### Identified MWEs: 
1- **się starać** (IReflV)Tokens : 
się
starać

## Sentence No. 6037 - 
wiele wskazuje na to , że zdarzenie ma związek z konfliktem pomiędzy kilkoma tamtejszymi radnymi . 
### Existing MWEs: 
1- **ma związek** (LVC, 1)Tokens : 
ma
związek

### Identified MWEs: 
1- **ma związek** (LVC)Tokens : 
ma
związek

## Sentence No. 6044 - 
przewodniczący obradom ministrów duńczyk thor pedersen odpowiedział , że przyjmuje do wiadomości postulaty krajów kandydujących , ale że " nie jest to odpowiednie forum do negocjacji członkowskich " . 
### Existing MWEs: 
1- **przyjmuje do wiadomości** (ID)Tokens : 
przyjmuje
do
wiadomości
...
## Sentence No. 6062 - 
anonimowa ankieta przeprowadzona wśród gości baru wykazała , że szczególnie wstydliwe są kobiety . 
### Existing MWEs: 
...
## Sentence No. 6066 - 
chłopcy będą odpowiadać przed sądem jak dorośli . 
### Existing MWEs: 
1- **odpowiadać przed sądem** (ID, 1)Tokens : 
odpowiadać
przed
sądem

## Sentence No. 6067 - 
istnieje duże prawdopodobieństwo , że osoby poszkodowane będą się od nich domagać odszkodowań na drodze postępowania cywilnego . 
### Existing MWEs: 
1- **się domagać** (IReflV, 1)Tokens : 
się
domagać

## Sentence No. 6074 - 
był to dobry gest ze strony niemieckiego właściciela , gdyż zgodnie z przepisami rolnicy powinni domagać się zaległych pieniędzy od syndyka upadłej cukrowni w przeworsku . 
### Existing MWEs: 
1- **domagać się** (IReflV, 12)Tokens : 
domagać
się

### Identified MWEs: 
1- **domagać się** (IReflV)Tokens : 
domagać
się

## Sentence No. 6080 - 
ale strat materialnych nie udało się uniknąć . 
### Existing MWEs: 
1- **udało się** (IReflV, 58)Tokens : 
udało
się
...
## Sentence No. 6095 - 
kolejowi robotnicy prowadzili tam prace modernizacyjne . 
### Existing MWEs: 
1- **prowadzili prace** (LVC, 4)Tokens : 
prowadzili
prace

## Sentence No. 6096 - 
ustawa ta nie precyzowała pojęcia " dochodu " , odwołując się w tej kwestii do przepisów o zaopatrzeniu emerytalnym pracowników i ich rodzin . 
### Existing MWEs: 
1- **odwołując się** (IReflV, 6)Tokens : 
odwołując
się
...
## Sentence No. 6099 - 
działania te , w które zaangażowane jest całe kierownictwo państwa , mają na celu uzyskanie jak najkorzystniejszych warunków członkostwa polski w ue . 
### Existing MWEs: 
1- **mają na celu** (LVC, 7)Tokens : 
mają
na
celu

### Identified MWEs: 
1- **mają na celu** (LVC)Tokens : 
mają
na
celu
...
### Existing MWEs: 
1- **spodobali się** (IReflV, 4)Tokens : 
spodobali
się

### Identified MWEs: 
1- **spodobali się** (IReflV)Tokens : 
spodobali
się
...
### Existing MWEs: 
1- **zabawiali się** (IReflV)Tokens : 
zabawiali
się

## Sentence No. 6113 - 
utalentowana artystka zachwyciła wszystkich , choć znalazł się mężczyzna , który niecelnie rzucał w nią jajkami . 
### Existing MWEs: 
1- **znalazł się** (IReflV, 25)Tokens : 
znalazł
się
...
### Existing MWEs: 
1- **mieli otarcia** (LVC)Tokens : 
mieli
otarcia

## Sentence No. 6120 - 
ma liczne rany tłuczone , poważny uraz głowy . 
### Existing MWEs: 
...
### Identified MWEs: 
1- **ma rany** (LVC)Tokens : 
ma
rany

## Sentence No. 6122 - 
wczoraj madrycki instytut niskich temperatur zajął się analizą właściwości spadającego z nieba lodu i jego struktury . 
### Existing MWEs: 
1- **zajął się** (IReflV, 8)Tokens : 
zajął
się

### Identified MWEs: 
1- **zajął się** (IReflV)Tokens : 
zajął
się

## Sentence No. 6132 - 
sprawą zajął się sąd okręgowy w Łodzi i nakazał " multimediom " zaprzestanie niezgodnych z prawem działań oraz usunięcie istniejących dotychczas sieci . 
### Existing MWEs: 
1- **zajął się** (IReflV, 8)Tokens : 
zajął
się
...
## Sentence No. 6134 - 
jedna z koncepcji zmiany tego przepisu zakłada , że rzuty karne należy wykonywać . . . przed meczem . 
### Existing MWEs: 
1- **rzuty karne wykonywać** (LVC)Tokens : 
rzuty
karne
...
### Existing MWEs: 
1- **otrzymują pomoc** (LVC, 1)Tokens : 
otrzymują
pomoc

## Sentence No. 6144 - 
zwierzęta przyszły na świat w październiku i zgodnie z obowiązującym w ośrodku zwyczajem , zostały ochrzczone . 
### Existing MWEs: 
1- **przyszły na świat** (ID, 1)Tokens : 
przyszły
na
świat

### Identified MWEs: 
1- **przyszły na świat** (ID)Tokens : 
przyszły
na
świat

## Sentence No. 6161 - 
w trzykondygnacyjnym budynku znajdzie się nie tylko finansowany z pieniędzy rządowych dom samopomocy , ale też ośrodek interwencji kryzysowej , o który od dawna zabiegano w lesznie . 
### Existing MWEs: 
1- **znajdzie się** (IReflV, 25)Tokens : 
znajdzie
się
...
## Sentence No. 6166 - 
zdaniem dziennikarza " wiadomości " piotra góreckiego , członka ekipy , napad miał charakter rabunkowy . 
### Existing MWEs: 
1- **miał charakter** (LVC, 11)Tokens : 
miał
charakter
...
## Sentence No. 6183 - 
sądząc po zainteresowaniu publiczności , coraz większym powodzeniem cieszy się agroturyzm . 
### Existing MWEs: 
...
## Sentence No. 6188 - 
rada zwróciła się więc do głównego inspektora pracy . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **domagając się** (IReflV, 12)Tokens : 
domagając
się

### Identified MWEs: 
1- **domagając się** (IReflV)Tokens : 
domagając
się
...
### Identified MWEs: 
1- **się okazało** (IReflV)Tokens : 
się
okazało

## Sentence No. 6191 - 
radni wypowiedzieli się także w sprawie konieczności zmian kursów mzk . 
### Existing MWEs: 
1- **wypowiedzieli się** (IReflV, 3)Tokens : 
wypowiedzieli
się

### Identified MWEs: 
1- **wypowiedzieli się** (IReflV)Tokens : 
wypowiedzieli
się

## Sentence No. 6194 - 
tymczasem rodzice sebastiana kraszewskiego , który przyszedł na świat minutę po rozpoczęciu się 2000 roku w wojewódzkim szpitalu specjalistycznym we wrocławiu , otrzymali już od premiera jerzego buzka wózek dziecięcy i list gratulacyjny . 
### Existing MWEs: 
1- **przyszedł na świat** (ID, 1)Tokens : 
przyszedł
na
świat

### Identified MWEs: 
1- **przyszedł na świat** (ID)Tokens : 
przyszedł
na
świat

## Sentence No. 6197 - 
już 13 komitetów może wziąć udział w wyborach . 
### Existing MWEs: 
1- **wziąć udział** (LVC, 27)Tokens : 
wziąć
udział
...
## Sentence No. 6198 - 
pkw przyjęła kolejne zawiadomienia o zamiarze zgłoszenia kandydatów : od sld - up , pis , polskiej partii narodowej , forum emerytów i rencistów oraz konfederacji antyliberalna platforma kpn-op . 
### Existing MWEs: 
1- **przyjęła zawiadomienia** (LVC)Tokens : 
przyjęła
zawiadomienia

## Sentence No. 6199 - 
ponadto pkw przyjęła zawiadomienie od komitetu wyborczego wyborców henryka kierzkowskiego - niezależnego kandydata na senatora . 
### Existing MWEs: 
1- **przyjęła zawiadomienie** (LVC)Tokens : 
przyjęła
zawiadomienie
...
## Sentence No. 6201 - 
jak wyjaśnił marszałek , chodzi o umożliwienie udziału w debacie i głosowania w tej sprawie premierowi jerzemu buzkowi , który jutro i w piątek będzie przebywał z oficjalną wizytą w portugalii . 
### Existing MWEs: 
1- **przebywał z wizytą** (LVC)Tokens : 
przebywał
z
wizytą
...
### Existing MWEs: 
1- **wyssane z palca** (ID)Tokens : 
wyssane
z
palca

## Sentence No. 6204 - 
teraz się do tego przyznała i postanowiła poddać się kuracji odwykowej w klinice meadows w teksasie , gdzie trafiła z objawami załamania nerwowego . 
### Existing MWEs: 
1- **się przyznała** (IReflV)Tokens : 
się
przyznała

### Identified MWEs: 
1- **poddać się** (IReflV)Tokens : 
poddać
się

## Sentence No. 6212 - 
Żołnierzom zginęły zasobniki , w których znajdowały się m.in . maski przeciwgazowe , płaszcze i buty wojskowe , karimaty służące do spania w warunkach polowych oraz inne wyposażenie osobiste . 
### Existing MWEs: 
1- **znajdowały się** (IReflV, 40)Tokens : 
znajdowały
się

### Identified MWEs: 
1- **znajdowały się** (IReflV)Tokens : 
znajdowały
się

## Sentence No. 6226 - 
w naszym kraju przemoc fizyczna i psychiczne znęcanie się jako przestępstwa , patologie i zagrożenia rodzinne , domowe , nie są zjawiskiem marginalnym . 
### Existing MWEs: 
1- **znęcanie się** (IReflV, 4)Tokens : 
znęcanie
się
...
## Sentence No. 6229 - 
w czwartek prokuratura okręgowa w warszawie skierowała do sądu wniosek o aresztowanie . 
### Existing MWEs: 
1- **skierowała wniosek** (LVC, 2)Tokens : 
skierowała
wniosek

## Sentence No. 6236 - 
zgłoszenia należy składać do 15 sierpnia pod numerem telefonu : 520-59-50 . 
### Existing MWEs: 
1- **zgłoszenia składać** (LVC)Tokens : 
zgłoszenia
składać
...
## Sentence No. 6241 - 
zaatakowany mężczyzna nie odniósł poważniejszych obrażeń . 
### Existing MWEs: 
1- **odniósł obrażeń** (LVC, 5)Tokens : 
odniósł
obrażeń

### Identified MWEs: 
1- **odniósł obrażeń** (LVC)Tokens : 
odniósł
obrażeń

## Sentence No. 6244 - 
po przysiędze putina , z 18 dział ustawionych pod murem kremla oddano salwę 30 wystrzałów . 
### Existing MWEs: 
1- **oddano salwę** (LVC)Tokens : 
oddano
salwę
...
### Existing MWEs: 
1- **popełnieniu przestępstwa** (LVC, 2)Tokens : 
popełnieniu
przestępstwa

### Identified MWEs: 
1- **popełnieniu przestępstwa** (LVC)Tokens : 
popełnieniu
przestępstwa
...
### Existing MWEs: 
1- **wchodzi w życie** (ID, 1)Tokens : 
wchodzi
w
życie

### Identified MWEs: 
1- **wchodzi w życie** (ID)Tokens : 
wchodzi
w
życie

## Sentence No. 6277 - 
pierwsza z nich otrzymała wyróżnienie za pomocniczy kocioł olejowy do statków , druga za serię maszyn pakujących towar w folię . 
### Existing MWEs: 
1- **otrzymała wyróżnienie** (LVC)Tokens : 
otrzymała
wyróżnienie
...
## Sentence No. 6289 - 
część radnych była zdania , że są one zbyt drastyczne . 
### Existing MWEs: 
1- **była zdania** (LVC, 5)Tokens : 
była
zdania

### Identified MWEs: 
1- **była zdania** (LVC)Tokens : 
była
zdania

## Sentence No. 6293 - 
stróże prawa postanowili zwrócić uwagę na inne auta legalizowane w rawickim wydziale komunikacji . 
### Existing MWEs: 
1- **zwrócić uwagę** (ID, 4)Tokens : 
zwrócić
uwagę
...
## Sentence No. 6294 - 
wykonali żmudną pracę , przewertowali setki formularzy odpraw celnych . 
### Existing MWEs: 
1- **wykonali pracę** (LVC, 1)Tokens : 
wykonali
pracę

### Identified MWEs: 
1- **wykonali pracę** (LVC)Tokens : 
wykonali
pracę

## Sentence No. 6295 - 
w kręgu podejrzeń znalazły się trzy następne osoby z podbojanowskich wiosek . 
### Existing MWEs: 
1- **znalazły się** (IReflV, 25)Tokens : 
znalazły
się
...
## Sentence No. 6296 - 
ochroniarz oddał do napastników kilka strzałów . 
### Existing MWEs: 
1- **oddał strzałów** (LVC)Tokens : 
oddał
strzałów

## Sentence No. 6309 - 
podobnie jak w całym kraju , także w Łodzi tysiące osób spotkało się na orkiestrowym festynie na placu dąbrowskiego . 
### Existing MWEs: 
1- **spotkało się** (IReflV, 22)Tokens : 
spotkało
się
...
## Sentence No. 6314 - 
ja już informowali śmy część radnych zastanawiała się nad możliwością zmiany szyldu , bo aws praktycznie już nie istnieje . 
### Existing MWEs: 
1- **zastanawiała się** (IReflV, 8)Tokens : 
zastanawiała
się

### Identified MWEs: 
1- **zastanawiała się** (IReflV)Tokens : 
zastanawiała
się
...
### Existing MWEs: 
1- **wchodzącymi w skład** (ID, 2)Tokens : 
wchodzącymi
w
skład

## Sentence No. 6316 - 
obu oskarżonym sąd wymierzył karę pozbawienia wolności , czasowego zakazu zajmowania kierowniczych stanowisk i grzywny . 
### Existing MWEs: 
1- **wymierzył karę** (LVC)Tokens : 
wymierzył
karę

## Sentence No. 6317 - 
wyrok ten dotychczas nie uprawomocnił się , gdyż prezydent i wiceprezydent postanowili wykorzystać przysługujący im tryb odwoławczy i złożyli wnioski o uzasadnienie . 
### Existing MWEs: 
1- **złożyli wnioski** (LVC, 2)Tokens : 
złożyli
wnioski

### Identified MWEs: 
1- **złożyli wnioski** (LVC)Tokens : 
złożyli
wnioski
...
### Existing MWEs: 
1- **zdają sobie sprawę** (ID, 4)Tokens : 
zdają
sobie
sprawę
...
## Sentence No. 6321 - 
wskazują jednak , że środowisko ma szereg nowych pomysłów . 
### Existing MWEs: 
1- **ma pomysłów** (LVC, 3)Tokens : 
ma
pomysłów
...
### Existing MWEs: 
1- **przyznaje zasiłki** (LVC)Tokens : 
przyznaje
zasiłki

## Sentence No. 6339 - 
dodajmy , że tylko postkomunistom udało się wydać dokładnie co do grosza wszystkie pieniądze , jakie zebrali na kampanię wyborczą . 
### Existing MWEs: 
1- **udało się** (IReflV, 58)Tokens : 
udało
się
...
## Sentence No. 6341 - 
aws ma dwa miliony zł deficytu , unia wolności ponad milion , zaś psl i rop po 200 tys . zł . 
### Existing MWEs: 
1- **ma deficytu** (LVC)Tokens : 
ma
deficytu

## Sentence No. 6342 - 
jednak wszystkie te ugrupowania nie będą miały problemów ze spłatą długów , bowiem już teraz mogą się ustawiać w kolejce po pieniądze z budżetu państwa . 
### Existing MWEs: 
1- **miały problemów** (LVC, 9)Tokens : 
miały
problemów

### Identified MWEs: 
1- **miały problemów** (LVC)Tokens : 
miały
problemów
...
## Sentence No. 6346 - 
możemy się jej spodziewać nie wcześniej niż w styczniu nowego roku . 
### Existing MWEs: 
1- **się spodziewać** (IReflV, 5)Tokens : 
się
spodziewać
...
## Sentence No. 6347 - 
szczegółowe informacje o tym , gdzie i kiedy możemy zgłosić się po aktualny spis , pojawią się na naszych wyciągach w chwili , gdy zbiór numerów będzie już wydrukowany . 
### Existing MWEs: 
1- **pojawią się** (IReflV, 52)Tokens : 
pojawią
się
...
## Sentence No. 6350 - 
nilam thukral , żona handlarza nieruchomościami , doznała szoku , gdy w niedzielę rano zobaczyła dzikie zwierzę , siedzące na progu domu . 
### Existing MWEs: 
1- **doznała szoku** (LVC)Tokens : 
doznała
szoku
...
## Sentence No. 6357 - 
oznacza to , że nie mają gwarancji skarbu państwa dla depozytów , czyli naszych oszczędności . 
### Existing MWEs: 
1- **mają gwarancji** (LVC, 1)Tokens : 
mają
gwarancji

### Identified MWEs: 
1- **mają gwarancji** (LVC)Tokens : 
mają
gwarancji
...
## Sentence No. 6370 - 
dr stelągowski twierdzi , że uszczelnione sito opieki podstawowej ma na celu ograniczenie specjalistycznych świadczeń medycznych . 
### Existing MWEs: 
1- **ma na celu** (LVC, 7)Tokens : 
ma
na
celu
...
## Sentence No. 6371 - 
we wchodzącym dzisiaj w życie roporządzeniu ministra spraw wewnętrznych i administracji za niebezpieczne uznano rasy : buldog amerykański , dog argentyński , amerykański pit bulterier , perro de presa mallorquin , perro de presa canario , tosa inu , rottweiler , akbash dog , anatolian karabasha , moskiewski stróżujący i owczarek kaukaski . 
### Existing MWEs: 
1- **wchodzącym w życie** (ID, 1)Tokens : 
wchodzącym
w
życie

## Sentence No. 6378 - 
do wstępnych badań pobiera się ją nie z żyły , lecz z palca , gdyż w lesznie wykonywane są tylko badania podstawowe . 
### Existing MWEs: 
1- **wykonywane badania** (LVC)Tokens : 
wykonywane
badania

## Sentence No. 6379 - 
do czasu , kiedy wykonane zostaną wszystkie główne prace budowlane i instalacyjne , niedzielne msze święte nadal odprawiane będą w kaplicy . 
### Existing MWEs: 
1- **wykonane prace** (LVC, 1)Tokens : 
wykonane
prace

## Sentence No. 6381 - 
powstaną między innymi trzy salki , gdzie będą mogły spotykać się działające przy parafii grupy duszpasterskie . 
### Existing MWEs: 
1- **spotykać się** (IReflV, 5)Tokens : 
spotykać
się

### Identified MWEs: 
1- **spotykać się** (IReflV)Tokens : 
spotykać
się

## Sentence No. 6391 - 
drugi w tym czasie zaczął się bacznie rozglądać po mieszkaniu . 
### Existing MWEs: 
1- **się rozglądać** (IReflV)Tokens : 
się
rozglądać

## Sentence No. 6392 - 
widząc to kobieta poważnie zaniepokoiła się . 
### Existing MWEs: 
1- **zaniepokoiła się** (IReflV)Tokens : 
zaniepokoiła
się

## Sentence No. 6397 - 
153 mln dolarów odszkodowania przyznano małżeństwu , którego 3-letni syn zginął pod ciężarówką forda , w której stwierdzono wadliwe hamulce ręczne . 
### Existing MWEs: 
1- **odszkodowania przyznano** (LVC, 1)Tokens : 
odszkodowania
przyznano

## Sentence No. 6414 - 
być może specjalnymi maszynami uda się jeszcze zagęścić zgromadzoną masę i przedłużyć okres eksploatacji składowiska , ale najwyżej o 1,5 roku . 
### Existing MWEs: 
1- **uda się** (IReflV, 58)Tokens : 
uda
się
...
## Sentence No. 6415 - 
tym samym samorząd wschowy " złapał by oddech " po sfinalizowanej w styczniu budowie miejskiej oczyszczalni ścieków . 
### Existing MWEs: 
1- **złapał oddech** (ID)Tokens : 
złapał
oddech

## Sentence No. 6416 - 
podpisanie w paryżu protokołu o całkowitym zakazie " tworzenia istot ludzkich na wzór innych , żywych lub zmarłych i niezależnie od techniki " , odbiło się szczególnym echem ze względu na niedawną zapowiedź amerykańskiego uczonego , który ogłosił , że w ciągu trzech miesięcy rozpocznie systematyczne klonowanie reprodukcyjne ludzi . 
### Existing MWEs: 
1- **odbiło się echem** (ID)Tokens : 
odbiło
się
echem

## Sentence No. 6428 - 
na liście tych firm znalazły się m.in . spółdzielnie mleczarskie w kolnie , wysokiem mazowieckiem oraz zakłady w suwałkach . 
### Existing MWEs: 
1- **znalazły się** (IReflV, 25)Tokens : 
znalazły
się
...
## Sentence No. 6432 - 
okazało się , że przebierańcem jest 48-letni stanisław ch . 
### Existing MWEs: 
1- **okazało się** (IReflV, 44)Tokens : 
okazało
się
...
## Sentence No. 6443 - 
działo się to podczas festynu rekreacyjno - informacyjnego ruchu społecznego aws w sobotę przed dworem artusa w gdańsku . 
### Existing MWEs: 
1- **działo się** (IReflV, 9)Tokens : 
działo
się
...
## Sentence No. 6444 - 
zainteresowani polityką i spacerujący ul . długą , mogli zaopatrzyć się w materiały informacyjne o przeprowadzonych reformach , zapoznać się z głównymi założeniami polityki gospodarczej pomorza . 
### Existing MWEs: 
1- **przeprowadzonych reformach** (LVC, 3)Tokens : 
przeprowadzonych
reformach

### Identified MWEs: 
1- **zainteresowani polityką** (LVC)Tokens : 
zainteresowani
polityką

2- **przeprowadzonych reformach** (LVC)Tokens : 
przeprowadzonych
reformach
...
## Sentence No. 6448 - 
na piotrkowskiej do końca września zamontowane będą kamery śledzące to , co dzieje się na ulicy - zapowiedział prezydent Łodzi marek czekalski po pobiciu studentów u zbiegu głównej łódzkiej ulicy z pasażem schillera . 
### Existing MWEs: 
1- **dzieje się** (IReflV, 9)Tokens : 
dzieje
się
...
## Sentence No. 6449 - 
pojawiły się jednak wątpliwości , czy w budżecie miasta znajdzie się gotówka na ten cel . 
### Existing MWEs: 
1- **pojawiły się** (IReflV, 52)Tokens : 
pojawiły
się
...
## Sentence No. 6450 - 
most w kuligach na rzece jegrzni znajduje się w fatalnym stanie i grozi zawaleniem . 
### Existing MWEs: 
1- **znajduje się** (IReflV, 40)Tokens : 
znajduje
się
...
## Sentence No. 6451 - 
gdy to się stanie , wstrzymany zostanie dojazd do 2,5 tys . ha terenu , w tym prawie tysiąca prywatnych , częściowo użytkowanych łąk . 
### Existing MWEs: 
1- **się stanie** (IReflV, 12)Tokens : 
się
stanie
...
## Sentence No. 6452 - 
rolnicy korzystający z obiektu starali się sami wywalczyć remont spróchniałego mostu . 
### Existing MWEs: 
1- **starali się** (IReflV, 20)Tokens : 
starali
się
...
## Sentence No. 6460 - 
po uroczystym pasowaniu na drukarza , młodzi adepci wzięli udział w konkursie wiedzy o poligrafii . 
### Existing MWEs: 
1- **wzięli udział** (LVC, 27)Tokens : 
wzięli
udział

### Identified MWEs: 
1- **wzięli udział** (LVC)Tokens : 
wzięli
udział

## Sentence No. 6462 - 
dzieci mogły wziąć udział w konkursach rysunkowych . 
### Existing MWEs: 
1- **wziąć udział** (LVC, 27)Tokens : 
wziąć
udział
...
## Sentence No. 6464 - 
efektownie prezentowała się ponad 80-letnia maszyna drukarska , wciąż sprawna technicznie . 
### Existing MWEs: 
1- **prezentowała się** (IReflV, 1)Tokens : 
prezentowała
się

### Identified MWEs: 
1- **prezentowała się** (IReflV)Tokens : 
prezentowała
się

## Sentence No. 6467 - 
sytuacja taka ma miejsce przy burzyńskiego i ciołkowskiego . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **szkody spowodował** (LVC)Tokens : 
szkody
spowodował
...
## Sentence No. 6481 - 
niewiele różni się od legendarnego już pw5 ( na którym lata prawie cały świat ) . 
### Existing MWEs: 
1- **różni się** (IReflV, 7)Tokens : 
różni
się

### Identified MWEs: 
1- **różni się** (IReflV)Tokens : 
różni
się

## Sentence No. 6484 - 
w islamabadzie rozeszły się w minionym tygodniu pogłoski o możliwości ataku wojsk indyjskich lub nawet komandosów izraelskich w celu zniszczenia pakistańskich instalacji nuklearnych . 
### Existing MWEs: 
1- **rozeszły się** (IReflV, 1)Tokens : 
rozeszły
się

### Identified MWEs: 
1- **rozeszły się** (IReflV)Tokens : 
rozeszły
się

## Sentence No. 6488 - 
blisko 90 polskich sportowców - studentów bierze udział w 20 . letniej uniwersjadzie , jaka rozpoczęła się w sobotę na majorce . 
### Existing MWEs: 
1- **bierze udział** (LVC, 12)Tokens : 
bierze
udział
...
## Sentence No. 6489 - 
spośród dwunastu dyscyplin znajdujących się w programie imprezy , polacy wystąpią w ośmiu : judo , gimnastyka sportowa , lekkoatletyka , pływanie , siatkówka , tenis , żeglarstwo i szermierka . 
### Existing MWEs: 
1- **znajdujących się** (IReflV, 40)Tokens : 
znajdujących
się
...
## Sentence No. 6498 - 
dla fizyków , matematyków , statystyków , nauczycieli nauczania początkowego i szkół specjalnych rejonowe urzędy pracy w Łodzi , pabianicach i zgierzu nie otrzymały ani jednej oferty . 
### Existing MWEs: 
1- **otrzymały oferty** (LVC)Tokens : 
otrzymały
oferty
...
## Sentence No. 6509 - 
zdaniem policji , znajdujące się obecnie w obiegu trefne " setki " są bardzo dobrej jakości i pochodzą z jednej nielegalnej drukarni . 
### Existing MWEs: 
1- **znajdujące się** (IReflV, 40)Tokens : 
znajdujące
się
...
### Existing MWEs: 
1- **dokonania operacji** (LVC)Tokens : 
dokonania
operacji
...
## Sentence No. 6516 - 
tylko jedna osoba przeżyła katastrofę i znajduje się obecnie na oddziale intensywnej terapii bratysławskiej kliniki . 
### Existing MWEs: 
1- **znajduje się** (IReflV, 40)Tokens : 
znajduje
się
...
### Existing MWEs: 
1- **upiekło się** (IReflV)Tokens : 
upiekło
się

## Sentence No. 6525 - 
trudniej będzie się od niej wymigać . 
### Existing MWEs: 
1- **się wymigać** (IReflV)Tokens : 
się
wymigać

## Sentence No. 6540 - 
tak zwane " pewniaki " - czyli tegoroczne tematy maturalne typowane przez uczniów pojawiły się już także w internecie . 
### Existing MWEs: 
1- **pojawiły się** (IReflV, 52)Tokens : 
pojawiły
się
...
## Sentence No. 6544 - 
na mocy porozumienia , jakie samorząd zawarł z generalną dyrekcją archiwów państwowych , kamienica dawnego gimnazjum braci czeskich wróci na własność miasta . 
### Existing MWEs: 
1- **porozumienia zawarł** (LVC)Tokens : 
porozumienia
zawarł

## Sentence No. 6547 - 
sprawcy oddali cztery strzały do wnętrza pomieszczenia . 
### Existing MWEs: 
1- **oddali strzały** (LVC)Tokens : 
oddali
strzały

## Sentence No. 6549 - 
kobieta zachowała się bardzo lekkomyślnie , bo przechodziła przez ruchliwą jezdnię w miejscu niedozwolonym . 
### Existing MWEs: 
...
## Sentence No. 6558 - 
ciekawie zapowiada się nowa scenografia " Łwd " . 
### Existing MWEs: 
1- **zapowiada się** (IReflV, 3)Tokens : 
zapowiada
się
...
## Sentence No. 6567 - 
sobotni festyn na ul . monte cassino w sopocie , zorganizowany przez fundację rodzina nadziei , w tym roku nosił nazwę " ulica walecznych serc " . 
### Existing MWEs: 
1- **nosił nazwę** (LVC)Tokens : 
nosił
nazwę

## Sentence No. 6574 - 
jacek ambroziak powiedział , że celem tej zmiany jest także to , aby czas prywatyzacji danego przedsiębiorstwa miał znaczenie dla wartości akcji danych pracownikom , tzn . im szybciej przedsiębiorstwo będzie sprywatyzowane , tym większa będzie wartość otrzymywanych przez pracowników bezpłatnych akcji . 
### Existing MWEs: 
1- **miał znaczenie** (LVC)Tokens : 
miał
znaczenie
...
## Sentence No. 6587 - 
na nadzwyczajnej sesji plenarnej w brukseli parlament europejski zatwierdził w sobotę zdecydowaną większością głosów wprowadzenie wspólnej waluty europejskiej euro w 11 krajach , które od 1 stycznia 1999 roku wejdą w skład unii gospodarczej i walutowej w ramach ue . 
### Existing MWEs: 
1- **wejdą w skład** (ID)Tokens : 
wejdą
w
...
## Sentence No. 6591 - 
pieniądze będą wykorzystane na zakup ubrań i przyborów szkolnych dla siedmiorga dzieci powodzian z sokolnik , które przebywają na wakacjach w górze . 
### Existing MWEs: 
1- **przebywają na wakacjach** (LVC)Tokens : 
przebywają
na
wakacjach

## Sentence No. 6592 - 
tymczasem okazuje się , że nie wszystko jest w najlepszym porządku . 
### Existing MWEs: 
1- **okazuje się** (IReflV, 10)Tokens : 
okazuje
się
...
## Sentence No. 6593 - 
zarząd rts widzew podczas wczorajszego posiedzenia odwołał z funkcji prezesa rts widzew andrzeja pawelca i jednocześnie złożył wniosek do walnego zgromadzenia akcjonariuszy i rady nadzorczej spn widzew ssa ( obradować będzie 17 stycznia ) o odwołanie go z funkcji prezesa spółki . 
### Existing MWEs: 
1- **złożył wniosek** (LVC, 2)Tokens : 
złożył
wniosek

### Identified MWEs: 
1- **złożył wniosek** (LVC)Tokens : 
złożył
wniosek

## Sentence No. 6594 - 
spotkania , mające na celu właściwe przygotowanie się do rewitalizacji odbywają się cyklicznie we wszystkich miastach polski , które przygotowują się do tego procesu . 
### Existing MWEs: 
...
## Sentence No. 6605 - 
w województwie nie ma ani jednego grzebowiska dla zwierząt , choć ustawa z 1927 roku nakłada na gminy obowiązek urzadzania takich obiektów . 
### Existing MWEs: 
1- **nakłada obowiązek** (LVC, 1)Tokens : 
nakłada
obowiązek

## Sentence No. 6612 - 
wszystkie dzieci są zdrowe i czują się dobrze . 
### Existing MWEs: 
1- **czują się** (IReflV, 11)Tokens : 
czują
się

### Identified MWEs: 
1- **czują się** (IReflV)Tokens : 
czują
się

## Sentence No. 6617 - 
odgłos wystrzału zaalarmował znajdujących się w okolicy innych myśliwych . 
### Existing MWEs: 
1- **znajdujących się** (IReflV, 40)Tokens : 
znajdujących
się
...
## Sentence No. 6619 - 
wkrótce też natknęli się na mężczyzn ściągających skórę z zabitego kozła . 
### Existing MWEs: 
1- **natknęli się** (IReflV, 1)Tokens : 
natknęli
się

### Identified MWEs: 
1- **natknęli się** (IReflV)Tokens : 
natknęli
się

## Sentence No. 6630 - 
zdaniem producenta sopockiego festiwalu mirosława Łękowskiego , tegoroczne gwiazdy festiwalu zucchero i garou nie mają żadnych kaprysów kulinarnych . 
### Existing MWEs: 
1- **mają kaprysów** (LVC)Tokens : 
mają
kaprysów

## Sentence No. 6632 - 
jak ujawnił wczoraj wiceminister obrony john hamre , wkrótce po przestawieniu zegarów komputerowych pentagonu na nową datę 2000 roku , eksperci resortu nie byli w stanie przetworzyć danych przysyłanych z amerykańskich satelitów szpiegowskich . 
### Existing MWEs: 
1- **byli w stanie** (ID, 15)Tokens : 
byli
w
stanie

### Identified MWEs: 
1- **byli w stanie** (ID)Tokens : 
byli
w
stanie
...
### Existing MWEs: 
1- **się podobała** (IReflV, 2)Tokens : 
się
podobała

### Identified MWEs: 
1- **się podobała** (IReflV)Tokens : 
się
podobała
...
### Existing MWEs: 
1- **decydując się** (IReflV, 3)Tokens : 
decydując
się

### Identified MWEs: 
1- **decydując się** (IReflV)Tokens : 
decydując
się

## Sentence No. 6647 - 
jarosław r . , którego doprowadzono do sądu z aresztu , zeznawał jako świadek w jednym z procesów o znęcanie się . 
### Existing MWEs: 
1- **znęcanie się** (IReflV, 4)Tokens : 
znęcanie
się
...
## Sentence No. 6651 - 
była miss america , 37-letnia elizabeth ward gracen , która ma zeznawać w procesie wytoczonym prezydentowi clintonowi przez paulę jones , oświadczyła , że uprawiała seks z billem clintonem w czasach , kiedy był jeszcze gubernatorem stanu arkansas , ale odbywał się to za obopólną zgodą . 
### Existing MWEs: 
1- **uprawiała seks** (LVC, 1)Tokens : 
uprawiała
seks

### Identified MWEs: 
1- **uprawiała seks** (LVC)Tokens : 
uprawiała
seks

## Sentence No. 6653 - 
ważnego odkrycia archeologicznego dokonano w okolicach wsi zdory , gmina pisz . 
### Existing MWEs: 
1- **odkrycia dokonano** (LVC)Tokens : 
odkrycia
dokonano

## Sentence No. 6655 - 
na znalezisko natknął się adam mackiewicz , archeolog wynajęty do prac przez wojewódzkie służby ochrony zabytków w olsztynie . 
### Existing MWEs: 
...
## Sentence No. 6661 - 
otwarte drzwi od stacji znajdującej się na terenie zakładu warszbud zauważył we wtorek wieczorem przypadkowy przechodzień . 
### Existing MWEs: 
1- **znajdującej się** (IReflV, 40)Tokens : 
znajdującej
się

### Identified MWEs: 
1- **znajdującej się** (IReflV)Tokens : 
znajdującej
się

## Sentence No. 6663 - 
ze wstępnych ustaleń policji wynika , że do stacji transformatorowej przesyłającej prąd o napięciu 15 tysięcy v , dokonano włamania . 
### Existing MWEs: 
1- **dokonano włamania** (LVC)Tokens : 
dokonano
włamania

## Sentence No. 6669 - 
sprawą zajęła się specjalna grupa śledczych . 
### Existing MWEs: 
1- **zajęła się** (IReflV, 8)Tokens : 
zajęła
się

### Identified MWEs: 
1- **zajęła się** (IReflV)Tokens : 
zajęła
się

## Sentence No. 6671 - 
działania były prowadzone na terenie całego kraju . 
### Existing MWEs: 
1- **działania prowadzone** (LVC, 2)Tokens : 
działania
prowadzone
...
## Sentence No. 6675 - 
wielka brytania skierowała wczoraj skargę do komisji europejskiej i polskiego rządu na eksporterów polskiego węgla . 
### Existing MWEs: 
1- **skierowała skargę** (LVC)Tokens : 
skierowała
skargę

## Sentence No. 6678 - 
w moskwie zatrzymano wczoraj mężczyznę , który groził wysadzeniem się w powietrze pod siedzibą federalnej służby bezpieczeństwa na Łubiance . 
### Existing MWEs: 
1- **wysadzeniem w powietrze** (ID, 2)Tokens : 
wysadzeniem
w
powietrze

### Identified MWEs: 
1- **wysadzeniem się** (IReflV)Tokens : 
wysadzeniem
się
...
### Existing MWEs: 
1- **domagał się** (IReflV, 12)Tokens : 
domagał
się
...
## Sentence No. 6681 - 
po kilkudziesięciu minutach terrorysta zgodził się na przestawienie swego samochodu w mniej zaludnione miejsce . 
### Existing MWEs: 
1- **zgodził się** (IReflV, 15)Tokens : 
zgodził
się
...
## Sentence No. 6685 - 
w schronisku dysponujemy 20 miejscami , prowadzimy także prace nad adaptacją poddasza . 
### Existing MWEs: 
1- **prowadzimy prace** (LVC, 4)Tokens : 
prowadzimy
prace

## Sentence No. 6693 - 
wczoraj , 22 bm . sąd wojewódzki w zamościu oddalił wniosek kazimierza pacuły ze stefankowic , ubiegającego się o miliardowe odszkodowanie za 19 miesięcy niesłusznego aresztu . 
### Existing MWEs: 
1- **ubiegającego się** (IReflV, 3)Tokens : 
ubiegającego
się

### Identified MWEs: 
1- **ubiegającego się** (IReflV)Tokens : 
ubiegającego
się

## Sentence No. 6698 - 
miały się one znajdować na liście gangu porywaczy . 
### Existing MWEs: 
...
## Sentence No. 6699 - 
sojusz lewicy demokratycznej nie zgadza się z zapowiedzianym przez premiera jerzego buzka przesunięciem wyborów samorządowych na wrzesień br . 
### Existing MWEs: 
...
## Sentence No. 6701 - 
to , że rządząca koalicja solidarność - unia wolności obawia się wyników tych wyborów , nie jest żadnym powodem ich odroczenia . 
### Existing MWEs: 
1- **obawia się** (IReflV, 11)Tokens : 
obawia
się
...
## Sentence No. 6703 - 
wczoraj w pobliżu groznego , stolicy czeczenii , partyzanci czeczeńscy zestrzelili rosyjski śmigłowiec wojskowy mi-8 , zabijając dziewięciu wojskowych , którzy znajdowali się na pokładzie . 
### Existing MWEs: 
1- **znajdowali się** (IReflV, 40)Tokens : 
znajdowali
się
...
### Existing MWEs: 
1- **skarżyć się** (IReflV, 5)Tokens : 
skarżyć
się

### Identified MWEs: 
1- **skarżyć się** (IReflV)Tokens : 
skarżyć
się

## Sentence No. 6711 - 
afp podała , powołując się na anonimowe źródła dyplomatyczne , że w nocy obecne w petersburgu delegacje zdołały skompletować listy około 200 kandydatów do tymczasowej rady mającej rządzić afganistanem do czasu powołania nowego rządu . 
### Existing MWEs: 
1- **powołując się** (IReflV, 7)Tokens : 
powołując
się
...
## Sentence No. 6713 - 
najciekawiej zapowiada się w moskwie , gdzie miejscowy spartak podejmuje ajax amsterdam . 
### Existing MWEs: 
1- **zapowiada się** (IReflV, 3)Tokens : 
zapowiada
się
...
## Sentence No. 6717 - 
jednak już 1 kwietnia można się spodziewać kolejnej podwyżki cen znaczków na obydwa rodzaje listów - do 70 groszy . 
### Existing MWEs: 
1- **się spodziewać** (IReflV, 5)Tokens : 
się
spodziewać
...
## Sentence No. 6719 - 
minister zdrowia podpisał w piątek rozporządzenie o standardach postępowania oraz procedurach medycznych obowiązujących przy udzielaniu świadczeń zdrowotnych w zakresie anestezjologii i intensywnej terapii . 
### Existing MWEs: 
1- **udzielaniu świadczeń** (LVC, 1)Tokens : 
udzielaniu
świadczeń

### Identified MWEs: 
1- **udzielaniu świadczeń** (LVC)Tokens : 
udzielaniu
świadczeń

## Sentence No. 6729 - 
tymczasem miejscowy sanepid prowadzi badania podejrzanego produktu . 
### Existing MWEs: 
...
### Identified MWEs: 
1- **prowadzi badania** (LVC)Tokens : 
prowadzi
badania

## Sentence No. 6733 - 
w trakcie czwartkowego szczytu liderów aws i uw - jak się dowiedzieli śmy - oprócz przesunięcia terminu elekcji samorządowej z czerwca na wrzesień , uzgodniono bowiem także , iż efektem utworzenia powiatów i rządowo - samorządowych województw nie może być zwiększenie ogólnej liczby radnych . 
### Existing MWEs: 
1- **się dowiedzieli** (IReflV, 6)Tokens : 
się
dowiedzieli
...
## Sentence No. 6737 - 
grzegorz p . od początku przyznawał się do wszczynania fałszywych alarmów . 
### Existing MWEs: 
1- **przyznawał się** (IReflV, 3)Tokens : 
przyznawał
się

### Identified MWEs: 
1- **przyznawał się** (IReflV)Tokens : 
przyznawał
się
...
## Sentence No. 6748 - 
w podziale ogólnym w grupie a nie znalazło się żadne miasto z naszego regionu . 
### Existing MWEs: 
1- **znalazło się** (IReflV, 25)Tokens : 
znalazło
się
...
## Sentence No. 6759 - 
dwie trzecie badanych spodziewają się , że " zaleją nas tańsze artykuły spożywcze , a rolnictwo padnie " . 
### Existing MWEs: 
1- **spodziewają się** (IReflV, 12)Tokens : 
spodziewają
się
...
## Sentence No. 6762 - 
przyznał jednak , że niektóre firmy rzeczywiście nie chcą ponosić odpowiedzialności za zatrudnianie robotników przymusowych . 
### Existing MWEs: 
1- **ponosić odpowiedzialności** (LVC)Tokens : 
ponosić
odpowiedzialności
...
## Sentence No. 6770 - 
będą działać przy sądach rejonowych i prowadzić będą drobne sprawy cywilne oraz karne . 
### Existing MWEs: 
1- **prowadzić sprawy** (LVC, 1)Tokens : 
prowadzić
sprawy

## Sentence No. 6781 - 
okazało się jednak , że lek może służyć do produkcji środków odurzających . 
### Existing MWEs: 
1- **okazało się** (IReflV, 44)Tokens : 
okazało
się
...
## Sentence No. 6784 - 
w skład leku wchodzą m.in . teophilina , phenobarbital i ephydryna . 
### Existing MWEs: 
...
## Sentence No. 6793 - 
gdy dwaj bracia , w wieku 22 i 24 lat poczuli się źle , wezwano pogotowie , ale zanim dojechała karetka , starszy mężczyzna zmarł . 
### Existing MWEs: 
1- **poczuli się** (IReflV, 1)Tokens : 
poczuli
się

### Identified MWEs: 
1- **poczuli się** (IReflV)Tokens : 
poczuli
się

## Sentence No. 6798 - 
ostatnio pieniądze na wypłaty firma pożyczyła od totolotka - dowiedziała się " rzeczpospolita " . 
### Existing MWEs: 
1- **dowiedziała się** (IReflV, 23)Tokens : 
dowiedziała
się
...
## Sentence No. 6801 - 
blisko 10 tysięcy mieszkańców bydgoszczy wzięło udział w piątkowym " czarnym marszu " przeciwko przemocy . 
### Existing MWEs: 
1- **wzięło udział** (LVC, 27)Tokens : 
wzięło
udział
...
## Sentence No. 6803 - 
w marszu wzięli też udział m.in . młodzież innych szkół , parlamentarzyści , przedstawiciele władz samorządowych i kierownictwo miejscowej policji . 
### Existing MWEs: 
1- **wzięli udział** (LVC, 27)Tokens : 
wzięli
udział
...
## Sentence No. 6804 - 
ponad trzy i pół tysiąca osób wzięło udział w pogrzebie 26 dzieci i trzech kobiet , które zginęły w czwartek pod gruzami szkoły i domów w san giuliano di puglia na południu włoch . 
### Existing MWEs: 
1- **wzięło udział** (LVC, 27)Tokens : 
wzięło
udział
...
## Sentence No. 6809 - 
za 2 - 3 tygodnie w bankach spółdzielczych , skupionych w lbr , będzie można ubiegać się o pożyczki ze środków programu agrolinia 2000 , o podobnym oprocentowaniu , jak kredyty z dopłatami arimr . 
### Existing MWEs: 
1- **ubiegać się** (IReflV, 3)Tokens : 
ubiegać
się
...
## Sentence No. 6813 - 
po uderzeniu policyjną pałką kobieta doznała poważnego urazu wewnętrznego . 
### Existing MWEs: 
1- **doznała urazu** (LVC, 1)Tokens : 
doznała
urazu

## Sentence No. 6815 - 
pobici rolnicy złożyli w prokuraturze doniesienie o przekroczeniu przez policję uprawnień . 
### Existing MWEs: 
1- **złożyli doniesienie** (LVC)Tokens : 
złożyli
doniesienie

## Sentence No. 6818 - 
mimo tego nie udał się uniknąć wypadków . 
### Existing MWEs: 
1- **udał się** (IReflV, 58)Tokens : 
udał
się
...
## Sentence No. 6822 - 
według wstępnych ustaleń szczytnowskiej drogówki , winę ponosi kierowca policyjnego vw transportera , ponieważ nie dostosował prędkości do warunków na drodze . 
### Existing MWEs: 
1- **winę ponosi** (LVC)Tokens : 
winę
ponosi

## Sentence No. 6826 - 
zakłady azotowe " puławy " s.a . rekomendując płytę , próbują uzmysłowić potencjalnym nabywcom , że jako firma z ponad 30-letnią tradycją , która jeszcze niedawno była postrzegana jako potencjalne zagrożenie dla otaczającej przyrody i środowiska , podejmuje obecnie działania zmierzające do poprawy stanu bezpieczeństwa i ochrony zdrowia . 
### Existing MWEs: 
1- **podejmuje działania** (LVC, 1)Tokens : 
podejmuje
działania

### Identified MWEs: 
1- **podejmuje działania** (LVC)Tokens : 
podejmuje
działania

## Sentence No. 6833 - 
pierwsze egzemplarze nowego samochodu o nazwie seicento przechodzą już testy homologacyjne . 
### Existing MWEs: 
1- **przechodzą testy** (LVC)Tokens : 
przechodzą
testy

## Sentence No. 6840 - 
policja zatrzymała wówczas egzaminatora wojewódzkiego ośrodka ruchu drogowego w olsztynie , zajmującego się egzaminowaniem kandydatów na kierowców . 
### Existing MWEs: 
1- **zajmującego się** (IReflV, 33)Tokens : 
zajmującego
się
...
## Sentence No. 6841 - 
tymczasowo aresztowany jerzy g . , emerytowany oficer wojska polskiego , dostał zarzut wzięcia 450 zł łapówek . 
### Existing MWEs: 
1- **dostał zarzut** (LVC)Tokens : 
dostał
zarzut
...
## Sentence No. 6858 - 
magazyn będzie miał powierzchnię 42 tys . m kw . 
### Existing MWEs: 
1- **miał powierzchnię** (LVC)Tokens : 
miał
powierzchnię

## Sentence No. 6864 - 
przekonała się o tym 15-letnia paulina serowik z olsztyna ( na zdjęciu ) , którą okradziono w drodze z zakopanego do domu . 
### Existing MWEs: 
1- **przekonała się** (IReflV, 4)Tokens : 
przekonała
się
...
## Sentence No. 6874 - 
sąd rejonowy w białej podlaskiej uznał , że w listopadzie 1996 roku lekarka dopuściła się błędu w sztuce lekarskiej : bezpośrednio po porodzie nie stwierdziła u pacjentki pęknięcia macicy , przez co na czas nie podjęła odpowiednich czynności ratujących zdrowie . 
### Existing MWEs: 
1- **dopuściła się** (IReflV, 2)Tokens : 
dopuściła
się

### Identified MWEs: 
1- **dopuściła się** (IReflV)Tokens : 
dopuściła
się

## Sentence No. 6875 - 
w żagańskim zespole szkół tekstylno - handlowych prezentacji programu komputerowego do konstruowania i modelowania odzieży cad grafis dla polskiego przemysłu odzieżowego dokonał autor , prof . claus friedrich z niemiec . 
### Existing MWEs: 
1- **prezentacji dokonał** (LVC)Tokens : 
prezentacji
dokonał

## Sentence No. 6878 - 
trójka polskich twórców otrzymała w sobotę doroczne nagrody czeskiej akademii filmowej i telewizyjnej - czeskie lwy . 
### Existing MWEs: 
1- **otrzymała nagrody** (LVC, 2)Tokens : 
otrzymała
nagrody

## Sentence No. 6879 - 
za najlepszą główną rolę męską ( w filmie vladimira michalka " trzeba zabić sekala " ) to prestiżowe wyróżnienie otrzymał olaf lubaszenko . 
### Existing MWEs: 
1- **wyróżnienie otrzymał** (LVC)Tokens : 
wyróżnienie
otrzymał

## Sentence No. 6888 - 
ogromnym wzięciem cieszą się przed sezonem urlopowym jednorazowe nakładki toaletowe . 
### Existing MWEs: 
1- **cieszą się** (IReflV, 18)Tokens : 
cieszą
się
...
## Sentence No. 6893 - 
sprawa rzekomej korupcji wiceprezydenta pojawiła się pod koniec ub . r . na sesji rady miasta . 
### Existing MWEs: 
1- **pojawiła się** (IReflV, 52)Tokens : 
pojawiła
się
...
## Sentence No. 6897 - 
siostry wykonują swoje obowiązki , a po pracy przechodzą do specjalnie wydzielonego przez dyrekcję pomieszczenia , w którym będą przebywać przez całą dobę ( na zmiany ) . 
### Existing MWEs: 
1- **wykonują obowiązki** (LVC)Tokens : 
wykonują
obowiązki
...
## Sentence No. 6912 - 
para taneczna klasy s : małgorzata piasna i konrad szymański wiodła prym na rozegranych w sobotę i mistrzostwach okręgu Łódzkiego w tańcu towarzyskim . 
### Existing MWEs: 
1- **wiodła prym** (ID)Tokens : 
wiodła
prym

## Sentence No. 6913 - 
była gorąco oklaskiwana przez publiczność i zdobyła uznanie w oczach sędziów , zajmując i miejsce w obu kategoriach - tańcach standardowych i latynoamerykańskich . 
### Existing MWEs: 
1- **zdobyła uznanie** (LVC, 1)Tokens : 
zdobyła
uznanie

## Sentence No. 6918 - 
- centrala nie dostała pozwolenia na wycięcie świerków , dlatego trzeba było je przesadzić o kilka metrów - tłumaczy anna wołowska z wydziału ochrony Środowiska umŁ . 
### Existing MWEs: 
1- **dostała pozwolenia** (LVC)Tokens : 
dostała
pozwolenia
...
## Sentence No. 6919 - 
- oczywiście zajęła się tym specjalistyczna firma - chirurgów drzew . 
### Existing MWEs: 
1- **zajęła się** (IReflV, 8)Tokens : 
zajęła
się
...
## Sentence No. 6920 - 
w tak ciężkich warunkach młode drzewka by się nie przyjęły dlatego warto było ratować już te rosnące . 
### Existing MWEs: 
1- **się przyjęły** (IReflV, 1)Tokens : 
się
przyjęły

### Identified MWEs: 
1- **się przyjęły** (IReflV)Tokens : 
się
przyjęły

## Sentence No. 6923 - 
wyliczenia przeprowadził ośrodek badań nad handlem elektronicznym uniwersytetu teksas w austin ( usa ) na zlecenie koncernu elektronicznego cisco systems inc . 
### Existing MWEs: 
1- **wyliczenia przeprowadził** (LVC)Tokens : 
wyliczenia
przeprowadził

### Identified MWEs: 
1- **przeprowadził badań** (LVC)Tokens : 
przeprowadził
badań
...
### Existing MWEs: 
1- **mają gwarancje** (LVC, 1)Tokens : 
mają
gwarancje

### Identified MWEs: 
1- **mają gwarancje** (LVC)Tokens : 
mają
gwarancje

## Sentence No. 6931 - 
po mszy beatyfikacyjnej ojca pio w niedzielę w watykanie papież jan paweł ii udzielił błogosławieństwa byłemu premierowi włoch giulio andreottiemu . 
### Existing MWEs: 
1- **udzielił błogosławieństwa** (LVC)Tokens : 
udzielił
błogosławieństwa

## Sentence No. 6934 - 
ranny został 26-letni mieszkaniec legnicy ( jak się potem okazało , poszukiwany przez legnicką prokuraturę w związku z rozbojem przy użyciu niebezpiecznego narzędzia ) . 
### Existing MWEs: 
1- **się okazało** (IReflV, 3)Tokens : 
się
okazało
...
## Sentence No. 6940 - 
weźmie w nim udział blisko 100 osób z całej polski . 
### Existing MWEs: 
1- **weźmie udział** (LVC, 27)Tokens : 
weźmie
udział
