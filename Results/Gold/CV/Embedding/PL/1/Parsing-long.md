...
### Existing MWEs: 
1- **biją się** (IReflV, 1)Tokens : 
biją
się

### Identified MWEs: 
1- **biją się** (IReflV)Tokens : 
biją
się

## Sentence No. 1084 - 
talibowie wierzą , że z samym massudem sobie poradzą . 
### Existing MWEs: 
1- **sobie poradzą** (IReflV, 2)Tokens : 
sobie
poradzą
...
## Sentence No. 1086 - 
- widział kto , żeby seks stanął komu przy ludziach ! 
### Existing MWEs: 
1- **widział kto** (ID)Tokens : 
widział
kto

## Sentence No. 1097 - 
ustawa tego nie precyzuje , a urzędy skarbowe udzielają sprzecznych wyjaśnień . 
### Existing MWEs: 
1- **udzielają wyjaśnień** (LVC)Tokens : 
udzielają
wyjaśnień

## Sentence No. 1098 - 
w takiej sytuacji decyzję podejmuje sam podatnik , który samodzielnie wypełnia roczne zeznanie podatkowe i nie musi przy tym pytać urzędników o zdanie . 
### Existing MWEs: 
1- **decyzję podejmuje** (LVC, 2)Tokens : 
decyzję
podejmuje
...
## Sentence No. 1101 - 
pan się nie boi , że rop będzie przyczyną rozłamu w " s " ? 
### Existing MWEs: 
1- **się boi** (IReflV, 2)Tokens : 
się
boi

### Identified MWEs: 
1- **się boi** (IReflV)Tokens : 
się
boi

## Sentence No. 1104 - 
Żadnej partii nie udało się opanować " solidarności " . 
### Existing MWEs: 
1- **udało się** (IReflV, 60)Tokens : 
udało
się
...
### Existing MWEs: 
1- **wykonywać zadania** (LVC)Tokens : 
wykonywać
zadania
...
## Sentence No. 1121 - 
- chodzi o jasny i czytelny sygnał - szefem rady ministrów jest buzek , to on podejmuje decyzje . 
### Existing MWEs: 
1- **podejmuje decyzje** (LVC, 4)Tokens : 
podejmuje
decyzje

### Identified MWEs: 
1- **podejmuje decyzje** (LVC)Tokens : 
podejmuje
decyzje
...
### Existing MWEs: 
1- **wyciąga wnioski** (LVC, 1)Tokens : 
wyciąga
wnioski

### Identified MWEs: 
1- **wyciąga wnioski** (LVC)Tokens : 
wyciąga
wnioski

## Sentence No. 1128 - 
ale niezwykłość tego programu polegała na tym , że tym razem nie chodziło o martyrologię , ale o pokazanie , że różne kultury i religie mają inne niż nasza świętości . 
### Existing MWEs: 
1- **mają świętości** (LVC)Tokens : 
mają
świętości
...
## Sentence No. 1132 - 
w nowym systemie każdy dostał by państwową rentę plus to , co sam wypracuje . 
### Existing MWEs: 
1- **dostał rentę** (LVC)Tokens : 
dostał
rentę
...
## Sentence No. 1141 - 
w końcu stał się większy niż sam " fryzjer " i przejął interes starego . 
### Existing MWEs: 
1- **stał się** (IReflV, 49)Tokens : 
stał
się
...
## Sentence No. 1148 - 
chce w bohatyrowiczach zrobić biznes . 
### Existing MWEs: 
1- **zrobić biznes** (LVC)Tokens : 
zrobić
biznes
...
## Sentence No. 1156 - 
pierwszy krzykacz wśród profesjonalnych koszykarzy - potężny skrzydłowy szerszeni z charlotte larry johnson , wrzeszczy , gdy rzuca wolne , gdy zdobywa punkty i gdy jest z siebie niezadowolony . 
### Existing MWEs: 
1- **zdobywa punkty** (LVC)Tokens : 
zdobywa
punkty
...
## Sentence No. 1163 - 
tyle że komunizm przetrącił jej kręgosłup , wpędził w poczucie winy i wskazał kierunek w dół - ku ludowi , a rolę przeformułował na służalczą . 
### Existing MWEs: 
1- **przetrącił kręgosłup** (ID)Tokens : 
przetrącił
kręgosłup

## Sentence No. 1167 - 
popieram tę inicjatywę , jeśli tylko w jej ramach - np . obok gwarancji stabilnej polityki podatkowej - zmieściły by się także rozwiązania zapewniające efektywną kontrolę wywiązywania się sektora prywatnego z zobowiązań podatkowych , świadczeń na zus oraz przestrzegania prawa pracy . 
### Existing MWEs: 
1- **wywiązywania się** (IReflV)Tokens : 
wywiązywania
się

## Sentence No. 1169 - 
bowiem proponowana przez rząd operacja zamrożenia skali podatkowej i tak przyniesie dodatkowe dochody budżetowi państwa . 
### Existing MWEs: 
1- **przyniesie dochody** (LVC)Tokens : 
przyniesie
dochody
...
### Existing MWEs: 
1- **czekanie na godota** (ID)Tokens : 
czekanie
na
godota

## Sentence No. 1186 - 
w lutym emisje przeprowadziły efekt , swarzędz i exbud . 
### Existing MWEs: 
1- **emisje przeprowadziły** (LVC)Tokens : 
emisje
przeprowadziły

### Identified MWEs: 
1- **przeprowadziły efekt** (LVC)Tokens : 
przeprowadziły
efekt

## Sentence No. 1187 - 
decyzje w tej sprawie podjęły mostostal warszawa , elektrim , polifarb i okocim . 
### Existing MWEs: 
1- **decyzje podjęły** (LVC, 7)Tokens : 
decyzje
podjęły

### Identified MWEs: 
1- **decyzje podjęły** (LVC)Tokens : 
decyzje
podjęły

## Sentence No. 1189 - 
pierwsze recenzje w niemczech pojawiły się już dwa tygodnie po ukazaniu się książki w usa . 
### Existing MWEs: 
1- **pojawiły się** (IReflV, 59)Tokens : 
pojawiły
się
...
## Sentence No. 1192 - 
atak na książkę przypuściły wszystkie środowiska , od lewicowo - liberalnych po prawicowo - konserwatywne . 
### Existing MWEs: 
1- **atak przypuściły** (LVC)Tokens : 
atak
przypuściły

## Sentence No. 1196 - 
omijał z daleka swój pomnik , ale z uśmiechem , którego nie tracił , nawet po operacji serca , którą przeszedł rok temu . 
### Existing MWEs: 
1- **operacji przeszedł** (LVC)Tokens : 
operacji
przeszedł

## Sentence No. 1206 - 
wybór padł na propan - butan - gaz płynny , który stał się w ostatnich latach prawdziwym przebojem . 
### Existing MWEs: 
1- **stał się** (IReflV, 49)Tokens : 
stał
się
...
## Sentence No. 1208 - 
leontyna gemza : - pojęcie " na własny rachunek " jest wzięte żywcem z ustawy o działalności gospodarczej . 
### Existing MWEs: 
1- **wzięte żywcem** (ID)Tokens : 
wzięte
żywcem

## Sentence No. 1209 - 
my takiej nie prowadzimy , nie wykonujemy zadań publicznych dla zysku , ale dla dobra mieszkańców . 
### Existing MWEs: 
1- **wykonujemy zadań** (LVC)Tokens : 
wykonujemy
zadań
...
## Sentence No. 1211 - 
wrocławska izba skarbowa , która prowadzi postępowanie , odmówiła udzielenia nam informacji . 
### Existing MWEs: 
1- **prowadzi postępowanie** (LVC, 2)Tokens : 
prowadzi
postępowanie

### Identified MWEs: 
1- **prowadzi postępowanie** (LVC)Tokens : 
prowadzi
postępowanie

## Sentence No. 1214 - 
warany cieszą się dużym zainteresowaniem kolekcjonerów , gdyż nie można ich kupić legalnie . 
### Existing MWEs: 
1- **cieszą się** (IReflV, 18)Tokens : 
cieszą
się
...
## Sentence No. 1223 - 
natomiast dr gręziak powiedziała wczoraj , że zapłodnienie pozaustrojowe - choć umożliwia zajście w ciążę - w ogóle nie jest leczeniem niepłodności . 
### Existing MWEs: 
1- **zajście w ciążę** (ID)Tokens : 
zajście
w
ciążę

## Sentence No. 1224 - 
tymczasem zdesperowani pacjenci novum zamierzają podobno zaskarżyć lekarza wojewódzkiego do prokuratury za uniemożliwienie im leczenia , do czego - ich zdaniem - mają konstytucyjne prawo . 
### Existing MWEs: 
1- **mają prawo** (LVC, 9)Tokens : 
mają
prawo
...
## Sentence No. 1231 - 
- biorąc pod uwagę czas , jaki spędza z prezydentem , jest z nim najbliżej . 
### Existing MWEs: 
...
## Sentence No. 1233 - 
- na pewno taką możliwość ma ungier . 
### Existing MWEs: 
1- **możliwość ma** (LVC)Tokens : 
możliwość
ma

## Sentence No. 1237 - 
jeżeli siemiątkowski nie miał konkretnych przesłanek do wysuwania oskarżeń , to popełnił niewybaczalny błąd . 
### Existing MWEs: 
1- **popełnił błąd** (LVC, 2)Tokens : 
popełnił
błąd

### Identified MWEs: 
1- **popełnił błąd** (LVC)Tokens : 
popełnił
błąd

## Sentence No. 1242 - 
błędy proceduralne popełnione podczas przygotowań do podpisania umowy kredytowej wykorzystał nowy rząd , aby odwołać dotychczasowy zarząd firmy - obsadzony przez sld i psl oraz radę nadzorczą . 
### Existing MWEs: 
1- **błędy popełnione** (LVC, 1)Tokens : 
błędy
popełnione

### Identified MWEs: 
1- **błędy popełnione** (LVC)Tokens : 
błędy
popełnione

## Sentence No. 1243 - 
zarząd nie powiadomił rady nadzorczej o planowanym kredycie , podczas gdy powinien uzyskać zgodę na każdą pożyczkę powyżej 50 mln zł . 
### Existing MWEs: 
...
## Sentence No. 1244 - 
z kolei radzie nadzorczej zarzucono , że nie sprawuje należytej kontroli nad telekomunikacją . 
### Existing MWEs: 
1- **sprawuje kontroli** (LVC)Tokens : 
sprawuje
kontroli
...
## Sentence No. 1249 - 
- oto - gorączkował się - dane o opadach . 
### Existing MWEs: 
1- **gorączkował się** (IReflV)Tokens : 
gorączkował
się

## Sentence No. 1258 - 
można mieć wątpliwości co do tego czy innego paragrafu konkordatu lub sposobu przygotowywania projektu . 
### Existing MWEs: 
1- **mieć wątpliwości** (LVC, 6)Tokens : 
mieć
wątpliwości

### Identified MWEs: 
1- **mieć wątpliwości** (LVC)Tokens : 
mieć
wątpliwości
...
### Existing MWEs: 
1- **decyzje podjąć** (LVC, 7)Tokens : 
decyzje
podjąć

### Identified MWEs: 
1- **złożony bushowi** (LVC)Tokens : 
złożony
bushowi
...
### Existing MWEs: 
1- **podjąć decyzje** (LVC, 14)Tokens : 
podjąć
decyzje

### Identified MWEs: 
1- **podjąć decyzje** (LVC)Tokens : 
podjąć
decyzje

## Sentence No. 1269 - 
obawiali się , że porwą je albańskie gangi - o których tak dużo plotek słyszeli w kosowie - i zmuszą do prostytuowania się we włoszech lub grecji . 
### Existing MWEs: 
1- **obawiali się** (IReflV, 10)Tokens : 
obawiali
się
...
## Sentence No. 1271 - 
w takiej sytuacji powinni wypowiedzieć się : minister transportu , wojewoda , komendant główny policji , komendant wojewódzki policji , minister spraw wewnętrznych w porozumieniu z ministrem transportu i gospodarki morskiej . 
### Existing MWEs: 
1- **wypowiedzieć się** (IReflV, 3)Tokens : 
wypowiedzieć
się

### Identified MWEs: 
1- **wypowiedzieć się** (IReflV)Tokens : 
wypowiedzieć
się

## Sentence No. 1283 - 
pamięta , jak przyglądał się sinym palcom . 
### Existing MWEs: 
1- **przyglądał się** (IReflV, 5)Tokens : 
przyglądał
się
...
## Sentence No. 1287 - 
odgadnięcie elementarnych sojuszy - kto z kim , przeciw komu i po co - staje się , zwłaszcza pod koniec filmu , właściwie niewykonalne . 
### Existing MWEs: 
1- **staje się** (IReflV, 11)Tokens : 
staje
się
...
## Sentence No. 1297 - 
rzeczywiście , zastępca sekretarza stanu , dawniej tłumacz pamiętników chruszczowa i dziennikarz zajmujący się rosyjskimi sprawami , widział problem rozszerzenia sojuszu przez pryzmat stosunków z moskwą . 
### Existing MWEs: 
1- **zajmujący się** (IReflV, 36)Tokens : 
zajmujący
się
...
## Sentence No. 1304 - 
niedobrze dzieje się na rynku rolnym . 
### Existing MWEs: 
1- **dzieje się** (IReflV, 10)Tokens : 
dzieje
się
...
## Sentence No. 1329 - 
zagrała mroczna , szeleszcząca jak pustynny piasek muzyka koniecznego , a między jeżdżącymi w górę i w dół częściami scenografii mądzika poczęły się majestatycznie przesuwać piękne kostiumy zofii de ines , ledwo , ledwo wyłaniające się z mroków , na tyle jednak , aby śmy docenili wysmakowany projekt . 
### Existing MWEs: 
1- **wyłaniające się** (IReflV, 1)Tokens : 
wyłaniające
się

### Identified MWEs: 
1- **wyłaniające się** (IReflV)Tokens : 
wyłaniające
się
...
## Sentence No. 1346 - 
dante raczył zajmować się przede wszystkim potępionymi . 
### Existing MWEs: 
1- **zajmować się** (IReflV, 36)Tokens : 
zajmować
się
...
## Sentence No. 1356 - 
kiedy halina mikołajska związała się z komitetem obrony robotników i miała zakaz występowania w telewizji - tabu żydowskie zostało zastąpione przez inne . 
### Existing MWEs: 
1- **miała zakaz** (LVC)Tokens : 
miała
zakaz
...
### Existing MWEs: 
1- **miał prawo** (LVC, 9)Tokens : 
miał
prawo

### Identified MWEs: 
1- **miał prawo** (LVC)Tokens : 
miał
prawo
...
### Existing MWEs: 
1- **spotykam się** (IReflV, 6)Tokens : 
spotykam
się

### Identified MWEs: 
1- **spotykam się** (IReflV)Tokens : 
spotykam
się
...
## Sentence No. 1378 - 
ursuska " s " chce większą część udziałów , które dziś ma skarb państwa ( ok . 60 proc . ) , oddać w ręce spółki pracowniczej . 
### Existing MWEs: 
1- **oddać w ręce** (ID)Tokens : 
oddać
w
ręce
...
## Sentence No. 1382 - 
planowano , że strategicznym udziałowcem stanie się amerykański koncern agco . 
### Existing MWEs: 
1- **stanie się** (IReflV, 49)Tokens : 
stanie
się
...
## Sentence No. 1386 - 
postkomuniści , niegdyś żerujący na nostalgii za prl-em , dziś prezentują się jako partia otwarta na europę zachodnią , kompetentna w sprawowaniu władzy i promująca rozsądne zmiany . 
### Existing MWEs: 
1- **sprawowaniu władzy** (LVC, 4)Tokens : 
sprawowaniu
władzy
...
2- **sprawowaniu władzy** (LVC)Tokens : 
sprawowaniu
władzy

## Sentence No. 1388 - 
nauczyciel może mieć obowiązek prowadzenia 30 lekcji w tygodniu i zarabiać o jedną czwartą więcej niż przeciętna krajowa ( jak w usa ) lub 15 godzin i zarabiać niewiele więcej niż płaca minimalna ( jak we francji ) . 
### Existing MWEs: 
1- **mieć obowiązek** (LVC, 4)Tokens : 
mieć
obowiązek

### Identified MWEs: 
1- **mieć obowiązek** (LVC)Tokens : 
mieć
obowiązek

## Sentence No. 1392 - 
- głupi pomysł - krzywi się babcia . 
### Existing MWEs: 
1- **krzywi się** (IReflV)Tokens : 
krzywi
się
...
### Existing MWEs: 
1- **prowadziły sprawy** (LVC, 2)Tokens : 
prowadziły
sprawy
...
## Sentence No. 1407 - 
nie przeprowadził etnicznych czystek , nawet w policji i prasie . 
### Existing MWEs: 
1- **przeprowadził czystek** (LVC)Tokens : 
przeprowadził
czystek
...
## Sentence No. 1409 - 
nikt już po nim nie popełni takiego błędu . 
### Existing MWEs: 
1- **popełni błędu** (LVC, 2)Tokens : 
popełni
błędu

### Identified MWEs: 
1- **popełni błędu** (LVC)Tokens : 
popełni
błędu

## Sentence No. 1411 - 
przeprowadzić wywiad z samym panem bogiem - takie jest przypuszczalnie marzenie najambitniejszych dziennikarzy świata . 
### Existing MWEs: 
1- **przeprowadzić wywiad** (LVC)Tokens : 
przeprowadzić
wywiad
...
## Sentence No. 1412 - 
guy sorman z " le figaro " zrobił wywiady z bogami współczesnej wiedzy humanistycznej , technicznej , politycznej , ekonomicznej , zbierając je w księgę , której dał tytuł " prawdziwi myśliciele naszych czasów " . 
### Existing MWEs: 
1- **zrobił wywiady** (LVC)Tokens : 
zrobił
wywiady
...
## Sentence No. 1419 - 
czy pocił się z podniecenia , a może pisał jak automat ? 
### Existing MWEs: 
1- **pocił się** (IReflV)Tokens : 
pocił
się
...
### Existing MWEs: 
1- **wyróżniających się** (IReflV, 1)Tokens : 
wyróżniających
się

### Identified MWEs: 
1- **wyróżniających się** (IReflV)Tokens : 
wyróżniających
się
...
## Sentence No. 1426 - 
w pracach funduszu zgodziło się uczestniczyć kilku wybitnych przedstawicieli oświaty , nauki i kultury . 
### Existing MWEs: 
1- **zgodziło się** (IReflV, 12)Tokens : 
zgodziło
się

### Identified MWEs: 
1- **zgodziło się** (IReflV)Tokens : 
zgodziło
się

## Sentence No. 1429 - 
bardzo się raduję , że na drodze mego pielgrzymowania po ziemi ojczystej dane mi jest odwiedzić krakowski szpital specjalistyczny i poświęcić nowo wybudowaną poliklinikę kardiochirurgii . 
### Existing MWEs: 
1- **się raduję** (IReflV)Tokens : 
się
raduję
...
### Existing MWEs: 
1- **przynosić zyski** (LVC)Tokens : 
przynosić
zyski

## Sentence No. 1437 - 
w tym miejscu expose miało trochę życzeniowy charakter . 
### Existing MWEs: 
1- **miało charakter** (LVC, 10)Tokens : 
miało
charakter

## Sentence No. 1438 - 
raczej nieunikniona wydaje się natomiast podwyżka - nawet kilkuprocentowa - stawek vat . 
### Existing MWEs: 
1- **wydaje się** (IReflV, 18)Tokens : 
wydaje
się
...
## Sentence No. 1441 - 
dziecko po przyjściu na świat jest kładzione mamie na brzuch na 1 - 3 minuty , a w ciągu 2 godzin przystawiane do piersi . 
### Existing MWEs: 
1- **przyjściu na świat** (ID, 3)Tokens : 
przyjściu
na
świat

### Identified MWEs: 
1- **przyjściu na świat** (ID)Tokens : 
przyjściu
na
świat
...
### Existing MWEs: 
1- **znalazła się** (IReflV, 35)Tokens : 
znalazła
się
...
## Sentence No. 1461 - 
- miller dostał od sld rekomendację na ministra spraw wewnętrznych i administracji - powiedział nam oleksy . 
### Existing MWEs: 
1- **dostał rekomendację** (LVC)Tokens : 
dostał
rekomendację
...
## Sentence No. 1489 - 
nieudanie tym razem skakał o tyczce ukrainiec siergiej bubka . 
### Existing MWEs: 
1- **skakał o tyczce** (ID)Tokens : 
skakał
o
tyczce

## Sentence No. 1498 - 
wszystko można o ponurych czasach prl-u powiedzieć , ale nie to , że za komuny sportowcy mieli krzywdę . 
### Existing MWEs: 
1- **mieli krzywdę** (LVC)Tokens : 
mieli
krzywdę
...
## Sentence No. 1501 - 
wczoraj sąd w szanghaju wydał taki właśnie wyrok na lin haia , 30-letniego miejscowego biznesmena za to , że przekazał 30 tys . adresów internetowemu biuletynowi , " vip reference " prowadzonemu przez grupę chińskich dysydentów w usa . 
### Existing MWEs: 
1- **wydał wyrok** (LVC)Tokens : 
wydał
wyrok

## Sentence No. 1506 - 
tychami interesują się przedstawiciele holenderskiego heinekena i grolscha oraz belgijska firma interbrew oraz duński karlsberg . 
### Existing MWEs: 
1- **interesują się** (IReflV, 6)Tokens : 
interesują
się
...
## Sentence No. 1512 - 
chodziło o to , że jaruzelski nie mógł by stanąć przed sądem wojskowym , bo nie ma ławników równych mu stopniem . 
### Existing MWEs: 
1- **stanąć przed sądem** (ID, 2)Tokens : 
stanąć
przed
sądem

### Identified MWEs: 
1- **stanąć przed sądem** (ID)Tokens : 
stanąć
przed
sądem

2- **ma stopniem** (LVC)Tokens : 
ma
stopniem
...
### Existing MWEs: 
1- **spotkały się** (IReflV, 28)Tokens : 
spotkały
się
...
## Sentence No. 1529 - 
( . . . ) wyobraża sobie , że jest chomeinim i mandelą . 
### Existing MWEs: 
1- **wyobraża sobie** (IReflV, 1)Tokens : 
wyobraża
sobie

## Sentence No. 1532 - 
nie mogę nie przypomnieć jeszcze , że wszystkie one stawały się treścią jego życia i zawodowej pracy . 
### Existing MWEs: 
1- **stawały się** (IReflV, 11)Tokens : 
stawały
się
...
### Existing MWEs: 
1- **widzę światełko w tunelu** (ID)Tokens : 
widzę
światełko
w
tunelu
...
## Sentence No. 1542 - 
w pierwszej chwili wydawało się wręcz nieprawdopodobne , żeby sprawa zacharskiego mogła wpłynąć na losy poważnej kwestii polityczno - gospodarczo - militarnej , jaką jest przyjęcie do nato sporego państwa europejskiego . 
### Existing MWEs: 
1- **wydawało się** (IReflV, 18)Tokens : 
wydawało
się
...
## Sentence No. 1563 - 
w oczywisty sposób jest to za mało , nie ma mowy o np . wspólnym analizowaniu i poprawianiu prac , o jakimkolwiek indywidualnym podejściu . 
### Existing MWEs: 
1- **nie ma mowy** (ID, 4)Tokens : 
nie
ma
...
## Sentence No. 1567 - 
np . po każdych trzech kęsach odkładaj sztućce na bok i policz do pięciu - po 20 minutach pojawi się uczucie sytości . 
### Existing MWEs: 
1- **pojawi się** (IReflV, 59)Tokens : 
pojawi
się
...
## Sentence No. 1572 - 
czy unia postawiła warunek : wasz marszałek , nasz minister sprawiedliwości ? 
### Existing MWEs: 
1- **postawiła warunek** (LVC, 2)Tokens : 
postawiła
warunek

## Sentence No. 1573 - 
jeśli tej poduszki wystarczy , to nasi południowi sąsiedzi będą mieli szczęście , gorzej , kiedy jej zabraknie , co jest bardziej prawdopodobne . 
### Existing MWEs: 
...
## Sentence No. 1579 - 
a czy skarby sprawiedliwie zdobyte , czy też z niegodziwości pochodzą , nie troszczą się one o to wcale - pomstował . 
### Existing MWEs: 
...
## Sentence No. 1593 - 
- za premiera należy nam się kontrola nad gospodarką - mówią . 
### Existing MWEs: 
1- **należy się** (IReflV, 1)Tokens : 
należy
się

## Sentence No. 1594 - 
ale szanse na to mają znikome . 
### Existing MWEs: 
1- **szanse mają** (IReflV, 1)Tokens : 
szanse
mają

## Sentence No. 1598 - 
władze obawiają się , że brytyjczycy mogą spowodować zniszczenie dróg , zaś wybuchy na poligonie zakłócą spokój mieszkańcom . 
### Existing MWEs: 
...
## Sentence No. 1619 - 
nie od dziś wiadomo , że losy naszej giełdy zależą w dużym stopniu od tego , co zdarzy się na wall street . 
### Existing MWEs: 
1- **zdarzy się** (IReflV, 3)Tokens : 
zdarzy
się

### Identified MWEs: 
1- **zdarzy się** (IReflV)Tokens : 
zdarzy
się
...
## Sentence No. 1621 - 
i to był zapewne decydujący czynnik , który popchnął polskich inwestorów do składania zleceń kupna na wczorajszą sesję . 
### Existing MWEs: 
1- **składania zleceń** (LVC)Tokens : 
składania
zleceń
...
## Sentence No. 1622 - 
- ma bardzo napięty plan . 
### Existing MWEs: 
1- **ma plan** (LVC)Tokens : 
ma
plan

## Sentence No. 1623 - 
- ale chyba nie uchylił się od pojedynku ? 
### Existing MWEs: 
1- **uchylił się** (IReflV)Tokens : 
uchylił
się
...
## Sentence No. 1629 - 
- za godzinę zjawi się u państwa moja sekundantka . 
### Existing MWEs: 
1- **zjawi się** (IReflV, 4)Tokens : 
zjawi
się

### Identified MWEs: 
1- **zjawi się** (IReflV)Tokens : 
zjawi
się
...
### Existing MWEs: 
1- **odbyło się** (IReflV, 4)Tokens : 
odbyło
się

## Sentence No. 1643 - 
tylko dzięki członkowi rady markowi siwcowi dziennikarze mogli razem z krajową radą delektować się tymi smakołykami . 
### Existing MWEs: 
1- **delektować się** (IReflV)Tokens : 
delektować
się
...
## Sentence No. 1646 - 
- nie , nie , nie zgodzimy się . . . - poszeptuje między sobą " s " . 
### Existing MWEs: 
1- **zgodzimy się** (IReflV, 12)Tokens : 
zgodzimy
się

### Identified MWEs: 
1- **zgodzimy się** (IReflV)Tokens : 
zgodzimy
się

## Sentence No. 1658 - 
- starały śmy się wyjaśnić gospodarzom różnicę między bezpieczeństwem a służbą bezpieczeństwa - mówi irene santiago , dyrektor forum . 
### Existing MWEs: 
1- **starały się** (IReflV, 23)Tokens : 
starały
się

### Identified MWEs: 
1- **starały się** (IReflV)Tokens : 
starały
się

## Sentence No. 1659 - 
władze wydały instrukcję dla obsługujących obrady : " zaopatrz się w spraye owadobójcze z uwagi na muchy przenoszące aids , którym zarażone są uczestniczki - lesbijki . 
### Existing MWEs: 
1- **wydały instrukcję** (LVC)Tokens : 
wydały
instrukcję

## Sentence No. 1668 - 
" mieli śmy do czynienia ze zdesperowanymi , gotowymi na wszystko , porywaczami , którzy nie chcieli pójść na żadne ustępstwa " - uzasadnił akcję komandosów minister spraw zagranicznych nigru abdourahamane hama . 
### Existing MWEs: 
1- **mieli do czynienia** (ID)Tokens : 
mieli
do
czynienia
...
### Existing MWEs: 
1- **miała dostęp** (LVC, 3)Tokens : 
miała
dostęp

### Identified MWEs: 
1- **miała dostęp** (LVC)Tokens : 
miała
dostęp

## Sentence No. 1688 - 
ale działo się tak bardziej ze względu na osobę szefa rządu niż jego partię . 
### Existing MWEs: 
1- **działo się** (IReflV, 10)Tokens : 
działo
się
...
## Sentence No. 1689 - 
na wzgórzu nad zatoką bakińską znajduje się cmentarz męczenników - szechidlar . 
### Existing MWEs: 
1- **znajduje się** (IReflV, 60)Tokens : 
znajduje
się
...
## Sentence No. 1698 - 
a co do vogtsa , to jednak nie zna się na piłce . 
### Existing MWEs: 
1- **zna się** (IReflV)Tokens : 
zna
się
...
## Sentence No. 1699 - 
klinsi strzelił dwa gole , a nie jednego . 
### Existing MWEs: 
1- **strzelił gole** (LVC, 1)Tokens : 
strzelił
gole
...
### Existing MWEs: 
1- **weszło w życie** (ID, 8)Tokens : 
weszło
w
życie

### Identified MWEs: 
1- **weszło w życie** (ID)Tokens : 
weszło
w
życie
...
### Existing MWEs: 
1- **wyjdzie na dobre** (ID, 1)Tokens : 
wyjdzie
na
dobre

## Sentence No. 1707 - 
- najbardziej prawdopodobną przyczyną pożaru we wrocławskim teatrze polskim jest podpalenie - powiedziała nam wczoraj prowadząca śledztwo lidia opacka z prokuratury wojewódzkiej we wrocławiu . 
### Existing MWEs: 
1- **prowadząca śledztwo** (LVC, 3)Tokens : 
prowadząca
śledztwo

### Identified MWEs: 
1- **prowadząca śledztwo** (LVC)Tokens : 
prowadząca
śledztwo

## Sentence No. 1712 - 
do dziś kibice pamiętają , jak po otrzymaniu pierwszej wypłaty , próbował on wymienić w banku złotówki na dolary . 
### Existing MWEs: 
1- **otrzymaniu wypłaty** (LVC)Tokens : 
otrzymaniu
wypłaty

## Sentence No. 1717 - 
w przypadku odmowy zrównają miasto z ziemią za pomocą artylerii i lotnictwa . 
### Existing MWEs: 
1- **zrównają z ziemią** (ID)Tokens : 
zrównają
z
ziemią

## Sentence No. 1733 - 
z samym psl miał by ledwie 191 mandatów ( w poprzednich wyborach 303 ! ) . 
### Existing MWEs: 
1- **miał mandatów** (LVC)Tokens : 
miał
mandatów

## Sentence No. 1739 - 
zatrzymali samochód , bo wydał się podejrzany . 
### Existing MWEs: 
1- **wydał się** (IReflV)Tokens : 
wydał
się
...
## Sentence No. 1742 - 
tu d . rozmyślił się i zapłacił . 
### Existing MWEs: 
1- **rozmyślił się** (IReflV)Tokens : 
rozmyślił
się
...
### Existing MWEs: 
1- **powoływał się** (IReflV, 8)Tokens : 
powoływał
się
...
## Sentence No. 1758 - 
szwecja pragnie odgrywać aktywną rolę w rozwiązywaniu konfliktu w byłej jugosławii , czego politycznym wyrazem jest działalność mediatora z ramienia ue carla bildta , a militarnym dotychczasowy udział szwedzkiego batalionu w pokojowych siłach onz w rejonie tuzli . 
### Existing MWEs: 
1- **odgrywać rolę** (LVC, 2)Tokens : 
odgrywać
rolę

### Identified MWEs: 
1- **odgrywać rolę** (LVC)Tokens : 
odgrywać
rolę

## Sentence No. 1764 - 
w 1950 roku sejm , powołując się na tezę lenina ( " komunizm to władza rad . . . " ) , przyjął ustawę o powszechnej elektryfikacji , która obowiązuje do dzisiaj . 
### Existing MWEs: 
...
## Sentence No. 1767 - 
nawet organ założycielski - minister czy wojewoda - reprezentujący wobec przedsiębiorstwa skarb państwa , musi uzyskać zgodę rady pracowniczej na odwołanie dyrektora . 
### Existing MWEs: 
1- **uzyskać zgodę** (LVC, 3)Tokens : 
uzyskać
zgodę
...
## Sentence No. 1769 - 
niektórzy specjaliści twierdzą , że ponad połowa , jednak źródła w kijowie zachowują na ten temat milczenie . 
### Existing MWEs: 
1- **zachowują milczenie** (LVC)Tokens : 
zachowują
milczenie

## Sentence No. 1774 - 
wyższa płaca stała się magnesem przyciągającym do pracy w przemyśle samochodowym , osłodą monotonii pracy przy taśmie i dodatkowym bodźcem rozwoju przemysłu samochodowego . 
### Existing MWEs: 
1- **stała się** (IReflV, 49)Tokens : 
stała
się
...
## Sentence No. 1787 - 
- nie wiem , czy popełnił przestępstwo , robił to nie dla siebie , a dla załogi . 
### Existing MWEs: 
1- **popełnił przestępstwo** (LVC, 2)Tokens : 
popełnił
przestępstwo

### Identified MWEs: 
1- **popełnił przestępstwo** (LVC)Tokens : 
popełnił
przestępstwo

## Sentence No. 1793 - 
po obejrzeniu filmu " jurassic park " ja i wszystkie osoby , które o to zapytał em , były zdania , że film stanowczo nie jest przeznaczony dla najmłodszej części widowni . 
### Existing MWEs: 
1- **były zdania** (LVC, 5)Tokens : 
były
zdania

### Identified MWEs: 
1- **były zdania** (LVC)Tokens : 
były
zdania

## Sentence No. 1797 - 
w jajnikach rodzącej się dziewczynki mieści się około miliona komórek płciowych , w momencie pokwitania zaś jest ich nie więcej niż dziesięć tysięcy . 
### Existing MWEs: 
...
## Sentence No. 1803 - 
jak aws zachowa się w głosowaniu nad wotum zaufania dla rządu premiera buzka ? - zapytali śmy wczoraj kilku posłów akcji . 
### Existing MWEs: 
1- **zachowa się** (IReflV, 3)Tokens : 
zachowa
się

### Identified MWEs: 
1- **zachowa się** (IReflV)Tokens : 
zachowa
się
...
### Existing MWEs: 
1- **boje toczą** (LVC)Tokens : 
boje
toczą

## Sentence No. 1808 - 
dzięki zdecydowanej polityce monetarnej i budżetowej udało się w 96 r . sprowadzić inflację do 2,6 proc . z 3,1 proc . rok wcześniej . 
### Existing MWEs: 
1- **udało się** (IReflV, 60)Tokens : 
udało
się
...
## Sentence No. 1814 - 
- nie zorganizowano zawodów na odpowiednim poziomie , na przykład w skokach do wody czy siatkówce , bo zimbabwe nie spodziewa się w tych dyscyplinach osiągnięć . 
### Existing MWEs: 
1- **spodziewa się** (IReflV, 10)Tokens : 
spodziewa
się
...
## Sentence No. 1827 - 
- chorwacja znajduje się dziś tutaj - wskazuje końcem długopisu podnóże góry . 
### Existing MWEs: 
1- **znajduje się** (IReflV, 60)Tokens : 
znajduje
się
...
## Sentence No. 1829 - 
inna sprawa , że narodowi chrześcijanie w nowej dla siebie roli ujawnili absolutną ignorancję ekonomiczną : protestowali przeciw podwójnemu opodatkowaniu dochodów tych obywateli , którzy dają na kościelną tacę . 
### Existing MWEs: 
1- **dają na tacę** (ID)Tokens : 
dają
na
tacę
...
## Sentence No. 1836 - 
była m po cesarce i miała m z tym kłopoty . 
### Existing MWEs: 
1- **miała kłopoty** (LVC, 2)Tokens : 
miała
kłopoty

### Identified MWEs: 
1- **miała kłopoty** (LVC)Tokens : 
miała
kłopoty

## Sentence No. 1839 - 
każdy pracuje na własne nazwisko , ale z chwilą wpisania na listę adwokacką staje się członkiem korporacji , co nakłada na niego szczegółowo określone prawa i obowiązki . 
### Existing MWEs: 
1- **staje się** (IReflV, 11)Tokens : 
staje
się
...
### Existing MWEs: 
1- **przeprowadzenia reform** (LVC, 3)Tokens : 
przeprowadzenia
reform

### Identified MWEs: 
1- **przeprowadzenia reform** (LVC)Tokens : 
przeprowadzenia
reform

## Sentence No. 1851 - 
takiej większości nie widać , a trudno o gorszą sytuację niż odwołanie rządu i jednocześnie powierzenie mu pełnienia obowiązków do czasu powołania następnego , czyli na czas nieokreślony . 
### Existing MWEs: 
...
## Sentence No. 1856 - 
poprzedni w połowie lutego wysadził w powietrze piętrowy autobus na aldwych . 
### Existing MWEs: 
1- **wysadził w powietrze** (ID, 2)Tokens : 
wysadził
w
powietrze

### Identified MWEs: 
1- **wysadził w powietrze** (ID)Tokens : 
wysadził
w
powietrze

## Sentence No. 1859 - 
dodał jednak : " oczywiście , dzisiaj można jeszcze dorzucić do tej ceny 250 tys . , tylko że jest taki problem , który ma każdy kupiec - każdy , kto pracuje w biznesie , wie , że jak ten towar sprzedał , a tamten kupił , to wraca do domu i jest ciężko niezadowolony . 
### Existing MWEs: 
1- **problem ma** (LVC, 2)Tokens : 
problem
ma
...
## Sentence No. 1881 - 
była bliska bankructwa , a po wdrożeniu " agendy " świeci przykładem . 
### Existing MWEs: 
1- **świeci przykładem** (ID)Tokens : 
świeci
przykładem

### Identified MWEs: 
1- **świeci przykładem** (LVC)Tokens : 
świeci
przykładem

## Sentence No. 1883 - 
ale młody człowiek pracujący w wykańczalni powiedział mi , że akcja " agenda " sprawiła mu satysfakcję . 
### Existing MWEs: 
1- **sprawiła satysfakcję** (LVC)Tokens : 
sprawiła
satysfakcję

## Sentence No. 1896 - 
rząd liczy , że polska znajdzie się w nato w 1999 r . 
### Existing MWEs: 
...
## Sentence No. 1901 - 
chciała by się spotkać raz jeszcze . 
### Existing MWEs: 
1- **się spotkać** (IReflV)Tokens : 
się
spotkać
...
## Sentence No. 1904 - 
piłkarze psg zafundowali fanom spektakl , który przejdzie do historii francuskiego futbolu . 
### Existing MWEs: 
...
## Sentence No. 1918 - 
szczególnie mi bliskie jest bezwarunkowe czynienie dobra , bez oglądania się - jak w chrześcijaństwie - na nagrodę , uznawaną przez wyznawców buddy za duchową lichwę . 
### Existing MWEs: 
1- **oglądania się** (IReflV)Tokens : 
oglądania
się

### Identified MWEs: 
1- **czynienie dobra** (LVC)Tokens : 
czynienie
dobra

2- **nagrodę uznawaną** (LVC)Tokens : 
nagrodę
uznawaną

## Sentence No. 1923 - 
igor merkulenko , młody , delikatny , w jarmułce , mówi , że mniej więcej od trzech lat można żyć w odessie " normalnym żydowskim życiem " . 
### Existing MWEs: 
1- **żyć życiem** (ID)Tokens : 
żyć
życiem

## Sentence No. 1933 - 
trzy kwartały temu kijowscy parlamentarzyści zastanawiali się , co zrobić z niespokojnym lobby kołchozowym , które groziło , że jesienią państwo zostanie bez ziarna i chleba . 
### Existing MWEs: 
1- **zastanawiali się** (IReflV, 8)Tokens : 
zastanawiali
się
...
## Sentence No. 1934 - 
w końcu wymyślili : lekką ręką przyznali kredyty żniwne . 
### Existing MWEs: 
1- **przyznali kredyty** (LVC, 1)Tokens : 
przyznali
kredyty

### Identified MWEs: 
1- **przyznali kredyty** (LVC)Tokens : 
przyznali
kredyty
...
### Existing MWEs: 
1- **się skręcało** (IReflV)Tokens : 
się
skręcało

## Sentence No. 1952 - 
nawet te , którym jakoś udało się wzbić pod chmury , spadały jak ulęgałki w trawę , bo powietrze też stanęło . 
### Existing MWEs: 
1- **udało się** (IReflV, 60)Tokens : 
udało
się
...
## Sentence No. 1963 - 
zgadzam się natomiast ze stwierdzeniem bp . głódzia , że redukcja wydatków na budowę i remonty kaplic opóźni naszą integrację z nato . 
### Existing MWEs: 
1- **zgadzam się** (IReflV, 7)Tokens : 
zgadzam
się

### Identified MWEs: 
1- **zgadzam się** (IReflV)Tokens : 
zgadzam
się

## Sentence No. 1964 - 
sądzę , że ta bieda połączy raczej kapłanów wojsk natowskich z naszymi we wspólnych zabiegach , aby kierownictwo polskiego resortu wojskowego odniosło się bardziej łaskawie do potrzeb materialnych duszpasterstwa . 
### Existing MWEs: 
1- **odniosło się** (IReflV, 1)Tokens : 
odniosło
się

### Identified MWEs: 
1- **odniosło się** (IReflV)Tokens : 
odniosło
się
...
## Sentence No. 1982 - 
niektórzy liderzy " s " nie godzą się na wprowadzone przez mariana krzaklewskiego korekty na listach wyborczych . 
### Existing MWEs: 
1- **godzą się** (IReflV, 1)Tokens : 
godzą
się

### Identified MWEs: 
1- **godzą się** (IReflV)Tokens : 
godzą
się
...
## Sentence No. 1989 - 
tak że trzymam się całą mocą , bo jestem dla nich zawsze przykładem i mocą . 
### Existing MWEs: 
1- **trzymam się** (IReflV, 2)Tokens : 
trzymam
się

### Identified MWEs: 
1- **trzymam się** (IReflV)Tokens : 
trzymam
się
...
## Sentence No. 1993 - 
między gwiazdozbiorami korony północnej i lutni znajduje się gwiazdozbiór herkulesa . 
### Existing MWEs: 
1- **znajduje się** (IReflV, 60)Tokens : 
znajduje
się
...
## Sentence No. 1998 - 
będę się starał o inne rozwiązanie , a jestem uparty . 
### Existing MWEs: 
1- **się starał** (IReflV, 2)Tokens : 
się
starał
...
## Sentence No. 2001 - 
jeżeli rząd chce wprowadzać swoje reformatorskie projekty , musi porozumiewać się z prezydentem . 
### Existing MWEs: 
1- **porozumiewać się** (IReflV, 2)Tokens : 
porozumiewać
się

### Identified MWEs: 
1- **porozumiewać się** (IReflV)Tokens : 
porozumiewać
się

## Sentence No. 2003 - 
to nie jest notariusz ani król , lecz ktoś , kto dysponuje szerokimi uprawnieniami - mówi w rozmowie z adamem michnikiem , agnieszką kublik i piotrem stasińskim aleksander kwaŚniewski . 
### Existing MWEs: 
1- **dysponuje uprawnieniami** (LVC)Tokens : 
dysponuje
uprawnieniami

## Sentence No. 2004 - 
dlaczego więc biskupi nie odcięli się wyraźnie od tej wypowiedzi ? 
### Existing MWEs: 
1- **odcięli się** (IReflV)Tokens : 
odcięli
się
...
## Sentence No. 2021 - 
margaret thatcher oskarżano o to , że za jej rządów nastąpiła zapaść porządku moralnego , wzrosła przestępczość ; że oddała się ona tworzeniu społeczeństwa obojętnego na los człowieka . 
### Existing MWEs: 
1- **oddała się** (IReflV)Tokens : 
oddała
się
...
## Sentence No. 2026 - 
więcej już się na taki program nie zgodzę , bo to naruszyło moją godność zawodową . 
### Existing MWEs: 
1- **się zgodzę** (IReflV, 3)Tokens : 
się
zgodzę

### Identified MWEs: 
1- **się zgodzę** (IReflV)Tokens : 
się
zgodzę

## Sentence No. 2028 - 
czy dlatego pan tak twardo opowiada się przeciwko udziałowi aktorów w reklamie , że to też narusza ich godność zawodową ? 
### Existing MWEs: 
1- **opowiada się** (IReflV, 2)Tokens : 
opowiada
się
...
### Existing MWEs: 
1- **zdarzali się** (IReflV, 11)Tokens : 
zdarzali
się

### Identified MWEs: 
1- **zdarzali się** (IReflV)Tokens : 
zdarzali
się

## Sentence No. 2032 - 
jak państwo ma jakieś ważne zadanie do wypełnienia , szuka najlepszych fachowców , a nie komunistów . 
### Existing MWEs: 
1- **ma zadanie** (LVC)Tokens : 
ma
zadanie
...
### Existing MWEs: 
1- **starali się** (IReflV, 23)Tokens : 
starali
się
...
## Sentence No. 2037 - 
- z czym się państwu kojarzy pamela anderson i kasia figura - krzyczał do publiczności artur orzech - piersi , oczywiście ! 
### Existing MWEs: 
1- **się kojarzy** (IReflV)Tokens : 
się
kojarzy
...
### Existing MWEs: 
1- **przeprowadzona gra** (LVC)Tokens : 
przeprowadzona
gra

## Sentence No. 2051 - 
jestem zwolennikiem poglądu , że jeśli da się utrzymać polski charakter instytucji , to należy zdecydowanie działać w tym kierunku . 
### Existing MWEs: 
1- **da się** (IReflV, 8)Tokens : 
da
się
...
## Sentence No. 2067 - 
dotychczas odwołujący się mogą pozostawać w niemczech przez wiele miesięcy . 
### Existing MWEs: 
1- **odwołujący się** (IReflV, 5)Tokens : 
odwołujący
się

### Identified MWEs: 
1- **odwołujący się** (IReflV)Tokens : 
odwołujący
się

## Sentence No. 2073 - 
morderstwo dokonane zostało z perfekcją , która zadziwiła francuską policję , przez fachowców wiaczesława iwankowa alias japończyka , jednego z hersztów rosyjskiej mafii na zachodzie . 
### Existing MWEs: 
1- **morderstwo dokonane** (LVC)Tokens : 
morderstwo
dokonane
...
## Sentence No. 2087 - 
w warunkach , w których każdy z nas czuł by się pokrzywdzonym przez boga i historię wyrobnikiem , ten człowiek , pracujący bez wytchnienia ( miał 75 lat , gdy przeszedł na emeryturę ) , nie biadał , nie narzekał , chyba nawet nie zgorzkniał . 
### Existing MWEs: 
1- **czuł się** (IReflV, 9)Tokens : 
czuł
się
...
### Existing MWEs: 
1- **zdarzało się** (IReflV, 11)Tokens : 
zdarzało
się
...
### Existing MWEs: 
1- **miał kontakty** (LVC, 4)Tokens : 
miał
kontakty

## Sentence No. 2114 - 
- jak jednemu krasnoludkowemu magnatowi kazali śmy zaprzestać działalności , to nic sobie z tego nie robił . 
### Existing MWEs: 
1- **nic sobie nie robił** (ID)Tokens : 
nic
sobie
nie
robił
...
## Sentence No. 2121 - 
przewagę mieli lubinianie , a goście grali wyjątkowo pasywnie . 
### Existing MWEs: 
1- **przewagę mieli** (LVC)Tokens : 
przewagę
mieli

## Sentence No. 2122 - 
jedynie czarnoskóry tetteh starał się walczyć , jednak osamotniony niewiele mógł zdziałać . 
### Existing MWEs: 
1- **starał się** (IReflV, 23)Tokens : 
starał
się
...
## Sentence No. 2123 - 
w 68 . min , w odstępie 20 sekund , zagłębie zdobyło dwie efektowne bramki i losy meczu zostały rozstrzygnięte . 
### Existing MWEs: 
1- **zdobyło bramki** (LVC, 1)Tokens : 
zdobyło
bramki
...
### Existing MWEs: 
1- **decydują się** (IReflV, 4)Tokens : 
decydują
się
...
## Sentence No. 2127 - 
w księgarni oświatowej w warszawie dowiedzieli śmy się , że po telewizyjnym apelu dyr . sławińskiego sprzedaje się znacznie mniej podręczników . 
### Existing MWEs: 
1- **dowiedzieli się** (IReflV, 16)Tokens : 
dowiedzieli
się
...
## Sentence No. 2148 - 
w zeszłym roku , poprzedniego katechetę , bo się nie nadawał do pracy z dziećmi - odpowiada dyrektorka . 
### Existing MWEs: 
1- **się nadawał** (IReflV, 1)Tokens : 
się
nadawał

### Identified MWEs: 
1- **się nadawał** (IReflV)Tokens : 
się
nadawał

## Sentence No. 2154 - 
haszkowy szwejk lepiej się prezentował . 
### Existing MWEs: 
1- **się prezentował** (IReflV)Tokens : 
się
prezentował
...
## Sentence No. 2159 - 
obowiązująca w czasie wyborów 1991 r . ordynacja " bez progu " każdemu dawała szansę . 
### Existing MWEs: 
1- **dawała szansę** (LVC, 2)Tokens : 
dawała
szansę

### Identified MWEs: 
1- **dawała szansę** (LVC)Tokens : 
dawała
szansę
...
## Sentence No. 2161 - 
nowa ekipa miała nowe pomysły , m.in . projekt masowej komercjalizacji zapisany w " strategii dla polski " . 
### Existing MWEs: 
1- **miała pomysły** (LVC, 5)Tokens : 
miała
pomysły

### Identified MWEs: 
1- **miała pomysły** (LVC)Tokens : 
miała
pomysły

## Sentence No. 2162 - 
za taką komercjalizacją - w myśl tezy , że ważna jest nie forma własności , lecz forma zarządzania - opowiadał się sld w programie wyborczym . 
### Existing MWEs: 
1- **opowiadał się** (IReflV, 2)Tokens : 
opowiadał
się
...
## Sentence No. 2167 - 
w zawodach oficjalnie figurujących w programie weźmie udział 9309 sportowców , w konkurencjach pokazowych - 260 . 
### Existing MWEs: 
1- **weźmie udział** (LVC, 41)Tokens : 
weźmie
udział
...
### Existing MWEs: 
1- **wywiąże się** (IReflV, 2)Tokens : 
wywiąże
się

### Identified MWEs: 
1- **wywiąże się** (IReflV)Tokens : 
wywiąże
się
...
### Existing MWEs: 
1- **okazała się** (IReflV, 48)Tokens : 
okazała
się
...
## Sentence No. 2181 - 
w radomiu wojciech kępczyński poświęcił cały budżet teatru na jedną , ale za to superprodukcję - musical " józef i cudowny płaszcz snów w technikolorze " , który odniósł komercyjny sukces roku . 
### Existing MWEs: 
1- **odniósł sukces** (LVC, 1)Tokens : 
odniósł
sukces

### Identified MWEs: 
1- **odniósł sukces** (LVC)Tokens : 
odniósł
sukces
...
## Sentence No. 2187 - 
w sporządzanych na gorąco po kampanii wrześniowej zapiskach 19-latka wojnę przedstawia jako bezładną szamotaninę : nocne czuwania , nocne strzelania , jakieś rozkazy , rozbiegani kurierzy . 
### Existing MWEs: 
1- **sporządzanych zapiskach** (LVC)Tokens : 
sporządzanych
zapiskach

## Sentence No. 2188 - 
przyłączył się do grupy ułanów , którzy postanowili przedzierać się na węgry , by walczyć dalej . 
### Existing MWEs: 
1- **przedzierać się** (IReflV)Tokens : 
przedzierać
się

## Sentence No. 2193 - 
- moja kariera sięgnęła szczytu . 
### Existing MWEs: 
1- **sięgnęła szczytu** (ID)Tokens : 
sięgnęła
szczytu
...
### Existing MWEs: 
1- **jestem w stanie** (ID, 14)Tokens : 
jestem
w
stanie

## Sentence No. 2197 - 
obie siedzą na garnuszku rodziców emerytów - byłego nauczyciela i byłego robotnika budowlanego . 
### Existing MWEs: 
1- **siedzą na garnuszku** (ID)Tokens : 
siedzą
na
garnuszku

## Sentence No. 2198 - 
urzędnik departamentu konsularnego i wychodźstwa w msz ( nie życzy sobie , żeby wymieniać jego nazwisko ) radzi : - niech obie panie napiszą podania o umorzenie długu . 
### Existing MWEs: 
1- **nie życzy sobie** (ID, 1)Tokens : 
nie
życzy
sobie
...
## Sentence No. 2207 - 
- gdyby ś teraz nie przyszedł , on stracił by twarz - cheng tłumaczył mi tę oczywistość cierpliwie , jak niezbyt rozgarniętemu dziecku . 
### Existing MWEs: 
1- **stracił twarz** (ID)Tokens : 
stracił
twarz

## Sentence No. 2208 - 
na obiedzie usłyszał em , że pewnej mojej prośby cheng nie jest w stanie spełnić . 
### Existing MWEs: 
1- **jest w stanie** (ID, 14)Tokens : 
jest
w
...
## Sentence No. 2211 - 
rzecznik praw obywatelskich prof . tadeusz zieliński zwrócił się do sądu najwyższego o rozstrzygnięcie , kto - pko bp czy skarb państwa - powinien zwaloryzować premie gwarancyjne przysługujące właścicielom książeczek mieszkaniowych . 
### Existing MWEs: 
1- **zwrócił się** (IReflV, 15)Tokens : 
zwrócił
się
...
## Sentence No. 2213 - 
mamy w piwnicy stary piec c.o na koks i chyba będziemy zmuszeni zainstalować go na nowo i spalać w nim wszystko , co się da , bo będzie taniej . 
### Existing MWEs: 
...
## Sentence No. 2214 - 
tego samego zdania jest wielu naszych znajomych , którzy również mają ogrzewanie gazowe . 
### Existing MWEs: 
...
2- **mają ogrzewanie** (LVC)Tokens : 
mają
ogrzewanie

## Sentence No. 2217 - 
przeprowadzenie sprawnej akcji jest niemożliwe , bo nie wiadomo , kto odpowiada za jej koordynację . 
### Existing MWEs: 
1- **przeprowadzenie akcji** (LVC, 2)Tokens : 
przeprowadzenie
akcji

### Identified MWEs: 
1- **przeprowadzenie akcji** (LVC)Tokens : 
przeprowadzenie
akcji

## Sentence No. 2219 - 
nie ma planów ratowniczych dla wydarzeń , które wymagają działań w paru województwach . 
### Existing MWEs: 
1- **ma planów** (LVC)Tokens : 
ma
planów

## Sentence No. 2227 - 
- bo walczył nieczysto , bała m się , że zrobi coś tacie - tłumaczy magda . 
### Existing MWEs: 
1- **bała się** (IReflV, 9)Tokens : 
bała
się

### Identified MWEs: 
1- **bała się** (IReflV)Tokens : 
bała
się
...
## Sentence No. 2242 - 
przekazał od żony , że choć to był piąty jej poród , nigdy nie zapomni nas : sanitariusza , kierowcy i mnie , bo tylko my naprawdę zaopiekowali śmy się nią i jej dzieckiem . 
### Existing MWEs: 
...
## Sentence No. 2244 - 
pyszny , choć kawałki występującego w nim mięsa były jakieś dziwne , wcale nie przypominały bekonu , a raczej bardzo twarde podroby , ale widać tak być miało , bo szef tutejszej kuchni zdaje się wiedzieć , co robi . 
### Existing MWEs: 
1- **zdaje się** (IReflV, 1)Tokens : 
zdaje
się

### Identified MWEs: 
1- **zdaje się** (IReflV)Tokens : 
zdaje
się

## Sentence No. 2246 - 
po dwóch i pół roku eksperymentu zrezygnowało bardzo niewielu słuchaczy , mimo że roboty mają tu znacznie więcej , niż gdyby robili doktorat w samotności . 
### Existing MWEs: 
1- **robili doktorat** (LVC)Tokens : 
robili
doktorat

## Sentence No. 2248 - 
nie przypadkiem najwięcej zgłasza się filologów , historyków , psychologów , a tylko z rzadka trafiają się absolwenci prawa czy ekonomii , których rynek kusi bogatymi ofertami . 
### Existing MWEs: 
1- **trafiają się** (IReflV, 1)Tokens : 
trafiają
się

### Identified MWEs: 
1- **trafiają się** (IReflV)Tokens : 
trafiają
się
...
## Sentence No. 2277 - 
chcemy też , by nasi gracze wzorowali się na najniebezpieczniejszej odmianie raptorsów - globoraptorach . 
### Existing MWEs: 
1- **wzorowali się** (IReflV)Tokens : 
wzorowali
się

## Sentence No. 2279 - 
- co przesądziło o tym , że nba zdecydowała się wyjść poza usa i właśnie do kanady ? 
### Existing MWEs: 
...
## Sentence No. 2284 - 
nie były to jakieś szczególnie porywające wykonania , jednak to spotkanie na długo zapamięta zarówno żywo i spontanicznie reagująca publiczność , jak i sami artyści , którzy zapewne nigdy nie spotkali się z tak owacyjnym i nie przystającym do kanonów filharmonii przyjęciem . 
### Existing MWEs: 
1- **spotkali się** (IReflV, 28)Tokens : 
spotkali
się
...
## Sentence No. 2289 - 
Żadnych radykalnych zmian nie mam zamiaru wprowadzać . 
### Existing MWEs: 
1- **mam zamiaru** (LVC, 4)Tokens : 
mam
zamiaru

### Identified MWEs: 
1- **mam zamiaru** (LVC)Tokens : 
mam
zamiaru
...
## Sentence No. 2298 - 
w 1984 r . kbw uważano jeszcze oficjalnie za bohaterską jednostkę , więc mieczysław jaworski w książce " korpus bezpieczeństwa wewnętrznego 1945 - 1965 " ( wydawnictwo ministerstwa obrony narodowej , warszawa 1984 ) podsumowywał pierwsze dni kbw pod dowództwem Świetlika : " w miesiącach grudzień 1946 - styczeń 1947 wojska kbw przeprowadziły na terenie kraju 1057 akcji operacyjnych , w wyniku których zginęło - 78 , raniono - 17 , ujęto - 1068 członków podziemia oraz aresztowano i zatrzymano 4344 podejrzanych " . 
### Existing MWEs: 
1- **przeprowadziły akcji** (LVC, 2)Tokens : 
przeprowadziły
akcji

### Identified MWEs: 
1- **przeprowadziły akcji** (LVC)Tokens : 
przeprowadziły
akcji

## Sentence No. 2301 - 
- i co , palcyma będziem robili ? - pyta józek , na którego wszyscy w domu się gniewają , bo jak go wypuścili wziął z opieki społecznej 500 tys . zł i przepił je sam w dwa dni . 
### Existing MWEs: 
1- **się gniewają** (IReflV)Tokens : 
się
gniewają

## Sentence No. 2302 - 
- ożenią się , pójdą na swoje , to będą robili - kończy dyskusje matka włodarskich . 
### Existing MWEs: 
1- **pójdą na swoje** (ID)Tokens : 
pójdą
na
swoje

## Sentence No. 2304 - 
popularne mogą stać się transakcje łączone : jedno ogłoszenie w gazecie z odsyłaczem do sieci . 
### Existing MWEs: 
1- **stać się** (IReflV, 49)Tokens : 
stać
się
...
## Sentence No. 2309 - 
pewien pan śpiewał bezwstydnie : " lubię mieć trochę w czubie " , pewna pani zabiegała o " odrobinę szczęścia w miłości " , a inny pan donosił triumfalnie : " umówił em się z nią na dziewiątą " . 
### Existing MWEs: 
1- **mieć w czubie** (ID)Tokens : 
mieć
w
czubie

## Sentence No. 2312 - 
informowały , co i gdzie się dzieje . 
### Existing MWEs: 
1- **się dzieje** (IReflV, 6)Tokens : 
się
dzieje
