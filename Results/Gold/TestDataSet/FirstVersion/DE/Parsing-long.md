...
### Identified MWEs: 
1- **fand ausflug interessant** Tokens : 
fand
ausflug
interessant
...
2- **stattfinden** (VPC, 8)Tokens : 
stattfinden

### Identified MWEs: 
1- **gibt stattfinden** Tokens : 
gibt
stattfinden
...
### Existing MWEs: 
1- **beschäftigen sich mit** (IReflV)Tokens : 
beschäftigen
sich
mit
...
### Existing MWEs: 
1- **auf ideen gekommen** (ID, 1)Tokens : 
auf
ideen
gekommen
