...
2- **s' passé** (IReflV, 13)Tokens : 
s'
passé

3- **eu impact** (LVC, 4)Tokens : 
eu
impact
...
2- **faisait l' objet** (ID, 20)Tokens : 
faisait
l'
objet
...
### Existing MWEs: 
1- **il plu** (ID, 1)Tokens : 
il
plu

2- **ont signification** (LVC, 2)Tokens : 
ont
signification
...
### Existing MWEs: 
1- **ont droit** (LVC, 9)Tokens : 
ont
droit

2- **avait droit** (LVC, 9)Tokens : 
avait
droit
...
### Existing MWEs: 
1- **mis en cause** (ID, 2)Tokens : 
mis
en
cause

2- **se rend** (IReflV, 2)Tokens : 
se
rend
...
### Existing MWEs: 
2- **s' impose** (IReflV, 13)Tokens : 
s'
impose

1- **attire attention** (ID, 3)Tokens : 
attire
attention
...
2- **prend conscience** (ID, 5)Tokens : 
prend
conscience
...
### Existing MWEs: 
2- **il semblerait** (ID, 9)Tokens : 
il
semblerait

1- **eu raison** (ID, 3)Tokens : 
eu
raison
...
### Existing MWEs: 
1- **eu lieu** (ID, 77)Tokens : 
eu
lieu

2- **eu influence** (LVC, 1)Tokens : 
eu
influence
...
### Existing MWEs: 
1- **faut -il** (ID, 14)Tokens : 
faut
-il

2- **faut -il** (ID, 14)Tokens : 
faut
-il
...
### Existing MWEs: 
1- **ferons preuve** (ID, 5)Tokens : 
ferons
preuve

2- **avons intention** (LVC, 2)Tokens : 
avons
intention
...
### Existing MWEs: 
1- **se plaignent** (IReflV, 4)Tokens : 
se
plaignent
...
2- **se trouvant** (IReflV, 80)Tokens : 
se
trouvant
...
1- **prendre direction** (ID, 1)Tokens : 
prendre
direction
...
### Existing MWEs: 
2- **connaissaient difficulté** (LVC, 1)Tokens : 
connaissaient
difficulté
...
### Existing MWEs: 
2- **se retournèrent** (IReflV, 5)Tokens : 
se
retournèrent
...
### Existing MWEs: 
1- **se déroulent** (IReflV, 41)Tokens : 
se
déroulent
...
### Existing MWEs: 
1- **se passer** (IReflV, 13)Tokens : 
se
passer

2- **s' emparer** (IReflV, 15)Tokens : 
s'
emparer
...
2- **il y a** (ID, 140), EmbeddedTokens : 
il
y
a
...
2- **se retrouvent** (IReflV, 21)Tokens : 
se
retrouvent
...
### Existing MWEs: 
1- **se rendirent** (IReflV, 34)Tokens : 
se
rendirent
...
### Existing MWEs: 
1- **en venir** (ID, 2)Tokens : 
en
venir

2- **se montrer** (IReflV, 7)Tokens : 
se
montrer
...
### Existing MWEs: 
1- **jouera matchs** (LVC, 6)Tokens : 
jouera
matchs

2- **joue matchs** (LVC, 6)Tokens : 
joue
matchs
...
2- **marquant buts** (LVC, 6)Tokens : 
marquant
buts

### Identified MWEs: 
1- **marquant buts** Tokens : 
marquant
buts
...
### Existing MWEs: 
1- **s' imposer** (IReflV, 13)Tokens : 
s'
imposer

2- **faire face** (ID, 17)Tokens : 
faire
face
...
### Existing MWEs: 
1- **mettre un terme** (ID, 10)Tokens : 
mettre
un
terme
...
### Existing MWEs: 
1- **questions poser** (LVC, 6)Tokens : 
questions
poser
...
### Existing MWEs: 
1- **il semble** (ID, 9)Tokens : 
il
semble

### Identified MWEs: 
1- **il me semble** Tokens : 
il
me
semble
...
### Existing MWEs: 
1- **couper l' herbe sous le pied** (ID, 1)Tokens : 
couper
l'
herbe
sous
...
### Identified MWEs: 
1- **couper l' herbe sous le pied** Tokens : 
couper
l'
herbe
sous
...
### Existing MWEs: 
1- **se déroulent** (IReflV, 5)Tokens : 
se
déroulent
...
### Existing MWEs: 
1- **fera l' objet** (ID, 20)Tokens : 
fera
l'
objet

### Identified MWEs: 
1- **fera l' objet** Tokens : 
fera
l'
objet
...
### Existing MWEs: 
1- **mettant en cause** (ID, 2)Tokens : 
mettant
en
cause

### Identified MWEs: 
1- **mettant en cause** Tokens : 
mettant
en
cause
...
### Existing MWEs: 
1- **mettent en examen** (ID, 15)Tokens : 
mettent
en
examen
...
### Existing MWEs: 
1- **mises en examen** (ID, 15)Tokens : 
mises
en
examen

### Identified MWEs: 
1- **mises en examen** Tokens : 
mises
en
examen
...
### Existing MWEs: 
1- **se trouvent** (IReflV, 80)Tokens : 
se
trouvent
...
### Existing MWEs: 
1- **se produits** (IReflV, 24)Tokens : 
se
produits
...
### Existing MWEs: 
1- **se présenta** (IReflV, 18)Tokens : 
se
présenta
...
### Existing MWEs: 
1- **se concentre** (IReflV, 5)Tokens : 
se
concentre
...
### Existing MWEs: 
1- **rendait visite** (LVC, 6)Tokens : 
rendait
visite

### Identified MWEs: 
1- **rendait visite** Tokens : 
rendait
visite
...
### Existing MWEs: 
1- **avait importance** (LVC, 1)Tokens : 
avait
importance
...
### Existing MWEs: 
1- **faisant référence** (LVC, 9)Tokens : 
faisant
référence
...
### Existing MWEs: 
1- **reprendre le flambeau** (ID, 1)Tokens : 
reprendre
le
flambeau
...
### Existing MWEs: 
1- **fait prisonniers** (ID, 5)Tokens : 
fait
prisonniers
...
### Existing MWEs: 
1- **se rapproche** (IReflV, 6)Tokens : 
se
rapproche
...
### Existing MWEs: 
1- **se signala** (IReflV, 1)Tokens : 
se
signala

### Identified MWEs: 
1- **fit prisonniers** Tokens : 
fit
prisonniers
...
### Existing MWEs: 
1- **effectuent missions** (LVC, 1)Tokens : 
effectuent
missions
...
### Existing MWEs: 
1- **donneront naissance** (ID, 8)Tokens : 
donneront
naissance
...
### Existing MWEs: 
1- **se trouvait** (IReflV, 80)Tokens : 
se
trouvait
...
### Identified MWEs: 
1- **passe de temps** Tokens : 
passe
de
temps

2- **faire recherches** Tokens : 
faire
recherches
...
### Existing MWEs: 
1- **tombée malade** (ID, 3)Tokens : 
tombée
malade

### Identified MWEs: 
1- **tombée malade** Tokens : 
tombée
malade
...
### Existing MWEs: 
1- **se dérouler** (IReflV, 41)Tokens : 
se
dérouler
...
### Existing MWEs: 
1- **remporte succès** (LVC, 1)Tokens : 
remporte
succès
...
### Existing MWEs: 
1- **se retrouvent** (IReflV, 21)Tokens : 
se
retrouvent
...
### Existing MWEs: 
1- **remporte victoires** (LVC, 7)Tokens : 
remporte
victoires
...
### Existing MWEs: 
1- **s' distinguée** (IReflV, 9)Tokens : 
s'
distinguée
...
### Identified MWEs: 
1- **livrait renseignements** Tokens : 
livrait
renseignements
...
### Existing MWEs: 
1- **se retrouve** (IReflV, 21)Tokens : 
se
retrouve
...
### Existing MWEs: 
1- **reçoit critiques** (LVC, 2)Tokens : 
reçoit
critiques
...
### Existing MWEs: 
1- **se produire** (IReflV, 24)Tokens : 
se
produire
...
### Existing MWEs: 
1- **se trouvant** (IReflV, 80)Tokens : 
se
trouvant
...
### Existing MWEs: 
1- **se déroulés** (IReflV, 41)Tokens : 
se
déroulés
...
### Existing MWEs: 
1- **se produisent** (IReflV, 24)Tokens : 
se
produisent
...
### Existing MWEs: 
1- **se retirèrent** (IReflV, 15)Tokens : 
se
retirèrent
...
### Existing MWEs: 
1- **fera découverte** (LVC, 2)Tokens : 
fera
découverte
...
### Existing MWEs: 
1- **est à le rendez-vous** (ID, 3)Tokens : 
est
à
le
rendez-vous
...
### Existing MWEs: 
1- **se fait remarquer** (ID, 2)Tokens : 
se
fait
remarquer
...
### Existing MWEs: 
1- **ayant problèmes** (LVC, 2)Tokens : 
ayant
problèmes
...
### Existing MWEs: 
1- **se consacrer** (IReflV, 7)Tokens : 
se
consacrer
...
### Existing MWEs: 
1- **ferme ses portes** (ID, 2)Tokens : 
ferme
ses
portes
...
### Existing MWEs: 
1- **rendent hommage** (LVC, 7)Tokens : 
rendent
hommage
...
### Existing MWEs: 
1- **se distinguent** (IReflV, 9)Tokens : 
se
distinguent
...
### Existing MWEs: 
1- **s' emparèrent** (IReflV, 15)Tokens : 
s'
emparèrent
...
### Existing MWEs: 
1- **prendre possession** (ID, 4)Tokens : 
prendre
possession
...
### Existing MWEs: 
1- **donnant naissance** (ID, 8)Tokens : 
donnant
naissance
...
### Existing MWEs: 
1- **se fit remarquer** (ID, 2)Tokens : 
se
fit
remarquer
...
### Existing MWEs: 
1- **se contenter** (IReflV, 8)Tokens : 
se
contenter
...
### Existing MWEs: 
1- **se retrouvèrent** (IReflV, 21)Tokens : 
se
retrouvèrent
...
### Existing MWEs: 
1- **se fait** (IReflV, 16)Tokens : 
se
fait

### Identified MWEs: 
1- **fait reproches** Tokens : 
fait
reproches
...
### Existing MWEs: 
1- **attirer attention** (ID, 3)Tokens : 
attirer
attention
...
### Existing MWEs: 
1- **se plaignaient** (IReflV, 4)Tokens : 
se
plaignaient
...
### Existing MWEs: 
1- **signera contrat** (LVC, 9)Tokens : 
signera
contrat
...
### Existing MWEs: 
1- **menaient vie** (LVC, 3)Tokens : 
menaient
vie

### Identified MWEs: 
1- **menaient vie** Tokens : 
menaient
vie
...
### Existing MWEs: 
1- **prenant part** (ID, 17)Tokens : 
prenant
part

### Identified MWEs: 
1- **prenant part** Tokens : 
prenant
part
...
### Existing MWEs: 
1- **subit pertes** (LVC, 1)Tokens : 
subit
pertes

### Identified MWEs: 
1- **subit pertes** Tokens : 
subit
pertes
...
il avait pour idéal politique de défendre le pays et d' assurer la sécurité de le peuple et surtout d' " expulser les occidentaux et les japonais " . 
### Existing MWEs: 
1- **avait idéal** (LVC)Tokens : 
avait
idéal
...
### Existing MWEs: 
1- **tomber amoureuse** (ID, 3)Tokens : 
tomber
amoureuse

### Identified MWEs: 
1- **tomber amoureuse** Tokens : 
tomber
amoureuse
...
ainsi , madrid semble se faire autant de mouron sinon plus que rabat sur la question de les frontières . 
### Existing MWEs: 
1- **se faire mouron** (ID)Tokens : 
se
faire
mouron

### Identified MWEs: 
1- **faire mouron** Tokens : 
faire
mouron

## Sentence No. 15555 - fr-ud-train_14124
tout à le long de ma lecture , je me demandais bien comment l' auteur allais se sortir de cette histoire . 
### Existing MWEs: 
1- **me demandais** (IReflV, 4)Tokens : 
me
demandais

### Identified MWEs: 
1- **me demandais** Tokens : 
me
demandais
...
### Existing MWEs: 
1- **présente avantages** (LVC, 1)Tokens : 
présente
avantages

## Sentence No. 15795 - fr-ud-train_14364
il se retire de la compétition à le terme de la même saison . 
### Existing MWEs: 
1- **se retire** (IReflV, 15)Tokens : 
se
retire
...
### Existing MWEs: 
1- **a signification** (LVC, 2)Tokens : 
a
signification
...
l' épreuve de baseball de les jeux asiatiques de 2010 s' est déroulée à guangzhou , guangdong , en chine de le 13 à le 19 novembre . 
### Existing MWEs: 
1- **s' déroulée** (IReflV, 41)Tokens : 
s'
déroulée
...
il est assisté d' un secrétaire général et d' une équipe de direction , variable selon les crlcc , mais qui fait appel à des principes de mélange de les cultures professionnelles ( gestionnaire , médicale , soignante , etc. ) et d' implication de les médecins cliniciens à les responsabilités de direction . 
### Existing MWEs: 
1- **fait appel** (LVC, 26)Tokens : 
fait
appel
...
les bombes aériennes se déclinent en un vaste gamme et des conceptions plus ou moins complexes , de les bombes gravitaires à les bombes guidées , de les bombes jeté manuellement d' un aéronef , à les bombes qui ont besoin d' un véhicule spécialement construit pour être larguée sur l' objectif , ou même peuvent -être l' appareil lui-même comme les bombes planantes , à détonation instantanée ou à retardement . 
### Existing MWEs: 
1- **ont besoin** (LVC, 22)Tokens : 
ont
besoin
...
le gouvernement français a fait encore une fois l' objet de sévères reproches quant à son soutien inconditionnel à le maroc dans le dossier de le sahara occidental qui oppose ce dernier à le front polisario depuis 35 ans . 
### Existing MWEs: 
1- **fait l' objet** (ID, 20)Tokens : 
fait
l'
...
### Existing MWEs: 
1- **tenu parole** (ID)Tokens : 
tenu
parole

### Identified MWEs: 
1- **tenu parole** Tokens : 
tenu
parole

## Sentence No. 16140 - fr-ud-dev_00155
l' action estimatoire permet à l' acheteur de garder la chose viciée en recevant un dédommagement ( articles 1645 et 1646 de le code civil ) . 
### Existing MWEs: 
1- **recevant dédommagement** (LVC)Tokens : 
recevant
dédommagement
...
### Existing MWEs: 
1- **se démarque** (IReflV, 3)Tokens : 
se
démarque

### Identified MWEs: 
1- **se démarque** Tokens : 
se
démarque
...
### Existing MWEs: 
1- **remporté succès** (LVC, 1)Tokens : 
remporté
succès
...
l' interdit qui frappe alors le mot " colonial " s' étend à les appellations à caractère géographique , à tous ces bataillons dits de côte d' ivoire , de le niger et autres aussi glorieux adjectifs " sénégalais " et à le terme " tirailleur " chargé de les plus belles traditions de l' armée française . 
### Existing MWEs: 
1- **s' étend** (IReflV, 12)Tokens : 
s'
étend
...
### Existing MWEs: 
1- **accusations pesant** (LVC)Tokens : 
accusations
pesant
...
2- **signer paix** Tokens : 
signer
paix

## Sentence No. 16460 - fr-ud-dev_00475
aucun autre pays ne s' occupe à ce point de les jeunes générations de joueurs . 
### Existing MWEs: 
1- **s' occupe** (IReflV, 8)Tokens : 
s'
occupe
...
ce tournoi de catégorie tier iv s' est disputé à rabat de le 15 à le 21 mai 2006 . 
### Existing MWEs: 
1- **s' disputé** (IReflV, 2)Tokens : 
s'
disputé

## Sentence No. 16495 - fr-ud-dev_00510
la musique de la gendarmerie mobile fait partie de les musiques militaires de la place de paris , placée sous l' autorité de le commandant de la région de gendarmerie de paris et de le gouverneur militaire de paris . 
### Existing MWEs: 
1- **fait partie** (ID, 70)Tokens : 
fait
partie
...
en septembre 1985 , il devient chef de la section santé de le front de résistance de le panshir , dans lequel s' illustra le commandant massoud . 
### Existing MWEs: 
1- **s' illustra** (IReflV, 3)Tokens : 
s'
illustra
...
### Existing MWEs: 
1- **investissement faire** (LVC)Tokens : 
investissement
faire

### Identified MWEs: 
1- **faire masse** Tokens : 
faire
masse
...
il se peut même que l' athenæum et la bibliothèque de le capitole ne fasse qu' un . 
### Existing MWEs: 
1- **se peut** (IReflV)Tokens : 
se
peut
...
gner s' est engagée à moderniser ses hst dans le cadre de sa nouvelle concession pour les porter à le même standard mallard que son parc dintercity 225 récemment réhabilité . 
### Existing MWEs: 
1- **s' engagée** (IReflV, 18)Tokens : 
s'
engagée
...
les réponses seront bientôt présentées à le public , ainsi que tous les travaux réalisés par les jeunes : maquettes , jeux de sociétés et quiz autour de la rénovation urbaine de berthe . 
### Existing MWEs: 
1- **travaux réalisés** (LVC, 2)Tokens : 
travaux
réalisés
...
### Existing MWEs: 
1- **connaissent développement** (LVC)Tokens : 
connaissent
développement

## Sentence No. 16825 - fr-ud-dev_00840
avant l' essor de la médecine , les accouchements se déroulaient à le domicile de la femme parturiente . 
### Existing MWEs: 
1- **se déroulaient** (IReflV, 41)Tokens : 
se
déroulaient

### Identified MWEs: 
1- **se déroulaient** Tokens : 
se
déroulaient
...
n' en voyant pas l' utilité , il l' offre à marge simpson qui , en échange , accepte de garder rod et todd pendant que ned flanders se rend à le congrès de les gauchers . 
### Existing MWEs: 
1- **se rend** (IReflV, 34)Tokens : 
se
rend
...
l' action se déroule à partir de le port de dutch harbor , premier port de pêche de les États-unis et zone industrielle de la ville d' unalaska située sur l' île d' unalaska dans les aléoutiennes occidentales de l' état d' alaska . 
### Existing MWEs: 
1- **se déroule** (IReflV, 41)Tokens : 
se
déroule
...
### Existing MWEs: 
1- **avoir significations** (LVC, 2)Tokens : 
avoir
significations

### Identified MWEs: 
1- **avoir significations** Tokens : 
avoir
significations

## Sentence No. 17030 - fr-ud-dev_01045
la justice donnait toujours raison à le propriétaire et les représentants britanniques ne pouvaient accéder librement à les habitations , devant passer par l' administration française qui cautionnait la situation . 
### Existing MWEs: 
1- **donnait raison** (ID, 1)Tokens : 
donnait
raison

### Identified MWEs: 
1- **donnait raison** Tokens : 
donnait
raison

## Sentence No. 17100 - fr-ud-dev_01115
les représentants de les médias sont invités à se joindre à l' événement . 
### Existing MWEs: 
1- **se joindre** (IReflV, 3)Tokens : 
se
joindre
...
pratiquant une danse dangereuse qui laisse des marques , sigalit landau fait montre d' une émouvante résistance à l' oppression , parvenant à jouer de le dernier périmètre vital laissé par un espace politique et social astringent qui menace directement l' intégrité physique de ses sujets . 
### Existing MWEs: 
1- **fait montre** (ID)Tokens : 
fait
montre

### Identified MWEs: 
1- **fait montre** Tokens : 
fait
montre
...
les six a380 de la compagnie australienne sont cloués à le sol depuis l' accident de le 4 novembre . 
### Existing MWEs: 
1- **cloués à le sol** (ID)Tokens : 
cloués
à
le
sol
...
si les résultats de les différentes élections à mirabeau donnent des résultats équivalents à les résultats nationaux ou locaux , la participation est toujours plus élevée ( jusqu' à 11 % de plus en mai 2005 ) . 
### Existing MWEs: 
1- **donnent résultats** (LVC)Tokens : 
donnent
résultats

## Sentence No. 17205 - fr-ud-dev_01220
les campagnes napoléoniennes permettront de perfectionner l' industrialisation de la guerre : les matériels initialement disparates s' uniformisent , l' équipement de le soldat également , même les tactiques se rapprochent . 
### Existing MWEs: 
1- **se rapprochent** (IReflV, 6)Tokens : 
se
rapprochent
...
lors de la guerre de tuscarora , qui s' achève en 1715 par une remontée de les indiens vers le nord puis lors de la guerre de yamasee , entre 1715 et 1717 , la ville de charleston et ses environs servent de refuge à les planteurs poursuivis par les amérindiens en colère , pendant un conflit qui fit plus de 400 morts parmi les colons blancs , mais eu pour résultat de libérer des terres à le sud de la caroline . 
### Existing MWEs: 
1- **eu résultat** (LVC, 1)Tokens : 
eu
résultat

### Identified MWEs: 
1- **eu résultat** Tokens : 
eu
résultat

## Sentence No. 17255 - fr-ud-dev_01270
le jour précédent , trois autres jésuites ( edmond campion , thomas cottam et james bosgrave ) avec quatre prêtres diocésains et un laïc avaient dû faire face à les mêmes accusations . 
### Existing MWEs: 
1- **faire face** (ID, 17)Tokens : 
faire
face
...
### Existing MWEs: 
1- **fit apparition** (LVC, 9)Tokens : 
fit
apparition

### Identified MWEs: 
1- **fit apparition** Tokens : 
fit
apparition
...
### Existing MWEs: 
1- **effectué vote** (LVC)Tokens : 
effectué
vote

### Identified MWEs: 
1- **effectué vote** Tokens : 
effectué
vote
...
### Existing MWEs: 
1- **connaître disgrâce** (LVC)Tokens : 
connaître
disgrâce

## Sentence No. 17500 - fr-ud-dev_01515
la pratique combinée de ces trois points a pour effet de diminuer l' emprise de les cinq kleśa ( afflictions ) . 
### Existing MWEs: 
...
son discours , inspiré d' une pensée de le moyen-âge , a trouvé preneur . 
### Existing MWEs: 
1- **trouvé preneur** (ID)Tokens : 
trouvé
preneur

### Identified MWEs: 
1- **trouvé preneur** Tokens : 
trouvé
preneur
...
### Existing MWEs: 
1- **appelle à secours** (ID, 2)Tokens : 
appelle
à
secours

## Sentence No. 17685 - fr-ud-test_00104
maintenant , si des supporters veulent aider le club à le travers d' une souscription pour faire revenir djibril à l' aja , qu' ils nous le fassent savoir . " 
### Existing MWEs: 
1- **fassent savoir** (ID, 3)Tokens : 
fassent
savoir

### Identified MWEs: 
1- **fassent savoir** Tokens : 
fassent
savoir

## Sentence No. 17715 - fr-ud-test_00134
en tous cas , la réorientation de le géant de les réseaux ip ne constitue pas une bonne nouvelle pour les adeptes de le wimax , qui perdent de plus en plus pied face à le lte . 
### Existing MWEs: 
1- **perdent pied** (ID)Tokens : 
perdent
pied
...
### Existing MWEs: 
1- **s' apprêtent** (IReflV, 1)Tokens : 
s'
apprêtent

### Identified MWEs: 
1- **s' apprêtent** Tokens : 
s'
apprêtent
...
### Existing MWEs: 
1- **coiffe à le poteau** (ID)Tokens : 
coiffe
à
le
poteau
...
### Existing MWEs: 
1- **il était temps** (ID, 5)Tokens : 
il
était
temps

### Identified MWEs: 
1- **il était temps** Tokens : 
il
était
temps
...
### Existing MWEs: 
1- **faire économies** (LVC)Tokens : 
faire
économies

### Identified MWEs: 
1- **faire économies** Tokens : 
faire
économies
