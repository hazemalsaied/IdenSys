...
2- **tagliare il traguardo** (ID)Tokens : 
tagliare
il
traguardo
...
2- **segna a porta vuota** (ID)Tokens : 
segna
a
porta
vuota
...
2- **mettendo a rischio** (ID)Tokens : 
mettendo
a
rischio
...
1- **facendo riferimento** (LVC, 1)Tokens : 
facendo
riferimento
