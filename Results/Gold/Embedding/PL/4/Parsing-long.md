...
2- **owijających się** (IReflV)Tokens : 
owijających
się
...
### Identified MWEs: 
1- **zainteresowane podmioty** (LVC)Tokens : 
zainteresowane
podmioty

2- **składać oferty** (LVC)Tokens : 
składać
oferty
...
2- **podjąć pracy** (LVC)Tokens : 
podjąć
pracy

3- **kierując się** (IReflV)Tokens : 
kierując
się
...
### Identified MWEs: 
1- **udział wziąć** (LVC)Tokens : 
udział
wziąć

2- **uprawiające malarstwo** (LVC)Tokens : 
uprawiające
malarstwo
...
2- **najlepsza okazała się** (ID)Tokens : 
najlepsza
okazała
się
