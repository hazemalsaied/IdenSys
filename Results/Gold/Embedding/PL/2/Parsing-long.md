...
3- **zgody przyczynili się** (ID)Tokens : 
zgody
przyczynili
się

4- **starający się** (IReflV)Tokens : 
starający
się
...
### Identified MWEs: 
1- **własne oczy** (ID)Tokens : 
własne
oczy

2- **przekonała się** (IReflV)Tokens : 
przekonała
się
...
### Identified MWEs: 
1- **przeprowadzonego czynienia** (LVC)Tokens : 
przeprowadzonego
czynienia
...
## Sentence No. 3288 - 
wydawało się więc , że podawanie zdrowym komórkom telomerazy nie doprowadzi do niczego dobrego . 
### Existing MWEs: 
...
## Sentence No. 3289 - 
staną się one co prawda nieśmiertelne , ale jednocześnie rozpocznie się w nich proces nowotworowy . 
### Existing MWEs: 
1- **staną się** (IReflV, 52)Tokens : 
staną
się
...
## Sentence No. 3312 - 
jelcyn we wczorajszym orędziu - wbrew oczekiwaniom - nie zdecydował się na rozpędzenie rad , choć znów je skrytykował oświadczając , że poparły by rebelię , gdyby zwyciężyła . 
### Existing MWEs: 
1- **zdecydował się** (IReflV, 11)Tokens : 
zdecydował
się
...
## Sentence No. 3318 - 
w zeszłym roku w cieszynie zawiązał się ckh i występował w naszej ii lidze . 
### Existing MWEs: 
1- **zawiązał się** (IReflV)Tokens : 
zawiązał
się
...
## Sentence No. 3322 - 
ogranicza jedynie arsenał broni mogących znaleźć zastosowanie . 
### Existing MWEs: 
1- **znaleźć zastosowanie** (LVC)Tokens : 
znaleźć
zastosowanie

## Sentence No. 3328 - 
czy nieprawdą jest , że przepędził antoniego chodorowskiego , gdy ten bezpośrednio po zdarzeniu udał się do niego po pomoc i interwencję , strasząc go przy tym użyciem policji , jeżeli nie opuści natychmiast budynku prokuratury ? 
### Existing MWEs: 
1- **udał się** (IReflV, 49)Tokens : 
udał
się
...
## Sentence No. 3333 - 
jak mówią w bbwr , to jego szef prof . zbigniew religa wpadł na pomysł , by przedsięwzięcie sfinansował belweder . 
### Existing MWEs: 
1- **wpadł na pomysł** (LVC)Tokens : 
wpadł
na
pomysł

## Sentence No. 3334 - 
idea jest prosta : bbwr tworzy w terenie swoje placówki , ale ponieważ prócz normalnej partyjnej roboty zajmuje się też zbieraniem informacji dla prezydenta , działa pod szyldem terenowej delegatury kancelarii . 
### Existing MWEs: 
1- **zajmuje się** (IReflV, 34)Tokens : 
zajmuje
się
...
## Sentence No. 3336 - 
tomasz iwan ( feyenoord rotterdam ) : - jutro w klubie znowu będą się ze mnie śmiali . 
### Existing MWEs: 
1- **się śmiali** (IReflV, 1)Tokens : 
się
śmiali

## Sentence No. 3339 - 
skoro porażka ze słowacją 1 : 4 była kompromitacją , to zastanawiam się , jak nazwać rezultat z hongkongu . 
### Existing MWEs: 
1- **zastanawiam się** (IReflV, 9)Tokens : 
zastanawiam
się

### Identified MWEs: 
1- **zastanawiam się** (IReflV)Tokens : 
zastanawiam
się

## Sentence No. 3353 - 
dlatego podwyższa oprocentowanie udzielanych kredytów . 
### Existing MWEs: 
1- **udzielanych kredytów** (LVC, 1)Tokens : 
udzielanych
kredytów

### Identified MWEs: 
1- **udzielanych kredytów** (LVC)Tokens : 
udzielanych
kredytów
...
### Existing MWEs: 
1- **Żeby piorun trzasł** (ID)Tokens : 
Żeby
piorun
trzasł

## Sentence No. 3371 - 
takie stawianie sprawy może prowadzić tylko do gorszącego wyrywania sobie symboli . 
### Existing MWEs: 
1- **stawianie sprawy** (ID, 1)Tokens : 
stawianie
sprawy

## Sentence No. 3376 - 
przypomnijmy , że kołodko nieustannie spiera się z prezes nbp hanną gronkiewicz - waltz i ministrem pracy leszkiem millerem ( sld ) . 
### Existing MWEs: 
1- **spiera się** (IReflV, 1)Tokens : 
spiera
się

### Identified MWEs: 
1- **spiera się** (IReflV)Tokens : 
spiera
się

## Sentence No. 3386 - 
sensacją według komentatorów jest powołanie byłych mistrzów anglii w barwach blackburn rovers : napastnika chrisa suttona i pomocnika tima sherwooda , który według keegana będzie spełniał rolę rozgrywającego . 
### Existing MWEs: 
1- **spełniał rolę** (LVC, 2)Tokens : 
spełniał
rolę

### Identified MWEs: 
1- **spełniał rolę** (LVC)Tokens : 
spełniał
rolę

## Sentence No. 3389 - 
krytyczny stosunek do rury ma też wielu specjalistów . 
### Existing MWEs: 
1- **stosunek ma** (LVC)Tokens : 
stosunek
ma

## Sentence No. 3394 - 
po przeczytaniu artykułu małgorzaty szejnert " bez miejsca " ( " gazeta " nr 288 ) doszedł em do wniosku , że autorka zbyt jednostronnie przedstawiła sprawę galerii foksal . 
### Existing MWEs: 
1- **doszedł do wniosku** (LVC, 3)Tokens : 
doszedł
do
wniosku
...
## Sentence No. 3401 - 
wyrok się przyjmuje , ale przyznaję , że w sprawie polsatu miał em inne zdanie niż rada . 
### Existing MWEs: 
1- **miał zdanie** (LVC)Tokens : 
miał
zdanie

### Identified MWEs: 
1- **się przyjmuje** (IReflV)Tokens : 
się
przyjmuje

2- **wyrok się przyjmuje** (ID)Tokens : 
wyrok
się
przyjmuje

## Sentence No. 3404 - 
jednocześnie w wielu firmach ubezpieczeniowych ubezpieczając samochód wyposażony w takie urządzenie dostaniemy ulgę . 
### Existing MWEs: 
1- **dostaniemy ulgę** (LVC)Tokens : 
dostaniemy
ulgę

## Sentence No. 3412 - 
ks . henryk sacewicz z rady zborów chrystusowych powiedział sędziom , że przed podpisaniem rozporządzenia przez ministra domagał się , by oceny z religii nie umieszczać na państwowym świadectwie . 
### Existing MWEs: 
1- **domagał się** (IReflV, 22)Tokens : 
domagał
się
...
## Sentence No. 3416 - 
bankierzy skarżą się na brak kapitału rodzimego . 
### Existing MWEs: 
1- **skarżą się** (IReflV, 4)Tokens : 
skarżą
się

### Identified MWEs: 
1- **skarżą się** (IReflV)Tokens : 
skarżą
się

## Sentence No. 3426 - 
przed kościołem Świętej trójcy znajduje się kilka okazałych głazów narzutowych zwiezionych z okolicy . 
### Existing MWEs: 
1- **znajduje się** (IReflV, 56)Tokens : 
znajduje
się
...
## Sentence No. 3432 - 
tam przyniesioną z domu finką zadały agnieszce kilka ciosów w klatkę piersiową i brzuch . 
### Existing MWEs: 
1- **zadały ciosów** (LVC, 1)Tokens : 
zadały
ciosów

### Identified MWEs: 
1- **przyniesioną zadały** (LVC)Tokens : 
przyniesioną
zadały

## Sentence No. 3451 - 
tylko neisemanowie nie mogli uciekać z małym dzieckiem , więc podchmieleni żołdacy pchali się do dworku i rzucali się na neisemanową . 
### Existing MWEs: 
1- **pchali się** (IReflV)Tokens : 
pchali
się

### Identified MWEs: 
1- **rzucali się** (IReflV)Tokens : 
rzucali
się
...
### Existing MWEs: 
1- **spotykają się** (IReflV, 7)Tokens : 
spotykają
się
...
## Sentence No. 3477 - 
" dziewiąte kraje " mogą się zdarzyć i na jawie , byle śmy tylko chcieli ich nie burzyć . 
### Existing MWEs: 
1- **się zdarzyć** (IReflV, 3)Tokens : 
się
zdarzyć
...
### Existing MWEs: 
1- **znalazło się** (IReflV, 31)Tokens : 
znalazło
się
...
## Sentence No. 3484 - 
leszek moczulski : nie ukrywamy , że kiedy kpn będzie miała władzę , to w bardzo stanowczy sposób zaprowadzimy w polsce porządek . 
### Existing MWEs: 
1- **miała władzę** (LVC)Tokens : 
miała
władzę
...
### Existing MWEs: 
1- **natykam się** (IReflV)Tokens : 
natykam
się

## Sentence No. 3492 - 
po pewnym czasie ( od kilku do kilkunastu sekund ) obrazek zaczyna się " mrowić " i . . . już widzę ! ! ! 
### Existing MWEs: 
1- **się mrowić** (IReflV)Tokens : 
się
mrowić

## Sentence No. 3509 - 
rozmawiają przyjaźnie z pogranicznikami , pozują do zdjęć , kiedy okazało się , że aparat nie należy do policji : - za cztery godziny będziemy znów w meksyku , nadejdzie zmrok , spróbujemy jeszcze raz - przyznają otwarcie . 
### Existing MWEs: 
1- **okazało się** (IReflV, 46)Tokens : 
okazało
się
...
## Sentence No. 3519 - 
minsky spodziewa się , że do połowy 1995 roku ponad 2000 studentów i naukowców przejdzie kurs , który nauczy ich , jak realizować zachodnie zamówienia na oprogramowanie , a także , jak tworzyć własne programy na eksport . 
### Existing MWEs: 
...
## Sentence No. 3522 - 
według danych waszyngtońskiego ministerstwa pracy również w tym roku nie należy spodziewać się przyspieszenia wzrostu cen . 
### Existing MWEs: 
1- **spodziewać się** (IReflV, 13)Tokens : 
spodziewać
się
...
## Sentence No. 3529 - 
rozwój najtańszych marek również stoi pod znakiem zapytania . 
### Existing MWEs: 
1- **stoi pod znakiem zapytania** (ID)Tokens : 
stoi
pod
znakiem
zapytania
...
## Sentence No. 3534 - 
dawna studentka szkoły filmowej w pradze , agnieszka holland , dla polskiego radia : " nie wiem , kto wpadł na ten pomysł , jak to się zrodziło . 
### Existing MWEs: 
1- **wpadł na pomysł** (LVC)Tokens : 
wpadł
na
...
## Sentence No. 3537 - 
dopiero kiedy wymknęło się jednej , że " trzeba było oczyścić cały ten gnój " , druga ją zmitygowała , ale zaraz dodała : - wie pan , powiem całkiem szczerze . 
### Existing MWEs: 
1- **wymknęło się** (IReflV, 1)Tokens : 
wymknęło
się

### Identified MWEs: 
1- **wymknęło się** (IReflV)Tokens : 
wymknęło
się

## Sentence No. 3542 - 
według informacji " gazety " pawlak skorzysta z okazji , by pozbyć się nie lubianego przez koalicję ministra , ale może przetrzymać wniosek olechowskiego aż do posiedzenia trybunału , co może się przeciągnąć do drugiej połowy stycznia . 
### Existing MWEs: 
1- **pozbyć się** (IReflV, 2)Tokens : 
pozbyć
się
...
## Sentence No. 3561 - 
spółkom , które zainteresowane są publiczną sprzedażą akcji , postawiono zbyt wysokie wymagania . 
### Existing MWEs: 
1- **postawiono wymagania** (LVC)Tokens : 
postawiono
wymagania

## Sentence No. 3564 - 
goście przyjechali bez kontuzjowanego andreasa moellera , mimo to nie mieli żadnych problemów z udowodnieniem swej wyższości . 
### Existing MWEs: 
1- **mieli problemów** (LVC, 9)Tokens : 
mieli
problemów
...
## Sentence No. 3583 - 
bo w końcu i tak już dostatecznie dużo narobiła m sobie wrogów przez swoją porywczość , zawsze mówię to , co myślę , i mam niewyparzony język . 
### Existing MWEs: 
1- **mam niewyparzony język** (LVC)Tokens : 
mam
niewyparzony
język

## Sentence No. 3591 - 
knin ( " stolica " chorwackich serbów - red . ) znajduje się w kleszczach , które wystarczy zacisnąć . 
### Existing MWEs: 
1- **znajduje się** (IReflV, 56)Tokens : 
znajduje
się
...
## Sentence No. 3601 - 
rozważa , czy prezydent może mieć romans z aktorką , czy niekatolicy muszą być skazani na jedzenie w piątki ryb , czy będzie wojna . 
### Existing MWEs: 
1- **mieć romans** (LVC)Tokens : 
mieć
romans
...
## Sentence No. 3603 - 
ministerstwo finansów stawia jednak twardy warunek : spółka dominująca musiała by posiadać 100 proc . udziałów w kapitale zakładowym ( lub akcyjnym ) spółek zależnych . 
### Existing MWEs: 
1- **stawia warunek** (LVC)Tokens : 
stawia
warunek
...
## Sentence No. 3613 - 
zdobyć nowego jest trudno , zwłaszcza że w początkowym okresie wysyłali śmy wiele knotów - w mrożonych owocach trafiały się kawałki drewnianych łubianek i zwyczajnych śmieci . 
### Existing MWEs: 
1- **trafiały się** (IReflV, 2)Tokens : 
trafiały
się

### Identified MWEs: 
1- **zdobyć nowego** (IReflV)Tokens : 
zdobyć
nowego

2- **trafiały się** (IReflV)Tokens : 
trafiały
się

## Sentence No. 3614 - 
na wyróżnienie trenera zasłużył także mathias sammer , który pełnił funkcję motoru napędowego reprezentacji . 
### Existing MWEs: 
1- **pełnił funkcję** (LVC, 5)Tokens : 
pełnił
funkcję
...
### Existing MWEs: 
1- **się obawiali** (IReflV, 1)Tokens : 
się
obawiali

## Sentence No. 3618 - 
córki cieszą się oczywiście i z nowego telewizora , i z kafelków . 
### Existing MWEs: 
1- **cieszą się** (IReflV, 18)Tokens : 
cieszą
się
...
## Sentence No. 3622 - 
inwestor może więc kupić obligacje i otrzymywać odsetki , które są mniejsze niż przy zwykłych obligacjach , ale zwykle większe od dywidend wypłacanych przez spółkę . 
### Existing MWEs: 
1- **otrzymywać odsetki** (LVC)Tokens : 
otrzymywać
odsetki

## Sentence No. 3623 - 
jeśli jednak inwestor liczy na znaczny wzrost kursu akcji , zamienia swoje obligacje i staje się pełnoprawnym udziałowcem spółki . 
### Existing MWEs: 
...
## Sentence No. 3629 - 
ma kłopoty z koordynacją ruchów , ale przede wszystkim z mówieniem . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **się poczuli** (IReflV)Tokens : 
się
poczuli

## Sentence No. 3643 - 
najwspanialsza wydawała się nam " oberża " kastylii i leonu , dziś siedziba maltańskiego premiera . 
### Existing MWEs: 
1- **wydawała się** (IReflV, 19)Tokens : 
wydawała
się

### Identified MWEs: 
1- **wydawała się** (IReflV)Tokens : 
wydawała
się
...
## Sentence No. 3647 - 
ale zaraz pojawił się też sekretarz prezydenta , który powiedział : ależ proszę , pracujcie tu spokojnie , 
### Existing MWEs: 
1- **pojawił się** (IReflV, 54)Tokens : 
pojawił
się
...
## Sentence No. 3666 - 
krzyknął em , że ich kocham , i z łoskotem wyciął em hołubca . 
### Existing MWEs: 
1- **wyciął hołubca** (LVC)Tokens : 
wyciął
hołubca

## Sentence No. 3668 - 
podczas przesłuchania w komisji minister zbigniew siemiątkowski zdystansował się wobec pomysłu cimoszewicza . 
### Existing MWEs: 
1- **zdystansował się** (IReflV)Tokens : 
zdystansował
się

## Sentence No. 3669 - 
obawiam się , że tylko werbalnie . 
### Existing MWEs: 
1- **obawiam się** (IReflV, 9)Tokens : 
obawiam
się

### Identified MWEs: 
1- **obawiam się** (IReflV)Tokens : 
obawiam
się
...
## Sentence No. 3677 - 
jak poinformował rzecznik compaqa , firma ogilvy and mather zajmowała się reklamą compaqa na starym kontynencie od chwili jego wejścia na europejski rynek w 1984 roku . 
### Existing MWEs: 
1- **zajmowała się** (IReflV, 34)Tokens : 
zajmowała
się
...
## Sentence No. 3686 - 
od nowego roku do składek mieli by się dołożyć również pracownicy . 
### Existing MWEs: 
1- **się dołożyć** (IReflV)Tokens : 
się
dołożyć

## Sentence No. 3692 - 
kilka tygodni później zgromadzenie wspólników codro uchyla decyzje o podniesieniu kapitału akcyjnego i o wniesieniu aportów . 
### Existing MWEs: 
1- **wniesieniu aportów** (LVC)Tokens : 
wniesieniu
aportów
...
## Sentence No. 3703 - 
z drugiej jednak strony teza o kryzysie jako głównym czynniku wzrostu popularności prawicy także wydaje się po części wątpliwa . 
### Existing MWEs: 
1- **wydaje się** (IReflV, 19)Tokens : 
wydaje
się
...
## Sentence No. 3714 - 
- zachodowi wydaje się , że wystarczy u nas dobry menedżer i sprawa będzie załatwiona - mówił . 
### Existing MWEs: 
1- **wydaje się** (IReflV, 19)Tokens : 
wydaje
się
...
### Existing MWEs: 
1- **dowie się** (IReflV, 20)Tokens : 
dowie
się

### Identified MWEs: 
1- **dowie się** (IReflV)Tokens : 
dowie
się

## Sentence No. 3733 - 
zresztą taki całkowicie zafałszowany obraz świata zewnętrznego jest dziełem nie tylko 50 lat komunizmu , ale i poprzednich 2000 lat cesarstwa , kiedy ów świat przedstawiany był niezmiennie jako obszar zamieszkany przez nieokrzesaną dzicz , która nie może się równać z państwem Środka , rządzonym przez syna niebios - cesarza . 
### Existing MWEs: 
1- **się równać** (IReflV)Tokens : 
się
równać

## Sentence No. 3734 - 
okazało się , że większość kuratoriów już rozdysponowała większość pieniędzy , które powinny starczyć na cały rok . 
### Existing MWEs: 
1- **okazało się** (IReflV, 46)Tokens : 
okazało
się
...
## Sentence No. 3743 - 
w obozie dla internowanych zachowywał się znakomicie . 
### Existing MWEs: 
...
## Sentence No. 3746 - 
na pewno nie miało to żadnego dalszego ciągu . 
### Existing MWEs: 
1- **miało dalszego ciągu** (LVC)Tokens : 
miało
dalszego
ciągu

## Sentence No. 3754 - 
minister wiatr , 3 września : " wychowanie seksualne pojawi się w szkołach jako przedmiot nieobowiązkowy . 
### Existing MWEs: 
1- **pojawi się** (IReflV, 54)Tokens : 
pojawi
się
...
## Sentence No. 3762 - 
niestety , kontakt już nieaktualny - pacyfiści oddali pole spółce handlującej sprzętem medycznym . 
### Existing MWEs: 
1- **oddali pole** (ID)Tokens : 
oddali
pole

## Sentence No. 3768 - 
projektem stosownej ustawy zajmuje się już sejm . 
### Existing MWEs: 
1- **zajmuje się** (IReflV, 34)Tokens : 
zajmuje
się
...
## Sentence No. 3789 - 
" przez dwa stulecia franciszkanie dawali się Żydom mocno we znaki . 
### Existing MWEs: 
1- **dawali się we znaki** (ID)Tokens : 
dawali
się
we
znaki
...
### Existing MWEs: 
1- **historia lubi się powtarzać** (ID)Tokens : 
historia
lubi
się
powtarzać
...
### Identified MWEs: 
1- **polityki dokonał** (LVC)Tokens : 
polityki
dokonał

2- **sprawującego władzę** (LVC)Tokens : 
sprawującego
władzę

## Sentence No. 3808 - 
robił czasem na ten temat zgryźliwe uwagi . 
### Existing MWEs: 
1- **robił uwagi** (LVC)Tokens : 
robił
uwagi
...
## Sentence No. 3821 - 
titkowowi udało się sfotografować pustkę po człowieku , wywołać żal , że nie znało się go bliżej . 
### Existing MWEs: 
1- **udało się** (IReflV, 49)Tokens : 
udało
się
...
## Sentence No. 3824 - 
hawking przypuszcza , że wycieczki w czasie mogły by zostać urzeczywistnione dzięki kosmicznym podróżom odbywanym z ogromnymi prędkościami . 
### Existing MWEs: 
1- **podróżom odbywanym** (LVC)Tokens : 
podróżom
odbywanym
...
## Sentence No. 3829 - 
podczas wczorajszej próby generalnej ceremonii wręczania nagród wisława szymborska zachowała najwięcej zimnej krwi spośród wszystkich tegorocznych laureatów nobla . 
### Existing MWEs: 
1- **zachowała zimnej krwi** (ID)Tokens : 
zachowała
zimnej
krwi

## Sentence No. 3834 - 
próbie przygląda się tylko kilkunastu dziennikarzy . 
### Existing MWEs: 
1- **przygląda się** (IReflV, 7)Tokens : 
przygląda
się

### Identified MWEs: 
1- **przygląda się** (IReflV)Tokens : 
przygląda
się
...
2- **wziąć dzień** (LVC)Tokens : 
wziąć
dzień

## Sentence No. 3836 - 
dariusz wołowski : prowadzi pan rozmowy z działaczami stołecznego klubu ? 
### Existing MWEs: 
1- **prowadzi rozmowy** (LVC, 3)Tokens : 
prowadzi
rozmowy

## Sentence No. 3839 - 
kadra zbiera się w czwartek , więc miał em czas odwiedzić kolegów z legii . 
### Existing MWEs: 
1- **miał czas** (LVC, 4)Tokens : 
miał
czas

### Identified MWEs: 
1- **zbiera się** (IReflV)Tokens : 
zbiera
się

2- **miał czas** (LVC)Tokens : 
miał
czas
...
## Sentence No. 3852 - 
droga do poprawy szkolnictwa wyższego w polsce prowadzi przez powszechność opłat za studia i przez skumulowanie środków budżetowych przeznaczanych na ten cel w dwu kierunkach : stypendiach dla najzdolniejszych i dotacjach dla szkół , proporcjonalnych do obiektywnej roli , jaką poszczególne uczelnie odgrywają w polsce i na świecie . 
### Existing MWEs: 
1- **roli odgrywają** (LVC, 1)Tokens : 
roli
odgrywają
...
### Existing MWEs: 
1- **obawiają się** (IReflV, 9)Tokens : 
obawiają
się

### Identified MWEs: 
1- **przygotowują się** (IReflV)Tokens : 
przygotowują
się

2- **obawiają się** (IReflV)Tokens : 
obawiają
się

## Sentence No. 3864 - 
w intymną narrację wdzierają się echa bośniackiej tragedii . 
### Existing MWEs: 
1- **wdzierają się** (IReflV)Tokens : 
wdzierają
się
...
## Sentence No. 3873 - 
sędzia rymarz przyznał , że telewizja miała prawo zatrzymać kasety bubla . 
### Existing MWEs: 
1- **miała prawo** (LVC, 13)Tokens : 
miała
prawo
...
## Sentence No. 3874 - 
- wszystkie programy wyborcze powinny mieścić się w ramach porządku prawnego - powiedział . 
### Existing MWEs: 
1- **mieścić się** (IReflV, 10)Tokens : 
mieścić
się

### Identified MWEs: 
1- **mieścić się** (IReflV)Tokens : 
mieścić
się

## Sentence No. 3882 - 
gdy odrywał em miodową taśmę , jurek powiedział , że czasem z jaja leżącego za piecem wykluje się w zimie owad . 
### Existing MWEs: 
...
## Sentence No. 3887 - 
krystyna kapica zapewnia , że w tym roku firma planuje 10-proc . wzrost produkcji i ma wszelkie szanse plan ten wypełnić . 
### Existing MWEs: 
1- **ma szanse** (LVC, 15)Tokens : 
ma
szanse
...
## Sentence No. 3894 - 
jestem pewien , że Żydzi zatroszczyli by się o godną pamięć wszystkich innych pomordowanych - w tym także polaków . 
### Existing MWEs: 
1- **zatroszczyli się** (IReflV)Tokens : 
zatroszczyli
się

## Sentence No. 3896 - 
pewien ksiądz z diecezji przemyskiej powiedział nam : - władze lokalne bardzo liczą się z arcybiskupem . 
### Existing MWEs: 
1- **liczą się** (IReflV, 7)Tokens : 
liczą
się
...
## Sentence No. 3897 - 
nie wiem , na czym to polega , ale on ma wpływ na liczne decyzje i nominacje . 
### Existing MWEs: 
1- **ma wpływ** (LVC, 4)Tokens : 
ma
wpływ

### Identified MWEs: 
1- **ma wpływ** (LVC)Tokens : 
ma
wpływ

## Sentence No. 3899 - 
informacji tych nie udało się potwierdzić ze źródeł oficjalnych . 
### Existing MWEs: 
1- **udało się** (IReflV, 49)Tokens : 
udało
się
...
## Sentence No. 3902 - 
dwa tygodnie temu socjaliści odnieśli zwycięstwo w wyborach federalnych , odbywających się razem z pierwszą turą wyborów lokalnych . 
### Existing MWEs: 
1- **odnieśli zwycięstwo** (LVC, 1)Tokens : 
odnieśli
zwycięstwo
...
### Existing MWEs: 
1- **spotkają się** (IReflV, 29)Tokens : 
spotkają
się
...
## Sentence No. 3912 - 
dzięki wysiłkom promotorów boksu drugi pojedynek udało się sprzedać jako walkę dobra ze złem . 
### Existing MWEs: 
1- **udało się** (IReflV, 49)Tokens : 
udało
się
...
## Sentence No. 3916 - 
kiedy doszedł do 300 , stwierdził , że jest już tak prosta , iż dało by się ją zbudować od podstaw w laboratorium . 
### Existing MWEs: 
1- **dało się** (IReflV, 5)Tokens : 
dało
się
...
## Sentence No. 3932 - 
kradzieżą " maluchów " czy polonezów zajmują się amatorzy , drobni przestępcy , tzw . leszcze . 
### Existing MWEs: 
1- **zajmują się** (IReflV, 34)Tokens : 
zajmują
się
...
## Sentence No. 3956 - 
w tym czasie polskie filmy , w odróżnieniu od tego , co dzieje się dzisiaj , były świetnie robione . 
### Existing MWEs: 
...
## Sentence No. 3957 - 
pod względem języka filmowego , techniki , nie różniły się niczym od zachodnich . 
### Existing MWEs: 
1- **różniły się** (IReflV, 7)Tokens : 
różniły
się

### Identified MWEs: 
1- **różniły się** (IReflV)Tokens : 
różniły
się

## Sentence No. 3959 - 
różniły się tylko tym , co wolno było opowiadać . 
### Existing MWEs: 
1- **różniły się** (IReflV, 7)Tokens : 
różniły
się
...
## Sentence No. 3964 - 
o takuhaibin nakręcono filmy dokumentalne i fabularne , a system czyni cuda w górzystej i zatłoczonej japonii . 
### Existing MWEs: 
1- **czyni cuda** (LVC)Tokens : 
czyni
cuda

## Sentence No. 3967 - 
po męczącym dniu spędzonym przy biurku warto zamienić ciasne ubranie na dres , zdjąć staniczek i wykonać kilka prostych ćwiczeń . 
### Existing MWEs: 
1- **wykonać ćwiczeń** (LVC)Tokens : 
wykonać
ćwiczeń

## Sentence No. 3974 - 
większe straty jednak poniosła ludność polska na wołyniu z rąk ukraińskich nacjonalistów podczas akcji terrorystycznych w latach 1942 - 1944 , a zwłaszcza w 1943 r . 
### Existing MWEs: 
...
## Sentence No. 3982 - 
według nieoficjalnych informacji " gazety " trybunał , który wielokrotnie upominał się o prawa emerytów , podobnie postąpi i tym razem . 
### Existing MWEs: 
1- **upominał się** (IReflV, 1)Tokens : 
upominał
się

### Identified MWEs: 
1- **upominał się** (IReflV)Tokens : 
upominał
się

## Sentence No. 3992 - 
umiejętność " czytania " mowy ciała przydaje się również w negocjacjach . 
### Existing MWEs: 
1- **przydaje się** (IReflV)Tokens : 
przydaje
się
...
2- **obniżać koszty** (LVC)Tokens : 
obniżać
koszty

## Sentence No. 4017 - 
na 28 tys . zatrudnionych aż 8 tys . wykonuje pracę nie związaną bezpośrednio z produkcją . 
### Existing MWEs: 
...
## Sentence No. 4019 - 
ceną za to opóźnienie okazał się udział w rynku francuskim . 
### Existing MWEs: 
1- **okazał się** (IReflV, 46)Tokens : 
okazał
się
...
## Sentence No. 4034 - 
często stosowne wnioski o wpis hipoteki do księgi wieczystej nieruchomości urzędnicy kierowali do sądu z wielomiesięcznym opóźnieniem , a potem nie interesowali się ich losem . 
### Existing MWEs: 
1- **interesowali się** (IReflV, 5)Tokens : 
interesowali
się
...
## Sentence No. 4048 - 
doświadczenia biurokracji komunistycznej w niewielkim stopniu dadzą się wykorzystać , a i tu legitymizowanie nowego porządku powoduje odżegnywanie się od tych doświadczeń na wszelkie sposoby . 
### Existing MWEs: 
1- **odżegnywanie się** (IReflV)Tokens : 
odżegnywanie
się

### Identified MWEs: 
1- **dadzą się** (IReflV)Tokens : 
dadzą
się
...
## Sentence No. 4053 - 
rzecznik ing powiedział , że " pierwsze rozmowy przedstawicieli obydwu instytucji odbędą się na pewno w tym miesiącu " . 
### Existing MWEs: 
...
## Sentence No. 4054 - 
jego zdaniem budapest bank , obsługujący rzeszę indywidualnych klientów , stanowił by doskonałe uzupełnienie dla działań prowadzonych przez ing na rynku kredytów dla handlu i firm . 
### Existing MWEs: 
1- **działań prowadzonych** (LVC, 2)Tokens : 
działań
prowadzonych

### Identified MWEs: 
1- **działań prowadzonych** (LVC)Tokens : 
działań
prowadzonych

## Sentence No. 4058 - 
należą do nich niewątpliwie : dog na wrotkach ( ciekawe , co na to tamtejsze towarzystwo przyjaciół zwierząt ) , uprawianie miłości przez telefon ( niech żyje bezpieczny seks ! ) oraz absolutnie rewelacyjna ( jak zawsze ) uma thurman . 
### Existing MWEs: 
1- **uprawianie miłości** (LVC)Tokens : 
uprawianie
miłości

## Sentence No. 4059 - 
słowo " cnota " , przyznajmy , nieco zostało ośmieszone w polskim języku , tak często i tak natarczywie było używane w jednym kontekście , mianowicie dla określenia seksualnej niewinności , głównie młodych kobiet ; mówiło się " cnota dziewicza " , " ona cnotę straciła " , " on na jej cnotę dybał " , " ta panienka nie jest sławna ze swej cnoty " itp . 
### Existing MWEs: 
1- **cnotę straciła** (ID)Tokens : 
cnotę
straciła
...
### Identified MWEs: 
1- **kładąc się** (IReflV)Tokens : 
kładąc
się

2- **przyglądało się** (IReflV)Tokens : 
przyglądało
się

## Sentence No. 4067 - 
umowa weszła w życie 1 czerwca 1994 r . 
### Existing MWEs: 
1- **weszła w życie** (ID, 7)Tokens : 
weszła
w
życie

## Sentence No. 4072 - 
w zależności od zarobków ustalany jest miesięczny limit - maksymalna kwota , za którą można robić zakupy z wykorzystaniem karty . 
### Existing MWEs: 
1- **robić zakupy** (LVC, 1)Tokens : 
robić
zakupy

### Identified MWEs: 
1- **robić zakupy** (LVC)Tokens : 
robić
zakupy

## Sentence No. 4073 - 
tymczasem pojawiają się sygnały świadczące o rozbieżności zdań w sprawie kosowa pomiędzy europejskimi sojusznikami . 
### Existing MWEs: 
1- **pojawiają się** (IReflV, 12)Tokens : 
pojawiają
się
...
## Sentence No. 4074 - 
wczoraj w rzadkim geście krytyki wobec polityków " najważniejszy wojskowy sojuszu " , przewodniczący komitetu wojskowego nato gen . klaus naumann , oburzył się na " przywódców państw członkowskich " , którzy w rozmowach z miloszeviciem gwarantują , że " pewne rzeczy się nie zdarzą " . 
### Existing MWEs: 
1- **się zdarzą** (IReflV, 3)Tokens : 
się
zdarzą

### Identified MWEs: 
1- **się zdarzą** (IReflV)Tokens : 
się
zdarzą

## Sentence No. 4078 - 
w latach 1990 - 93 polska miała największą liczbę akcji protestacyjnych w byłym bloku . 
### Existing MWEs: 
1- **miała akcji** (LVC)Tokens : 
miała
akcji

## Sentence No. 4096 - 
mroczna historia odcisnęła swe piętno na wciąż żywych językach : irlandzkim , szkockim , walijskim , kornwalijskim . 
### Existing MWEs: 
1- **odcisnęła piętno** (LVC)Tokens : 
odcisnęła
piętno

## Sentence No. 4104 - 
pasował jak ulał na papieża antysztuki . 
### Existing MWEs: 
1- **pasował jak ulał** (ID)Tokens : 
pasował
jak
ulał
...
### Existing MWEs: 
1- **grał mecz** (LVC)Tokens : 
grał
mecz

## Sentence No. 4124 - 
tadeusz s . ( a może paweł p . ) tym razem oświadcza się na piśmie . 
### Existing MWEs: 
1- **oświadcza się** (IReflV)Tokens : 
oświadcza
się
...
## Sentence No. 4127 - 
od 1985 r . była bezpartyjna , bo nie zgadzała się ze stanowiskiem partii pracy co do ówczesnego porozumienia irlandii z anglią , niesprawiedliwego , jej zdaniem , dla protestantów ulsteru . 
### Existing MWEs: 
1- **zgadzała się** (IReflV, 7)Tokens : 
zgadzała
się

### Identified MWEs: 
1- **zgadzała się** (IReflV)Tokens : 
zgadzała
się

## Sentence No. 4128 - 
na monciaku - sopockim deptaku - przed wejściem na molo pojawiła się groźna konkurencja dla festiwalu . 
### Existing MWEs: 
1- **pojawiła się** (IReflV, 54)Tokens : 
pojawiła
się
...
## Sentence No. 4132 - 
ponieważ do zdarzenia doszło na oczach kilku hiszpańskich dziennikarzy , incydentu nie udało się zatuszować . 
### Existing MWEs: 
1- **udało się** (IReflV, 49)Tokens : 
udało
się
...
## Sentence No. 4133 - 
hierro z seedorfem zaczęli się sprzeczać już w pierwszej połowie meczu . 
### Existing MWEs: 
1- **się sprzeczać** (IReflV)Tokens : 
się
sprzeczać

## Sentence No. 4146 - 
w kwietniu podobny zarzut postawił publicznie kazimierz gródek z radia rmf fm . 
### Existing MWEs: 
1- **zarzut postawił** (LVC)Tokens : 
zarzut
postawił
...
### Existing MWEs: 
1- **mają zarzuty** (LVC)Tokens : 
mają
zarzuty

## Sentence No. 4149 - 
oznacza to , że nie wolno poruszać się po drogach , szlakach pieszych i rowerowych . 
### Existing MWEs: 
1- **poruszać się** (IReflV, 4)Tokens : 
poruszać
się
...
## Sentence No. 4153 - 
prezes klubu edward trylik potwierdza , że kilka tygodni temu do pzu zostało skierowane memorandum informacyjne , na podstawie którego firma może podjąć decyzję o zaangażowaniu w sportową spółkę . 
### Existing MWEs: 
1- **podjąć decyzję** (LVC, 12)Tokens : 
podjąć
decyzję
...
### Existing MWEs: 
1- **uwijali się jak w ukropie** (ID)Tokens : 
uwijali
się
jak
w
...
## Sentence No. 4162 - 
inne - kupione - zostały postawione w stan likwidacji . 
### Existing MWEs: 
1- **postawione w stan** (ID, 1)Tokens : 
postawione
w
stan

### Identified MWEs: 
1- **postawione w stan** (ID)Tokens : 
postawione
w
stan

## Sentence No. 4168 - 
uczniowie " dwunastki " tym samym zakwalifikowali się do finału , który odbędzie się w czerwcu w warszawie . 
### Existing MWEs: 
1- **zakwalifikowali się** (IReflV, 1)Tokens : 
zakwalifikowali
się

### Identified MWEs: 
1- **zakwalifikowali się** (IReflV)Tokens : 
zakwalifikowali
się

## Sentence No. 4184 - 
polacy mieli by odpowiedzieć na pytanie , czy sprzeciwiają się sprzedaży ziemi cudzoziemcom . 
### Existing MWEs: 
1- **sprzeciwiają się** (IReflV, 5)Tokens : 
sprzeciwiają
się
...
## Sentence No. 4188 - 
w końcu marca w libanie odbyła się tajna narada przywódców ugrupowań terrorystycznych : al-quaidy , hamasu i hezbollahu - podała amerykańska sieć abc , powołując się na informacje z kół wywiadu . 
### Existing MWEs: 
...
## Sentence No. 4202 - 
wyjaśnił też , że wniosek o nadawanie programu telewizyjnego złożyła fundacja lux veritatis ( Światło prawdy ) . 
### Existing MWEs: 
1- **wniosek złożyła** (LVC, 2)Tokens : 
wniosek
złożyła

## Sentence No. 4204 - 
w trwającej sześć miesięcy operacji ma wziąć udział 600 amerykańskich żołnierzy , w tym 160 komandosów . 
### Existing MWEs: 
1- **wziąć udział** (LVC, 37)Tokens : 
wziąć
udział
...
## Sentence No. 4212 - 
wicepremier grzegorz kołodko spotkał się z szefem międzynarodowego funduszu walutowego horstem koehlerem i banku Światowego jimem wolfensohnem . 
### Existing MWEs: 
1- **spotkał się** (IReflV, 29)Tokens : 
spotkał
się
...
### Existing MWEs: 
1- **dostać się** (IReflV, 2)Tokens : 
dostać
się

### Identified MWEs: 
1- **dostać się** (IReflV)Tokens : 
dostać
się
...
### Existing MWEs: 
1- **znajdowali się** (IReflV, 56)Tokens : 
znajdowali
się
...
## Sentence No. 4226 - 
inna lawina w drefreggental we wschodnim tyrolu przysypała siedmioosobową grupę austriackich narciarzy , również poruszających się poza wyznaczonymi szlakami . 
### Existing MWEs: 
1- **poruszających się** (IReflV, 4)Tokens : 
poruszających
się

### Identified MWEs: 
1- **poruszających się** (IReflV)Tokens : 
poruszających
się

## Sentence No. 4227 - 
sześciu osobom udało się wydostać o własnych siłach . 
### Existing MWEs: 
1- **udało się** (IReflV, 49)Tokens : 
udało
się
...
## Sentence No. 4228 - 
jeden mężczyzna odniósł tak ciężkie obrażenia , że zmarł wkrótce po tym , kiedy ratownicy wydobyli go ze śniegu . 
### Existing MWEs: 
1- **odniósł obrażenia** (LVC, 6)Tokens : 
odniósł
obrażenia

### Identified MWEs: 
1- **odniósł obrażenia** (LVC)Tokens : 
odniósł
obrażenia

## Sentence No. 4229 - 
sejm zajmie się poselskim projektem nowelizacji ustawy o radzie ministrów na posiedzeniu w tym tygodniu . 
### Existing MWEs: 
1- **zajmie się** (IReflV, 11)Tokens : 
zajmie
się
...
### Existing MWEs: 
1- **podjęcia inicjatywy** (LVC)Tokens : 
podjęcia
inicjatywy
...
## Sentence No. 4243 - 
wydma nowodworska rozciągająca się w okolicach ul . poetów na białołęce jest wyjątkowa . 
### Existing MWEs: 
1- **rozciągająca się** (IReflV)Tokens : 
rozciągająca
się

## Sentence No. 4257 - 
będzie też można wziąć udział w konkursach , a także potańczyć i pośpiewać . 
### Existing MWEs: 
1- **wziąć udział** (LVC, 37)Tokens : 
wziąć
udział
...
## Sentence No. 4259 - 
niezwykle interesująca okazała się wizyta policjantów w mieszkaniach zatrzymanych . 
### Existing MWEs: 
1- **okazała się** (IReflV, 46)Tokens : 
okazała
się
...
## Sentence No. 4261 - 
wykonano ją chałupniczo , ale nie powstydził by się ich żaden fachowiec . 
### Existing MWEs: 
1- **powstydził się** (IReflV)Tokens : 
powstydził
się
...
### Existing MWEs: 
1- **zwracano uwagę** (ID, 5)Tokens : 
zwracano
uwagę

### Identified MWEs: 
1- **zwracano uwagę** (ID)Tokens : 
zwracano
uwagę

## Sentence No. 4273 - 
w prasie włoskiej pojawiły się niedawno pogłoski o czekającej go operacji wszczepienia protezy stawu kolanowego . 
### Existing MWEs: 
1- **pojawiły się** (IReflV, 54)Tokens : 
pojawiły
się
...
## Sentence No. 4282 - 
parlamentarzyści liczą sobie od 12 do 15 lat , pochodzą z czeskiego hradka , niemieckiego zittau oraz bogatyni , porajowa i sieniawki . 
### Existing MWEs: 
1- **liczą sobie** (IReflV)Tokens : 
liczą
sobie
...
### Existing MWEs: 
1- **zawarciu porozumienia** (LVC, 4)Tokens : 
zawarciu
porozumienia

## Sentence No. 4284 - 
witold sobociński , znakomity polski operator filmowy , absolwent i wykładowca łódzkiej pwsftvit , zostanie w tym roku uhonorowany specjalną nagrodą za całokształt twórczości , przyznaną przez amerykańskie stowarzyszenie operatorów filmowych . 
### Existing MWEs: 
1- **nagrodą przyznaną** (LVC, 2)Tokens : 
nagrodą
przyznaną

## Sentence No. 4291 - 
policja wciąż uważa , że " jędrzejowi " nie udało się opuścić naszego województwa . 
### Existing MWEs: 
1- **udało się** (IReflV, 49)Tokens : 
udało
się
...
### Existing MWEs: 
1- **złożyło zeznania** (LVC)Tokens : 
złożyło
zeznania

## Sentence No. 4318 - 
promocja netii dotyczy także połączeń lokalnych , międzymiastowych oraz międzynarodowych wykonywanych przez system telefonii internetowej ( voip ) . 
### Existing MWEs: 
1- **połączeń wykonywanych** (LVC)Tokens : 
połączeń
wykonywanych

## Sentence No. 4326 - 
podobnego zdania jest norwegia , trzeci po arabii saudyjskiej i rosji eksporter ropy . 
### Existing MWEs: 
1- **zdania jest** (LVC, 1)Tokens : 
zdania
jest

### Identified MWEs: 
1- **zdania jest** (LVC)Tokens : 
zdania
jest

## Sentence No. 4331 - 
opozycja domagała się wczoraj nawet 50 proc . 
### Existing MWEs: 
1- **domagała się** (IReflV, 22)Tokens : 
domagała
się
...
## Sentence No. 4333 - 
dziś prokuratura zdecyduje , czy wystąpić do sądu z wnioskiem o aresztowanie zatrzymanego wczoraj siódmego już podejrzanego - kierowcy jednej z karetek . 
### Existing MWEs: 
1- **wystąpić z wnioskiem** (LVC)Tokens : 
wystąpić
z
wnioskiem
...
### Existing MWEs: 
1- **zgodzili się** (IReflV, 13)Tokens : 
zgodzili
się
...
## Sentence No. 4362 - 
przeciwko noweli opowie się najprawdopodobniej cała opozycja . 
### Existing MWEs: 
1- **opowie się** (IReflV, 5)Tokens : 
opowie
się

### Identified MWEs: 
1- **opowie się** (IReflV)Tokens : 
opowie
się

## Sentence No. 4363 - 
w ostatnich dniach do parlamentu trafił także rządowy projekt zmiany ustawy o banku centralnym , który ma za zadanie dostosować nasze prawo do regulacji obowiązujących w unii europejskiej . 
### Existing MWEs: 
1- **ma za zadanie** (LVC, 1)Tokens : 
ma
za
zadanie

## Sentence No. 4378 - 
przez semestr studenci pilnie studiowali topografię parku , rysowali koncepcje i wykonywali odlewy . 
### Existing MWEs: 
1- **wykonywali odlewy** (LVC)Tokens : 
wykonywali
odlewy
...
## Sentence No. 4386 - 
wcześniej zarząd tvp sa wyraził zgodę na rozprowadzanie przez polsat programów publicznej telewizji w systemie bezprzewodowym . 
### Existing MWEs: 
1- **wyraził zgodę** (LVC)Tokens : 
wyraził
zgodę

## Sentence No. 4389 - 
do 31 grudnia byli robotnicy przymusowi , którzy w czasie ii wojny światowej byli zatrudnieni w placówkach kościoła katolickiego w niemczech , mogą składać wnioski o odszkodowania - przypomina fundacja polsko - niemieckie pojednanie . 
### Existing MWEs: 
1- **składać wnioski** (LVC, 2)Tokens : 
składać
wnioski

### Identified MWEs: 
1- **składać wnioski** (LVC)Tokens : 
składać
wnioski

## Sentence No. 4394 - 
jak się można było spodziewać , na mocno elastycznym torze nie brakowało niespodzianek , szczególnie na trzecich - czwartych miejscach . 
### Existing MWEs: 
1- **się spodziewać** (IReflV, 6)Tokens : 
się
spodziewać
...
## Sentence No. 4398 - 
z kolei rzecznik komisarza ds . poszerzenia ue guntera verheugena oświadczył , iż komisja europejska pozostaje ufna , że rozmowy o swobodnym przepływie kapitału da się zakończyć w czwartek . 
### Existing MWEs: 
1- **da się** (IReflV, 5)Tokens : 
da
się
...
### Existing MWEs: 
1- **zdarzające się** (IReflV, 10)Tokens : 
zdarzające
się

### Identified MWEs: 
1- **zdarzające się** (IReflV)Tokens : 
zdarzające
się

## Sentence No. 4407 - 
dlatego też kanclerz edmund stoiber był by chętniej widziany - pisała dpa , powołując się na koła rządowe w stolicy usa . 
### Existing MWEs: 
1- **powołując się** (IReflV, 8)Tokens : 
powołując
się
...
## Sentence No. 4408 - 
wpływowi amerykańscy politycy starają się jednak bagatelizować znaczenie napięć w stosunkach między usa a niemcami . 
### Existing MWEs: 
1- **starają się** (IReflV, 20)Tokens : 
starają
się
...
## Sentence No. 4411 - 
po 13 maja 2002 r . na przednim siedzeniu bez fotelików ochronnych będą mogły siedzieć również dzieci do 12 lat , które mają więcej niż 150 cm wzrostu . 
### Existing MWEs: 
1- **mają wzrostu** (LVC)Tokens : 
mają
wzrostu

## Sentence No. 4412 - 
powód był prosty - prezesi giełdowych spółek często większość swoich dochodów czerpią ze sprzedaży akcji firm , którym szefują . 
### Existing MWEs: 
1- **dochodów czerpią** (LVC)Tokens : 
dochodów
czerpią

## Sentence No. 4417 - 
umowy wejdą w życie , jeśli f-16 wygra przetarg , który powinien zostać rozstrzygnięty do końca tego roku . 
### Existing MWEs: 
1- **wejdą w życie** (ID, 7)Tokens : 
wejdą
w
życie

### Identified MWEs: 
1- **wejdą w życie** (ID)Tokens : 
wejdą
w
życie

2- **umowy wejdą w życie** (LVC)Tokens : 
umowy
wejdą
w
życie
...
## Sentence No. 4423 - 
nie przypomina też sobie , jak dostał się do mieszkania państwa p . , w którym strzelił do elżbiety p . 
### Existing MWEs: 
1- **dostał się** (IReflV, 2)Tokens : 
dostał
się
...
### Existing MWEs: 
1- **znajdował się** (IReflV, 56)Tokens : 
znajdował
się
...
## Sentence No. 4433 - 
sytuację starał się jeszcze załagodzić kanclerz gerhard schroder , pisząc wyjaśniający list do prezydenta busha . 
### Existing MWEs: 
1- **starał się** (IReflV, 20)Tokens : 
starał
się
...
### Existing MWEs: 
1- **interesują się** (IReflV, 5)Tokens : 
interesują
się

### Identified MWEs: 
1- **interesują się** (IReflV)Tokens : 
interesują
się

## Sentence No. 4443 - 
wyjaśnił także , że są już przygotowane stosowne zapisy nowelizujące ustawy , jednak nie wiadomo , kiedy mogły by wejść w życie . 
### Existing MWEs: 
1- **wejść w życie** (ID, 7)Tokens : 
wejść
w
życie

### Identified MWEs: 
1- **wejść w życie** (ID)Tokens : 
wejść
w
życie

## Sentence No. 4451 - 
w szczecinie , z inicjatywy urzędu marszałkowskiego sejmiku wojewódzkiego i ozb , ma powstać młodzieżowy polsko - niemiecki ośrodek pięściarski , w którym znaleźć by się mogli także przedstawiciele tzw . trudnej młodzieży . 
### Existing MWEs: 
1- **znaleźć się** (IReflV, 31)Tokens : 
znaleźć
się
...
## Sentence No. 4457 - 
z tego typu zaufania pacjenta cierpiącego na zaburzenia erekcji wyłączone są jednak pielęgniarki . 
### Existing MWEs: 
1- **cierpiącego na zaburzenia** (LVC, 1)Tokens : 
cierpiącego
na
zaburzenia

### Identified MWEs: 
1- **cierpiącego na zaburzenia** (LVC)Tokens : 
cierpiącego
na
zaburzenia

## Sentence No. 4458 - 
z lekarskich statystyk wynika , że problemy z erekcją ma - przynajmniej od czasu do czasu - ponad połowa czechów w wieku ponad 40 lat . 
### Existing MWEs: 
1- **problemy ma** (LVC, 2)Tokens : 
problemy
ma

## Sentence No. 4461 - 
według cnn , policja przychyla się do wersji ładunku wybuchowego pozostawionego w ręcznej torbie w bufecie , gdzie było tłoczno . 
### Existing MWEs: 
1- **przychyla się** (IReflV)Tokens : 
przychyla
się

## Sentence No. 4467 - 
w tym tygodniu aleksander kwaśniewski podejmie decyzję w sprawie ustaw podatkowych - poinformował wczoraj prezydencki prawnik ryszard kalisz . 
### Existing MWEs: 
1- **podejmie decyzję** (LVC, 12)Tokens : 
podejmie
decyzję
...
## Sentence No. 4469 - 
" prezydent zamierza podjąć decyzję jeszcze w tym tygodniu . 
### Existing MWEs: 
1- **podjąć decyzję** (LVC, 12)Tokens : 
podjąć
decyzję
...
## Sentence No. 4474 - 
zeznania składał powołany przez oskarżyciela świadek , władimir p . , ukrainiec zamieszkujący czasowo w pile . 
### Existing MWEs: 
1- **zeznania składał** (LVC, 1)Tokens : 
zeznania
składał

### Identified MWEs: 
1- **składał powołany** (LVC)Tokens : 
składał
powołany

2- **zeznania składał powołany** (LVC)Tokens : 
zeznania
składał
powołany
...
## Sentence No. 4476 - 
zdaniem dyrekcji centrum kształcenia ustawicznego w krakowie , przestępstwa dopuścił się uczeń , który w wypracowaniu na temat : " opisz w dowolnej formie swoją pasję " opisał siebie i nauczycielkę . 
### Existing MWEs: 
1- **dopuścił się** (IReflV, 2)Tokens : 
dopuścił
się

### Identified MWEs: 
1- **dopuścił się** (IReflV)Tokens : 
dopuścił
się

## Sentence No. 4486 - 
na jej parkiecie można będzie rozgrywać mecze koszykówki , siatkówki , piłki ręcznej i tenisa . 
### Existing MWEs: 
1- **rozgrywać mecze** (LVC, 1)Tokens : 
rozgrywać
mecze
...
### Existing MWEs: 
1- **w rachubę wchodzi** (ID)Tokens : 
w
rachubę
wchodzi

## Sentence No. 4491 - 
po pierwszych oględzinach doszli do wniosku , że nie budzi zastrzeżeń . 
### Existing MWEs: 
...
### Identified MWEs: 
1- **doszli do wniosku** (LVC)Tokens : 
doszli
do
wniosku

## Sentence No. 4511 - 
zastępca rzecznika interesu publicznego krzysztof kauba wniesie apelację . 
### Existing MWEs: 
1- **wniesie apelację** (LVC)Tokens : 
wniesie
apelację

## Sentence No. 4518 - 
szpital , znany ze swej działalności w całej polsce , ma podpisane umowy o udzielanie świadczeń zdrowotnych z kasami chorych : zachodniopomorską , branżową i lubuską . 
### Existing MWEs: 
1- **udzielanie świadczeń** (LVC, 1)Tokens : 
udzielanie
świadczeń

### Identified MWEs: 
1- **udzielanie świadczeń** (LVC)Tokens : 
udzielanie
świadczeń

## Sentence No. 4519 - 
jako jedyny w województwie wykonuje operacje nowotworów płuc oraz urazów kręgosłupa . 
### Existing MWEs: 
1- **wykonuje operacje** (LVC, 1)Tokens : 
wykonuje
operacje

## Sentence No. 4522 - 
można otrzymać pożyczkę na indywidualną działalność gospodarczą . 
### Existing MWEs: 
1- **otrzymać pożyczkę** (LVC)Tokens : 
otrzymać
pożyczkę

## Sentence No. 4527 - 
agencja nie ma jednak własnych magazynów i ponosi koszty związane z przechowywaniem zapasów . 
### Existing MWEs: 
1- **ponosi koszty** (LVC)Tokens : 
ponosi
koszty
...
## Sentence No. 4531 - 
wśród nich są dwie , które widziały i mogły mieć kontakt ze sprawcami napadu . 
### Existing MWEs: 
1- **mieć kontakt** (LVC, 4)Tokens : 
mieć
kontakt

### Identified MWEs: 
1- **mieć kontakt** (LVC)Tokens : 
mieć
kontakt

## Sentence No. 4533 - 
jego kierowca i 3 kolejnych pasażerów oraz 4 jadących autobusem znalazło się w szpitalu . 
### Existing MWEs: 
1- **znalazło się** (IReflV, 31)Tokens : 
znalazło
się
...
## Sentence No. 4539 - 
miasto postanowiło przyjrzeć się sposobowi gospodarowania placówką . 
### Existing MWEs: 
1- **przyjrzeć się** (IReflV, 2)Tokens : 
przyjrzeć
się
...
### Existing MWEs: 
1- **zdecydowało się** (IReflV, 11)Tokens : 
zdecydowało
się
...
## Sentence No. 4549 - 
będą się zatem wyróżniać w tłumie funkcjonariuszy , którzy mają pilnować porządku podczas mińskich uroczystości dnia milicji - 4 marca . 
### Existing MWEs: 
1- **się wyróżniać** (IReflV)Tokens : 
się
wyróżniać

## Sentence No. 4556 - 
wstępną odpowiedź firma ma dać w ciągu dwóch tygodni . 
### Existing MWEs: 
1- **odpowiedź dać** (LVC)Tokens : 
odpowiedź
dać

## Sentence No. 4557 - 
faurecia jest światowym koncernem zajmującym się produkcją wyposażenia do wszelkich typów samochodów , m.in . foteli , elementów kokpitów , paneli drzwiowych oraz wyciszenia aut . 
### Existing MWEs: 
1- **zajmującym się** (IReflV, 34)Tokens : 
zajmującym
się

### Identified MWEs: 
1- **zajmującym się** (IReflV)Tokens : 
zajmującym
się
...
## Sentence No. 4566 - 
w komitecie wspierającym odbudowę parku znalazła się m.in . maria wodzyńska - walicka , ambasador polski w holandii oraz prezydenci partnerskich miast cor de vos oraz janusz grobel . 
### Existing MWEs: 
...
## Sentence No. 4589 - 
zgodnie z przepisami rozporządzenia - osoba kontrolująca prawidłowość wykorzystania przez pracownika lekarskiego zwolnienia od pracy jest uprawniona do wykonywania kontroli w miejscu zamieszkania , miejscu czasowego pobytu lub w miejscu zatrudnienia osoby kontrolowanej . 
### Existing MWEs: 
1- **wykonywania kontroli** (LVC)Tokens : 
wykonywania
kontroli
...
## Sentence No. 4592 - 
tylko podczas jednej kontroli , przeprowadzonej przez niemiecką policję w lipcu bieżącego roku w hesji , stwierdzono , że 214 niemieckich rodzin zatrudniało polki " na czarno " . 
### Existing MWEs: 
...
## Sentence No. 4594 - 
5 września br . " kurier " informował o pojawieniu się w tym antykwariacie listów ( autorstwa adama mickiewicza i zygmunta krasińskiego ) i wiersza juliusza słowackiego . 
### Existing MWEs: 
1- **pojawieniu się** (IReflV, 54)Tokens : 
pojawieniu
się
...
## Sentence No. 4597 - 
o oprocentowaniu rat nie ma mowy , ponieważ to wyznacza ustawa o gospodarce nieruchomościami . 
### Existing MWEs: 
1- **nie ma mowy** (ID, 4)Tokens : 
nie
ma
...
### Identified MWEs: 
1- **ma mowy** (LVC)Tokens : 
ma
mowy

2- **nie ma mowy** (ID)Tokens : 
nie
ma
mowy

## Sentence No. 4601 - 
podobną akcję przeprowadzono w czasie wojny w zatoce perskiej w 1990 r . 
### Existing MWEs: 
1- **akcję przeprowadzono** (LVC)Tokens : 
akcję
przeprowadzono

## Sentence No. 4612 - 
sprawą zajęła się już prokuratura w gryficach . 
### Existing MWEs: 
1- **zajęła się** (IReflV, 11)Tokens : 
zajęła
się
...
## Sentence No. 4613 - 
w trakcie kontroli zasadności wystawiania recept refundowanych przez zachodniopomorską regionalną kasę chorych okazało się , że dwaj lekarze z trzebiatowa wystawili recepty pacjentom nie leczącym się hormonalnie . 
### Existing MWEs: 
1- **okazało się** (IReflV, 46)Tokens : 
okazało
się
...
## Sentence No. 4624 - 
takie prawo mają wyłącznie partie polityczne i komitety wyborcze obywateli . 
### Existing MWEs: 
1- **prawo mają** (LVC, 1)Tokens : 
prawo
mają
...
## Sentence No. 4626 - 
funkcjonariusze dodają również , że bardzo rzadko zdarza się , aby system monitoringu chronił nie tylko sklepowy towar , ale także klientów . 
### Existing MWEs: 
1- **zdarza się** (IReflV, 10)Tokens : 
zdarza
się
...
## Sentence No. 4627 - 
papież w obecności trzech tysięcy indian , kardynałów i biskupów z całej ameryki Łacińskiej oraz prezydenta meksyku , vincente foxa , dokonał wczoraj w meksykańskiej stolicy historycznego aktu kanonizacji pierwszego indiańskiego świętego , juana diego . 
### Existing MWEs: 
1- **dokonał aktu** (LVC)Tokens : 
dokonał
aktu
