...
### Existing MWEs: 
1- **έρχεται σε σύγκρουση** (LVC, 2)Tokens : 
έρχεται
σε
σύγκρουση
...
2- **πάρουν πρωτοβουλία** (LVC, 1)Tokens : 
πάρουν
πρωτοβουλία

### Identified MWEs: 
1- **πάρουν την πρωτοβουλία** Tokens : 
πάρουν
την
πρωτοβουλία
...
2- **κάνουμε τα στραβά μάτια** (ID, 5)Tokens : 
κάνουμε
τα
στραβά
μάτια
...
### Existing MWEs: 
1- **ληφθεί υπόψη** (ID, 9)Tokens : 
ληφθεί
υπόψη

2- **μέτρων ληφθούν** (ID, 4)Tokens : 
μέτρων
ληφθούν
...
### Existing MWEs: 
2- **έχουν να κάνουν** (ID, 10)Tokens : 
έχουν
να
κάνουν

1- **πάρουμε αποφάσεις** (LVC, 10)Tokens : 
πάρουμε
αποφάσεις
...
1- **έχουν στη διάθεσή τους** (LVC, 1)Tokens : 
έχουν
στη
διάθεσή
τους
...
2- **δώσει εξηγήσεις** (LVC, 2)Tokens : 
δώσει
εξηγήσεις
...
2- **κλείνονται στον εαυτό τους** (ID, 1)Tokens : 
κλείνονται
στον
εαυτό
τους
...
### Existing MWEs: 
1- **Παίρνοντας τον λόγο** (ID, 1)Tokens : 
Παίρνοντας
τον
λόγο
...
### Existing MWEs: 
1- **κάνει τα αδύνατα δυνατά** (ID, 2)Tokens : 
κάνει
τα
αδύνατα
δυνατά
...
### Identified MWEs: 
1- **κάνει τα αδύνατα δυνατά** Tokens : 
κάνει
τα
αδύνατα
δυνατά
...
### Existing MWEs: 
1- **κλειστεί στον εαυτό του** (ID, 1)Tokens : 
κλειστεί
στον
εαυτό
του
...
### Existing MWEs: 
1- **θέτει υπό αμφισβήτηση** (LVC, 1)Tokens : 
θέτει
υπό
αμφισβήτηση
...
### Existing MWEs: 
1- **δόθηκαν εντολές** (LVC, 9)Tokens : 
δόθηκαν
εντολές
...
### Existing MWEs: 
1- **πέφτουν στα χέρια** (ID, 2)Tokens : 
πέφτουν
στα
χέρια
...
### Existing MWEs: 
1- **πάρει αποφάσεις** (LVC, 10)Tokens : 
πάρει
αποφάσεις
...
### Existing MWEs: 
1- **λαμβάνεται υπόψιν** (ID, 9)Tokens : 
λαμβάνεται
υπόψιν
...
### Existing MWEs: 
1- **συνάντηση είχε** (LVC, 1)Tokens : 
συνάντηση
είχε

### Identified MWEs: 
1- **συνάντηση είχε** Tokens : 
συνάντηση
είχε
...
### Existing MWEs: 
1- **πήραμε αποφάσεις** (LVC, 10)Tokens : 
πήραμε
αποφάσεις
...
### Existing MWEs: 
1- **πατάει σε δύο βάρκες** (ID, 1)Tokens : 
πατάει
σε
δύο
βάρκες
...
### Existing MWEs: 
1- **παίρνουν κουράγιο** (LVC, 1)Tokens : 
παίρνουν
κουράγιο
...
### Existing MWEs: 
1- **πραγματοποιήσει συναντήσεις** (LVC)Tokens : 
πραγματοποιήσει
συναντήσεις

### Identified MWEs: 
1- **πραγματοποιήσει συναντήσεις** Tokens : 
πραγματοποιήσει
συναντήσεις
...
### Existing MWEs: 
1- **φέρουμε σε πέρας** (LVC, 3)Tokens : 
φέρουμε
σε
πέρας

### Identified MWEs: 
1- **φέρουμε σε πέρας** Tokens : 
φέρουμε
σε
πέρας
...
### Existing MWEs: 
1- **τίθεται ερώτημα** (LVC, 3)Tokens : 
τίθεται
ερώτημα
...
### Existing MWEs: 
1- **λάδι στην φωτιά ρίχνουν** (ID, 2)Tokens : 
λάδι
στην
φωτιά
ρίχνουν
...
### Existing MWEs: 
1- **παρέχει ″χείρα βοηθείας″** (ID, 1)Tokens : 
παρέχει
″χείρα
βοηθείας″
...
### Existing MWEs: 
1- **έκανε δημοσίευση** (LVC, 3)Tokens : 
έκανε
δημοσίευση
...
### Existing MWEs: 
1- **παίρνουν απόφαση** (LVC, 10)Tokens : 
παίρνουν
απόφαση
...
### Existing MWEs: 
1- **διατρέχει κίνδυνο** (LVC, 1)Tokens : 
διατρέχει
κίνδυνο
...
### Existing MWEs: 
1- **έχουμε να κάνουμε** (OTH, 10)Tokens : 
έχουμε
να
κάνουμε
...
### Existing MWEs: 
1- **κάνουμε προσπάθεια** (LVC, 3)Tokens : 
κάνουμε
προσπάθεια
...
### Existing MWEs: 
1- **αδράξουν την ευκαιρία** (ID, 1)Tokens : 
αδράξουν
την
ευκαιρία
...
### Existing MWEs: 
1- **δοθεί στη δημοσιότητα** (LVC, 10)Tokens : 
δοθεί
στη
δημοσιότητα
...
### Existing MWEs: 
1- **κάνοντας προσπάθεια** (LVC, 3)Tokens : 
κάνοντας
προσπάθεια
...
### Existing MWEs: 
1- **κάνουμε αναφορά** (LVC, 5)Tokens : 
κάνουμε
αναφορά
...
### Existing MWEs: 
1- **ανοίγει τον δρόμο** (ID, 8)Tokens : 
ανοίγει
τον
δρόμο
...
### Existing MWEs: 
1- **δώσει το πράσινο φως** (ID, 1)Tokens : 
δώσει
το
πράσινο
φως
...
### Existing MWEs: 
1- **τεθεί σε εφαρμογή** (LVC, 5)Tokens : 
τεθεί
σε
εφαρμογή
...
### Existing MWEs: 
1- **το έβαζε στα πόδια** (ID, 1)Tokens : 
το
έβαζε
στα
πόδια
...
### Existing MWEs: 
1- **έδινε στη δημοσιότητα** (LVC, 10)Tokens : 
έδινε
στη
δημοσιότητα
...
### Existing MWEs: 
1- **κερδίζουν έδαφος** (ID, 1)Tokens : 
κερδίζουν
έδαφος
...
### Existing MWEs: 
1- **θέσει σε λειτουργία** (LVC, 2)Tokens : 
θέσει
σε
λειτουργία
...
### Identified MWEs: 
1- **άφησε τη σφραγίδα του** Tokens : 
άφησε
τη
σφραγίδα
του
...
### Existing MWEs: 
1- **πάρετε απόφαση** (LVC, 10)Tokens : 
πάρετε
απόφαση
...
### Existing MWEs: 
1- **κόβει την ανάσα** (ID, 1)Tokens : 
κόβει
την
ανάσα

### Identified MWEs: 
1- **κόβει την ανάσα** Tokens : 
κόβει
την
ανάσα
...
### Existing MWEs: 
1- **κάνουμε μεταρρύθμιση** (LVC, 1)Tokens : 
κάνουμε
μεταρρύθμιση
...
### Existing MWEs: 
1- **αποφάσεις ληφθούν** (LVC, 4)Tokens : 
αποφάσεις
ληφθούν
...
### Existing MWEs: 
1- **κάνουν ψηφοφορία** (LVC, 1)Tokens : 
κάνουν
ψηφοφορία
...
### Existing MWEs: 
1- **δίνουν συνέχεια** (LVC, 4)Tokens : 
δίνουν
συνέχεια
...
### Existing MWEs: 
1- **θέτει σε κίνδυνο** (LVC, 4)Tokens : 
θέτει
σε
κίνδυνο
...
### Existing MWEs: 
1- **ασκήσει ποινική δίωξη** (LVC, 1)Tokens : 
ασκήσει
ποινική
δίωξη
...
### Existing MWEs: 
1- **κάνει μετρήσεις** (LVC, 1)Tokens : 
κάνει
μετρήσεις
...
### Existing MWEs: 
1- **γίνει πραγματικότητα** (LVC)Tokens : 
γίνει
πραγματικότητα
...
### Existing MWEs: 
1- **και οι πέτρες γνώριζαν** (OTH)Tokens : 
και
οι
πέτρες
γνώριζαν
...
### Existing MWEs: 
1- **λαμβάνεται υπόψη** (ID, 9)Tokens : 
λαμβάνεται
υπόψη

### Identified MWEs: 
1- **λαμβάνεται ποσό** Tokens : 
λαμβάνεται
ποσό

2- **λαμβάνεται υπόψη** Tokens : 
λαμβάνεται
υπόψη
...
### Existing MWEs: 
1- **ανοίγει το δρόμο** (ID, 8)Tokens : 
ανοίγει
το
δρόμο

### Identified MWEs: 
1- **ανοίγει το δρόμο** Tokens : 
ανοίγει
το
δρόμο
...
### Existing MWEs: 
1- **ακολούθησαν πορεία** (LVC)Tokens : 
ακολούθησαν
πορεία
