...
### Existing MWEs: 
1- **prisiimti įsipareigojimų** (LVC)
## Sentence No. 2759 - 
...
### Existing MWEs: 
1- **kiekvienas kvailys žino** (ID)
## Sentence No. 3100 - 
Taigi švietimas , atsidūręs kreivųjų veidrodžių karalystėje , dūžta .
### Existing MWEs: 
1- **atsidūręs kreivųjų veidrodžių karalystėje ,** (ID)
## Sentence No. 3129 - 
...
### Existing MWEs: 
1- **braunasi ne į savo daržą** (ID)
## Sentence No. 3174 - 
„ Roko naktų “ žvaigždės „ Queen Kwong “ : mūsų vokalistė bet kam išspardytų užpakalius !
### Existing MWEs: 
1- **išspardytų užpakalius** (ID)
## Sentence No. 3199 - 
Atiduodu visą save .
### Existing MWEs: 
1- **Atiduodu visą save** (ID)
## Sentence No. 3210 - 
...
### Existing MWEs: 
1- **priėmusi sprendimo** (LVC)
## Sentence No. 3990 - 
Londono Sitis kraunasi lagaminus .
### Existing MWEs: 
1- **kraunasi lagaminus** (ID, 1)
### Identified MWEs: 
1- **kraunasi lagaminus** (OTH)
## Sentence No. 4000 - 
...
### Existing MWEs: 
1- **susikrauti lagaminus** (ID)
### Identified MWEs: 
1- **turint galvoje** (OTH)
## Sentence No. 4050 - 
...
### Existing MWEs: 
1- **sėdėjome tarsi ant parako statinės** (ID)
## Sentence No. 4192 - 
