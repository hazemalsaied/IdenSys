...
### Existing MWEs: 
1- **λαμβάνουν υπόψη** (LVC, 11)
2- **λαμβάνουν υπόψη** (LVC, 11)
### Identified MWEs: 
1- **λαμβάνουν υπόψη** (OTH)
...
### Existing MWEs: 
2- **έδειξαν ανοχή** (LVC)
1- **κάνουν υπομονή** (LVC)
### Identified MWEs: 
1- **κάνουν υπομονή** (OTH)
## Sentence No. 2844 - 
« Μου έκανε εντύπωση ότι ήταν ζεστός άνθρωπος και είχε εξαιρετική λαϊκή αποδοχή » . 
### Existing MWEs: 
1- **έκανε εντύπωση** (LVC, 2)
2- **είχε αποδοχή** (LVC)
### Identified MWEs: 
1- **έκανε εντύπωση** (OTH)
## Sentence No. 2914 - 
...
### Existing MWEs: 
1- **κρατηθούν στη ζωή** (ID)
2- **έχει εμπιστοσύνη** (LVC)
## Sentence No. 2924 - 
...
### Existing MWEs: 
1- **είναι σε επαφή** (LVC, 2)
2- **εξαχθούν συμπεράσματα** (LVC)
## Sentence No. 3034 - 
...
### Existing MWEs: 
1- **κινούν τα νήματα** (ID, 2)
2- **κάνουν περιουσίες** (ID, 1)
### Identified MWEs: 
...
### Existing MWEs: 
1- **Κάνοντας λόγο** (LVC, 24)
2- **δώσαμε μάχες** (LVC, 10)
### Identified MWEs: 
1- **Κάνοντας λόγο** (OTH)
2- **δώσαμε μάχες** (OTH)
3- **δώσαμε ανάσα** (OTH)
...
### Existing MWEs: 
1- **έδωσαν μάχη** (LVC, 10)
2- **κρατήσουν στη ζωή** (ID)
### Identified MWEs: 
1- **έδωσαν μάχη** (OTH)
## Sentence No. 3050 - 
...
### Existing MWEs: 
1- **κάνει επίκληση** (LVC, 1)
### Identified MWEs: 
1- **κάνει επίκληση** (OTH)
## Sentence No. 2112 - 
...
### Existing MWEs: 
1- **πραγματοποιήσουν επίθεση** (LVC, 1)
### Identified MWEs: 
1- **πραγματοποιήσουν επίθεση** (OTH)
## Sentence No. 2163 - 
...
### Existing MWEs: 
1- **δέσμευση έδωσε** (LVC)
### Identified MWEs: 
1- **έδωσε υπουργός** (OTH)
## Sentence No. 2220 - 
...
### Existing MWEs: 
1- **πραγματοποιηθεί τηλεφωνικές επικοινωνίες** (LVC)
## Sentence No. 2256 - 
...
### Existing MWEs: 
1- **βρίσκονται σε επικοινωνία** (LVC)
### Identified MWEs: 
1- **βρίσκονται σε επικοινωνία** (OTH)
## Sentence No. 2267 - 
...
### Existing MWEs: 
1- **έχει ικανότητα διαπραγματευτική** (LVC)
## Sentence No. 2268 - 
...
### Existing MWEs: 
1- **τίθεται επί τάπητος** (LVC, 1)
### Identified MWEs: 
1- **λάμβανε μήνυμα** (OTH)
2- **τίθεται επί τάπητος** (OTH)
## Sentence No. 2301 - 
...
### Existing MWEs: 
1- **συνεδρίαση πραγματοποιήθηκε** (LVC)
## Sentence No. 2303 - 
...
### Existing MWEs: 
1- **κάνοντας μνεία** (LVC, 1)
### Identified MWEs: 
1- **κάνοντας μνεία** (OTH)
## Sentence No. 2334 - 
...
### Existing MWEs: 
1- **κάνει μαθήματά** (LVC, 2)
### Identified MWEs: 
1- **κάνει μαθήματά** (OTH)
## Sentence No. 2515 - 
...
### Existing MWEs: 
1- **λάδι στην φωτιά ρίχνουν** (ID, 1)
### Identified MWEs: 
...
### Existing MWEs: 
1- **τίθεται εν αμφιβόλω** (ID, 1)
### Identified MWEs: 
1- **τίθεται εν αμφιβόλω** (OTH)
## Sentence No. 2524 - 
...
### Existing MWEs: 
1- **λαμβανομένων υπόψη** (ID)
### Identified MWEs: 
1- **βρίσκονται προ των πυλών** (OTH)
## Sentence No. 2532 - 
...
### Existing MWEs: 
1- **ανοίξει τα χαρτιά της** (ID, 1)
### Identified MWEs: 
1- **ανοίξει τα χαρτιά της** (OTH)
## Sentence No. 2588 - 
...
### Existing MWEs: 
1- **δώσουμε χέρι βοηθείας** (ID)
### Identified MWEs: 
1- **δώσουμε χέρι βοηθείας** (OTH)
## Sentence No. 2592 - 
...
### Existing MWEs: 
1- **ελάμβανε αποφάσεις** (LVC, 8)
### Identified MWEs: 
1- **ελάμβανε αποφάσεις** (OTH)
## Sentence No. 2600 - 
...
### Existing MWEs: 
1- **θέτουν σε κίνδυνο** (LVC, 4)
### Identified MWEs: 
1- **θέτουν σε κίνδυνο** (OTH)
## Sentence No. 2794 - 
...
### Existing MWEs: 
1- **κάνει κωλοτούμπα** (ID)
### Identified MWEs: 
1- **κάνει κωλοτούμπα** (OTH)
## Sentence No. 2856 - 
...
### Identified MWEs: 
1- **έβαλαν φωτιά** (OTH)
2- **δόθηκαν στην δημοσιότητα** (OTH)
## Sentence No. 2875 - 
...
### Existing MWEs: 
1- **έχουν ανάγκη** (LVC, 6)
### Identified MWEs: 
1- **έχουν ανάγκη** (OTH)
## Sentence No. 2904 - 
Εκεί έκανε τις δηλώσεις – απάντηση στο ΔΝΤ . 
### Existing MWEs: 
1- **έκανε δηλώσεις** (LVC, 11)
### Identified MWEs: 
1- **έκανε δηλώσεις** (OTH)
## Sentence No. 2906 - 
...
### Existing MWEs: 
1- **Είμαι σε επαφή** (LVC, 2)
### Identified MWEs: 
1- **Είμαι σε επαφή** (OTH)
## Sentence No. 2943 - 
...
### Existing MWEs: 
1- **κρούουν τον κώδωνα του κινδύνου** (ID, 1)
### Identified MWEs: 
...
### Existing MWEs: 
1- **βάζουν στο στόχαστρό τους** (LVC)
### Identified MWEs: 
1- **βάζουν στο στόχαστρό τους** (OTH)
## Sentence No. 3104 - 
...
### Existing MWEs: 
1- **δόθηκε στη δημοσιότητα** (LVC, 9)
### Identified MWEs: 
1- **δόθηκε στη δημοσιότητα** (OTH)
## Sentence No. 3106 - 
...
### Existing MWEs: 
1- **ασκούν επίδραση** (LVC, 1)
### Identified MWEs: 
1- **ασκούν επίδραση** (OTH)
## Sentence No. 3124 - 
