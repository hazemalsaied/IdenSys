...
### Existing MWEs: 
1- **πήρε διάσταση** (LVC, 3)
2- **πάρετε αποφάσεις** (LVC, 13)
### Identified MWEs: 
1- **πήρε διάσταση** (OTH)
...
2- **θολώσει τα νερά** (ID, 1)
### Identified MWEs: 
1- **θολώσει τα νερά** (OTH)
## Sentence No. 213 - 
...
### Existing MWEs: 
1- **δώσει γραμμή** (ID)
2- **δίνει γραμμή** (ID), Interleaving 
## Sentence No. 228 - 
...
### Existing MWEs: 
1- **μέτρα λαμβάνονται** (ID, 4)
2- **εισηγήσεις έκανε** (LVC)
### Identified MWEs: 
1- **μέτρα λαμβάνονται** (OTH)
2- **έκανε αστυνομία** (OTH)
## Sentence No. 259 - 
...
### Existing MWEs: 
1- **παίρνει το μέρος** (ID, 2)
2- **παίρνουν μέρος** (ID, 3), DistributedEmbedding 
### Identified MWEs: 
1- **παίρνει το μέρος** (OTH)
2- **παίρνουν μέρος** (OTH)
## Sentence No. 299 - 
...
### Existing MWEs: 
1- **κάνει ανατροπή** (LVC)
2- **πάρει το εισιτήριο** (ID)
### Identified MWEs: 
1- **κάνει ανατροπή** (OTH)
2- **πάρει το εισιτήριο** (OTH)
## Sentence No. 405 - 
...
### Existing MWEs: 
1- **παίρνουν νίκες** (LVC)
2- **παίρνουν το εισιτήριο** (ID)
## Sentence No. 495 - 
...
### Existing MWEs: 
1- **ελάμβαναν μέρος** (ID, 7)
2- **έπαιζαν ρόλο** (ID, 12)
### Identified MWEs: 
...
### Existing MWEs: 
1- **έκανε πρεμιέρα** (LVC, 1)
2- **έκανε εισπράξεις** (LVC, 1)
### Identified MWEs: 
1- **έκανε πρεμιέρα** (OTH)
2- **έκανε εισπράξεις** (OTH)
## Sentence No. 3 - 
...
### Existing MWEs: 
1- **βάλει υπογραφή** (LVC, 1)
### Identified MWEs: 
1- **βάλει υπογραφή** (OTH)
## Sentence No. 17 - 
...
### Existing MWEs: 
1- **δώσουν μάχη** (LVC, 13)
### Identified MWEs: 
1- **δώσουν σε ημέρες** (OTH)
## Sentence No. 34 - 
...
### Existing MWEs: 
1- **παίζουν στα δάχτυλα** (ID)
### Identified MWEs: 
1- **παίζουν στα δάχτυλα** (OTH)
## Sentence No. 39 - 
...
### Existing MWEs: 
1- **παίρνουν άφεση αμαρτιών** (ID)
### Identified MWEs: 
1- **παίρνουν άφεση αμαρτιών** (OTH)
## Sentence No. 41 - 
...
### Existing MWEs: 
1- **καταλήγουν στο συμπέρασμα** (LVC, 2)
## Sentence No. 42 - 
...
### Existing MWEs: 
1- **έδωσε στη δημοσιότητα** (LVC, 11)
### Identified MWEs: 
...
### Existing MWEs: 
1- **Άφεση αμαρτιών δίνει** (ID, 1)
### Identified MWEs: 
1- **Άφεση αμαρτιών δίνει** (OTH)
## Sentence No. 115 - 
...
### Existing MWEs: 
1- **κινήθηκε στο ίδιο μήκος κύματος** (ID)
## Sentence No. 127 - 
...
### Existing MWEs: 
1- **έκανε επίκληση** (LVC, 2)
### Identified MWEs: 
1- **έκανε επίκληση** (OTH)
## Sentence No. 137 - 
...
### Existing MWEs: 
1- **Είμαι σε θέση** (ID, 5)
### Identified MWEs: 
1- **δώσει λεπτομέρειες** (OTH)
## Sentence No. 162 - 
...
### Existing MWEs: 
1- **βρίσκονται σε διαβουλεύσεις** (LVC)
### Identified MWEs: 
1- **βρίσκονται σε διαβουλεύσεις** (OTH)
## Sentence No. 167 - 
...
### Existing MWEs: 
1- **εντολή έδωσε** (LVC, 1)
### Identified MWEs: 
1- **έδωσε εισαγγελέας** (OTH)
## Sentence No. 220 - 
...
### Existing MWEs: 
1- **έπεσε στα χέρια** (ID)
### Identified MWEs: 
1- **έπεσε στα χέρια** (OTH)
## Sentence No. 341 - 
...
### Existing MWEs: 
1- **έρχεται αντιμέτωπος** (LVC, 3)
### Identified MWEs: 
1- **έρχεται αντιμέτωπος** (OTH)
## Sentence No. 407 - 
...
### Existing MWEs: 
1- **κάνει εμφανίσεις** (LVC, 3)
### Identified MWEs: 
1- **κάνει εμφανίσεις** (OTH)
## Sentence No. 426 - 
...
### Existing MWEs: 
1- **πιάνει δουλειά** (ID, 1)
### Identified MWEs: 
1- **πιάνει δουλειά** (OTH)
## Sentence No. 468 - 
...
### Existing MWEs: 
1- **έκανε μαθήματα** (LVC, 1)
### Identified MWEs: 
1- **έκανε μαθήματα** (OTH)
## Sentence No. 497 - 
...
### Existing MWEs: 
1- **δίνουν στα νεύρα** (LVC)
### Identified MWEs: 
1- **δίνουν στα νεύρα** (OTH)
## Sentence No. 520 - 
...
### Existing MWEs: 
1- **κλειστεί στον εαυτό του** (ID, 2)
## Sentence No. 528 - 
...
### Existing MWEs: 
1- **έθεταν υπό την προστασία τους** (LVC)
## Sentence No. 539 - 
...
### Existing MWEs: 
1- **είχαν στην κατοχή τους** (OTH)
### Identified MWEs: 
1- **είχαν στην κατοχή** (OTH)
## Sentence No. 556 - 
...
### Existing MWEs: 
1- **έπαιξε το χαρτί** (ID)
### Identified MWEs: 
1- **έπαιξε με προσοχή** (OTH)
## Sentence No. 575 - 
...
### Existing MWEs: 
1- **τον τόνο έδωσαν** (ID)
### Identified MWEs: 
1- **έδωσαν πολιτικής** (OTH)
## Sentence No. 579 - 
...
### Existing MWEs: 
1- **νερό έχει κυλήσει κάτω από τις γέφυρες του Μόσκοβα** (ID)
## Sentence No. 581 - 
...
### Existing MWEs: 
1- **κάνει ετοιμασίες** (LVC)
### Identified MWEs: 
1- **κάνει ετοιμασίες** (OTH)
## Sentence No. 587 - 
...
### Existing MWEs: 
1- **ήρθε σε σύγκρουση** (LVC, 2)
### Identified MWEs: 
1- **ήρθε σε σύγκρουση** (OTH)
## Sentence No. 591 - 
...
### Existing MWEs: 
1- **λάμβαναν υπόψη** (ID, 11)
### Identified MWEs: 
1- **λάμβαναν υπόψη** (OTH)
## Sentence No. 601 - 
...
### Existing MWEs: 
1- **λαμβάνει διαστάσεις** (LVC, 2)
### Identified MWEs: 
1- **λαμβάνει διαστάσεις** (OTH)
## Sentence No. 603 - 
...
### Existing MWEs: 
1- **τέθηκε σε εφαρμογή** (LVC, 5)
### Identified MWEs: 
1- **τέθηκε σε εφαρμογή** (OTH)
## Sentence No. 664 - 
...
### Existing MWEs: 
1- **έκαναν την εμφάνισή τους** (LVC, 1)
### Identified MWEs: 
1- **έκαναν εμφάνισή** (OTH)
## Sentence No. 690 - 
...
### Existing MWEs: 
1- **Έχοντας τον έλεγχο** (LVC, 2)
### Identified MWEs: 
1- **Έχοντας τον έλεγχο** (OTH)
## Sentence No. 692 - 
...
### Existing MWEs: 
1- **δει το φως της δημοσιότητας** (ID, 1)
### Identified MWEs: 
1- **δοθεί άλλοθι** (OTH)
## Sentence No. 703 - 
...
### Existing MWEs: 
1- **ρίχνοντας μια ματιά** (LVC)
### Identified MWEs: 
1- **ρίχνοντας ματιά** (OTH)
## Sentence No. 709 - 
Πολυάριθμα μαύρα στίγματα έχουν κάνει την εμφάνισή τους σε αυτήν . 
### Existing MWEs: 
1- **κάνει εμφάνισή** (LVC, 3)
### Identified MWEs: 
...
### Existing MWEs: 
1- **παίρνει το δρόμο της επιστροφής** (ID)
### Identified MWEs: 
1- **παίρνει το δρόμο** (OTH)
## Sentence No. 718 - 
...
### Existing MWEs: 
1- **έπεφτε στα χέρια** (ID)
### Identified MWEs: 
1- **έπεφτε στα χέρια** (OTH)
## Sentence No. 731 - 
...
### Existing MWEs: 
1- **άσκησε επιρροή** (LVC, 1)
### Identified MWEs: 
1- **έχοντας ρόλο** (OTH)
2- **άσκησε επιρροή** (OTH)
## Sentence No. 742 - 
...
### Existing MWEs: 
1- **τέθηκαν υπό περιορισμό** (LVC)
### Identified MWEs: 
1- **τέθηκαν υπό περιορισμό** (OTH)
## Sentence No. 760 - 
...
### Existing MWEs: 
1- **έφερε τη σφραγίδα** (ID)
### Identified MWEs: 
1- **έφερε τη σφραγίδα** (OTH)
## Sentence No. 769 - 
...
### Existing MWEs: 
1- **έκαναν εκστρατεία** (LVC, 2)
### Identified MWEs: 
1- **έκαναν εκστρατεία** (OTH)
## Sentence No. 770 - 
...
### Existing MWEs: 
1- **παίρνοντας θέση** (LVC, 3)
### Identified MWEs: 
1- **παίρνοντας θέση** (OTH)
## Sentence No. 784 - 
...
### Existing MWEs: 
1- **έδωσαν συγκατάθεση** (LVC, 2)
### Identified MWEs: 
1- **έδωσαν συγκατάθεση** (OTH)
## Sentence No. 815 - 
...
### Existing MWEs: 
1- **πραγματοποιήθηκαν αλλαγές** (LVC)
## Sentence No. 820 - 
...
### Existing MWEs: 
1- **δόθηκαν εντολές** (LVC, 6)
### Identified MWEs: 
1- **δόθηκαν εντολές** (OTH)
## Sentence No. 821 - 
...
### Existing MWEs: 
1- **ασκεί επίδραση** (LVC, 1)
### Identified MWEs: 
1- **ήρθε αντιμέτωπος** (OTH)
2- **ασκεί επίδραση** (OTH)
## Sentence No. 845 - 
...
### Existing MWEs: 
1- **έρχεται σε ρήξη** (LVC, 2)
### Identified MWEs: 
1- **έρχεται σε ρήξη** (OTH)
## Sentence No. 851 - 
...
### Existing MWEs: 
1- **έκανε εικονογράφηση** (LVC)
### Identified MWEs: 
1- **έκανε εικονογράφηση** (OTH)
## Sentence No. 859 - 
Οι « Γυναίκες του Αλγερίου » έκαναν μεγάλη επιτυχία στο Σαλόνι του 1834 . 
### Existing MWEs: 
1- **έκαναν επιτυχία** (LVC, 2)
### Identified MWEs: 
1- **έκαναν επιτυχία** (OTH)
## Sentence No. 860 - 
...
### Existing MWEs: 
1- **πραγματοποίησε επενδύσεις** (LVC)
### Identified MWEs: 
1- **πραγματοποίησε επενδύσεις** (OTH)
## Sentence No. 873 - 
...
### Existing MWEs: 
1- **βάλει στοίχημα** (LVC)
### Identified MWEs: 
1- **βάλει στοίχημα** (OTH)
## Sentence No. 905 - 
...
### Existing MWEs: 
1- **άσκησε κριτική** (LVC, 2)
### Identified MWEs: 
1- **άσκησε κριτική** (OTH)
## Sentence No. 915 - 
...
### Existing MWEs: 
1- **το έβαλαν στα πόδια** (ID, 1)
### Identified MWEs: 
1- **το έβαλαν στα πόδια** (OTH)
## Sentence No. 937 - 
...
### Existing MWEs: 
1- **πραγματοποιούσε επαφές** (LVC)
### Identified MWEs: 
1- **πραγματοποιούσε επαφές** (OTH)
## Sentence No. 993 - 
...
### Existing MWEs: 
1- **κάνει εκκλήσεις** (LVC, 2)
### Identified MWEs: 
1- **κάνει εκκλήσεις** (OTH)
## Sentence No. 1036 - 
...
### Existing MWEs: 
1- **διεξάγει έρευνα** (LVC, 1)
### Identified MWEs: 
1- **διεξάγει έρευνα** (OTH)
## Sentence No. 1039 - 
