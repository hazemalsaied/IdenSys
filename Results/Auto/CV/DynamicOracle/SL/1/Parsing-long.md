...
### Existing MWEs: 
1- **požrl slino** (ID)
2- **beseda obstala v grlu** (ID)
## Sentence No. 101 - 
tam so samo zamahnili z roko , češ , se bo že vrnila . 
### Existing MWEs: 
1- **zamahnili z roko** (ID, 1)
2- **se vrnila** (IReflV)
## Sentence No. 113 - 
...
### Existing MWEs: 
1- **se nasmehnil** (IReflV, 6)
2- **se zahahljala** (IReflV, 2)
### Identified MWEs: 
1- **se zahahljala** (OTH)
## Sentence No. 171 - 
...
### Existing MWEs: 
1- **se nanašale na** (VPC, 4)
2- **dali na led** (ID)
### Identified MWEs: 
1- **se nanašale na** (OTH)
## Sentence No. 341 - 
...
### Existing MWEs: 
1- **se zgodilo** (IReflV, 35)
2- **se dogajati** (IReflV, 15)
### Identified MWEs: 
1- **se zgodilo** (OTH)
## Sentence No. 1769 - 
...
### Existing MWEs: 
1- **boste v zadregi** (LVC)
### Identified MWEs: 
1- **boste v zadregi** (OTH)
## Sentence No. 224 - 
...
### Existing MWEs: 
1- **prinesle sive lase** (ID)
## Sentence No. 1697 - 
nadzorujte porabo svojega denarja , spomnite se , kje in kako ste ga porabili , odkar ste bili nazadnje v banki . 
### Existing MWEs: 
1- **spomnite se** (IReflV, 9)
## Sentence No. 1698 - 
prav tako se poskusite spomniti glavnih točk nedavnega pogovora s prijateljem . 
### Existing MWEs: 
1- **se spomniti** (IReflV, 6)
## Sentence No. 1718 - 
vsem pa se zadeva ne zdi smešna . 
### Existing MWEs: 
1- **se zdi** (IReflV, 50)
## Sentence No. 1719 - 
evropski prvak v kategoriji masters rob costa je dejal : strinjam se , da je treba skoke v vodo približati ljudem , vendar bi na tekmovanjih rad videl dovolj visoke standarde . 
### Existing MWEs: 
1- **strinjam se** (IReflV, 2)
## Sentence No. 1722 - 
komercializacija trpljenja se glasi elegantna uradna utemeljitev . 
### Existing MWEs: 
1- **se glasi** (IReflV, 6)
### Identified MWEs: 
1- **se glasi** (OTH)
## Sentence No. 1728 - 
sicer pa imata adria in jat še stare nerazčiščene finančne zadeve , ki jih bo adria potegnila iz rokava , če se bo položaj zaostril . 
### Existing MWEs: 
