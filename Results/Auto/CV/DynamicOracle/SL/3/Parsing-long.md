...
### Existing MWEs: 
1- **se obnašal** (IReflV, 5)
2- **ima ves čas na tem svetu** (ID)
### Identified MWEs: 
1- **se obnašal** (OTH)
## Sentence No. 4162 - 
...
### Existing MWEs: 
1- **zamenjal strani** (ID)
2- **trenili z očesom** (ID, 1)
## Sentence No. 4203 - 
...
### Existing MWEs: 
1- **se izkaže** (IReflV, 5)
2- **pride do izraza** (LVC)
### Identified MWEs: 
1- **pride do** (OTH)
## Sentence No. 4252 - 
...
### Existing MWEs: 
1- **se zdijo** (IReflV, 47)
2- **se zdele** (IReflV, 47)
### Identified MWEs: 
1- **se zdijo** (OTH)
2- **se zdele** (OTH)
## Sentence No. 4504 - 
...
### Existing MWEs: 
1- **Še pes ima rad mir pri jedi** (ID)
2- **zajeti v jadra** (ID)
## Sentence No. 4791 - 
...
### Existing MWEs: 
1- **imela opravka z** (LVC, 2)
2- **se počutijo** (IReflV, 16)
## Sentence No. 4883 - 
...
### Existing MWEs: 
1- **se sprijaznijo s** (VPC)
2- **se vtikajo** (IReflV, 2)
## Sentence No. 4888 - 
...
### Existing MWEs: 
1- **se počutil** (IReflV, 16)
## Sentence No. 3630 - 
tako se je zdelo smiselno tudi eni sestri . 
### Existing MWEs: 
1- **se zdelo** (IReflV, 47)
### Identified MWEs: 
1- **se zdelo** (OTH)
## Sentence No. 3640 - 
...
### Existing MWEs: 
1- **se zgodilo** (IReflV, 44)
## Sentence No. 3781 - 
Še posebno ženske so ji vseskozi stale ob strani . 
### Existing MWEs: 
1- **stale ob strani** (ID, 2)
### Identified MWEs: 
1- **stale ob strani** (OTH)
## Sentence No. 3782 - 
...
### Existing MWEs: 
1- **spomnil se** (IReflV, 9)
## Sentence No. 4132 - 
vendar o krvi ni ne duha ne sluha . 
### Existing MWEs: 
1- **o ni ne duha ne sluha** (ID)
## Sentence No. 4134 - 
...
### Existing MWEs: 
1- **se ukvarjati s** (VPC, 10)
### Identified MWEs: 
1- **se ukvarjati s** (OTH)
## Sentence No. 4253 - 
...
### Existing MWEs: 
1- **predstavljajmo si** (IReflV, 1)
### Identified MWEs: 
1- **predstavljajmo si** (OTH)
## Sentence No. 4436 - 
...
### Existing MWEs: 
1- **se ukvarjamo s** (VPC, 10)
### Identified MWEs: 
1- **se ukvarjamo s** (OTH)
## Sentence No. 4764 - 
...
### Existing MWEs: 
1- **boste na strani** (ID)
## Sentence No. 4912 - 
mnogokrat so se obračali tudi na vodne vile nimfe in duha travnikov in gozdov silena , dasiravno so , kot bomo brž slišali , ti duhovi lahko tudi pomenili prevod pojmov iz staroselskih verskih predstav v italikom razumljivo govorico . 
### Existing MWEs: 
1- **se obračali na** (VPC)
## Sentence No. 4913 - 
dasi današnjemu človeku iz grško - rimske literature silijo v misel predvsem razne ljubko spotikljive prigode teh bogov , se moramo zavedati , da so bili za večino svojih častilcev vendarle poosebljenja naravnih sil . 
### Existing MWEs: 
1- **se zavedati** (IReflV, 6)
### Identified MWEs: 
1- **se zavedati** (OTH)
## Sentence No. 4916 - 
v sredozemskih deželah je zvezdni par , ki še danes nosi njuni imeni , viden ravno pol leta . 
### Existing MWEs: 
1- **nosi imeni** (LVC, 1)
## Sentence No. 4917 - 
zelo kratek je bil korak od te ljubke razlage naravnega pojava do tega , da so ju šteli za zavetnika umrlih in ju zato upodobili tudi na steni priscianove grobnice v Šempetru . 
### Existing MWEs: 
1- **šteli za** (VPC, 3)
### Identified MWEs: 
1- **šteli za** (OTH)
## Sentence No. 4934 - 
toda že dejstvo , da so šteli za potrebno , ovekovečati svoje zaobljube bogovom z napisano besedo , da so želeli ohraniti spomin na kar moč dosti ljudi in dejanj z javno razstavljeno zapisano besedo , je vendarle tako mogočna sprememba v miselnosti in v okolju , da dejansko moramo domnevati da je bila sposobnost brati in razumeti latinski jezik zelo razširjena . 
### Existing MWEs: 
1- **šteli za** (VPC, 3)
### Identified MWEs: 
1- **šteli za** (OTH)
## Sentence No. 4935 - 
s tem pa so bila vrata latinski literaturi in omiki v deželi široko odprta . 
### Existing MWEs: 
1- **bila vrata široko odprta** (ID)
## Sentence No. 4936 - 
Še bolj so ji , kot smo omenili ( gl. verstvo ) , ta vrata tudi med nižje sloje odpirali verski obredi in praznovanja . 
### Existing MWEs: 
1- **vrata odpirali** (ID)
## Sentence No. 4951 - 
dokler se jim zdiš prpravlen delat , ti nč ne morjo . 
### Existing MWEs: 
1- **se zdiš** (IReflV, 47)
### Identified MWEs: 
1- **se zdiš** (OTH)
## Sentence No. 4954 - 
rekl bojo : tega tipa totalno boli kurac . 
### Existing MWEs: 
1- **boli kurac** (ID)
## Sentence No. 4958 - 
malce se je bal lennyja . 
### Existing MWEs: 
1- **se bal** (IReflV, 9)
### Identified MWEs: 
1- **se bal** (OTH)
## Sentence No. 4962 - 
renton se skremži , ko v daljavi zagleda sikboja in pomisli , kakšne bedarije mu morajo trenutno prihajati iz ust . 
### Existing MWEs: 
1- **se skremži** (IReflV)
## Sentence No. 4966 - 
billy se je ves ponosen idiotsko zarežu . 
### Existing MWEs: 
1- **se zarežu** (IReflV, 2)
## Sentence No. 4976 - 
prhulen se splazm odzad za psa ; nočem , dab ga ta kurba spustu pa name skoču , čeprou je zlo mal verjetn , dab to naredu . 
### Existing MWEs: 
1- **se splazm** (IReflV)
## Sentence No. 4986 - 
dr. forbes : ste se o teh občutkih že kdaj s kom pogovarjali ? 
### Existing MWEs: 
1- **se pogovarjali** (IReflV, 10)
## Sentence No. 4995 - 
tlelevš ostal , kjer te mam pred očmi . 
### Existing MWEs: 
1- **mam pred očmi** (ID)
## Sentence No. 5000 - 
dere se . 
...
1- **se bojim** (OTH)
## Sentence No. 5006 - 
sikboj me je že opozoru na to , pa tud sam sem to že skoz dal ; sam nben prejšn opozarjanje al pa izkušne te ne morjo čist prpravt na to . 
### Existing MWEs: 
1- **skoz dal** (VPC)
## Sentence No. 5017 - 
franco se prezirliv reži pa našteje tamalmu kup bankovcev , v glavnem pa sam kovance . 
### Existing MWEs: 
1- **se reži** (IReflV)
## Sentence No. 5019 - 
Če sam prdneš kakšenmu kurcu o celi tej zadevi , pol lohk sam molš , da teu polcija kurčeva prej zagrabla pa te v polmont poslala , koker te jest v roke dobim , as me slišu ? 
### Existing MWEs: 
1- **v roke dobim** (ID)
## Sentence No. 5024 - 
sem poznal ene par folka , kse je s tem bavu , pa so zagazl v pizdarije . 
### Existing MWEs: 
1- **kse s bavu** (VPC)
## Sentence No. 5027 - 
ne skrbi ga higiena , le občutku mokrote na naježeni koži bi se rad izognil . 
### Existing MWEs: 
1- **se izognil** (IReflV, 11)
### Identified MWEs: 
1- **se izognil** (OTH)
## Sentence No. 5033 - 
odločm se , dam obisku na na v unih zavarvanih fletih dol na konc easter roada . 
### Existing MWEs: 
1- **odločm se** (IReflV, 4)
## Sentence No. 5039 - 
kva bi bla to kul scena , u , jebemti , se ne zajebavam , muca moja . 
### Existing MWEs: 
1- **se zajebavam** (IReflV)
## Sentence No. 5040 - 
v taksiju sta se pogovarjala . 
### Existing MWEs: 
1- **se pogovarjala** (IReflV, 10)
### Identified MWEs: 
...
1- **se odločila** (IReflV, 20)
## Sentence No. 5045 - 
hitro je potegnil nase majico in pulover . 
### Existing MWEs: 
1- **potegnil nase** (ID)
## Sentence No. 5046 - 
potem je odprl spalno vrečo , vrgel noge s kavča in si potegnil gor kavbojke , vse skoraj v enem samem gibu . 
### Existing MWEs: 
1- **potegnil gor** (VPC)
## Sentence No. 5064 - 
— beli labod neb nikol izkoristu dame v stiski , se zareži . 
### Existing MWEs: 
1- **se zareži** (IReflV, 2)
## Sentence No. 5072 - 
osemnajsturne šole dojenja , ki so jo organizirali v bolnišnici , so se udeležile tudi patronažne sestre vseh zdravstvenih domov na gorenjskem . 
### Existing MWEs: 
1- **se udeležile** (IReflV, 8)
### Identified MWEs: 
1- **se udeležile** (OTH)
## Sentence No. 5076 - 
javna občila so slovenski hokej zaradi razmer in odnosov v njem , ki jih je afera razgalila , resda naredila za » grešnega kozla « , pri tem pa so vede ali nevede spregledala širše procese , ki že vrsto let pri nas niso navzoči samo v tej športni panogi , temveč vse bolj v slovenskem športu nasploh . 
### Existing MWEs: 
1- **naredila za** (VPC, 1)
## Sentence No. 5077 - 
pri tem seveda ne gre prezreti , da gre tudi za posledice in vplive dogajanj v svetovnem športu . 
### Existing MWEs: 
1- **gre za** (VPC, 62)
### Identified MWEs: 
1- **gre za** (OTH)
## Sentence No. 5080 - 
ko ste se v zgodbi prepričevanja , kako naj se glasuje za vlado , lotili celo mojih staršev , mi je postalo jasno , da bi bilo pametno , če bi danes glasovala drugače , kot sem glasovala pri mandatarju . 
### Existing MWEs: 
1- **se lotili** (IReflV, 14)
## Sentence No. 5083 - 
na obeh straneh so ugibali , kaj napoved pomeni in skušali razvozlati , kaj je imela poslanka v mislih s pritiski na - že pokojne - starše . 
### Existing MWEs: 
1- **imela v mislih** (LVC, 1)
## Sentence No. 5089 - 
kot pevca okteta , ki nosi ime lesna , ga seveda skrbi usoda lesne , potem ko je podjetje prevzel andrej kokalj . 
### Existing MWEs: 
1- **nosi ime** (LVC, 1)
### Identified MWEs: 
1- **nosi ime** (OTH)
...
1- **igra vlogo** (OTH)
## Sentence No. 5101 - 
te izhajajo iz vsebinskih konotacij in izvedbe same . 
### Existing MWEs: 
1- **izhajajo iz** (VPC, 1)
## Sentence No. 5102 - 
v gledališču smo priča igri , ki oponaša ali zrcali življenje , performans pa je življenje samo . 
### Existing MWEs: 
1- **smo priča** (LVC, 1)
## Sentence No. 5103 - 
pri postavljanju razstave lahko učenci uporabljajo usvojena znanja s področij plastičnega oblikovanja in oblikovanja prostora , ki pa imajo v okviru te zaposlitve sekundarno vlogo . 
### Existing MWEs: 
1- **imajo vlogo** (LVC, 3)
## Sentence No. 5104 - 
pri predstavitvi likovne naloge se osredotočimo in poudarjamo pomene , vsebine , spomine in čustva miselne vsebine , ki jih sprožajo uporabljeni predmeti . 
### Existing MWEs: 
1- **se osredotočimo** (IReflV)
## Sentence No. 5118 - 
ko prespiš sto noči , se stvari naslednje jutro ne zdijo več take , kot so bile prvo jutro . 
### Existing MWEs: 
1- **se zdijo** (IReflV, 47)
## Sentence No. 5120 - 
...
## Sentence No. 5149 - 
ljubljana - ker bodo kvalifikacije za evropsko prvenstvo v beogradu šele naslednjo jesen , se košarkarji s seznama prejšnjega selektorja slobodana subotića med tednom niso posebej ubadali z zamenjavo na klopi . 
### Existing MWEs: 
1- **se ubadali z** (VPC)
## Sentence No. 5152 - 
takrat naj bi se pri za vreme najbolj občutljivih ljudeh pojavili tudi glavoboli , le pri redkih migrena . 
### Existing MWEs: 
1- **se pojavili** (IReflV, 15)
## Sentence No. 5155 - 
...
1- **se zgodilo** (IReflV, 44)
## Sentence No. 5167 - 
Če se zavemo : " aha , to , kar sedaj občutim , je jeza , " nam ta misel omogoča , da se jeza ohladi in da potem ugotovimo , kaj je v resnici problem in kako bomo ustrezno ravnali . 
### Existing MWEs: 
1- **se zavemo** (IReflV, 2)
## Sentence No. 5176 - 
predsednik odbora slavko gliha in župan franc Škufca sta čestitala skladatelju in glasbeniku globokarju za njegovo dosedanje delo in prejeto nagrado in se mu zahvalila za milijon tolarjev , ki jih je namenil prav za obnovo gradu . 
### Existing MWEs: 
1- **se zahvalila** (IReflV, 3)
### Identified MWEs: 
1- **se zahvalila** (OTH)
## Sentence No. 5177 - 
vinko globokar je povedal , da se je zdelo povsem samoumevno , da je del nagrade namenil za grad , ki leži nad njegovo hišo . 
### Existing MWEs: 
1- **se zdelo** (IReflV, 47)
### Identified MWEs: 
1- **se zdelo** (OTH)
## Sentence No. 5178 - 
» slikar lahko spreminja barve in obliko gradu le na platnu , na vas pa je da to resnično sliko v naravi popravite , da bo grad odslej še lepši , « je dejal skladatelj globokar . 
### Existing MWEs: 
1- **na je** (VPC, 1)
## Sentence No. 5183 - 
nič nimam proti tvoji psici … « je mencal feliks . 
### Existing MWEs: 
1- **nimam proti** (LVC)
### Identified MWEs: 
1- **nimam proti** (OTH)
## Sentence No. 5199 - 
poudariti je treba , da dokumenti , ki jih v zadnjih dneh pošilja razočarani ( premalo nagrajeni ? ) udeleženec tedanjega početja , skušajo dokazati , da so se varnostni organi brigade moris ukvarjali z zbiranjem podatkov o tatvinah orožja in vojaške opreme iz slovenskih vojašnic . 
### Existing MWEs: 
1- **se ukvarjali z** (VPC, 10)
## Sentence No. 5200 - 
...
1- **imeli na voljo** (LVC, 2)
## Sentence No. 5202 - 
upravičenci bodo morali letos oddati vloge med 25. aprilom in 24. majem ( tako kot lani jim bodo pri izpolnjevanju pomagali kmetijski svetovalci ) , agencija pa ima na vesti še nekaj dolga za lanske subvencije . 
### Existing MWEs: 
1- **ima na vesti** (LVC, 1)
### Identified MWEs: 
1- **ima na vesti** (OTH)
## Sentence No. 5203 - 
doslej je bilo izplačanih za 13,4 milijarde tolarjev neposrednih plačil , približno milijardo tolarjev pa bodo še morali razdeliti , in sicer tistim , ki so se na odločbo pritožili ( takih je bilo okoli 1300 ) , in tistim , ki so oddali vloge za klavne premije . 
### Existing MWEs: 
1- **se pritožili** (IReflV, 1)
### Identified MWEs: 
1- **se pritožili** (OTH)
## Sentence No. 5209 - 
metodologija sloni na pristopih , ki so osredotočeni na otroka , je razložila vodja centra korak za korakom pri pedagoškem inštitutu tatjana vonta . 
### Existing MWEs: 
1- **sloni na** (VPC)
## Sentence No. 5211 - 
njihov moto se glasi : otrok se nauči tistega , kar živi . 
### Existing MWEs: 
1- **se glasi** (IReflV, 6)
### Identified MWEs: 
1- **se glasi** (OTH)
...
1- **se veselila** (OTH)
## Sentence No. 5226 - 
to namreč ne postavi pod vprašaj le splošnega poslovnega optimizma , temveč tudi zadovoljstvo ob napovedanih naročilih , povečani proizvodnji in izvozu . 
### Existing MWEs: 
1- **postavi pod vprašaj** (ID)
## Sentence No. 5241 - 
na sliki 4.4 si lahko ogledate , kakšen je seznam videti v internet explorerju . 
### Existing MWEs: 
1- **si ogledate** (IReflV, 1)
### Identified MWEs: 
1- **si ogledate** (OTH)
## Sentence No. 5246 - 
brez naslova ali kake druge vrste " podpisa " spletnih strani je včasih skoraj nemogoče izvedeti , kdo je stran napisal ali s kom stopiti v stik za dodatno informacijo . 
### Existing MWEs: 
1- **stopiti v stik** (ID)
## Sentence No. 5247 - 
podpisovanje vsake spletne strani s pomočjo oznake < address > je odličen način , da si zagotovite , da vas bodo ljudje , ki želijo z vami stopiti v stik , tudi našli . 
### Existing MWEs: 
1- **stopiti v stik** (ID)
## Sentence No. 5260 - 
...
### Existing MWEs: 
1- **so na voljo** (LVC, 10)
### Identified MWEs: 
1- **so na voljo** (OTH)
## Sentence No. 5270 - 
preden si ogledamo , kako stranem dodamo okvirje , morate spoznati še en atribut oznake < a > . 
### Existing MWEs: 
1- **si ogledamo** (IReflV, 1)
## Sentence No. 5283 - 
vsako teh spletnih mest je bodisi tipičen primer vrste informacije , ki jo danes najdemo na spletu , ali pa prikazuje določeno metodo reševanja problema , na katerega lahko naletite med razvojem svojih spletnih mest . 
### Existing MWEs: 
1- **na naletite** (VPC, 2)
## Sentence No. 5284 - 
ogledali si boste naslednja spletna mesta : 
### Existing MWEs: 
1- **ogledali si** (IReflV)
## Sentence No. 5292 - 
zadnjih nekaj let se je pojavilo veliko organizacij , ki ne nudijo drugega kot objavljanje na spletu . 
### Existing MWEs: 
1- **se pojavilo** (IReflV, 15)
## Sentence No. 5295 - 
o na voljo imate dve možnosti . 
### Existing MWEs: 
1- **na voljo imate** (LVC, 1)
### Identified MWEs: 
1- **na voljo imate** (OTH)
## Sentence No. 5310 - 
z odločitvijo za potomce se starši pogosto odločijo tudi za življenje v pomanjkanju 
### Existing MWEs: 
1- **se odločijo** (IReflV, 20)
## Sentence No. 5311 - 
z razmišljanjem , kdaj bi se to lahko uresničilo , bomo spet prišli do tistega kmeta , ki čepi v umazanih hlačah ob robu ceste . 
### Existing MWEs: 
1- **prišli do** (VPC, 23)
### Identified MWEs: 
1- **prišli do** (OTH)
## Sentence No. 5312 - 
ko bo njegov mobilni telefon zapel in se bo s hudim lokalnim narečjem lahko dogovoril za boljše pogoje z gospodarjem , ker bo imel v nasprotnem primeru pravico oditi k svojemu neodvisnemu sindikatu , in ko bo gospodar prisiljen razmisliti o tem , s katerim proizvodom bo zaslužil veliko , ker kmeta ne more plačati malo , in ko bo računalniški inženir nagrajen za neubogljivost v razmišljanju o vsem , pa tudi o jiangovem govoru enako kot o novem programu , ki se bo prodajal kot znanje , ne pa kot poceni delovna sila . 
### Existing MWEs: 
1- **se dogovoril** (IReflV, 4)
## Sentence No. 5313 - 
sodišče je lucijskega podjetnika spoznalo za krivega vseh desetih očitanih dejanj - petim oškodovancem mora vrniti denar 
### Existing MWEs: 
1- **spoznalo za** (VPC)
## Sentence No. 5317 - 
pogovarjala sva se le nekaj dni pred njegovim odhodom na julijsko zasedanje upravnega odbora v kopenhagnu , medtem pa je bil koršič tudi izbran za podpredsednika izvršnega biroja eurimagesa . 
### Existing MWEs: 
1- **pogovarjala se** (IReflV)
## Sentence No. 5323 - 
v skrbeh pa smo zaradi ostriža , ki se je v zadnjih letih naselil v jezero . 
### Existing MWEs: 
1- **v skrbeh smo** (LVC)
