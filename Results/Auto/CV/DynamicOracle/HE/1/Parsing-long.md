...
### Existing MWEs: 
1- **אסורה באיסורי תורה חמורים** (OTH)
2- **ביארנו בהרחבה** (VPC)
## Sentence No. 72 - 
...
### Existing MWEs: 
2- **של להיות ליבו** (OTH)
1- **להיות ליבו של** (OTH), Interleaving 
## Sentence No. 349 - 
...
### Existing MWEs: 
1- **ואבן הבוחן על פיה נבחנה** (OTH)
2- **ואבן הבוחן פיה נבחנה על** (OTH), Interleaving 
## Sentence No. 459 - 
הרב הקים גרעין חדש שיגיע לישוב ממכון מאיר ומשכונת נווה יעקב והחיה את הישוב סיפר הרב אזולאי
### Existing MWEs: 
1- **הקים גרעין** (ID)
2- **והחיה את הישוב** (VPC)
## Sentence No. 480 - 
...
### Existing MWEs: 
1- **להקפיא את חקיקת** (OTH)
2- **להקפיא חקיקת את** (OTH), Interleaving 
## Sentence No. 507 - 
...
### Existing MWEs: 
2- **לא תאחר מלהגיע** (OTH)
1- **תאחר מלהגיע** (OTH), Embedded 
## Sentence No. 605 - 
...
2- **להוציא מחוץ לחוק** (OTH, 1), DistributedEmbedding 
## Sentence No. 3 - 
...
### Existing MWEs: 
1- **להקפיא את המגעים** (VPC)
### Identified MWEs: 
1- **להקפיא את המגעים** (OTH)
## Sentence No. 143 - 
...
### Existing MWEs: 
1- **להקפיא את הליכי תיקון החקיקה** (OTH)
## Sentence No. 486 - 
...
### Existing MWEs: 
1- **לפרוץ את מעגל שפיכות הדמים** (OTH)
## Sentence No. 785 - 
