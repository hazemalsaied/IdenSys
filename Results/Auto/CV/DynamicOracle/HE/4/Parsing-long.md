...
### Existing MWEs: 
1- **שמסרו את עדויותיהם** (VPC)
2- **שמסרו עדויותיהם את** (VPC), Interleaving 
## Sentence No. 3467 - 
...
### Existing MWEs: 
1- **היד הארוכה שתשיג** (ID)
2- **מוטלים מתחת לקברים** (VPC)
## Sentence No. 3639 - 
...
### Existing MWEs: 
1- **עומד על חודו של קול** (OTH)
2- **עומד על חודו קול של** (OTH), Interleaving 
## Sentence No. 3700 - 
...
### Existing MWEs: 
1- **תשמוט את השטיח תחת** (ID)
2- **יהפכו את המדינה** (OTH)
## Sentence No. 2803 - 
...
### Existing MWEs: 
1- **עברה על חודו של קול** (OTH, 1)
### Identified MWEs: 
1- **עברה על חודו של קול** (OTH)
## Sentence No. 2871 - 
...
### Existing MWEs: 
1- **ושהתקבלו בחיוכים ונפנופי ידיים לשלום** (OTH)
## Sentence No. 3024 - 
...
### Existing MWEs: 
1- **פועלת מתוך מניעים טהורים** (OTH)
## Sentence No. 3174 - 
...
### Existing MWEs: 
1- **גזר על החיים מבקש לגרש את המתים** (OTH)
## Sentence No. 3243 - 
...
### Existing MWEs: 
1- **מנסה להתחקות אחרי עקבותיהם** (VPC)
## Sentence No. 3481 - 
...
### Existing MWEs: 
1- **אוי לאומה שכך מתייחסת ואוי לאומה שכך מתייחסת** (OTH)
## Sentence No. 3560 - 
...
### Existing MWEs: 
1- **ומשמשים כמרצים מן המניין** (OTH)
## Sentence No. 3625 - 
