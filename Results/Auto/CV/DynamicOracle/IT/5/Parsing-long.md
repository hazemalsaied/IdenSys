...
### Existing MWEs: 
1- **tiene un discorso** (LVC, 1)
### Identified MWEs: 
1- **tiene un discorso** (OTH)
## Sentence No. 12894 - 
...
### Existing MWEs: 
1- **far- si interprete** (ID)
### Identified MWEs: 
1- **far- si** (OTH)
2- **far- si interprete** (OTH)
## Sentence No. 12948 - 
...
### Existing MWEs: 
1- **preso in prestito** (ID)
### Identified MWEs: 
1- **preso in prestito** (OTH)
## Sentence No. 13049 - 
...
### Existing MWEs: 
1- **insegue una idea** (ID)
## Sentence No. 14665 - 
maddalena finisce in carcere . 
### Existing MWEs: 
1- **finisce in carcere** (ID)
## Sentence No. 14668 - 
...
### Existing MWEs: 
1- **faceva ricorso** (LVC, 2)
### Identified MWEs: 
1- **faceva ricorso** (OTH)
## Sentence No. 14730 - 
...
### Existing MWEs: 
1- **posta in contrapposizione** (LVC)
### Identified MWEs: 
1- **ha paura** (OTH)
## Sentence No. 15271 - 
...
### Existing MWEs: 
1- **andare oltre** (VPC, 2)
### Identified MWEs: 
1- **andare oltre** (OTH)
## Sentence No. 15282 - 
la donna che visse due volte : paperino , in seguito a un incidente , ha la fobia delle altezze elevate ( come james stewart ) , appare ogni tanto una " misteriosa papera bionda " che ricorda kim novak e la scena sul faro ricorda molto quella del campanile presente nel film e , come lo stesso stewart , anche lo sfortunato papero rimane appeso ad un edificio ; 
### Existing MWEs: 
1- **ha fobia** (LVC)
## Sentence No. 15286 - 
inoltre la storia presenta una caricatura di hitchcock ( chiamato per l' occasione alfred iciok ) , che presenta il classico abbigliamento con cui il grande regista si recava a " lavoro " , i suoi giochi di parole e .... la stazza . 
### Existing MWEs: 
1- **si recava** (IReflV, 4)
## Sentence No. 15308 - 
a soli 4 anni i genitori si separano e finisce in un collegio cattolico . 
### Existing MWEs: 
1- **si separano** (IReflV)
## Sentence No. 15311 - 
a 17 anni si arruola come paracadutista nel corpo di spedizione militare francese in indocina , ma al congedo , dopo 5 anni , avrà totalizzato ben 11 mesi complessivi di prigione per indisciplina . 
### Existing MWEs: 
1- **si arruola** (IReflV)
## Sentence No. 15324 - 
ormai affermato e molto popolare , delon inizia a girare quasi esclusivamente film " polar " ( un genero ibrido fra poliziesco e noir ) , ritagliando- si il classico personaggio di duro hard boiled , affascinante e dal destino spesso segnato , indipendentemente dall' appartenenza ora alla malavita ora alla polizia . 
### Existing MWEs: 
1- **ritagliando- si** (IReflV)
## Sentence No. 15330 - 
...
### Existing MWEs: 
1- **prende parte** (LVC, 1)
### Identified MWEs: 
1- **prende parte** (OTH)
## Sentence No. 15345 - 
all' attore , 74 anni , viene proposto di commentare una sequenza di baci dati sul set alle famose attrici con cui ha lavorato , ed al termine dell' intervista si esibisce in un valzer con le vallette del programma , tra calorosi applausi del pubblico . 
### Existing MWEs: 
1- **si esibisce** (IReflV)
## Sentence No. 15346 - 
nel corso dell' intervista dichiara di aver sconfitto la depressione che lo aveva afflitto ; afferma di conservare un grandissimo ricordo degli attori e dei registi italiani con cui ha lavorato ; ed in particolare cita come suo grande amico lo scomparso attore renato salvatori . 
### Existing MWEs: 
1- **conservare ricordo** (LVC)
## Sentence No. 15363 - 
gli isotopi dell' astato non godono di vita abbastanza lunga da studiar- ne le proprietà , ma le misure spettroscopiche lasciano pensare a caratteristiche simili a quelle dello iodio - come quest' ultimo , è probabile che possa accumular- si nella ghiandola tiroide . 
### Existing MWEs: 
1- **accumular- si** (IReflV)
## Sentence No. 15372 - 
l' astato è un elemento radioattivo che si presenta in natura nei minerali di uranio e di torio . 
### Existing MWEs: 
1- **si presenta** (IReflV, 4)
## Sentence No. 15378 - 
in soluzione acquosa l' astato si comporta in modo simile allo iodio , anche se le soluzioni che lo contengono devono essere estremamente diluite . 
### Existing MWEs: 
1- **si comporta** (IReflV, 2)
### Identified MWEs: 
1- **si comporta** (OTH)
## Sentence No. 15386 - 
in particolare le reazioni a cui prende parte sono state studiate in soluzioni molto diluite di astato e , in maggiore quantità , di iodio che agisce da trasportatore , facilitando la filtrazione , la precipitazione e l' isolamento dei singoli composti . 
### Existing MWEs: 
1- **prende parte** (LVC, 1)
### Identified MWEs: 
1- **prende parte** (OTH)
## Sentence No. 15402 - 
si trova in tracce nei minerali dell' uranio sotto forma di 227ac , un isotopo che emette particelle alfa e beta con un' emivita di 21,773 anni . 
### Existing MWEs: 
1- **si trova** (IReflV, 30)
### Identified MWEs: 
1- **si trova** (OTH)
## Sentence No. 15407 - 
a parte questa , non ha altre applicazioni industriali significative . 
### Existing MWEs: 
1- **ha applicazioni** (LVC)
## Sentence No. 15408 - 
...
1- **prende il nome** (OTH)
## Sentence No. 15423 - 
227ac è estremamente radioattivo e , in termini di danni alla salute , è da considerar- si pericoloso quasi quanto il plutonio . 
### Existing MWEs: 
1- **considerar- si** (IReflV)
## Sentence No. 15424 - 
...
1- **trovato uso** (OTH)
## Sentence No. 15488 - 
questo produsse prima 240pu e poi 241pu che a sua volta si convertì in 241am tramite un decadimento beta . 
### Existing MWEs: 
1- **si convertì** (IReflV)
## Sentence No. 15523 - 
...
### Existing MWEs: 
1- **si estendeva** (IReflV)
## Sentence No. 15534 - 
nel 1371 si verificò un forte attrito tra gli abitanti ed il vescovo , quando giovanni fieschi esasperò gli animi degli adornesi , divenuti ormai troppo insofferenti di fronte alle sue pretese . 
### Existing MWEs: 
1- **si verificò** (IReflV, 4)
## Sentence No. 15536 - 
nel 1378 il vescovo ibleto fieschi concedeva il feudo per 4.000 ducati al conte federico di challant , e convinse gli andornesi a sottometter- si ai savoia . 
### Existing MWEs: 
1- **sottometter- si** (IReflV)
## Sentence No. 15537 - 
dopo la dedizione del 29 ottobre 1379 il conte amedeo vi di savoia divenne proprietario del castello e lo affidò a giovanni duco di moncalieri , a giraudo de cresto , francescino tua di mongrando , sibueto rivoire , bonifacio de strada de vallice , e dopo la morte di questi ai suoi diretti familiari e fece parte del mandamento di biella . 
### Existing MWEs: 
1- **fece parte** (LVC, 31)
### Identified MWEs: 
1- **fece parte** (OTH)
...
1- **si contano** (IReflV)
## Sentence No. 15596 - 
qui sopravvivono solo piante ed animali che si sono adattati al clima rigido , tra cui pinguini , foche , muschi , licheni , e molti tipi di alghe . 
### Existing MWEs: 
1- **si adattati** (IReflV)
## Sentence No. 15597 - 
...
1- **si trovano** (OTH)
## Sentence No. 15650 - 
intorno al continente , soprattutto intorno alla penisola antartica , si trova un ampio numero di isole . 
### Existing MWEs: 
1- **si trova** (IReflV, 30)
## Sentence No. 15653 - 
tra le varie classificazioni proposte per il clima antartico la più valida resta quella elaborata da paul c. dalrymple nel 1966 : essa , pur tralasciando la fascia costiera e la penisola antartica , suddivide l' interno del continente in quattro zone , sulla base di precisi parametri , che mettono in relazione le temperature medie ed estreme , la velocità media e la frequenza del vento , la misura delle precipitazioni annuali e l' intensità del windchill . 
### Existing MWEs: 
1- **mettono in relazione** (ID, 1)
### Identified MWEs: 
1- **mettono in relazione** (OTH)
## Sentence No. 15656 - 
il plateau antartico è un tavolato di ghiaccio con spessori che , nella parte orientale , possono superare i 4.000 metri di quota , ed è qui che si realizzano le temperature più basse del mondo . 
### Existing MWEs: 
1- **si realizzano** (IReflV)
## Sentence No. 15660 - 
a vostok , nel nucleo centrale freddo , la media annua ( 1958-2006 , con interruzioni ) si colloca invece a -55,3 °c. 
### Existing MWEs: 
1- **si colloca** (IReflV)
## Sentence No. 15662 - 
perciò la classica suddivisione stagionale , pur mantenuta per omogeneità di confronti , nella realtà ha poco senso : nell' area interiore fredda e nel nucleo centrale freddo , che inglobano circa la metà della superficie continentale , si può parlare di un bimestre estivo ( dicembre e gennaio ) , preceduto e seguito da due stagioni di transizione ( seconda metà di ottobre e novembre , febbraio e prima metà di marzo ) , i restanti sette mesi ( dalla metà di marzo a metà ottobre ) sono quelli invernali . 
### Existing MWEs: 
1- **ha senso** (LVC, 1)
## Sentence No. 15669 - 
ciò fa sì che , in qualsiasi periodo dell' inverno , si possano toccare i valori estremi : il record ad amundsen-scott si colloca a -82,8 °c ( 23 giugno 1982 ) , a vostok a -89,2 °c ( 21 luglio 1983 ) ; quest' ultima è la temperatura più bassa registrata sulla terra . 
### Existing MWEs: 
1- **si colloca** (IReflV)
## Sentence No. 15670 - 
altro elemento caratterizzante dell' antartide è il vento : in particolare , le " correnti catabatiche " che , in estrema sintesi , si originano per via della densità dell' aria fredda che staziona sul plateau antartico , e che tende a " scivolare " verso le coste . 
### Existing MWEs: 
1- **si originano** (IReflV)
## Sentence No. 15678 - 
in generale va detto che nella regione antartica esistono grandi differenze tra le varie zone : ad esempio le parti più a nord ( come la penisola antartica ) sono le zone dove in generale si realizza il passaggio del ghiaccio all' oceano mentre le parti più interne sono quelle dove si ha un accumulo e ispessimento dei ghiacci . 
### Existing MWEs: 
1- **si realizza** (IReflV)
## Sentence No. 15684 - 
...
1- **si riproducono** (IReflV)
## Sentence No. 15690 - 
nei mesi estivi oltre 100 milioni di uccelli migratori nidificano e si riproducono sulla banchisa e nelle isole prospicienti il continente . 
### Existing MWEs: 
1- **si riproducono** (IReflV)
## Sentence No. 15692 - 
le uniche forme di vita che vi si trovano sono batteri , microorganismi e alcuni invertebrati . 
### Existing MWEs: 
1- **si trovano** (IReflV, 30)
### Identified MWEs: 
1- **si trovano** (OTH)
## Sentence No. 15696 - 
non sono state fatte rivendicazioni nel settore tra 90 gradi est e 150 gradi ovest . 
### Existing MWEs: 
1- **fatte rivendicazioni** (LVC)
## Sentence No. 15702 - 
