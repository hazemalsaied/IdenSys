...
### Existing MWEs: 
1- **se llevó** (IReflV, 5), Embedded 
2- **se llevó la victoria** (ID)
### Identified MWEs: 
1- **se llevó** (OTH)
## Sentence No. 599 - 
...
### Existing MWEs: 
1- **tenemos ventajas** (LVC, 2)
2- **no queda más remedio** (ID)
### Identified MWEs: 
1- **tenemos ventajas** (OTH)
## Sentence No. 622 - 
...
### Existing MWEs: 
1- **teniendo en cuenta** (ID, 7)
2- **instalar se** (IReflV)
### Identified MWEs: 
1- **teniendo en cuenta** (OTH)
## Sentence No. 631 - 
...
### Existing MWEs: 
1- **reunir se** (IReflV, 5)
2- **restado posibilidades** (ID)
### Identified MWEs: 
1- **reunir se** (OTH)
## Sentence No. 642 - 
...
### Existing MWEs: 
1- **hacer se** (IReflV, 1)
2- **estuvieran a cargo** (LVC)
### Identified MWEs: 
1- **estuvieran a cargo** (OTH)
## Sentence No. 904 - 
...
### Existing MWEs: 
1- **se mantenían** (IReflV, 6)
2- **se declararon** (IReflV, 2)
### Identified MWEs: 
1- **se mantenían** (OTH)
2- **se declararon** (OTH)
## Sentence No. 503 - 
...
### Existing MWEs: 
1- **puesto de manifiesto** (LVC, 3)
### Identified MWEs: 
1- **puesto de manifiesto** (OTH)
## Sentence No. 541 - 
...
### Existing MWEs: 
1- **cumplido con responsabilidad** (ID)
## Sentence No. 567 - 
...
### Existing MWEs: 
1- **llevará a cabo** (ID, 4)
### Identified MWEs: 
1- **llevará a cabo** (OTH)
## Sentence No. 572 - 
...
### Existing MWEs: 
1- **tiene problemas** (LVC, 3)
### Identified MWEs: 
1- **tiene problemas** (OTH)
## Sentence No. 618 - 
...
### Existing MWEs: 
1- **dar respuestas** (LVC)
### Identified MWEs: 
1- **dar respuestas** (OTH)
## Sentence No. 623 - 
...
### Existing MWEs: 
1- **dar por perdida** (LVC, 1)
### Identified MWEs: 
1- **dar por perdida** (OTH)
## Sentence No. 646 - 
...
### Existing MWEs: 
1- **estaba de acuerdo** (ID, 1)
### Identified MWEs: 
1- **estaba de acuerdo** (OTH)
## Sentence No. 649 - 
...
### Existing MWEs: 
1- **tomará decisiones** (LVC, 2)
### Identified MWEs: 
1- **tomará decisiones** (OTH)
## Sentence No. 689 - 
...
### Existing MWEs: 
1- **poner en entredicho** (LVC)
### Identified MWEs: 
1- **poner en entredicho** (OTH)
## Sentence No. 757 - 
...
### Existing MWEs: 
1- **tienen previsto** (ID, 5)
### Identified MWEs: 
1- **tienen previsto** (OTH)
## Sentence No. 789 - 
...
### Existing MWEs: 
1- **se mordió la lengua** (OTH)
## Sentence No. 837 - 
" no , no creo que tenga nada que ver . 
### Existing MWEs: 
1- **tenga que ver** (ID, 6)
## Sentence No. 841 - 
...
### Existing MWEs: 
1- **haciendo declaraciones** (LVC, 2)
### Identified MWEs: 
1- **haciendo declaraciones** (OTH)
## Sentence No. 924 - 
