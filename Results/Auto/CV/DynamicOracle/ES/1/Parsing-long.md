...
### Existing MWEs: 
1- **tomaran acuerdos** (LVC)
2- **decisiones toman** (LVC, 1)
### Identified MWEs: 
1- **tomaran acuerdos** (OTH)
## Sentence No. 139 - 
...
### Existing MWEs: 
1- **influencia tener** (LVC)
2- **tener repercusión** (LVC, 1)
## Sentence No. 175 - 
...
### Existing MWEs: 
2- **rondar en la cabeza** (ID)
1- **ve con buenos ojos** (ID)
## Sentence No. 255 - 
...
### Existing MWEs: 
2- **hacer movimiento** (LVC)
1- **se desmarcara** (IReflV, 2)
### Identified MWEs: 
1- **se desmarcara** (OTH)
## Sentence No. 306 - 
...
### Existing MWEs: 
1- **puso en acción** (LVC)
2- **presentó batalla** (ID)
### Identified MWEs: 
1- **puso en acción** (OTH)
## Sentence No. 425 - 
...
### Existing MWEs: 
1- **se llevado** (IReflV, 5), Embedded 
2- **se llevado una alegría** (ID)
### Identified MWEs: 
1- **se llevado** (OTH)
## Sentence No. 4 - 
...
### Existing MWEs: 
1- **se comprometió** (IReflV, 7)
### Identified MWEs: 
1- **se comprometió** (OTH)
## Sentence No. 24 - 
...
### Existing MWEs: 
1- **pondrá en circulación** (LVC, 1)
### Identified MWEs: 
1- **pondrá en circulación** (OTH)
## Sentence No. 109 - 
...
### Existing MWEs: 
1- **tienen que ver** (ID, 7)
### Identified MWEs: 
1- **tienen que ver** (OTH)
## Sentence No. 112 - 
...
### Existing MWEs: 
1- **pongan en marcha** (LVC, 3)
### Identified MWEs: 
1- **pongan en marcha** (OTH)
## Sentence No. 144 - 
...
### Existing MWEs: 
1- **blanquear dinero** (ID)
### Identified MWEs: 
1- **introducir billetes** (OTH)
## Sentence No. 148 - 
...
### Existing MWEs: 
1- **dieron ejemplo** (LVC)
### Identified MWEs: 
1- **dieron ejemplo** (OTH)
## Sentence No. 174 - 
...
### Existing MWEs: 
1- **llevarán a cabo** (ID, 4)
### Identified MWEs: 
1- **llevarán a cabo** (OTH)
## Sentence No. 261 - 
...
### Existing MWEs: 
1- **dar tranquilidad** (LVC)
### Identified MWEs: 
1- **resolver los problemas** (OTH)
## Sentence No. 302 - 
...
### Existing MWEs: 
1- **hicimos apuesta** (LVC)
### Identified MWEs: 
1- **hacer partícipes** (OTH)
## Sentence No. 380 - 
...
### Existing MWEs: 
1- **pone de manifiesto** (LVC, 2)
### Identified MWEs: 
1- **pone de manifiesto** (OTH)
## Sentence No. 397 - 
...
### Existing MWEs: 
1- **puesta de manifiesto** (LVC, 2)
### Identified MWEs: 
1- **puesta de manifiesto** (OTH)
## Sentence No. 433 - 
...
### Existing MWEs: 
1- **se encontraban** (IReflV, 8)
### Identified MWEs: 
1- **se encontraban** (OTH)
## Sentence No. 484 - 
