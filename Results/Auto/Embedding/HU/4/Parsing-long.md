...
### Identified MWEs: 
1- **jogait gyakorolja** (LVC)Tokens : 
jogait
gyakorolja
...
2- **forgalomba hozatalával** (LVC)Tokens : 
forgalomba
hozatalával
...
4- **forgalomba hozatalával** (LVC)Tokens : 
forgalomba
hozatalával
...
2- **tett szándéknyilatkozatra** (LVC)Tokens : 
tett
szándéknyilatkozatra
...
### Identified MWEs: 
1- **határozatot jelenteni** (LVC)Tokens : 
határozatot
jelenteni
...
## Sentence No. 2287 - 
a zártkörű alaptőke-emelés során követendő eljárásról a 250. §-ához fűzötteknél már volt szó . ) 
### Existing MWEs: 
1- **eljárásról** (VPC, 64)Tokens : 
eljárásról
...
## Sentence No. 2288 - 
jegyzési elsőbbség illeti meg a nyilvános alaptőke-emelés során kibocsátásra kerülő részvényekkel azonos sorozatba tartozó részvényeseket , ezt követően a társaság egyéb részvényeseit , majd végül a jegyzési jogot biztosító kötvények [ gt. ( új ) 199. § (2) ] tulajdonosait . 
### Existing MWEs: 
1- **kibocsátásra kerülő** (LVC)Tokens : 
kibocsátásra
kerülő
...
## Sentence No. 2307 - 
a részvénytársaság az alaptőkéjét alaptőkén felüli vagyonával vagy annak egy részével - a számviteli törvény szerinti beszámolót elfogadó közgyűlésen - az alapító okirat ( alapszabály ) módosításával felemelheti . 
### Existing MWEs: 
1- **beszámolót** (VPC, 20)Tokens : 
beszámolót
...
## Sentence No. 2318 - 
ennek keretében az igazgatóságnak a zártkörű , illetve nyilvános működés szabályai szerint fel kell hívnia a részvényeseket a felülbélyegzendő , illetve kicserélendő részvények benyújtására , és az új vagy felülbélyegzett részvények átvételére , a hely és időtartam pontos megjelölésével . 
### Existing MWEs: 
1- **benyújtására** (VPC, 20)Tokens : 
benyújtására
...
## Sentence No. 2319 - 
a határidőben be nem nyújtott részvényeket az igazgatóság érvénytelenné nyilvánítja , ezzel a részvényes részvényesi jogai megszűnnek . 
### Existing MWEs: 
1- **be nyújtott** (VPC, 3)Tokens : 
be
nyújtott
...
## Sentence No. 2322 - 
abban az esetben ha az új , illetve felülbélyegzett részvények értékesítése 6 hónapon belül nem történik meg , a határidő lejártát követő közgyűlésen a részvényeket az alaptőke leszállítás szabályaival be kell vonni . 
### Existing MWEs: 
1- **lejártát** (VPC, 3)Tokens : 
lejártát
...
## Sentence No. 2323 - 
ha a (2)-(3) bekezdés szerinti értékesítésre hat hónapon belül nem kerül sor , a részvényeket legkésőbb a következő közgyűlésen az alaptőke leszállításával be kell vonni . 
### Existing MWEs: 
1- **bekezdés** (VPC, 578)Tokens : 
bekezdés
...
## Sentence No. 2327 - 
a dolgozói részvény kibocsátására a zártkörű forgalomba hozatal szabályait kell megfelelően alkalmazni . 
### Existing MWEs: 
1- **megfelelően** (VPC, 99)Tokens : 
megfelelően
...
## Sentence No. 2329 - 
kedvezményesen kibocsátásra kerülő dolgozói részvény esetében továbbá meg kell határozni a részvényesek befizetési kötelezettségét . 
### Existing MWEs: 
1- **kibocsátásra kerülő** (LVC)Tokens : 
kibocsátásra
kerülő
...
## Sentence No. 2336 - 
a kötvény futamidejének , és az átváltásra nyitva álló határidőnek nem feltétlenül kell egybeesnie . 
### Existing MWEs: 
1- **egybeesnie** (VPC, 1)Tokens : 
egybeesnie
...
## Sentence No. 2338 - 
a kötvénytulajdonosok a kötvény futamidején belül , a közgyűlés által meghatározott időtartam alatt írásban - a kötvényeknek az igazgatóság részére történő benyújtásával - kötvényeik helyébe részvényt igényelhetnek . 
### Existing MWEs: 
1- **benyújtásával** (VPC, 20)Tokens : 
benyújtásával
...
## Sentence No. 2357 - 
tekintettel arra továbbá , hogy az alaptőke leszállítás nemcsak az alaptőke összegében , hanem szükségszerűen az annak ellenében kibocsátott részvények összetételében , ( értékében , mennyiségében ) is változást eredményez a határozatban ezen adatokat is meg kell jelölni . 
### Existing MWEs: 
1- **összetételében** (VPC)Tokens : 
összetételében

### Identified MWEs: 
1- **leszállítás** Tokens : 
leszállítás

## Sentence No. 2359 - 
tekintettel arra , hogy a tőkeleszállítás technikai lebonyolítását ( végrehajtását ) követően újabb közgyűlés tartására nem kerül sor , a közgyűlésnek a leszállításról rendelkező határozattal egyidejűleg , s azzal összhangban módosítania kell az alapító okiratot , illetve alapszabályt . 
### Existing MWEs: 
1- **végrehajtását** (VPC, 5)Tokens : 
végrehajtását

### Identified MWEs: 
1- **végrehajtását** Tokens : 
végrehajtását

2- **leszállításról** Tokens : 
leszállításról
...
## Sentence No. 2361 - 
e szavazás során a szükséges szavazatarány megállapításánál valamennyi a részvénysorozathoz tartozó részvényest figyelembe kell venni . 
### Existing MWEs: 
1- **figyelembe venni** (LVC, 20)Tokens : 
figyelembe
venni
...
## Sentence No. 2362 - 
a hozzájárulás megtörténhet közgyűlésen kívül , vagy akár közgyűlésen is . 
### Existing MWEs: 
1- **hozzájárulás** (VPC, 108)Tokens : 
hozzájárulás
...
## Sentence No. 2367 - 
a részvények kicserélése során a korábban kibocsátott részvények helyett - azok megsemmisítése mellett - új alacsonyabb névértékű részvények kerülnek kiadásra . 
### Existing MWEs: 
1- **kerülnek kiadásra** (LVC)Tokens : 
kerülnek
kiadásra
...
## Sentence No. 2369 - 
( Így pl. a részvényesek által birtokolt részvények darabszám szerint meghatározott hányadának benyújtásával és megsemmisítésével . ) 
### Existing MWEs: 
1- **benyújtásával** (VPC, 20)Tokens : 
benyújtásával
...
## Sentence No. 2372 - 
a felhívásban megjelölt határidőben be nem nyújtott részvényeket az igazgatóság érvénytelennek nyilvánítja , ezzel a részvényesi jogviszony megszűnik . 
### Existing MWEs: 
1- **be nyújtott** (VPC, 3)Tokens : 
be
nyújtott
...
### Identified MWEs: 
1- **felhívásban** Tokens : 
felhívásban

2- **be nyújtott** (VPC)Tokens : 
be
nyújtott

## Sentence No. 2373 - 
abban az esetben , ha a be nem nyújtott és ezért érvénytelennek nyilvánított részvények helyett a társaság új részvényeket állít ki , azokat értékesíteni köteles . 
### Existing MWEs: 
1- **be nyújtott** (VPC, 3)Tokens : 
be
nyújtott
...
## Sentence No. 2376 - 
az alaptőke leszállítását elhatározó közgyűlési határozat cégbírósághoz történt benyújtását követően a közgyűlési határozatot az igazgatóságnak kétszer egymás után , legalább harminc napos időközzel a cégközlönyben közzé kell tennie . 
### Existing MWEs: 
1- **benyújtását** (VPC, 20)Tokens : 
benyújtását

### Identified MWEs: 
1- **leszállítását** Tokens : 
leszállítását

2- **benyújtását** Tokens : 
benyújtását

## Sentence No. 2377 - 
a hirdetményben egyúttal fel kell hívni a társaság hitelezőit , hogy az alaptőke leszállításához hozzá nem járuló hitelezők a követeléseiket a hirdetmény utolsó közzétételétől számított harminc napon belül jelentsék be . 
### Existing MWEs: 
1- **hozzá járuló** (VPC, 1)Tokens : 
hozzá
járuló

### Identified MWEs: 
1- **leszállításához** Tokens : 
leszállításához

2- **hozzá járuló** (VPC)Tokens : 
hozzá
járuló

## Sentence No. 2379 - 
az alaptőke leszállításának bejegyzésére csak akkor kerülhet sor , ha az (1)-(2) bekezdésben foglaltak betartását a részvénytársaság a cégközlöny lappéldányaival és az igazgatóság nyilatkozatával igazolja . 
### Existing MWEs: 
1- **bekezdésben** (VPC, 578)Tokens : 
bekezdésben
...
## Sentence No. 2381 - 
amennyiben nem az alaptőke leszállítás valamelyik kötelező esetéről van szó , a törvény az hitelezők védelme érdekében előírja a közgyűlési határozat hivatalos lapban történő kétszeri közzétételét . 
### Existing MWEs: 
...
## Sentence No. 2384 - 
utóbbi feltétel igazolására az igazgatóság nyilatkozata szolgál . 
### Existing MWEs: 
1- **feltétel** (VPC, 63)Tokens : 
feltétel
...
## Sentence No. 2387 - 
a felszólítás ellenére be nem nyújtott részvényeket a részvénytársaság érvénytelennek nyilvánítja és ezt a cégközlönyben közzéteszi . 
### Existing MWEs: 
1- **be nyújtott** (VPC, 3)Tokens : 
be
nyújtott
...
## Sentence No. 2395 - 
kifizetéseket eszközölni , illetve a hátralékos befizetést elengedni csakis az alaptőkeleszállítás cégbejegyzését követően lehet . 
### Existing MWEs: 
1- **kifizetéseket eszközölni** (LVC)Tokens : 
kifizetéseket
eszközölni

## Sentence No. 2398 - 
a 237. § (1)-(2) bekezdéséből következően azonban az alapító okirat , illetve alapszabály a jogutód nélküli megszűnés elhatározásához ennél magasabb szavazatarányt is előírhat . 
### Existing MWEs: 
1- **bekezdéséből** (VPC, 578)Tokens : 
bekezdéséből
...
## Sentence No. 2402 - 
a végelszámolás megindítását a ctv. szabályai szerint a cégjegyzékbe be kell jegyezni . 
### Existing MWEs: 
1- **végelszámolás** (VPC)Tokens : 
végelszámolás

## Sentence No. 2403 - 
a hitelezői igények bejelentésére nyitva álló 40 napos határidőt ezen utóbbi - tehát a végelszámoló - közleményének megjelenésétől kell számítani . 
### Existing MWEs: 
1- **végelszámoló** (VPC)Tokens : 
végelszámoló
...
### Existing MWEs: 
1- **hozzájárulások** (VPC, 108)Tokens : 
hozzájárulások

### Identified MWEs: 
1- **hozzájárulások** Tokens : 
hozzájárulások

## Sentence No. 2407 - 
ha a részvénytársaság likvidációs hányadhoz fűződő elsőbbséget biztosító részvényt bocsátott ki , a vagyon felosztásakor az elsőbbségi részvény biztosította jogokat figyelembe kell venni . 
### Existing MWEs: 
1- **figyelembe venni** (LVC, 20)Tokens : 
figyelembe
venni
...
## Sentence No. 2409 - 
a felosztás során ugyanakkor figyelemmel kell lenni a gt. ( új ) 183. § (2) bekezdés b) pontja alapján kibocsátott likvidációs hányadhoz fűződő elsőbbségi részvényekre is . 
### Existing MWEs: 
1- **bekezdés** (VPC, 578)Tokens : 
bekezdés
...
## Sentence No. 2416 - 
a 4. § (4) bekezdése szerint azonban nem alapíthat egyszemélyes részvénytársaságot másik egyszemélyes gazdasági társaság , és egyedüli részvényes sem lehet . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
## Sentence No. 2417 - 
a gt. ( új ) 10. § (1) bekezdése szerint az egyszemélyes részvénytársaság alapítása alapító okirattal történik . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
## Sentence No. 2422 - 
a gt. ( új ) 19. § (4) bekezdése kimondja , hogy egyszemélyes gazdasági társaság esetében a legfőbb szerv nem működik . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
## Sentence No. 2432 - 
a gt. ( új ) 297. , illetve 294. §-ában foglaltakkal összhangban mondja ki a törvény a kölcsönös részesedésszerzés tilalmát , illetve írja elő annak megszüntetési kötelezettségét . 
### Existing MWEs: 
...
## Sentence No. 2433 - 
Így ha nyomban az alapításnál jön létre egyszemélyes részvénytársaság , a társaság a gazdálkodó szervezet részvényesénél részesedést egyáltalán nem szerezhet . 
### Existing MWEs: 
1- **jön létre** (VPC, 16)Tokens : 
jön
létre
...
## Sentence No. 2434 - 
mindaddig a gazdálkodó szervezet részvényes saját részvényeként kell számításba venni az olyan részvényeit is , amelyek az egyszemélyes részvénytársaság tulajdonában vannak . 
### Existing MWEs: 
1- **számításba venni** (LVC)Tokens : 
számításba
venni

## Sentence No. 2438 - 
az egyesülés saját nyereségre nem törekszik ; vagyonát meghaladó tartozásaiért a tagok korlátlanul és egyetemlegesen felelnek . 
### Existing MWEs: 
1- **meghaladó** (VPC, 11)Tokens : 
meghaladó
...
### Existing MWEs: 
1- **tevékenységet végezhet** (LVC)Tokens : 
tevékenységet
végezhet
...
### Existing MWEs: 
1- **megkülönböztetésre kerüljön** (LVC)Tokens : 
megkülönböztetésre
kerüljön
...
### Existing MWEs: 
1- **kifejezést juttatva** (LVC)Tokens : 
kifejezést
juttatva
...
## Sentence No. 2511 - 
egyebekben minden a mellékszolgáltatással kapcsolatos szerződéses kikötésre , mint a társasági szerződésbe foglalt polgári jogi megállapodásra , a ptk. szerződéses szabadságra vonatkozó általános jogelve érvényesül , vagyis a felek szabad megállapodásának tárgya . 
### Existing MWEs: 
1- **kikötésre** (VPC, 7)Tokens : 
kikötésre
...
## Sentence No. 2521 - 
a tagok e szerv ülésén keresztül gyakorolják tagsági jogaikat , vesznek részt az egyesülés működésében . 
### Existing MWEs: 
1- **gyakorolják jogaikat** (LVC, 6)Tokens : 
gyakorolják
jogaikat

### Identified MWEs: 
1- **gyakorolják jogaikat** (LVC)Tokens : 
gyakorolják
jogaikat
...
## Sentence No. 2533 - 
azt azonban már szabadon határozhatja meg a társasági szerződés , hogy az évi egy ülésen kívül előír -e további igazgatótanácsi ülést kötelező jelleggel , vagy az igazgatóra bízza annak szükség szerinti összehívását , illetve az ülésen kívüli " írásbeli " határozathozatalt . 
### Existing MWEs: 
1- **előír** (VPC, 13)Tokens : 
előír
...
2- **határozathozatalt** Tokens : 
határozathozatalt

## Sentence No. 2536 - 
arra nézve , hogy a meghívót milyen határidővel az ülés előtt kell kiküldeni , a törvény előírást nem tartalmaz , arról a tagok a társasági szerződésben szabadon rendelkezhetnek . 
### Existing MWEs: 
1- **előírást** (VPC, 115)Tokens : 
előírást
...
## Sentence No. 2542 - 
a jegyzőkönyvből megállapíthatónak kell lennie , hogy az ülés megtartására , s a határozathozatalra a törvényes rendben került -e sor ezért a (3) bekezdésben felsorolt adatokat , tényeket a jegyzőkönyvnek tartalmaznia kell . 
### Existing MWEs: 
1- **bekezdésben** (VPC, 578)Tokens : 
bekezdésben

### Identified MWEs: 
1- **határozathozatalra** Tokens : 
határozathozatalra
...
## Sentence No. 2543 - 
a szerződés a háromnegyedes aránynál szigorúbb szabályt , akár egyhangúságot előírhat , nem szállhat azonban a háromnegyedes arány alá . 
### Existing MWEs: 
1- **előírhat** (VPC, 10)Tokens : 
előírhat
...
## Sentence No. 2549 - 
egyenlő mértékben illeti meg azonban minden esetben a tagokat a szavazatarány az átalakulás , megszűnés , a csatlakozás , a tagkizárás kezdeményezése és a 275. § (2) bekezdés m) pontjában írt szerződések jóváhagyása tekintetében . 
### Existing MWEs: 
1- **bekezdés** (VPC, 578)Tokens : 
bekezdés
...
## Sentence No. 2551 - 
a tagok egyhangúan határoznak a következő ügyekben : a) az egyesülés tárgyának megváltoztatása , b) az egyes tagok szavazatai számának a megváltoztatása , c) a határozathozatal feltételeinek a megváltoztatása . 
### Existing MWEs: 
1- **feltételeinek** (VPC, 63)Tokens : 
feltételeinek

### Identified MWEs: 
1- **határozathozatal** Tokens : 
határozathozatal
...
## Sentence No. 2562 - 
a törvénytől itt is csak a szigorítás irányában ehet eltérni , a társasági szerződés tehát csak magasabb szavazatarányt írhat elő . 
### Existing MWEs: 
1- **írhat elő** (VPC, 4)Tokens : 
írhat
elő
...
## Sentence No. 2567 - 
az igazgatótanács főszabályként ülésen hozza határozatait , a törvény azonban az " írásbeli határozathozatalt " is lehetővé teszi . 
### Existing MWEs: 
...
### Existing MWEs: 
1- **foglalt állást** (LVC, 2)Tokens : 
foglalt
állást

### Identified MWEs: 
1- **határozathozatallal** Tokens : 
határozathozatallal

2- **foglalt állást** (LVC)Tokens : 
foglalt
állást

## Sentence No. 2573 - 
ha a társasági szerződés módosítása tekintetében úgy születik döntés , hogy a módosítás szövegét az egyesülés valamennyi tagjának megküldik és azt valamennyi tag aláírja , az okiratot ügyvéd vagy jogtanácsos ellenjegyzéssel látja el , ez esetben az írásbeli szavazás eredményeképpen is létrejöhet szerződésmódosítás . " 
### Existing MWEs: 
...
## Sentence No. 2574 - 
az egyesülés ügyvezetését és képviseletét az igazgató - a társasági szerződés , továbbá az igazgatótanács határozatainak keretei között - látja el . 
### Existing MWEs: 
1- **látja el** (VPC, 5)Tokens : 
látja
el
...
## Sentence No. 2578 - 
az igazgató felett a munkáltatói jogokat az igazgatótanács gyakorolja . 
### Existing MWEs: 
...
## Sentence No. 2582 - 
az egyesülés dolgozói felett a munkáltatói jogkört az igazgató gyakorolja . 
### Existing MWEs: 
1- **jogkört gyakorolja** (LVC)Tokens : 
jogkört
gyakorolja

## Sentence No. 2583 - 
az igazgató képviseleti jogkörét meghatározott ügykörben a társaság dolgozóira átruházza [ gt. ( új ) 39. § (4) ] . 
### Existing MWEs: 
1- **átruházza** (VPC, 5)Tokens : 
átruházza
...
## Sentence No. 2585 - 
az igazgató a munkáltatói jogosítványokat csak korlátozottan gyakorolhatja egyszemélyben , ha az igazgatótanács az egyes vezető állású dolgozókkal kapcsolatos munkáltatói részjogosítványok gyakorlását a saját egyetértéséhez köti . 
### Existing MWEs: 
1- **jogosítványokat gyakorolhatja** (LVC)Tokens : 
jogosítványokat
gyakorolhatja

### Identified MWEs: 
1- **munkáltatói részjogosítványok** (LVC)Tokens : 
munkáltatói
részjogosítványok

## Sentence No. 2593 - 
a társasági szerződésben foglalt feltételek szerint az egyesülésbe bárki beléphet ( csatlakozás ) . 
### Existing MWEs: 
1- **feltételek** (VPC, 63)Tokens : 
feltételek
...
## Sentence No. 2598 - 
a csatlakozás elfogadása - a társasági szerződés esetleges idevonatkozó rendelkezéseinek figyelembevételével - az igazgatótanács hatáskörébe tartozik , amely a kérdésben - amennyiben a társasági szerződés magasabb szavazatarányt nem ír elő - háromnegyedes szótöbbséggel dönt [ gt. ( új ) 280. § (2) ] . 
### Existing MWEs: 
1- **ír elő** (VPC, 24)Tokens : 
ír
elő
...
## Sentence No. 2601 - 
mentesül a felelősség alól , ha a csatlakozás elfogadása tekintetben hozott határozat így rendelkezik . 
### Existing MWEs: 
1- **hozott határozat** (LVC, 2)Tokens : 
hozott
határozat

### Identified MWEs: 
1- **hozott határozat** (LVC)Tokens : 
hozott
határozat

## Sentence No. 2603 - 
megszűnik a tagsági jogviszony a) ha a tag a társasági szerződésben meghatározott vagyoni hozzájárulását felhívás ellenére nem teljesítette ; b) a tag kilépésével ; c) a tag kizárásával ; d) a tag halálával vagy jogutód nélküli megszűnésével ; e) ha annak fenntartása jogszabályba ütközik . 
### Existing MWEs: 
1- **hozzájárulását** (VPC, 108)Tokens : 
hozzájárulását
...
## Sentence No. 2614 - 
ha azonban a jogutód ( örökös ) folytatni kívánja a tag tevékenységét , az igazgatótanács hozzájárulásával az egyesülés tagjává válhat . 
### Existing MWEs: 
1- **hozzájárulásával** (VPC, 108)Tokens : 
hozzájárulásával
...
## Sentence No. 2622 - 
az örökössel , jogutóddal a kilépésre irányadó szabályok szerint el kell számolni . 
### Existing MWEs: 
1- **el számolni** (VPC, 3)Tokens : 
el
számolni

### Identified MWEs: 
1- **el számolni** (VPC)Tokens : 
el
számolni

## Sentence No. 2623 - 
az örökös , jogutód azonban az igazgatótanács hozzájárulásával az egyesülés tagjává is válhat . 
### Existing MWEs: 
1- **hozzájárulásával** (VPC, 108)Tokens : 
hozzájárulásával
...
## Sentence No. 2632 - 
miután e döntés egyidejűleg a társasági szerződés módosítását is jelenti , a határozatot ( igazgatótanács ülésének jegyzőkönyvét ) közokiratba kell foglalni , vagy ügyvédi ( jogtanácsosi ) ellenjegyzéssel kell ellátni . 
### Existing MWEs: 
1- **ellátni** (VPC, 2)Tokens : 
ellátni
...
## Sentence No. 2634 - 
főszabályként a végelszámolást az igazgató végzi . 
### Existing MWEs: 
1- **végelszámolást** (VPC)Tokens : 
végelszámolást
...
## Sentence No. 2649 - 
jelezve ezzel is azt , hogy a konszernhelyzet kizárólag csak a részvénytársaságok egymás közti vonatkozásában merülhet fel . 
### Existing MWEs: 
...
## Sentence No. 2651 - 
részlegesen azért , mert csak kizárólag a részvénytársaságok viszonylatában voltak ezek a kérdések szabályozva , és azon belül is kizárólag csak a részvényvásárlással megvalósuló befolyás kialakulásáról fogalmaztak meg előírásokat . 
### Existing MWEs: 
1- **előírásokat** (VPC, 115)Tokens : 
előírásokat
...
## Sentence No. 2658 - 
az 1988. évi vi. tv. szabályaihoz képest ugyanakkor külön törvények is rendelkeztek a konszernhelyzetekről , ezek az előírások viszont már jóval szigorúbbak és következetesebbek voltak a társasági jogi szabályoknál . 
### Existing MWEs: 
1- **előírások** (VPC, 115)Tokens : 
előírások
...
## Sentence No. 2661 - 
emellett az olyan helyzeteket is a befolyásoló részesedés hatálya alá vonta , amely egy vállalkozásban szerződés , létesítő okirat vagy elsőbbségi részvény alapján a döntést hozó vagy felügyelő szervek tagjainak kinevezése , elmozdítása útján , vagy " egyéb módon " tett lehetővé jelentős befolyást . 
### Existing MWEs: 
1- **döntést hozó** (LVC)Tokens : 
döntést
hozó
...
## Sentence No. 2664 - 
nevezetesen az , hogy a magyarországon bejegyzett részvénytársaságok mellett a külföldön nyilvántartásba vett részvénytársaságokra is kiterjednek -e ezek a szabályok . 
### Existing MWEs: 
1- **nyilvántartásba vett** (LVC)Tokens : 
nyilvántartásba
vett

## Sentence No. 2666 - 
más nézetek szerint viszont azok a külföldön nyilvántartásba vett részvénytársaságok magyarországi részvénytársaságokban való részesedésszerzésére is kiterjedt . 
### Existing MWEs: 
1- **nyilvántartásba vett** (LVC)Tokens : 
nyilvántartásba
vett
...
## Sentence No. 2668 - 
( bár ennél a többség az alkalmazhatóság mellett foglalt állást . ) 
### Existing MWEs: 
1- **foglalt állást** (LVC, 2)Tokens : 
foglalt
állást
...
## Sentence No. 2671 - 
a xiv. fejezetben lévő előírások ugyan változatlanul csak a részesedésszerzéssel történő konszernhelyzeteket szabályozzák , de ezt az új törvény már más megközelítésből és a korábbi szabályozástól eltérő módon oldja meg . 
### Existing MWEs: 
1- **előírások** (VPC, 115)Tokens : 
előírások
...
## Sentence No. 2674 - 
emellett a jogalanyok körének a gt. ( új ) 3. § (1) bekezdés szerinti kibővítéssel a társasági , a hitelezői , valamint a kisebbség védelmét a befolyásoló személyek oldaláról is védettebbé tették . 
### Existing MWEs: 
1- **bekezdés** (VPC, 578)Tokens : 
bekezdés
...
## Sentence No. 2682 - 
kimondja a gt. ( új ) 288. § (1) bekezdése azt is , hogy a konszernhelyzet csak " működés " során alakul ki , mert a konszern fogalmi szabálya csak a működés során való részesedésszerzést vonja a hatálya alá . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
## Sentence No. 2683 - 
ez pedig azt jelenti , hogy a kft. és a részvénytársaság alapításánál az előírásból következően nincsen konszernhelyzet . 
### Existing MWEs: 
1- **előírásból** (VPC, 115)Tokens : 
előírásból
...
## Sentence No. 2691 - 
abban az esetben sem kell alkalmazni a konszernjogi előírásokat , pontosabban a xiv. fejezetben foglalt kötelezettségeket , illetve jogkövetkezményeket , ha például egy 70%-os szavazati jogot biztosító tőkerészesedéssel rendelkező tag vagy részvényes ebből 60%-ot idegenít el , mert ilyenkor sincs részesedés , illetve szavazati jog növekedés az értékesítés előtti helyzethez viszonyítva . 
### Existing MWEs: 
1- **előírásokat** (VPC, 115)Tokens : 
előírásokat
...
## Sentence No. 2697 - 
emellett a szóban forgó új megoldás arra is lehetőséget ad , hogy a leendő társaság számára közömbösnek tűnő uralkodó csak szerzője legyen a befolyásoló részesedésnek és azt - konszernjogi következmények nélkül - a szerzés után nyomban továbbadja egy , az ellenőrzött társaság számára nem kívánatos cégnek . 
### Existing MWEs: 
1- **lehetőséget ad** (LVC, 15)Tokens : 
lehetőséget
ad
...
## Sentence No. 2711 - 
ez pedig nem feltétlenül esik egybe az ellenőrzött társaság érdekeivel . 
### Existing MWEs: 
1- **esik egybe** (VPC)Tokens : 
esik
egybe
...
## Sentence No. 2719 - 
ez akkor jön létre , ha az uralkodó tag , illetve a részvényes a szavazatok több mint 50%-ával rendelkezik az ellenőrzött társaságnál . 
### Existing MWEs: 
1- **jön létre** (VPC, 16)Tokens : 
jön
létre
...
## Sentence No. 2732 - 
ehhez többletszabályt mulasztási szankcióként egyedül a 292. § (3) bekezdése állapít meg a többségi fokozat két alakzatára . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
## Sentence No. 2734 - 
a befolyás tényének a fennállása mellett annak a módját és mértékét is be kell jelenteni a befolyással rendelkezőnek . 
### Existing MWEs: 
...
3- **befolyással** Tokens : 
befolyással

## Sentence No. 2738 - 
ez tehát azt jelenti , hogy az uralkodó tag , illetve a részvényes a bejelentésig a bejelentési kötelezettséggel nem érintett részesedése alapján gyakorolhatja a szavazati jogot , de kizárólag csak ennek erejéig . 
### Existing MWEs: 
1- **gyakorolhatja jogot** (LVC, 7)Tokens : 
gyakorolhatja
jogot
...
### Identified MWEs: 
1- **gyakorolhatja jogot** (LVC)Tokens : 
gyakorolhatja
jogot
...
### Existing MWEs: 
1- **összefüggésben** (VPC, 22)Tokens : 
összefüggésben
...
## Sentence No. 2741 - 
a gt. ( új ) 292. § (1) bekezdésénél is például külön nevesíti a közzétételi kötelezettséget . 
### Existing MWEs: 
1- **bekezdésénél** (VPC, 578)Tokens : 
bekezdésénél
...
## Sentence No. 2742 - 
ugyanakkor a 292. § (2) bekezdése már ezt a kötelezettséget nem sorolja fel a szavazati jogról való rendelkezésnél . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
## Sentence No. 2744 - 
szerintünk a szavazati tilalom tényleges szankcióként az új előírás alapján csakis akkor működhet , ha például az uralkodó részvényes egyetlen aktussal egyszerre szerzi meg a befolyások különböző fokozataihoz szükséges részesedéseket . 
### Existing MWEs: 
1- **előírás** (VPC, 115)Tokens : 
előírás
...
## Sentence No. 2748 - 
ezért a jelentős befolyáshoz szükséges arányt jóval átlépve a " szankció " alatt is gyakorolni tudja a meglévő részvényeivel a jelentős befolyást . 
### Existing MWEs: 
1- **gyakorolni befolyást** (LVC)Tokens : 
gyakorolni
befolyást

### Identified MWEs: 
1- **befolyáshoz** Tokens : 
befolyáshoz
...
2- **számában kerül** (LVC)Tokens : 
számában
kerül

3- **tett eleget** (LVC)Tokens : 
tett
eleget

## Sentence No. 2756 - 
olyan esetekben , ha kölcsönös részesedésről szóló hirdetmények azonos számában jelennének meg a cégközlönynek , úgy akkor azt a társaságot terheli az elidegenítési kötelezettség , amelyik később tett eleget a cégbíróságon a bejelentési kötelezettségének . 
### Existing MWEs: 
1- **tett eleget** (LVC, 5)Tokens : 
tett
eleget
...
### Identified MWEs: 
1- **tett eleget** (LVC)Tokens : 
tett
eleget

## Sentence No. 2757 - 
a gt. ( új ) 293. § (3) bekezdése szavazati jog korlátozási szankciót is megállapít az elidegenítésre kötelezett társasággal szemben . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
## Sentence No. 2758 - 
eszerint az elidegenítési kötelezettség teljesítéséig ez a társaság a tagsági jogait csak az elidegenítési kötelezettség által nem érintett részesedése szerinti mértékben gyakorolhatja . 
### Existing MWEs: 
1- **jogait gyakorolhatja** (LVC, 19)Tokens : 
jogait
gyakorolhatja
...
2- **befolyásáról** Tokens : 
befolyásáról

## Sentence No. 2761 - 
az elidegenítés megtörténtéig az ellenőrzött társaság az uralkodó tag legfőbb szervének ülésén szavazati jogát nem gyakorolhatja . 
### Existing MWEs: 
1- **jogát gyakorolhatja** (LVC, 19)Tokens : 
jogát
gyakorolhatja
...
## Sentence No. 2764 - 
az előírás értelmében az ellenőrzött társaságok , vagyis a konszernalakzat uralt jogalanyai a részvénytársaságok és a kft.-k az uralkodó tag többségi részesedésének a bekövetkezése után nem szerezhetnek az uralkodó társaságokban további részesedést . 
### Existing MWEs: 
1- **előírás** (VPC, 115)Tokens : 
előírás
...
## Sentence No. 2771 - 
ez pedig azt jelenti , hogy az új szabály már a többségi fokozatoknál az egyes fokozatokon belül nem tesz különbséget az 1988. évi vi. tv. hasonló szabályával ellentétben az igényérvényesítési idő tekintetében . 
### Existing MWEs: 
1- **tesz különbséget** (LVC, 1)Tokens : 
tesz
különbséget

### Identified MWEs: 
1- **tesz különbséget** (LVC)Tokens : 
tesz
különbséget

## Sentence No. 2778 - 
a gt. ( új ) 295. § (3) bekezdése az ellenőrzött társaság részvényeseit és a kft. tagjait is megillető jogosítványokat fogalmaz meg . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
### Existing MWEs: 
1- **jogokat gyakorolhatják** (LVC, 19)Tokens : 
jogokat
gyakorolhatják
...
## Sentence No. 2788 - 
a gt. ( új ) 296. § (2) bekezdése a közvetlen irányítás biztosító befolyás esetén a hitelezők számára biztosít egy biztosíték igénylési lehetőséget az uralkodó taggal szemben . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
### Existing MWEs: 
1- **jogukat gyakorolhatják** (LVC, 19)Tokens : 
jogukat
gyakorolhatják
...
3- **üzletpolitikát folytat** (LVC)Tokens : 
üzletpolitikát
folytat

## Sentence No. 2793 - 
a gt. ( új ) 296. § (3) bekezdése a közvetlen irányítás esetén megállapítható felelősségről rendelkezik . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
## Sentence No. 2802 - 
a 306. § (3) bekezdésében foglalt rendelkezés e törvény vii. fejezetének hatálybalépése napján veszti hatályát . 
### Existing MWEs: 
1- **bekezdésében** (VPC, 578)Tokens : 
bekezdésében
...
## Sentence No. 2819 - 
azon gazdasági társaságoknak , amelyeknek a cégbejegyzése a törvény hatálybalépésekor folyamatban van , a cégbejegyzéskor a gazdasági társaságokról szóló 1988. évi vi. törvény rendelkezéseinek kell megfelelniük . 
### Existing MWEs: 
1- **megfelelniük** (VPC, 3)Tokens : 
megfelelniük

### Identified MWEs: 
1- **megfelelniük** Tokens : 
megfelelniük
...
## Sentence No. 2823 - 
az új törvény 1998. június 16-i életbelépése után alapított társaságokra természetesen teljes terjedelmükben alkalmazni kell a gt. ( új ) előírásait a hatálybalépése után . 
### Existing MWEs: 
1- **előírásait** (VPC, 115)Tokens : 
előírásait
...
## Sentence No. 2831 - 
ezért a 299. § (4)-(5) bekezdése a gt. ( új ) életbelépésekor már nem létező szabály volt . 
### Existing MWEs: 
1- **bekezdése** (VPC, 578)Tokens : 
bekezdése
...
## Sentence No. 2833 - 
ezért ilyenkor ezeknek a cégeknek is még a korábbi szabályoknak kell megfelelniük . 
### Existing MWEs: 
1- **megfelelniük** (VPC, 3)Tokens : 
megfelelniük
...
### Existing MWEs: 
1- **járhatnak el** (VPC, 2)Tokens : 
járhatnak
el

### Identified MWEs: 
1- **járhatnak el** (VPC)Tokens : 
járhatnak
el
