...
2- **prendre nourriture** (LVC)Tokens : 
prendre
nourriture
...
### Identified MWEs: 
1- **présente avantages** (LVC)Tokens : 
présente
avantages
...
### Identified MWEs: 
1- **en revenait** (ID)Tokens : 
en
revenait

2- **n' en revenait** (ID)Tokens : 
n'
en
revenait
