...
### Existing MWEs: 
1- **се срещна** (IReflV, 55)Tokens : 
се
срещна

2- **даде оценка** (LVC, 14)Tokens : 
даде
оценка
...
### Existing MWEs: 
1- **си сътрудничат** (IReflV, 2)Tokens : 
си
сътрудничат
...
2- **направят всичко възможно** Tokens : 
направят
всичко
възможно
...
### Existing MWEs: 
1- **се опитва** (IReflV, 5)Tokens : 
се
опитва

2- **се укрие** (IReflV, 1)Tokens : 
се
укрие
...
### Existing MWEs: 
2- **е подложена на натиск** (ID, 2)Tokens : 
е
подложена
на
натиск
...
### Existing MWEs: 
2- **ще внесе вот на недоверие** (ID, 1)Tokens : 
ще
внесе
вот
на
...
### Identified MWEs: 
1- **ще внесе вот на недоверие** Tokens : 
ще
внесе
вот
на
...
### Existing MWEs: 
1- **се е случило** (IReflV, 1)Tokens : 
се
е
случило
...
### Existing MWEs: 
1- **ще се състои** (IReflV, 3)Tokens : 
ще
се
състои
...
### Existing MWEs: 
1- **се присъединят** (IReflV, 10)Tokens : 
се
присъединят

### Identified MWEs: 
1- **се присъединят през** Tokens : 
се
присъединят
през
...
### Existing MWEs: 
1- **поеме отговорността** (LVC, 2)Tokens : 
поеме
отговорността
...
### Identified MWEs: 
1- **ще поемат отговорност** Tokens : 
ще
поемат
отговорност
...
### Existing MWEs: 
1- **ще се срещнат** (IReflV, 5)Tokens : 
ще
се
срещнат
...
### Existing MWEs: 
1- **изрази увереност** (LVC, 4)Tokens : 
изрази
увереност
...
### Existing MWEs: 
1- **окажат подкрепа** (LVC, 1)Tokens : 
окажат
подкрепа
...
### Existing MWEs: 
1- **се е подобрила** (IReflV, 1)Tokens : 
се
е
подобрила
...
### Existing MWEs: 
1- **изрази подкрепата** (LVC, 2)Tokens : 
изрази
подкрепата
...
### Existing MWEs: 
1- **няма да се отрази** (IReflV, 1)Tokens : 
няма
да
се
отрази
