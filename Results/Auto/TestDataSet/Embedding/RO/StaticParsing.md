...
### Existing MWEs: 
11- **se desfășura** (IReflV)

1- **luându se în considerare** (LVC)

2- **luându în considerare** (LVC), DistributedEmbedding 
...
5- **se pregăteau** (IReflV)

9- **s confruntat** (IReflV)

10- **s înregistrat** (IReflV)

6- **se pregătesc** (IReflV)
...
1038- REDUCE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [prin, surprindere, gărzile ,.. ]
...
1040- REDUCE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [surprindere, gărzile, republicane ,.. ]
...
4- **s confruntat** (IReflV)

8- **s prezentat** (IReflV)

9- **s destrămat** (IReflV)

10- **s retras** (IReflV)

2- **se prezinte** (IReflV)

3- **se află** (IReflV)

5- **s înregistrat** (IReflV)
...
913- REDUCE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [s]   B= [au, refugiat, în ,.. ]
...
915- REDUCE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [s]   B= [refugiat, în, siria ,.. ]
...
917- **MERGE_AS_IReflV**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [[s, refugiat]]   B= [în, siria, l ,.. ]
...
959- REDUCE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [s]   B= [terminat, l, lupte ,.. ]
...
961- **MERGE_AS_IReflV**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [[s, terminat]]   B= [l, lupte, izolate ,.. ]
...
7- REDUCE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [se]   B= [clasa, pe, primul ,.. ]
...
9- **MERGE_AS_IReflV**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [[se, clasa]]   B= [pe, primul, loc ,.. ]
...
9- **MERGE_AS_IReflV**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [[se, alinia]]   B= [și, cel, mai ,.. ]
...
79- **MERGE_AS_IReflV**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [[se, clasa]]   B= [pentru, a, cincea ,.. ]
