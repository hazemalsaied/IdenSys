...
2- **s lăsat** (IReflV, 4), DistributedEmbedding 
3- **s - lăsat** (IReflV, 4)
### Identified MWEs: 
...
### Identified MWEs: 
1- **luat cunoștință** (LVC)
2- **avut întâlniri** (LVC)
## Sentence No. 9105 - 
...
### Identified MWEs: 
1- **piatra de temelie** (ID)
2- **pus piatra de temelie** (ID)
3- **se ridica** (IReflV)
## Sentence No. 15285 - 
...
### Existing MWEs: 
1- **s soldat** (IReflV, 3), Embedded 
2- **s soldat cu moartea** (ID, 1)
### Identified MWEs: 
1- **s soldat** (IReflV)
2- **s soldat cu moartea** (ID)
## Sentence No. 24990 - 
