...
B0Token: transporto, B0_LastThreeLetters: rto, B0_LastTwoLetters: to, B1Token: priemonių, B1_LastThreeLetters: ių, B1_LastTwoLetters: ų, S0B0Distance: 1, S0B0Token: Vokietijos_transporto, S0B1Token: Vokietijos_priemonių, S0B2Token: Vokietijos_kontrolieriaus, S0Token: Vokietijos, S0_LastThreeLetters: jos, S0_LastTwoLetters: os, 

2- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [transporto, priemonių, kontrolieriaus ,.. ]

B0Token: transporto, B0_LastThreeLetters: rto, B0_LastTwoLetters: to, B1Token: priemonių, B1_LastThreeLetters: ių, B1_LastTwoLetters: ų, TransHistory1: 0, 

3- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [transporto]   B= [priemonių, kontrolieriaus, įstaiga ,.. ]

B0Token: priemonių, B0_LastThreeLetters: ių, B0_LastTwoLetters: ų, B1Token: kontrolieriaus, B1_LastThreeLetters: aus, B1_LastTwoLetters: us, S0B0Distance: 1, S0B0Token: transporto_priemonių, S0B1Token: transporto_kontrolieriaus, S0B2Token: transporto_įstaiga, S0Token: transporto, S0_LastThreeLetters: rto, S0_LastTwoLetters: to, TransHistory1: 2, TransHistory2: 20, 

4- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [priemonių, kontrolieriaus, įstaiga ,.. ]

B0Token: priemonių, B0_LastThreeLetters: ių, B0_LastTwoLetters: ų, B1Token: kontrolieriaus, B1_LastThreeLetters: aus, B1_LastTwoLetters: us, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

5- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [priemonių]   B= [kontrolieriaus, įstaiga, KBA ,.. ]

B0Token: kontrolieriaus, B0_LastThreeLetters: aus, B0_LastTwoLetters: us, B1Token: įstaiga, B1_LastThreeLetters: iga, B1_LastTwoLetters: ga, S0B0Distance: 1, S0B0Token: priemonių_kontrolieriaus, S0B1Token: priemonių_įstaiga, S0B2Token: priemonių_KBA, S0Token: priemonių, S0_LastThreeLetters: ių, S0_LastTwoLetters: ų, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

6- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [kontrolieriaus, įstaiga, KBA ,.. ]

B0Token: kontrolieriaus, B0_LastThreeLetters: aus, B0_LastTwoLetters: us, B1Token: įstaiga, B1_LastThreeLetters: iga, B1_LastTwoLetters: ga, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 
...
B0Token: įstaiga, B0_LastThreeLetters: iga, B0_LastTwoLetters: ga, B1Token: KBA, B1_LastThreeLetters: KBA, B1_LastTwoLetters: BA, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

9- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [įstaiga]   B= [KBA, uždegė, žalią ,.. ]

B0Token: KBA, B0_LastThreeLetters: KBA, B0_LastTwoLetters: BA, B1Token: uždegė, B1_LastThreeLetters: gė, B1_LastTwoLetters: ė, S0B0Distance: 1, S0B0Token: įstaiga_KBA, S0B1Token: įstaiga_uždegė, S0B2Token: įstaiga_žalią, S0Token: įstaiga, S0_LastThreeLetters: iga, S0_LastTwoLetters: ga, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

10- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [KBA, uždegė, žalią ,.. ]

B0Token: KBA, B0_LastThreeLetters: KBA, B0_LastTwoLetters: BA, B1Token: uždegė, B1_LastThreeLetters: gė, B1_LastTwoLetters: ė, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

11- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [KBA]   B= [uždegė, žalią, šviesą ,.. ]

B0Token: uždegė, B0_LastThreeLetters: gė, B0_LastTwoLetters: ė, B1Token: žalią, B1_LastThreeLetters: ią, B1_LastTwoLetters: ą, S0B0Distance: 1, S0B0Token: KBA_uždegė, S0B1Token: KBA_žalią, S0B2Token: KBA_šviesą, S0Token: KBA, S0_LastThreeLetters: KBA, S0_LastTwoLetters: BA, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

12- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [uždegė, žalią, šviesą ,.. ]

B0Token: uždegė, B0_LastThreeLetters: gė, B0_LastTwoLetters: ė, B1Token: žalią, B1_LastThreeLetters: ią, B1_LastTwoLetters: ą, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 
...
B0Token: šviesą, B0_LastThreeLetters: są, B0_LastTwoLetters: ą, B1Token: „, B1_LastThreeLetters: „, B1_LastTwoLetters: ��, S0B0Distance: 1, S0B0Token: žalią_šviesą, S0B1Token: žalią_„, S0B2Token: žalią_Opel, S0S1Distance: 1, S0Token: žalią, S0_LastThreeLetters: ią, S0_LastTwoLetters: ą, S1B0Token: uždegė_šviesą, S1S0B0Token: uždegė_žalią_šviesą, S1S0Token: uždegė_žalią, S1Token: uždegė, S1_LastThreeLetters: gė, S1_LastTwoLetters: ė, StackLengthIs: 2, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

15- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [uždegė, žalią, šviesą]   B= [„, Opel, “ ,.. ]

B0Token: „, B0_LastThreeLetters: „, B0_LastTwoLetters: ��, B1Token: Opel, B1_LastThreeLetters: pel, B1_LastTwoLetters: el, S0B0Distance: 1, S0B0Token: šviesą_„, S0B1Token: šviesą_Opel, S0B2Token: šviesą_“, S0S1Distance: 1, S0Token: šviesą, S0_LastThreeLetters: są, S0_LastTwoLetters: ą, S1B0Token: žalią_„, S1S0B0Token: žalią_šviesą_„, S1S0Token: žalią_šviesą, S1Token: žalią, S1_LastThreeLetters: ią, S1_LastTwoLetters: ą, StackLengthIs: 3, TransHistory1: 0, TransHistory2: 00, TransHistory3: 002, 

16- **MERGE**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [uždegė, [žalią, šviesą]]   B= [„, Opel, “ ,.. ]

B0Token: „, B0_LastThreeLetters: „, B0_LastTwoLetters: ��, B1Token: Opel, B1_LastThreeLetters: pel, B1_LastTwoLetters: el, S0B0Distance: 1, S0B0Token: žalią_šviesą_„, S0B1Token: žalią_šviesą_Opel, S0B2Token: žalią_šviesą_“, S0Token: žalią_šviesą, S1B0Token: uždegė_„, S1S0B0Token: uždegė_žalią_šviesą_„, S1S0Token: uždegė_žalią_šviesą, S1Token: uždegė, S1_LastThreeLetters: gė, S1_LastTwoLetters: ė, StackLengthIs: 2, TransHistory1: 0, TransHistory2: 00, TransHistory3: 000, 

17- **MERGE**&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [[uždegė, [žalią, šviesą]]]   B= [„, Opel, “ ,.. ]

B0Token: „, B0_LastThreeLetters: „, B0_LastTwoLetters: ��, B1Token: Opel, B1_LastThreeLetters: pel, B1_LastTwoLetters: el, S0B0Distance: 1, S0B0Token: uždegė_žalią_šviesą_„, S0B1Token: uždegė_žalią_šviesą_Opel, S0B2Token: uždegė_žalią_šviesą_“, S0Token: uždegė_žalią_šviesą, TransHistory1: 1, TransHistory2: 10, TransHistory3: 100, 

18- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [„, Opel, “ ,.. ]

B0Token: „, B0_LastThreeLetters: „, B0_LastTwoLetters: ��, B1Token: Opel, B1_LastThreeLetters: pel, B1_LastTwoLetters: el, TransHistory1: 1, TransHistory2: 11, TransHistory3: 110, 

19- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [„]   B= [Opel, “, dyzeliniams ,.. ]

B0Token: Opel, B0_LastThreeLetters: pel, B0_LastTwoLetters: el, B1Token: “, B1_LastThreeLetters: “, B1_LastTwoLetters: ��, S0B0Distance: 1, S0B0Token: „_Opel, S0B1Token: „_“, S0B2Token: „_dyzeliniams, S0Token: „, S0_LastThreeLetters: „, S0_LastTwoLetters: ��, TransHistory1: 2, TransHistory2: 21, TransHistory3: 211, 

20- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [Opel, “, dyzeliniams ,.. ]

B0Token: Opel, B0_LastThreeLetters: pel, B0_LastTwoLetters: el, B1Token: “, B1_LastThreeLetters: “, B1_LastTwoLetters: ��, TransHistory1: 0, TransHistory2: 02, TransHistory3: 021, 

21- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [Opel]   B= [“, dyzeliniams, varikliams ,.. ]

B0Token: “, B0_LastThreeLetters: “, B0_LastTwoLetters: ��, B1Token: dyzeliniams, B1_LastThreeLetters: ams, B1_LastTwoLetters: ms, S0B0Distance: 1, S0B0Token: Opel_“, S0B1Token: Opel_dyzeliniams, S0B2Token: Opel_varikliams, S0Token: Opel, S0_LastThreeLetters: pel, S0_LastTwoLetters: el, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

22- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [“, dyzeliniams, varikliams ,.. ]

B0Token: “, B0_LastThreeLetters: “, B0_LastTwoLetters: ��, B1Token: dyzeliniams, B1_LastThreeLetters: ams, B1_LastTwoLetters: ms, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

23- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [“]   B= [dyzeliniams, varikliams, , ,.. ]

B0Token: dyzeliniams, B0_LastThreeLetters: ams, B0_LastTwoLetters: ms, B1Token: varikliams, B1_LastThreeLetters: ams, B1_LastTwoLetters: ms, S0B0Distance: 1, S0B0Token: “_dyzeliniams, S0B1Token: “_varikliams, S0B2Token: “_,, S0Token: “, S0_LastThreeLetters: “, S0_LastTwoLetters: ��, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

24- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [dyzeliniams, varikliams, , ,.. ]

B0Token: dyzeliniams, B0_LastThreeLetters: ams, B0_LastTwoLetters: ms, B1Token: varikliams, B1_LastThreeLetters: ams, B1_LastTwoLetters: ms, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

25- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [dyzeliniams]   B= [varikliams, ,, ant ,.. ]

B0Token: varikliams, B0_LastThreeLetters: ams, B0_LastTwoLetters: ms, B1Token: ,, B1_LastThreeLetters: ,, B1_LastTwoLetters: ,, S0B0Distance: 1, S0B0Token: dyzeliniams_varikliams, S0B1Token: dyzeliniams_,, S0B2Token: dyzeliniams_ant, S0Token: dyzeliniams, S0_LastThreeLetters: ams, S0_LastTwoLetters: ms, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

26- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [varikliams, ,, ant ,.. ]

B0Token: varikliams, B0_LastThreeLetters: ams, B0_LastTwoLetters: ms, B1Token: ,, B1_LastThreeLetters: ,, B1_LastTwoLetters: ,, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

27- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [varikliams]   B= [,, ant, kurių ,.. ]

B0Token: ,, B0_LastThreeLetters: ,, B0_LastTwoLetters: ,, B1Token: ant, B1_LastThreeLetters: ant, B1_LastTwoLetters: nt, S0B0Distance: 1, S0B0Token: varikliams_,, S0B1Token: varikliams_ant, S0B2Token: varikliams_kurių, S0Token: varikliams, S0_LastThreeLetters: ams, S0_LastTwoLetters: ms, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

28- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [,, ant, kurių ,.. ]

B0Token: ,, B0_LastThreeLetters: ,, B0_LastTwoLetters: ,, B1Token: ant, B1_LastThreeLetters: ant, B1_LastTwoLetters: nt, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

29- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [,]   B= [ant, kurių, buvo ,.. ]

B0Token: ant, B0_LastThreeLetters: ant, B0_LastTwoLetters: nt, B1Token: kurių, B1_LastThreeLetters: ių, B1_LastTwoLetters: ų, S0B0Distance: 1, S0B0Token: ,_ant, S0B1Token: ,_kurių, S0B2Token: ,_buvo, S0Token: ,, S0_LastThreeLetters: ,, S0_LastTwoLetters: ,, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

30- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [ant, kurių, buvo ,.. ]

B0Token: ant, B0_LastThreeLetters: ant, B0_LastTwoLetters: nt, B1Token: kurių, B1_LastThreeLetters: ių, B1_LastTwoLetters: ų, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

31- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [ant]   B= [kurių, buvo, kritęs ,.. ]

B0Token: kurių, B0_LastThreeLetters: ių, B0_LastTwoLetters: ų, B1Token: buvo, B1_LastThreeLetters: uvo, B1_LastTwoLetters: vo, S0B0Distance: 1, S0B0Token: ant_kurių, S0B1Token: ant_buvo, S0B2Token: ant_kritęs, S0Token: ant, S0_LastThreeLetters: ant, S0_LastTwoLetters: nt, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

32- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [kurių, buvo, kritęs ,.. ]

B0Token: kurių, B0_LastThreeLetters: ių, B0_LastTwoLetters: ų, B1Token: buvo, B1_LastThreeLetters: uvo, B1_LastTwoLetters: vo, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

33- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [kurių]   B= [buvo, kritęs, įtarimų ,.. ]

B0Token: buvo, B0_LastThreeLetters: uvo, B0_LastTwoLetters: vo, B1Token: kritęs, B1_LastThreeLetters: ęs, B1_LastTwoLetters: �s, S0B0Distance: 1, S0B0Token: kurių_buvo, S0B1Token: kurių_kritęs, S0B2Token: kurių_įtarimų, S0Token: kurių, S0_LastThreeLetters: ių, S0_LastTwoLetters: ų, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

34- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [buvo, kritęs, įtarimų ,.. ]

B0Token: buvo, B0_LastThreeLetters: uvo, B0_LastTwoLetters: vo, B1Token: kritęs, B1_LastThreeLetters: ęs, B1_LastTwoLetters: �s, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

35- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [buvo]   B= [kritęs, įtarimų, šešėlis ,.. ]

B0Token: kritęs, B0_LastThreeLetters: ęs, B0_LastTwoLetters: �s, B1Token: įtarimų, B1_LastThreeLetters: mų, B1_LastTwoLetters: ų, S0B0Distance: 1, S0B0Token: buvo_kritęs, S0B1Token: buvo_įtarimų, S0B2Token: buvo_šešėlis, S0Token: buvo, S0_LastThreeLetters: uvo, S0_LastTwoLetters: vo, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

36- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [kritęs, įtarimų, šešėlis ,.. ]

B0Token: kritęs, B0_LastThreeLetters: ęs, B0_LastTwoLetters: �s, B1Token: įtarimų, B1_LastThreeLetters: mų, B1_LastTwoLetters: ų, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

37- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [kritęs]   B= [įtarimų, šešėlis, , ,.. ]

B0Token: įtarimų, B0_LastThreeLetters: mų, B0_LastTwoLetters: ų, B1Token: šešėlis, B1_LastThreeLetters: lis, B1_LastTwoLetters: is, S0B0Distance: 1, S0B0Token: kritęs_įtarimų, S0B1Token: kritęs_šešėlis, S0B2Token: kritęs_,, S0Token: kritęs, S0_LastThreeLetters: ęs, S0_LastTwoLetters: �s, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

38- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [kritęs, įtarimų]   B= [šešėlis, ,, esą ,.. ]

B0Token: šešėlis, B0_LastThreeLetters: lis, B0_LastTwoLetters: is, B1Token: ,, B1_LastThreeLetters: ,, B1_LastTwoLetters: ,, S0B0Distance: 1, S0B0Token: įtarimų_šešėlis, S0B1Token: įtarimų_,, S0B2Token: įtarimų_esą, S0S1Distance: 1, S0Token: įtarimų, S0_LastThreeLetters: mų, S0_LastTwoLetters: ų, S1B0Token: kritęs_šešėlis, S1S0B0Token: kritęs_įtarimų_šešėlis, S1S0Token: kritęs_įtarimų, S1Token: kritęs, S1_LastThreeLetters: ęs, S1_LastTwoLetters: �s, StackLengthIs: 2, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

39- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [kritęs]   B= [šešėlis, ,, esą ,.. ]

B0Token: šešėlis, B0_LastThreeLetters: lis, B0_LastTwoLetters: is, B1Token: ,, B1_LastThreeLetters: ,, B1_LastTwoLetters: ,, S0B0Distance: 2, S0B0Token: kritęs_šešėlis, S0B1Token: kritęs_,, S0B2Token: kritęs_esą, S0Token: kritęs, S0_LastThreeLetters: ęs, S0_LastTwoLetters: �s, TransHistory1: 0, TransHistory2: 00, TransHistory3: 002, 
...
B0Token: ,, B0_LastThreeLetters: ,, B0_LastTwoLetters: ,, B1Token: esą, B1_LastThreeLetters: są, B1_LastTwoLetters: ą, S0B0Distance: 1, S0B0Token: kritęs_šešėlis_,, S0B1Token: kritęs_šešėlis_esą, S0B2Token: kritęs_šešėlis_juose, S0Token: kritęs_šešėlis, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

42- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [,, esą, juose ,.. ]

B0Token: ,, B0_LastThreeLetters: ,, B0_LastTwoLetters: ,, B1Token: esą, B1_LastThreeLetters: są, B1_LastTwoLetters: ą, TransHistory1: 1, TransHistory2: 10, TransHistory3: 102, 

43- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [,]   B= [esą, juose, naudojama ,.. ]

B0Token: esą, B0_LastThreeLetters: są, B0_LastTwoLetters: ą, B1Token: juose, B1_LastThreeLetters: ose, B1_LastTwoLetters: se, S0B0Distance: 1, S0B0Token: ,_esą, S0B1Token: ,_juose, S0B2Token: ,_naudojama, S0Token: ,, S0_LastThreeLetters: ,, S0_LastTwoLetters: ,, TransHistory1: 2, TransHistory2: 21, TransHistory3: 210, 

44- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [esą, juose, naudojama ,.. ]

B0Token: esą, B0_LastThreeLetters: są, B0_LastTwoLetters: ą, B1Token: juose, B1_LastThreeLetters: ose, B1_LastTwoLetters: se, TransHistory1: 0, TransHistory2: 02, TransHistory3: 021, 
...
B0Token: juose, B0_LastThreeLetters: ose, B0_LastTwoLetters: se, B1Token: naudojama, B1_LastThreeLetters: ama, B1_LastTwoLetters: ma, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

47- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [juose]   B= [naudojama, programinė, įranga ,.. ]

B0Token: naudojama, B0_LastThreeLetters: ama, B0_LastTwoLetters: ma, B1Token: programinė, B1_LastThreeLetters: nė, B1_LastTwoLetters: ė, S0B0Distance: 1, S0B0Token: juose_naudojama, S0B1Token: juose_programinė, S0B2Token: juose_įranga, S0Token: juose, S0_LastThreeLetters: ose, S0_LastTwoLetters: se, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

48- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [naudojama, programinė, įranga ,.. ]

B0Token: naudojama, B0_LastThreeLetters: ama, B0_LastTwoLetters: ma, B1Token: programinė, B1_LastThreeLetters: nė, B1_LastTwoLetters: ė, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

49- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [naudojama]   B= [programinė, įranga, , ,.. ]

B0Token: programinė, B0_LastThreeLetters: nė, B0_LastTwoLetters: ė, B1Token: įranga, B1_LastThreeLetters: nga, B1_LastTwoLetters: ga, S0B0Distance: 1, S0B0Token: naudojama_programinė, S0B1Token: naudojama_įranga, S0B2Token: naudojama_,, S0Token: naudojama, S0_LastThreeLetters: ama, S0_LastTwoLetters: ma, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

50- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [programinė, įranga, , ,.. ]

B0Token: programinė, B0_LastThreeLetters: nė, B0_LastTwoLetters: ė, B1Token: įranga, B1_LastThreeLetters: nga, B1_LastTwoLetters: ga, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

51- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [programinė]   B= [įranga, ,, skirta ,.. ]

B0Token: įranga, B0_LastThreeLetters: nga, B0_LastTwoLetters: ga, B1Token: ,, B1_LastThreeLetters: ,, B1_LastTwoLetters: ,, S0B0Distance: 1, S0B0Token: programinė_įranga, S0B1Token: programinė_,, S0B2Token: programinė_skirta, S0Token: programinė, S0_LastThreeLetters: nė, S0_LastTwoLetters: ė, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

52- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [įranga, ,, skirta ,.. ]

B0Token: įranga, B0_LastThreeLetters: nga, B0_LastTwoLetters: ga, B1Token: ,, B1_LastThreeLetters: ,, B1_LastTwoLetters: ,, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

53- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [įranga]   B= [,, skirta, nuslėpti ,.. ]

B0Token: ,, B0_LastThreeLetters: ,, B0_LastTwoLetters: ,, B1Token: skirta, B1_LastThreeLetters: rta, B1_LastTwoLetters: ta, S0B0Distance: 1, S0B0Token: įranga_,, S0B1Token: įranga_skirta, S0B2Token: įranga_nuslėpti, S0Token: įranga, S0_LastThreeLetters: nga, S0_LastTwoLetters: ga, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

54- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [,, skirta, nuslėpti ,.. ]

B0Token: ,, B0_LastThreeLetters: ,, B0_LastTwoLetters: ,, B1Token: skirta, B1_LastThreeLetters: rta, B1_LastTwoLetters: ta, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

55- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [,]   B= [skirta, nuslėpti, tikruosius ,.. ]

B0Token: skirta, B0_LastThreeLetters: rta, B0_LastTwoLetters: ta, B1Token: nuslėpti, B1_LastThreeLetters: pti, B1_LastTwoLetters: ti, S0B0Distance: 1, S0B0Token: ,_skirta, S0B1Token: ,_nuslėpti, S0B2Token: ,_tikruosius, S0Token: ,, S0_LastThreeLetters: ,, S0_LastTwoLetters: ,, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

56- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [skirta, nuslėpti, tikruosius ,.. ]

B0Token: skirta, B0_LastThreeLetters: rta, B0_LastTwoLetters: ta, B1Token: nuslėpti, B1_LastThreeLetters: pti, B1_LastTwoLetters: ti, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

57- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [skirta]   B= [nuslėpti, tikruosius, duomenis ,.. ]

B0Token: nuslėpti, B0_LastThreeLetters: pti, B0_LastTwoLetters: ti, B1Token: tikruosius, B1_LastThreeLetters: ius, B1_LastTwoLetters: us, S0B0Distance: 1, S0B0Token: skirta_nuslėpti, S0B1Token: skirta_tikruosius, S0B2Token: skirta_duomenis, S0Token: skirta, S0_LastThreeLetters: rta, S0_LastTwoLetters: ta, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

58- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [nuslėpti, tikruosius, duomenis ,.. ]

B0Token: nuslėpti, B0_LastThreeLetters: pti, B0_LastTwoLetters: ti, B1Token: tikruosius, B1_LastThreeLetters: ius, B1_LastTwoLetters: us, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

59- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [nuslėpti]   B= [tikruosius, duomenis, apie ,.. ]

B0Token: tikruosius, B0_LastThreeLetters: ius, B0_LastTwoLetters: us, B1Token: duomenis, B1_LastThreeLetters: nis, B1_LastTwoLetters: is, S0B0Distance: 1, S0B0Token: nuslėpti_tikruosius, S0B1Token: nuslėpti_duomenis, S0B2Token: nuslėpti_apie, S0Token: nuslėpti, S0_LastThreeLetters: pti, S0_LastTwoLetters: ti, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

60- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [tikruosius, duomenis, apie ,.. ]

B0Token: tikruosius, B0_LastThreeLetters: ius, B0_LastTwoLetters: us, B1Token: duomenis, B1_LastThreeLetters: nis, B1_LastTwoLetters: is, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

61- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [tikruosius]   B= [duomenis, apie, aplinkai ,.. ]

B0Token: duomenis, B0_LastThreeLetters: nis, B0_LastTwoLetters: is, B1Token: apie, B1_LastThreeLetters: pie, B1_LastTwoLetters: ie, S0B0Distance: 1, S0B0Token: tikruosius_duomenis, S0B1Token: tikruosius_apie, S0B2Token: tikruosius_aplinkai, S0Token: tikruosius, S0_LastThreeLetters: ius, S0_LastTwoLetters: us, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

62- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [duomenis, apie, aplinkai ,.. ]

B0Token: duomenis, B0_LastThreeLetters: nis, B0_LastTwoLetters: is, B1Token: apie, B1_LastThreeLetters: pie, B1_LastTwoLetters: ie, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 
...
B0Token: apie, B0_LastThreeLetters: pie, B0_LastTwoLetters: ie, B1Token: aplinkai, B1_LastThreeLetters: kai, B1_LastTwoLetters: ai, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

65- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [apie]   B= [aplinkai, daromą, žalą ,.. ]

B0Token: aplinkai, B0_LastThreeLetters: kai, B0_LastTwoLetters: ai, B1Token: daromą, B1_LastThreeLetters: mą, B1_LastTwoLetters: ą, S0B0Distance: 1, S0B0Token: apie_aplinkai, S0B1Token: apie_daromą, S0B2Token: apie_žalą, S0Token: apie, S0_LastThreeLetters: pie, S0_LastTwoLetters: ie, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

66- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [aplinkai, daromą, žalą ,.. ]

B0Token: aplinkai, B0_LastThreeLetters: kai, B0_LastTwoLetters: ai, B1Token: daromą, B1_LastThreeLetters: mą, B1_LastTwoLetters: ą, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

67- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [aplinkai]   B= [daromą, žalą, , ,.. ]

B0Token: daromą, B0_LastThreeLetters: mą, B0_LastTwoLetters: ą, B1Token: žalą, B1_LastThreeLetters: lą, B1_LastTwoLetters: ą, S0B0Distance: 1, S0B0Token: aplinkai_daromą, S0B1Token: aplinkai_žalą, S0B2Token: aplinkai_,, S0Token: aplinkai, S0_LastThreeLetters: kai, S0_LastTwoLetters: ai, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

68- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [daromą, žalą, , ,.. ]

B0Token: daromą, B0_LastThreeLetters: mą, B0_LastTwoLetters: ą, B1Token: žalą, B1_LastThreeLetters: lą, B1_LastTwoLetters: ą, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

69- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [daromą]   B= [žalą, ,, skelbia ,.. ]

B0Token: žalą, B0_LastThreeLetters: lą, B0_LastTwoLetters: ą, B1Token: ,, B1_LastThreeLetters: ,, B1_LastTwoLetters: ,, S0B0Distance: 1, S0B0Token: daromą_žalą, S0B1Token: daromą_,, S0B2Token: daromą_skelbia, S0Token: daromą, S0_LastThreeLetters: mą, S0_LastTwoLetters: ą, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

70- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [žalą, ,, skelbia ,.. ]

B0Token: žalą, B0_LastThreeLetters: lą, B0_LastTwoLetters: ą, B1Token: ,, B1_LastThreeLetters: ,, B1_LastTwoLetters: ,, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

71- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [žalą]   B= [,, skelbia, „ ,.. ]

B0Token: ,, B0_LastThreeLetters: ,, B0_LastTwoLetters: ,, B1Token: skelbia, B1_LastThreeLetters: bia, B1_LastTwoLetters: ia, S0B0Distance: 1, S0B0Token: žalą_,, S0B1Token: žalą_skelbia, S0B2Token: žalą_„, S0Token: žalą, S0_LastThreeLetters: lą, S0_LastTwoLetters: ą, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

72- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [,, skelbia, „ ,.. ]

B0Token: ,, B0_LastThreeLetters: ,, B0_LastTwoLetters: ,, B1Token: skelbia, B1_LastThreeLetters: bia, B1_LastTwoLetters: ia, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

73- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [,]   B= [skelbia, „, Bild ,.. ]

B0Token: skelbia, B0_LastThreeLetters: bia, B0_LastTwoLetters: ia, B1Token: „, B1_LastThreeLetters: „, B1_LastTwoLetters: ��, S0B0Distance: 1, S0B0Token: ,_skelbia, S0B1Token: ,_„, S0B2Token: ,_Bild, S0Token: ,, S0_LastThreeLetters: ,, S0_LastTwoLetters: ,, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

74- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [skelbia, „, Bild ,.. ]

B0Token: skelbia, B0_LastThreeLetters: bia, B0_LastTwoLetters: ia, B1Token: „, B1_LastThreeLetters: „, B1_LastTwoLetters: ��, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

75- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [skelbia]   B= [„, Bild, am ,.. ]

B0Token: „, B0_LastThreeLetters: „, B0_LastTwoLetters: ��, B1Token: Bild, B1_LastThreeLetters: ild, B1_LastTwoLetters: ld, S0B0Distance: 1, S0B0Token: skelbia_„, S0B1Token: skelbia_Bild, S0B2Token: skelbia_am, S0Token: skelbia, S0_LastThreeLetters: bia, S0_LastTwoLetters: ia, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

76- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [„, Bild, am ,.. ]

B0Token: „, B0_LastThreeLetters: „, B0_LastTwoLetters: ��, B1Token: Bild, B1_LastThreeLetters: ild, B1_LastTwoLetters: ld, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

77- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [„]   B= [Bild, am, Sonntag ,.. ]

B0Token: Bild, B0_LastThreeLetters: ild, B0_LastTwoLetters: ld, B1Token: am, B1_LastThreeLetters: am, B1_LastTwoLetters: am, S0B0Distance: 1, S0B0Token: „_Bild, S0B1Token: „_am, S0B2Token: „_Sonntag, S0Token: „, S0_LastThreeLetters: „, S0_LastTwoLetters: ��, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

78- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [Bild, am, Sonntag ,.. ]

B0Token: Bild, B0_LastThreeLetters: ild, B0_LastTwoLetters: ld, B1Token: am, B1_LastThreeLetters: am, B1_LastTwoLetters: am, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

79- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [Bild]   B= [am, Sonntag, “ ,.. ]

B0Token: am, B0_LastThreeLetters: am, B0_LastTwoLetters: am, B1Token: Sonntag, B1_LastThreeLetters: tag, B1_LastTwoLetters: ag, S0B0Distance: 1, S0B0Token: Bild_am, S0B1Token: Bild_Sonntag, S0B2Token: Bild_“, S0Token: Bild, S0_LastThreeLetters: ild, S0_LastTwoLetters: ld, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

80- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [am, Sonntag, “ ,.. ]

B0Token: am, B0_LastThreeLetters: am, B0_LastTwoLetters: am, B1Token: Sonntag, B1_LastThreeLetters: tag, B1_LastTwoLetters: ag, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

81- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [am]   B= [Sonntag, “, . ,.. ]

B0Token: Sonntag, B0_LastThreeLetters: tag, B0_LastTwoLetters: ag, B1Token: “, B1_LastThreeLetters: “, B1_LastTwoLetters: ��, S0B0Distance: 1, S0B0Token: am_Sonntag, S0B1Token: am_“, S0B2Token: am_., S0Token: am, S0_LastThreeLetters: am, S0_LastTwoLetters: am, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 

82- COMPLETE&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= []   B= [Sonntag, “, . ,.. ]

B0Token: Sonntag, B0_LastThreeLetters: tag, B0_LastTwoLetters: ag, B1Token: “, B1_LastThreeLetters: “, B1_LastTwoLetters: ��, TransHistory1: 0, TransHistory2: 02, TransHistory3: 020, 

83- SHIFT&nbsp;&nbsp;&nbsp;>&nbsp;&nbsp;&nbsp;S= [Sonntag]   B= [“, . ,.. ]

B0Token: “, B0_LastThreeLetters: “, B0_LastTwoLetters: ��, B1Token: ., B1_LastThreeLetters: ., B1_LastTwoLetters: ., S0B0Distance: 1, S0B0Token: Sonntag_“, S0B1Token: Sonntag_., S0Token: Sonntag, S0_LastThreeLetters: tag, S0_LastTwoLetters: ag, TransHistory1: 2, TransHistory2: 20, TransHistory3: 202, 
