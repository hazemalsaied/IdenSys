...
class Corpus:
    ...
    def __init__(self, path):
        ...
        Report.createLanguageFolder(Parameters.languageName)
    ...
    def getTrainAndTestConlluPath(self,path):
        conlluFile, testConllu = '' , ''
        if Parameters.useAutoGeneratedPOS and Parameters.useAutoGeneratedDEP and os.path.isfile(
        ...
        elif Parameters.useAutoGeneratedPOS and os.path.isfile(os.path.join(path, 'train.conllu.autoPOS')):
    ...
    def printSentsWithEmbeddedMWEs(self):
        if not Parameters.printSentsWithEmbeddedMWEs:
            return
        for sent in self.trainDataSet:
            printSent = False
    ...
    def getMWEDic(trainingSents):
        ...
        if not Parameters.useCrossValidation:
            Report.createMWELexic(mweTokenDictionary)
    ...
    def __str__(self):
        ...
        while True:
            ...
            if transition is not None:
                ...
                if Parameters.printFeaturesOfSent and  len(self.featuresInfo) == 2 and len(self.featuresInfo[1]) > 0:
...
class VMWE:
    ...
    def __init__(self, id, token=None, type=None, isEmbedded=False, isInterleaving=False, isInTrainingCorpus=0):
        self.id = int(id)
